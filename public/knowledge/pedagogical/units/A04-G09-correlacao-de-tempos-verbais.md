...
**Método central:** A correlação verbal é reconstruída entre as orações: identifique os verbos, seus valores e a relação temporal-modal que torna a combinação coerente.
...
- **Morfologia Verbal:** Reconhecimento das desinências temporais e modais (ex.: `-sse-` para Pretérito Imperfeito do Subjuntivo, `-ria-` para Futuro do Pretérito, `-rá-/-rei-` para Futuro do Presente).
...
CORRELAÇÃO DE TEMPOS VERBAIS (Articulação / Paralelismo Semântico)
 ├── 1. Fundamentos & Bússola Temporal
 │ ├── Nomenclaturas: Correlação (FCC/VUNESP), Articulação (VUNESP), Paralelismo Semântico (FGV)
 │ └── Regra do 1º Verbo: O tempo do 1º verbo orienta a linha temporal subsequente
 ├── 2. Matrizes Temporais Canônicas
 ...
 │ └── Estruturas Compostas: Tivesse + Particípio ↔ Teria + Particípio
 ├── 3. Regras Especiais e Comportamentos Sintáticos
 ...
 │ └── Verbos de Desejo / Expectativa / Hipótese (desejava que, caso, se)
 ├── 4. Exceções Semânticas Legítimas
 │ └── Presente + Pretérito: Válido quando o Presente expressa um estado resultante de fatos passados
 └── 5. Estratégias por Banca Examinadora
 ├── Múltipla Escolha (VUNESP / FCC / FGV): Eliminação em bloco por descompasso de eixos
 ├── FCC: Cuidado com frases com mesmo tempo/modo, mas desprovidas de nexo lógico
 └── CEBRASPE: Diferenciar "manter a correlação temporal" de "preservar o sentido original"
```
...
Em editais e enunciados de provas, o assunto apresenta três nomenclaturas sinônimas:

1. **Correlação de Tempos e Modos Verbais** (nomenclatura clássica e padrão da FCC e VUNESP);
...
```text
 ┌──► Eixo do PRESENTE ──► Exige PRESENTE ou FUTURO DO PRESENTE
1º VERBO
(Bússola)
...
$$
\text{Presente} \longrightarrow \begin{cases} \text{Presente (Indicativo ou Subjuntivo)} \\ \text{Futuro do Presente (Indicativo)} \end{cases}
$$

Da mesma forma, quando a oração subordinada abre o período no **Futuro do Subjuntivo** ou no **Presente do Subjuntivo**, a oração principal correlata projeta-se no **Futuro do Presente do Indicativo**:
...
- **Presente do Subjuntivo + Futuro do Presente:** *Caso eu estude [Pres. Subj.], o resultado será [Fut. Pres. Ind.] satisfatório.* (Correto).
- **Futuro do Subjuntivo + Futuro do Presente:** *Quem vier [Fut. Subj.] a se empenhar, estará [Fut. Pres. Ind.] mais perto...* (Correto).
- **Inadequação por descompasso:** *Acredito [Presente] que estivesse [Pret. Imp. Subj.] doente.* (Incorreto).
...
$$
\text{Pretérito} \longrightarrow \begin{cases} \text{Pretérito (Indicativo ou Subjuntivo)} \\ \text{Futuro do Pretérito (Indicativo)} \end{cases}
$$

$$
\text{Futuro do Pretérito} \longrightarrow \text{Pretérito Imperfeito do Subjuntivo}
$$

$$
\text{Pretérito Imperfeito do Subjuntivo} \longrightarrow \text{Futuro do Pretérito do Indicativo}
$$

Nas **estruturas compostas**, o paralelismo mantém-se rigorosamente no pretérito:
...
- **Futuro do Pretérito + Pretérito:** *Seria [Fut. Pret.] legítimo que as pessoas lutassem [Pret. Imp. Subj.] por melhores condições.* (Correto).
- **Pretérito Composto + Futuro do Pretérito Composto:** *Se Dolores tivesse tornado [Pret. Imp. Subj. Comp.] seus dias úteis, teria recebido [Fut. Pret. Comp.] seu livro.* (Correto).
- **Inadequação por descompasso:** *Se eu tivesse dinheiro, viajo.* ou *Se estudasse, passará.* (Incorretos).
...
A regência sintática e o emprego de conjunções subordinativas frequentemente forçam a alternância modal (ex.: matriz declarativa que exige oração subordinada em modo subjuntivo). A harmonia verbal consiste em assegurar que ambos os modos convivam **dentro do mesmo ecrã temporal**:
...
|:----------------------------------- |:------------------------------------------ |:----------------------------------- |:------------------------------- |:---------------- |
| Principal$\rightarrow$ Subordinada | *Acredito* (Pres. Indicativo) | *esteja* (Pres. Subjuntivo) | **Presente** | **Correto** |
| Subordinada$\rightarrow$ Principal | *estudasse* (Pret. Imp. Subjuntivo) | *seria* (Fut. Pret. Indicativo) | **Pretérito / Hipótese** | **Correto** |
| Principal$\rightarrow$ Subordinada | *É legítimo* (Pres. Indicativo) | *lutem* (Pres. Subjuntivo) | **Presente** | **Correto** |
| Principal$\rightarrow$ Subordinada | *Seria legítimo* (Fut. Pret. Indicativo) | *lutassem* (Pret. Imp. Subjuntivo) | **Pretérito / Hipótese** | **Correto** |

- **Evita o erro descrito em:**
- **Citado em:**
...
FUTURO DO PRESENTE ──┼──► Amigo do FUTURO DO SUBJUNTIVO
 (Tem muitos amigos) └──► Amigo do próprio FUTURO DO PRESENTE

FUTURO DO PRETÉRITO ────► Amigo EXCLUSIVO do PRETÉRITO (especialmente Pret. Imp. Subj.)
 (Só tem 1 amigo)
```
...
1. Na locução `vier a se empenhar`: o auxiliar é `vier` (Futuro do Subjuntivo do verbo *vir*). Tempo da locução = **Futuro**.
2. Na oração seguinte: o verbo `estará` encontra-se no **Futuro do Presente do Indicativo**.
3. Na locução `costumam ocultar`: o auxiliar é `costumam` (Presente do Indicativo). Tempo da locução = **Presente**.

- **Diagnóstico:** Correlação perfeitamente harmônica no Eixo Presente/Futuro.
...
- **Altera o sentido:** Sim, pois o Modo Subjuntivo expressa possibilidade/hipótese, enquanto o Modo Indicativo afirma um fato categórico e certo.
- **Mantém a correlação verbal:** Sim, pois ambas as formas verbais situam-se rigorosamente no **Eixo do Presente**, mantendo a harmonia sintática com o verbo da oração principal (*parece*).
...
### Tabela Sintética de Combinações Canônicas

| Tempo / Estrutura Inicial (1º Verbo) | Tempos Correlatos Permitidos | Exemplo de Aplicação Canônica | ID Detalhado |
|:-------------------------------------------- |:------------------------------------------------------------------- |:------------------------------------------------------------ |:----------------- |
| **Presente do Indicativo** | Presente do Indicativo / Presente do Subjuntivo / Futuro do Presente | *Acredito que esteja doente.* / *É legítimo que lutem.* |  |
| **Presente do Subjuntivo** | Futuro do Presente do Indicativo / Presente do Indicativo | *Caso estude, o resultado será satisfatório.* |  |
| **Futuro do Subjuntivo** | Futuro do Presente do Indicativo | *Quem vier a se empenhar, estará mais perto.* |  |
| **Pretérito Imperfeito do Subjuntivo** | Futuro do Pretérito do Indicativo | *Se eu fosse rico, estaria viajando.* |  |
| **Futuro do Pretérito do Indicativo** | Pretérito Imperfeito do Subjuntivo | *Seria necessário que estudasse mais.* |  |
| **Pret. Imperfeito Subj. Composto** | Futuro do Pretérito Composto do Indicativo | *Se tivesse tornado, teria recebido o livro.* |  |
| **Presente do Indicativo (Resultado)** | Pretérito Perfeito do Indicativo (Causa pregressa) | *Hoje sou o que sou por tudo que conquistei.* |  |
...
```text
 ...
 │
 ▼
 [ Passo 2: Diagnóstico Semântico Rápido ]
 ├── Ideia de PRESENTE / FUTURO?
 └── Ideia de PASSADO / HIPÓTESE?
 │
 ▼
 [ Passo 3: Varredura e Eliminação em Bloco ]
 ├── Descartar misturas grosseiras (Futuro + Pretérito Perfeito, etc.)
 └── Reter apenas as 2 ou 3 alternativas com eixos congruentes
 │
 ▼
 [ Passo 4: Verificação de Gatilhos Sintáticos e Conectivos ]
 ├── Presença de Concessiva (mesmo que / embora) -> exige Subjuntivo
 ├── Presença de Verbo Volitivo (desejava que) -> exige Pret. Imp. Subj.
 └── Presença de Condicional irreal (se / caso) -> exige correlação modal
 │
 ▼
 [ Passo 5: Teste de Lógica Textual e Marcação ]
 ├── Confirmar nexo semântico global
 └── Marcar gabarito SEM tentar consertar alternativas erradas
```
...
### Tabela 1: Futuro do Presente vs. Futuro do Pretérito

| Parâmetro | Futuro do Presente do Indicativo | Futuro do Pretérito do Indicativo |
|:--------------------------------- |:------------------------------------------------------------------------------------- |:---------------------------------------------------------------- |
| **Sentido Central** | Ação certa ou provável posterior ao momento da fala | Ação hipotética, condicionada ou posterior a um fato passado |
| **Comportamento Relacional** | Amplo / Flexível ("Tem muitos amigos") | Rígido / Exclusivo ("Só é amigo do pretérito") |
...
|:-------------------------------- |:------------------------------------------------------------------------------------------ |:------------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------------------ |
| **Correlação Verbal** | Simetria de**linha temporal** (Eixo Presente com Presente; Eixo Passado com Passado). | Não exige que ambos os verbos estejam no mesmo**modo verbal**. | Julgar errada a frase*Acredito [Indicativo] que venha [Subjuntivo]* por terem modos diferentes. |
| **Identidade Modal (Mito)** | Exigência inexistente de manter Indicativo com Indicativo ou Subjuntivo com Subjuntivo. | Incompatível com as regras de subordinação substantiva e adverbial da língua portuguesa. | Tentar forçar o verbo subordinado para o Indicativo após conectivo concessivo ou volitivo. |
...
- **Julgamento:** **CORRETA.** Contexto legítimo de causa e efeito temporal (estado presente decorrente de fatos passados).
...
- **Gabarito:** **ERRADO**
- **Justificativa:** O verbo de referência no período é *passará* (Futuro do Presente). A introdução de *exigiria* (Futuro do Pretérito) quebraria a correlação, pois o Futuro do Pretérito não se correlaciona com o Futuro do Presente, mas exclusivamente com o Pretérito.
...
1. O verbo inicial expressa **PRESENTE** ou **PASSADO**?
...
Ao concluir este grupo temático, o estudante domina a análise teórica e a resolução prática da **Correlação de Tempos e Modos Verbais**:

1. **Domínio Conceitual:** Compreende que correlação, articulação e paralelismo semântico são termos equivalentes que exigem a preservação da coerência cronológica entre orações.
2. **Operacionalização da Bússola Temporal:** Sabe localizar o primeiro verbo da estrutura para identificar o eixo orientador (Presente ou Pretérito), reconhecendo que os demais verbos devem gravitar ao redor dessa mesma linha temporal.
3. **Desmistificação da Variação Modal:** Reconhece com segurança que o paralelismo exigido é temporal e não de modo, aceitando como perfeitamente normativas frases que combinam Modo Indicativo com Modo Subjuntivo no mesmo tempo.
4. **Comportamento dos Futuros e Gatilhos:** Sabe que o Futuro do Presente harmoniza-se com o Presente e com o Futuro, enquanto o Futuro do Pretérito liga-se exclusivamente ao Pretérito. Identifica de imediato conectivos concessivos (*mesmo que*) e verbos de desejo (*desejava que*) como gatilhos atratores do Subjuntivo.
5. **Análise de Locuções e Exceções:** Avalia locuções verbais examinando apenas o verbo auxiliar e evita o "raciocínio robótico", validando combinações de Presente + Pretérito quando expressarem causa e efeito temporal legítimos.
6. **Desempenho em Provas:** Aplica o método de eliminação em bloco para liquidar questões da VUNESP, FCC e FGV em menos de um minuto e sabe diferenciar questões do CEBRASPE sobre correção da correlação daquelas sobre manutenção de sentido.
