...
1. **O Mecanismo da Substituição por "Isso":** A oração subjetiva inteira funciona como um bloco conceitual neutro equivalente ao pronome demonstrativo invariável **"isso"**:
 ...
 $$
2. **Invariabilidade Absoluta:** Como o pronome neutro *isso* (e a oração que ele sintetiza) não possui gênero feminino nem número plural, é gramaticalmente impossível flexionar o predicativo para o feminino ou para o plural. No sujeito oracional, nem o verbo nem o adjetivo sofrem qualquer flexão.

`text
[ É necessário ] ◄─────── [ solidarizar-se com o indivíduo que não aceita... ]
 (Predicado) (Oração Subordinada Substantiva Subjetiva)
 │ │
 ▼ ▼
...
## Concordância do Adjetivo "Possível" em Estruturas Superlativas Relativas
 ...
 * Se o artigo estiver no **plural** (*os*, *as*), emprega-se obrigatoriamente a forma no **plural** (*possíveis*).
2. **Independência Sintática:**
 * O substantivo rege a concordância normal dos adjetivos qualificadores comuns (ex.: *histórias interessantes*, *casos variados*).
 * O adjetivo *possível* ignora o substantivo e atrela-se unicamente ao artigo da locução intensificadora.

### Exemplos e contraexemplos

* Substantivo Feminino Plural:
 * *Histórias as mais interessantes **possíveis**.* (Artigo *as* plural $\to$ *possíveis*).
 * *Histórias o mais interessantes **possível**.* (Artigo *o* singular $\to$ *possível*).
* Substantivo Masculino Plural:
 * *Casos os mais variados **possíveis**.* (Artigo *os* plural $\to$ *possíveis*).
 * *Casos o mais variados **possível**.* (Artigo *o* singular $\to$ *possível*).
* Questão de Concurso:
 * *A enfermeira vacinou **o** maior número de crianças **possível**.* (Artigo *o* no singular $\to$ *possível*).

---

## Dupla Possibilidade da Locução Explicativa "Haja Vista"
...
2. **Segunda Possibilidade — Flexão Verbal diante de Plural (Padrão Clássico):** Caso o termo subsequente seja um substantivo plural, aceita-se que esse substantivo funcione como sujeito sintático da locução, fazendo o verbo flexionar para *hajam*.
 * *Exemplo:* *hajam vista as suas edições sucessivas*.
3. **Invariabilidade Absoluta de "Vista":** A palavra *vista* jamais aceita desinência de plural nesta locução. As formas *haja vistas* ou *hajam vistas* são incorretas.

* **Paralelo com:**  (*Olhos vistos*).

---

## Dupla Possibilidade da Locução "A Olhos Vistos / Olhos Vistos"
...
2. **Segunda Possibilidade — Concordância com o Referente (*a olhos visto/vista/vistas/vistos*):** O elemento *visto* projeta sua concordância para o sujeito da oração (sob a semântica de que o sujeito foi visto a olhos).
...
## Concordância Bivalente da Locução Comparativa "Tal Qual" e Anáfora de "Como Tal"
...
2. **Estrutura Anafórica "Como Tal / Como Tais":** O pronome demonstrativo/adjetivo *tal* não é invariável. Se o termo antecedente retomado for plural, exige-se a forma no plural *como tais*.
...
"o período de seca e de inundação" ──► 1 núcleo ──► alterado (singular - preferência Bechara)
"o período de seca e o de inundação" ──► 2 núcleos ──► alterados (plural obrigatório)
```text

---

## Comportamento Sintático de Vocábulos Especiais: "Menos", "Só", "Junto" e "Alerta"
...
3. **Junto (Duplo Referente Sintático):**
...
4. **Alerta e a Locução "Em Alerta":**
 * *Alerta* como advérbio permanece invariável ("Os soldados ficaram **alerta**").
...
## Concordância do Particípio na Voz Passiva Analítica
...
### Tabela 1: Expressões Avaliativas — Determinante vs. Sentido Genérico vs. Sujeito Oracional
