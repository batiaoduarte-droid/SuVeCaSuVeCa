...
**Apoio estrutural:** Na narração e descrição, a SuVeCA acompanha agentes, eventos, estados, tempos e circunstâncias; a tipologia resulta do funcionamento global do texto.
...
- Conceito Básico de Tipologia Textual: Compreensão de que tipos textuais são modos de organização discursiva estruturados por traços linguísticos internos (distintos de gêneros textuais).
...
text DISTINÇÃO TIPOLÓGICA: NARRAÇÃO vs. DESCRIÇÃO
- ➔ 1. EIXO DA TEMPORALIDADE (Critério Estrutural Supremo)
➔ DESCRIÇÃO: Simultaneidade
- ➔ Um único momento no tempo
➔ Metáfora da Fotografia / Cena Congelada
- ➔ Inexistência de linha temporal "antes e depois"
➔ NARRAÇÃO: Sucessividade
- ➔ Momentos sucessivos no tempo
➔ Vetor Cronológico ("Antes e Depois" / Causa e Efeito)
- ➔ Transformação de estado / Enredo em movimento
➔ 2. EIXO DA INTENÇÃO COMUNICATIVA (Critério Pragmático Supremo)
- ➔ DESCRIÇÃO: Identificar, qualificar, localizar e detalhar
➔ Objetos, cenários, paisagens, pessoas
- ➔ Metas e objetivos institucionais abstratos
➔ Hábitos, costumes e rotinas periódicas
- ➔ NARRAÇÃO: Relatar acontecimentos e enredos
➔ Fatos vivenciados por personagens
- ➔ Presença de conflito, clímax e desfecho
➔ Diálogos e alternância de vozes (discurso direto/indireto)
- ➔ 3. EIXO DOS TEMPOS VERBAIS (Critério Secundário / Relativo)
➔ Padrão Prototípico no Pretérito:
- ➔ Pretérito Imperfeito ➔ > Expressa duração/continuidade ➔ > Base da Descrição
➔ Pretérito Perfeito / MQP ➔ > Expressa pontualidade/sucessão ➔ > Base da Narração
- ➔ Comportamento Híbrido no Presente:
➔ Presente Histórico ➔ > Substitui o pretérito (aproximação, vivacidade, suspense)
- ➔ Presente Descritivo ➔ > Detalha características estáticas ou metas
➔ Regra Crítica: O tempo verbal NÃO determina a tipologia por si só
- ➔ 4. EIXO DA PREDOMINÂNCIA EM TEXTOS HÍBRIDOS (Padrão de Concurso / Cebraspe) ➔ Estrutura Literária Padrão: Abertura narrativa + Entremeio descritivo + Desfecho narrativo
➔ Classificação: Texto PREDOMINANTEMENTE NARRATIVO com aspectos descritivos ➔ Tipos de Formulação de Questões: ➔ Itens Excludentes: Exigem a tipologia dominante (Narração prevalece em romances/contos) ➔ Itens Cumulativos: Validam a coexistência de sequências narrativas e descritivas
...
- Princípio da Simultaneidade: Todos os elementos e ações retratados coexistem em um mesmo instante temporal. O observador visualiza panoramicamente o cenário ou o objeto sem que a conclusão de uma ação seja pré-requisito para o início da outra.
...
- Pretérito Perfeito na Narração ("O tempo instantâneo"):

O pretérito perfeito expressa um fato delimitado, perfeito e completamente encerrado no passado (acabou, repousou, voltou-se, quis, respondeu). Cada ocorrência conclui um ciclo pontual e dispara a ação subsequente, fazendo a história avançar.
...
1. Equivalência Semântico-Funcional:
...
1. Pergunta da Temporalidade: "As ações acontecem em momentos sucessivos (antes e depois) ou coexistem em um único instante (simultaneidade)?"
...
1. Método de Checagem Estrutural:
...
1. Tipologias de Enunciado no Cebraspe:
...
1. Descrição de Rotina Habitual:
...
| Eixo Analítico | Tipo Textual DESCRIÇÃO | Tipo Textual NARRAÇÃO |
| --- | --- | --- |
| Temporalidade Interna | Simultaneidade (um único momento no tempo; tempo estático / congelado). | Sucessividade (momentos sucessivos; tempo em evolução / linha de antes e depois). |
| Metáfora Operacional | Fotografia (todos os elementos cabem em um único quadro visual estático). | Filme / Cinema (sucessão de quadros móveis com mudança de estado). |
| Intenção Comunicativa | Identificar, localizar, qualificar, caracterizar e detalhar objetos, cenas, pessoas, rotinas ou metas. | Relatar acontecimentos, enredos, histórias e conflitos vivenciados por personagens. |
| Tempos Verbais Típicos (Pretérito) | Pretérito Imperfeito do Indicativo (ações durativas, de cenário, incompletas). | Pretérito Perfeito / Mais-que-perfeito (ações instantâneas, pontuais, sucessivas). |
| Comportamento no Presente | Presente Descritivo / Presente Histórico (caracterização de metas, rotinas ou quadros simultâneos). | Presente Histórico / Narrativo (sucessão de ações pretéritas trazidas ao presente para criar vivacidade). |
| Elementos de Suporte | Substantivos, adjetivos, locuções adjetivas e termos qualificadores. | Verbos de ação, advérbios temporais, diálogos e discurso direto/indireto. |
| Regra de Predominância (Cebraspe) | Atua predominantemente como suporte cênico ou detalhamento de passagens em obras narrativas. | Prevalece estruturalmente em romances, contos e crônicas híbridas com evolução de enredo. |
...
**text [FRAGMENTO TEXTUAL DE PROVA]**

1. Mapear as ações, estados e intenção discursiva central
2. Aplicar o Teste da Temporalidade Interna As ações / estados ocorrem em momentos cronológicos sucessivos? [SIM] [NÃO] O tempo avançou? As ações e atributos coexistem Há linha de "antes e depois"? em um só instante (fotografia)? (Teste: "1º... depois... então") (Teste: "Cena congelada") NARRAÇÃO DESCRIÇÃO
3. Validação Secundária por Intenção Comunicativa
...
1. Passo 1 — Identificar o Tipo de Proposição da Banca:

- Proposição de Predomínio Excludente: A banca afirma que o texto é "predominantemente narrativo" ou "predominantemente descritivo".
- Proposição Cumulativa: A banca afirma que o texto desenvolve-se em "sequências predominantemente descritivas e narrativas".

1. Passo 2 — Inspeção Tripartite do Texto (Abertura, Meio e Desfecho):

- Abertura: Verifique se o primeiro parágrafo introduz o tempo, o espaço e inicia uma ação ou lembrança de personagem.
- Meio: Verifique se as descrições de cenários e personagens servem de apoio a diálogos ou conflitos.
- Desfecho: Verifique se os parágrafos finais mostram uma tomada de decisão, ação conclusiva ou encerramento do evento narrado.

1. Passo 3 — Regra de Decisão:

- Se o item for excludente e houver enredo avançando no início e no fim, marque Predominantemente Narrativo. Se a banca afirmar que é "predominantemente descritivo", marque ERRADO.
...
- Item de Prova: "A referência aos 'objetivos perseguidos' (L.8-9) faz parte de uma passagem descritiva do texto."
- Resolução e Justificativa: O trecho detalha, qualifica e caracteriza os objetivos institucionais por meio de núcleos substantivos e adjetivos. Embora o verbo são esteja no presente do indicativo, a intenção comunicativa é caracterizadora, sem avanço temporal.
...
- Item de Prova: "Predomina no texto o tipo textual narrativo."
- Resolução e Justificativa: O excerto inicia com ações encadeadas no passado (Recordou-se, sucedera, recorrera), contém descrições acessórias de suporte (quartos de porco, pedaços de carne, chapéu de couro) e culmina em diálogos e no desfecho da ação (Despedira-se, metera a carne no saco e fora vendê-la). A macroestrutura é uma história com progressão temporal.
- Gabarito Oficial: CERTO.
...
- Item de Prova: "No que se refere à tipologia, o texto é predominantemente descritivo."
- Resolução e Justificativa: O texto inicia com um estado (me coagia), mas logo desenvolve uma sucessão de eventos cronológicos de rememoração no pretérito (Quis lembrar-me, não consegui, acabara, lembrei-me, consegui rememorar, Revi). As frases descritivas finais (traços finos e delicados) são apenas o fechamento de um processo narrativo. O texto é predominantemente narrativo com aspectos descritivos.
...
- Item de Prova: "O texto se desenvolve em sequências tipológicas predominantemente descritivas e narrativas."
- Resolução e Justificativa: A carta integra sequências narrativas de viagem (cheguei, fui visitar, não vi) com sequências descritivas de rotina e hábitos no presente histórico (acorda-se às cinco, leva-se o dia lendo), além de interlocução epistolar. A proposição reconhece cumulativamente a presença de ambas as tipologias sem forçar exclusão.
- Gabarito Oficial: CERTO.
...
- A Conduta Correta: Analisar a temporalidade interna. Se houver sucessão de fatos no presente, é narração; se houver simultaneidade de caracterizações no presente, é descrição.
...
- A Conduta Correta: Reconhecer que o detalhamento de finalidades institucionais via substantivos e adjetivos configura passagem descritiva.
...
Ao concluir o estudo desta unidade, o estudante deve dominar com segurança as seguintes competências operacionais:

1. Superar a Análise Mecânica de Tempos Verbais: Compreender que o Pretérito Imperfeito não é exclusividade da descrição e que o Pretérito Perfeito não é a única forma de narrar.
2. Dominar o Critério da Temporalidade: Saber diagnosticar se as ações do fragmento coexistem em um único instante estático (Simultaneidade $\rightarrow$ Descrição) ou se avançam em uma linha vetorial cronológica irreversível (Sucessividade / Antes e Depois $\rightarrow$ Narração).
3. Compreender e Identificar o Presente Histórico: Reconhecer que o uso do Presente do Indicativo no lugar do Pretérito é um recurso estilístico de aproximação que pode figurar tanto em narrações quanto em descrições (neutralidade tipológica).
4. Identificar Descrições Institucionais e de Rotinas: Reconhecer que o detalhamento de metas institucionais no presente (IRIB) ou de hábitos periódicos em cartas configura passagem descritiva.
5. Resolver Itens de Predominância no Cebraspe: Saber que em obras literárias híbridas contendo histórias com início, diálogos e fim, o texto é predominantemente narrativo com aspectos descritivos, e reconhecer a validade de formulações cumulativas da banca.
