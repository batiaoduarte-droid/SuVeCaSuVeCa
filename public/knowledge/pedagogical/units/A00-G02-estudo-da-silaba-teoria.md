...
1. Ditongo Crescente ($DC = SV + V$): A curva de intensidade ascende do som brando (semivogal) para o ápice (vogal).

- Exemplos: lí-rio, quan-do, sé-rie, gê-nio, his-tó-ria, á-rea.

1. A Teoria do Divórcio e as Proparoxítonas Eventuais ($DC = H$):
...
1. Letra H em Início de Palavra:
...
1. Letra L em Final de Palavra/Sílaba:
