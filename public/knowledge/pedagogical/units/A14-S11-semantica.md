...
- Ex: manga (fruta) x manga (da camisa)
...
- **paciente (substantivo) x paciente (adjetivo)**
- **manga (fruta) x manga (da camisa)**
- **Gosto de silêncio: não tolero barulho. (silêncio x barulho)**
- **o leão é o animal mais visitado do zoológico.**
