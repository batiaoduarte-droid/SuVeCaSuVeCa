...
**Método central:** Nas coordenadas, cada oração mantém mapa próprio e a conjunção acrescenta a relação semântica que articula estruturas sintaticamente independentes.
...
- Conceito de Oração e Período: Reconhecimento obrigatório de verbos ou locuções verbais para delimitar orações (sem verbo, não há oração).
...
SINTAXE DO PERÍODO COMPOSTO POR COORDENAÇÃO ├── 1. Orações Coordenadas Assindéticas │ └── Justapostas por pontuação (vírgula, ponto e vírgula), sem conectivo │ └── 2. Orações Coordenadas Sindéticas (Classificadas pela Conjunção) ├──
A) Aditivas (Soma, acréscimo) │ ├── Conectivo "E": Adição pura, Adição + Tempo (cronologia), Adversativo, Conclusivo │ ├── Conectivo "NEM" (= "e não"): Condenação culta do pleonasmo "e nem" │ ├── Estrutura "Nem... nem...": 1º nem = Advérbio; 2º nem = Conjunção Aditiva │ ├── Locuções Correlativas: "não só... mas também/como/principalmente" (e elipse do 1º termo) │ └── Conectivo "MAS" Aditivo: Conecta atributos acumulativos convergentes │ ├──
B) Alternativas (Alternância vs. Exclusão) │ ├── Conectivos: ou, ou...ou, ora...ora, seja...seja, quer...quer, já...já │ ├── Valor de Alternância: Ações cíclicas/distributivas que se revezam no tempo │ ├── Valor de Exclusão / Alternativo Puro: Polos opostos mutuamente excludentes │ └── Duplicidade Sindética: Ambas as orações podem ser coordenadas sindéticas │ ├──
C) Adversativas (Quebra de expectativa) │ ├── Conectivos canônicos: mas, porém, contudo, todavia, entretanto, no entanto, não obstante │ ├── Valor de Oposição / Contraste: Polos antagônicos diretos (+ vs. -) │ ├── Valor de Ressalva / Compensação: Ponderação atenuante ("em compensação") │ └── Pontuação do "E" adversativo: Uso de vírgula antes do conectivo é facultativo │ ├──
D) Conclusivas (Dedução, desfecho lógico) │ ├── Conectivos: logo, portanto, então, assim, por conseguinte, por isso │ └── Conectivo "POIS" Conclusivo: Obrigatoriamente posposto/deslocado após o verbo, entre vírgulas │ └──
...
1. Aditivas (ideia de soma/acréscimo);
2. Adversativas (ideia de oposição/contraste/ressalva);
3. Alternativas (ideia de alternância ou escolha/exclusão);
4. Conclusivas (ideia de dedução/conclusão);
...
3. Segmento com verbo $\rightarrow$ Estrutura oracional.
...
1. Valor Conclusivo / Consecutivo (Consequência): A segunda oração expressa a decorrência lógica ou efeito da primeira, equivalendo a portanto, por isso ("Carla passou mal na festa e foi embora mais cedo").
...
3. Rejeitar assertivas de bancas que classifiquem o nem como adversativo devido à polaridade negativa.
...
3. Se a banca isolar a palavra mas dentro da locução correlata e afirmar que é adversativa, julgar como ERRADO.
...
3. Testar anulação recíproca $\rightarrow$ Se uma inviabiliza a outra $\rightarrow$ Exclusão (Valor Alternativo Puro).
...
| Tipologia | Conectivos Canônicos | Valor Semântico Central | Regra de Reconhecimento Rápido |
| --- | --- | --- | --- |
| Assindética | Nenhum (justapostas por pontuação) | Independência sintática sem conector | Ausência total de conjunção entre as orações |
| Sindética Aditiva | e, nem, não só... mas também/como | Soma, acréscimo, sequência cronológica | Conecta proposições de mesma orientação;nem = e não |
| Sindética Adversativa | mas, porém, contudo, todavia, entretanto, no entanto | Oposição, quebra de expectativa, ressalva | Conecta polos semânticos contraditórios (+ com -) |
| Sindética Alternativa | ou, ou...ou, ora...ora, seja...seja, quer...quer | Alternância (revezamento) ou Exclusão (mútua) | Pares permutáveis; se anula o outro = exclusão |
| Sindética Conclusiva | logo, portanto, então, assim, por conseguinte, pois (posposto) | Dedução lógica, desfecho, consequência | Pois deslocado após o verbo, isolado entre vírgulas |
| Sindética Explicativa | porque, que (= pois), porquanto, pois (anteposto) | Justificativa, fundamentação discursiva | Verbo no imperativo antecedente ou justificativa |
...
1. Desconsiderar modalizadores: Não confundir advérbios de dúvida/certeza com a oposição real dos adjetivos principais.

1. Isolar os dois polos conectados.
2. Atribuir cargas axiológicas/discursivas contextuais:

1. Calcular a resultante semântica:
...
| Par de Conceitos | Critério Decisivo de Diferenciação | Exemplo Típico A | Exemplo Típico B |
| --- | --- | --- | --- |
| Adição vs. Adversidade no conectivo "E" | Homogeneidade (+/+ ou -/-) versus Heterogeneidade (+/-) das polaridades semânticas | "Apaguei as luzes e acelerei." (Adição) | "Trabalhou muito e nada recebeu." (Adversidade) |
| Alternância vs. Exclusão no conectivo "OU" | Revezamento de ações no tempo versus Incompatibilidade/anulação mútua entre polos | "Ora ri, ora chora." (Alternância) | "Ou você estuda ou será reprovado." (Exclusão) |
| Oposição vs. Ressalva no conectivo "MAS" | Choque direto de antônimos versus Ponderação compensatória atenuante (em compensação) | "Dispensa teorias, mas é a base." (Oposição) | "Não li o livro, mas vi o filme." (Ressalva) |
| Explicativa vs. Causal com "PORQUE" | Justificativa/indício do julgamento do falante versus Causa física geradora no mundo real | "Ela era feliz, porque vivia sorrindo." (Explicativa) | "O chão molhou porque choveu." (Causal) |
| POIS Conclusivo vs. POIS Explicativo | Posição sintática: deslocado após o verbo entre vírgulas versus posicionado antes do verbo | "Estudou; foi, pois, aprovado." (Conclusivo) | "Venha, pois já é tarde." (Explicativo) |
| Conexão Intertermos vs. Interoracional | Ligação de termos nominais da mesma oração versus Ligação de orações dotadas de verbos próprios | "Gosto de café e leite." (Intertermos) | "Tomei café e comi pão." (Interoracional) |
| Adversativa vs. Concessiva | Regime sintático: Coordenação independente versus Subordinação com oração principal | "Estudei, mas não passei." (Adversativa) | "Embora tenha estudado, não passei." (Concessiva) |
...
| --- | --- | --- | --- | --- |
| 01 | Não desejo nada, não temo nada, sou livre. | Sem conectivo | Orações Coordenadas Assindéticas | Três orações justapostas e delimitadas por vírgulas. |
| 02 | Sente aqui, que precisamos conversar. | que (= pois) | O. C. Sindética Explicativa | Justificativa discursiva associada ao verbo no imperativo (Sente). |
| 03 | Dario abre a boca, move os lábios, não se ouve resposta. | Sem conectivo | Orações Coordenadas Assindéticas | Sequência narrativa de orações justapostas independentes. |
| 04 | Apaguei as luzes do carro e acelerei. | e | O. C. Sindética Aditiva | Soma sequencial de duas ações de mesma polaridade. |
| 05 | ...não sabem ler nem escrever. | nem (= e não) | O. C. Sindética Aditiva | Adição de proposições de polaridade negativa. |
| 06 | ...dominava o inglês, pois estudara em escolas americanas. | pois (anteposto) | O. C. Sindética Explicativa | Conectivo no início da oração introduzindo justificativa evidente. |
| 07 | Eu odeio celular, mas acabei tendo um... | mas | O. C. Sindética Adversativa | Oposição direta entre sentimento de aversão e fato de possuir. |
| 08 | Trabalhou com afinco... e não obteve reconhecimento. | e (= porém) | O. C. Sindética Adversativa | Choque de expectativas entre dedicação (+) e frustração (-). |
| 09 | Ora estava alegre, ora ficava calado em um canto. | ora... ora | O. C. Sindética Alternativa | Alternância distributiva de estados emocionais no tempo. |
| 10 | Eles se admiravam, contudo não se falavam. | contudo | O. C. Sindética Adversativa | Contraste semântico clássico entre admiração e silêncio. |
| 11 | ...dependem, pois, de seu método e talento. | pois (deslocado) | O. C. Sindética Conclusiva | Conectivo posposto ao verbo e entre vírgulas (=portanto). |

- Exemplos e Análises:

1. "João e Guilherme chegaram cedo." $\rightarrow$ Adição pura.
2. "Chegou em casa e dormiu." $\rightarrow$ Adição + Tempo (Sequência cronológica).
...
- Q12 (Pref. Bombinhas-SC / Fiscal): "Ele disse verdades, mas também ouviu" $\rightarrow$ Elipse do não só, oração coordenada sindética aditiva. Gabarito: C.
...
- Q17 (VUNESP / TJ-SP — Técnico): "Dispensa teorias, mas é a base..." $\rightarrow$ Período composto por coordenação, 2ª oração adversativa. Gabarito: C.
- Q18 (FCC / AL-AP — Assistente): "Era uma exceção, mas certamente..." $\rightarrow$ Coordenação articulada por sentido de adversidade. Gabarito: A.
- Q19 (FCC / SANASA Campinas — Técnico): "Diversos países estão propondo... // mas, até o momento, não tomaram..." $\rightarrow$ Relação límpida de oposição. Gabarito: C.
- Q20 (FGV / Pref. Paulínia — Procurador): "O casamento é bom [+] e tem seus inconvenientes [-]" $\rightarrow$ Conjunção e com valor adversativo em Machado de Assis. Gabarito: E.
- Q21 (IBADE / Pref. Rio Branco — Professor): "...designam, portanto, categorias..." $\rightarrow$ Conjunção conclusiva. Gabarito: D.
- Q22 (Inst. Excelência / Tremembé — Secretário): "...por isso será contratado..." $\rightarrow$ Oração coordenada sindética conclusiva. Gabarito: C.
- Q23 (Pref. Fortaleza / Professor): "Penso, logo existo" $\rightarrow$ Orações coordenadas entre si estabelecendo conclusão. Gabarito: C.
- Q24 (EXATUS / Caxias do Sul — Eletricista): "...porque o voo já nasce dentro dos pássaros" $\rightarrow$ Oração coordenada sindética explicativa. Gabarito: D.
...
- Frase 3: "Dario abre a boca, move os lábios, não se ouve resposta." $\rightarrow$ Orações Coordenadas Assindéticas.
- Frase 4: "Apaguei as luzes do carro e acelerei." $\rightarrow$ O.C. Sindética Aditiva.
- Frase 5: "Três quartos... não sabem ler nem escrever." $\rightarrow$ O.C. Sindética Aditiva (nem = e não).
- Frase 6: "A irmã... dominava o inglês, pois estudara em escolas americanas." $\rightarrow$ O.C. Sindética Explicativa.
- Frase 7: "Eu odeio celular, mas acabei tendo um..." $\rightarrow$ O.C. Sindética Adversativa.
- Frase 8: "Trabalhou com afinco [+] e não obteve reconhecimento [-]." $\rightarrow$ O.C. Sindética Adversativa (e = porém).
- Frase 9: "Ora estava alegre, ora ficava calado..." $\rightarrow$ O.C. Sindética Alternativa.
...
- Q29 (FCC / TRT-21): "O roteiro original, portanto, tornou-se..." $\rightarrow$ Segmento conclusivo identificado verticalmente por portanto. Gabarito: E.
- Q30 (Quadrix / SEDUCE-GO): "não só..., mas, principalmente..." $\rightarrow$ Assertiva afirma sentido adversativo. Gabarito: Errado.
- Q31 (Quadrix / CRMV-AC): "nem usados..." $\rightarrow$ Assertiva afirma sentido adversativo. Gabarito: Errado.
...
- Q36 (CEBRASPE / Rio Branco): "é essencial e depende..." $\rightarrow$ Conjunção e coordena duas orações com valor aditivo. Gabarito: Certo.
- Q37 (CEBRASPE / TRF-1): "não apenas..., mas também..." $\rightarrow$ Ideia que complementa e reforça a anterior. Gabarito: Certo.
- Q38 (CEBRASPE / TCE-RO): "seja... seja" por "quer... quer" $\rightarrow$ Substituição gramaticalmente perfeita. Gabarito: Certo.
- Q39 (CEBRASPE / STM): "trabalhar com esses temas, ou sequer saber que existem" $\rightarrow$ Relação de exclusão e não de alternância. Gabarito: Errado.
- Q40 (CEBRASPE / DPU — Mafalda): "Mas finalmente a proeza se concretiza" $\rightarrow$ Oração adversativa de contraste. Gabarito: Certo.
- Q41 (CEBRASPE / MS): "mas as escolhas... podem levar" $\rightarrow$ Mas não é termo aditivo, é adversativo. Gabarito: Errado.
- Q42 (CEBRASPE / São Cristóvão): "faça o que eu mando, e não o que eu faço" $\rightarrow$ Apresenta oposição de ideias (e adversativo). Gabarito: Certo.
- Q43 (CEBRASPE / FUB): "mas" introduzindo oração coordenada que exprime concessão $\rightarrow$ Incompatibilidade terminológica. Gabarito: Errado.
...
- Questão 12 (Pref. Bombinhas - Fiscal): "Ele disse verdades, mas também ouviu". Estrutura aditiva com elipse do "não só". Gabarito: C.
- Questão 13 (FGV - SEE-PE - Professor de Português): "A vontade de acreditar é talvez o mais poderoso, mas certamente é o mais perigoso atributo humano". O conectivo mas conecta dois qualificadores convergentes (mais poderoso $+$ mais perigoso), assumindo valor aditivo. Gabarito: B.
- Questão 14 (AMAUC - Pref. Itá - Fiscal): "Nem Pedro estuda nem Maria trabalha". Oração introduzida pelo conectivo aditivo nem. Gabarito: C.
- Questão 15 (IBADE - Pref. Rio Branco - Cuidador): "...ou ser uma carga para os filhos". Conectivo ou introduzindo oração coordenada sindética alternativa. Gabarito: D.
- Questão 16 (FUNDEP - TJ-MG - Oficial): "[...] ou o homem se entende [...], ou se aniquila [...]". Correlação alternativa. Gabarito: A.
- Questão 17 (VUNESP - TJ-SP - Técnico): "Dispensa teorias, mas é a base de qualquer convívio...". Período composto por coordenação com segunda oração adversativa. Gabarito: C.
- Questão 18 (FCC - AL-AP - Assistente): "Era uma exceção, mas certamente os outros...". Coordenação articulada por sentido de adversidade. Gabarito: A.
- Questão 19 (FCC - SANASA Campinas - Técnico): Identificação de oposição em períodos longos: "...estão propondo alternativas... // mas, até o momento, não tomaram quaisquer medidas concretas". Gabarito: C.
- Questão 20 (FGV - Paulínia - Procurador): Identificação do e adversativo em Machado de Assis: "O casamento é bom [+] e tem seus inconvenientes [-] como tudo neste mundo". Gabarito: E.
- Questão 21 (IBADE - Pref. Rio Branco - Professor): "Negro e branco designam, portanto, categorias...". Conectivo portanto estritamente conclusivo. Gabarito: D.
- Questão 22 (Inst. Excelência - Tremembé): "Rodrigo fez um ótimo trabalho, por isso será contratado novamente". Oração coordenada conclusiva. Gabarito: C.
- Questão 23 (Pref. Fortaleza - Professor): "Penso, logo existo". Axioma cartesiano com orações coordenadas articuladas por elo conclusivo. Gabarito: C.
- Questão 24 (EXATUS - Caxias do Sul): "Ensinar o voo, isso elas não podem fazer, porque o voo já nasce...". Oração coordenada sindética explicativa. Gabarito: D.
- Questão 25 (CESPE/CEBRASPE - SEED-PR - Professor): "Socorro, alguém me dê um coração, / que esse já não bate...". Modo imperativo (dê) seguido de que explicativo (= pois). Gabarito: B.
- Questão 26 (FGV - SEFAZ-RJ - Fiscal de Rendas): "...seria desumano, pois ela nada mais é...". Conectivo pois anteposto ao verbo introduzindo valor de explicação. Gabarito: E.
- Questão 27 (Quadrix - CRN-8): "mas gorduras são ricas em calorias". Oposição entre dieta saudável e excesso calórico. Gabarito: B (adversativo).
- Questão 28 (AOCP - EBSERH): "mas não sem uma mudança dramática". Conectivo mas expressando contraste. Gabarito: C.
- Questão 29 (FCC - TRT-21): Localização vertical de oração conclusiva: segmento contendo a conjunção portanto. Gabarito: E.
- Questão 30 (Quadrix - SEDUCE-GO): Item: "o vocábulo 'mas' introduz oração adversativa" em não só... mas principalmente. Locução aditiva correlativa. Gabarito: ERRADO.
- Questão 31 (Quadrix - CRMV-AC): Item: "o vocábulo 'nem' introduz oração adversativa". Nem é conjunção aditiva (= e não). Gabarito: ERRADO.
- Questão 32 (FGV - PROCEMPA): Identificação de e adversativo: "Pensamos em demasia [+] e sentimos bem pouco [-]" (antítese muito vs. pouco). Gabarito: E.
- Questão 33 (VUNESP - Semae Piracicaba): Substituição de dois-pontos explicativos por vírgula seguida de pois explicativo. Gabarito: A.
- Questão 34 (CESPE - TC-DF): Assertiva: "a vírgula separa orações coordenadas" em "Quanto ao gênero deles, não sei...". Falso: não há verbo antes da vírgula (trata-se de adjunto adverbial antecipado). Gabarito: ERRADO.
- Questão 35 (CESPE - SEDU-ES): Assertiva: "em ambas as ocorrências o 'e' introduz oração coordenada aditiva". Falso: o 1º "e" liga adjuntos adnominais nominais (computador e Internet); apenas o 2º liga orações (negar e ensinar). Gabarito: ERRADO.
- Questão 36 (CESPE - Rio Branco): "é essencial e depende...". O "e" conecta duas orações coordenadas aditivas. Gabarito: CERTO.
- Questão 37 (CESPE - TRF-1): A locução "mas também" introduz ideia que complementa e reforça a oração anterior. Gabarito: CERTO.
- Questão 38 (CESPE - TCE-RO): Permutabilidade do par correlativo "seja... seja" por "quer... quer". Gabarito: CERTO.
- Questão 39 (CESPE - STM): Assertiva de que "trabalhar com esses temas, ou sequer saber que existem" expressa alternância. Falso: trata-se de polos extremos que se anulam mutuamente (exclusão / valor alternativo). Gabarito: ERRADO.
- Questão 40 (CESPE - DPU): Mafalda: mas introduzindo contraste entre o ambiente adverso (-) e a proeza concretizada (+). Gabarito: CERTO.
- Questão 41 (CESPE - MS): Assertiva de que o mas exerce função de termo aditivo em contexto de ressalva. Gabarito: ERRADO.
- Questão 42 (CESPE - Pref. São Cristóvão): "faça o que eu mando, e não o que eu faço". Conectivo e expressando genuína oposição de ideias. Gabarito: CERTO.
- Questão 43 (CESPE - FUB): Assertiva de que o mas inicia oração coordenada que exprime ideia de concessão. Erro categorial: concessão é privativa da subordinação adverbial. Gabarito: ERRADO.
- Questão 44 (CESPE - SEDU-ES): "assim que eu cheguei". A locução assim que é subordinativa adverbial temporal, refutando valor explicativo. Gabarito: ERRADO.
...
-  — Oração Coordenada Assindética (O.C.A.): Oração sintaticamente independente que integra o período composto sem conectivo interoracional, unida às demais exclusivamente por pontuação.
-  — Oração Coordenada Sindética (O.C.S.): Oração sintaticamente independente encabeçada por conjunção coordenativa, a qual determina sua tipologia semântica (aditiva, adversativa, alternativa, conclusiva ou explicativa).
-  — Síndeto: Vocábulo de origem grega que designa o elo, vínculo ou conectivo coordenativo interoracional.
-  — Sequência Cronológica (Valor Aditivo-Temporal): Matiz semântico da conjunção e em que as ações coordenadas sucedem-se obrigatoriamente em linha temporal sucessiva.
-  — Par Correlato / Estrutura Correlativa: Pares conectivos coordenados (não só... mas também, seja... seja, quer... quer) que estruturam períodos bimembres aditivos ou alternativos.
-  — Alternância Distributiva: Matiz da coordenação alternativa em que as ações revezam-se ciclicamente no tempo sem se anularem reciprocamente.
-  — Exclusão (Valor Alternativo Puro): Matiz da coordenação alternativa caracterizado por polos incompatíveis, em que a escolha de um implica a negação definitiva do outro.
-  — Ressalva / Compensação: Matiz da coordenação adversativa em que não há oposição frontal de contrários, mas a introdução de uma ponderação atenuante compensatória (em compensação).
-  — Conjunção Posposta / Deslocada: Conectivo posicionado no interior da oração após o verbo principal, isolado entre vírgulas, que impõe valor conclusivo ao vocábulo pois.
...
Ao concluir o estudo deste grupo temático, o estudante deve ter consolidado as seguintes competências conceituais e operacionais:
...
1. Agilidade em Concursos: Aplicar o teste de polaridades semânticas (+ vs. -), a técnica de resolução vertical de conectivos e a substituição de dois-pontos explicativos por pois/porque.

A abordagem didática consolida a sintaxe do período composto por coordenação, demonstrando que o domínio das orações coordenadas reside no domínio das conjunções e de seus valores semânticos contextuais.

As orações coordenadas dividem-se em assindéticas (sem conectivo, justapostas por pontuação) e sindéticas (encabeçadas por conjunção coordenativa). Toda oração sindética é analisada de trás para frente a partir do seu conectivo:

1. Aditivas: Expressam soma. A conjunção e possui 4 valores: adição pura, sequência cronológica (tempo), adversidade (oposição) e consequência/conclusão. A conjunção nem equivale a e não; a locução "e nem" é pleonasmo condenável; e no par nem... nem..., o 1º elemento é advérbio de negação e o 2º é conjunção aditiva. Estruturas como não só... mas também complementam e reforçam a argumentação, admitindo elipse do não só. O conectivo mas adquire valor aditivo quando acumula qualificadores sobre o mesmo referente sem oposição.
2. Alternativas: Expressam alternância distributiva (revezamento cíclico no tempo) ou exclusão/valor alternativo puro (polos mutuamente excludentes). Pares correlatos como seja... seja e quer... quer são mutuamente permutáveis.
3. Adversativas: Expressam quebra de expectativa discursiva, dividindo-se em oposição/contraste direto (sim x não) e ressalva/compensação (em compensação). O e adversativo é identificado via teste de polaridade semântica (+ e -). Adversidade é privativa da coordenação e não se confunde com concessão.
4. Conclusivas: Expressam dedução lógica ou consequência (logo, portanto). O conectivo pois é conclusivo exclusivamente quando posposto ao verbo e isolado entre vírgulas.
5. Explicativas: Justificam uma ordem prévia (verbo no imperativo + que/pois) ou fundamentam uma declaração anterior. Diferenciam-se das causais porque trazem a justificativa discursiva do falante, e não a causa física real do mundo dos fatos.
6. Rigor Estrutural: Para haver oração coordenada, é obrigatória a presença de verbo. Vírgula que isola adjunto adverbial antecipado não separa orações. A conjunção e pode ligar termos nominais (adjuntos adnominais) ou orações distintas.
