...
**Método central:** Adjuntos adverbiais e adnominais são conectados ao verbo, ao nome ou à oração que modificam, com atenção a deslocamento, escopo e pontuação.
...
Para o pleno aproveitamento deste grupo consolidado, o estudante deve possuir conhecimentos prévios sobre:

* **Classes gramaticais básicas da morfologia:** distinção preliminar entre substantivo, adjetivo, advérbio, verbo, pronome, artigo, numeral e preposição.
...
└── 2. ADJUNTO ADNOMINAL
 ├── Âncora Sintática: Modifica exclusivamente:
 │ └── Substantivo (atua delimitando, individuando, determinando e restringindo a generalização)
 ├── Distribuição Sintática:
 │ └── Localização irrestrita dentro de qualquer sintagma que contenha substantivo núcleo
 ├── Morfossintaxe Adnominal (As 5 Classes Satélites):
 ...
 │ └── Pronome Adjetivo (possessivo, demonstrativo, indefinido, etc.)
 └── Contraste com Predicativos (Sujeito e Objeto):
 ├── Adjunto Adnominal: Satélite acessório / Sua retirada preserva o sentido lexical do verbo
 └── Predicativo: Termo necessário à predicação / Sua retirada altera a acepção e transitividade verbal
```
...
1. **Verbo:** adicionando circunstâncias de tempo, lugar, modo, causa, intensidade, finalidade, etc. (*Falavam muito*);
...
* **6C (Seis circunstâncias iniciadas pela letra C):**
 1. **C**ausa (*morrem de exaustão*);
 2. **C**ondição (*sem estudo, não haverá aprovação*);
 3. **C**oncessão (*apesar da chuva, saímos*);
 4. **C**omparação (*agia como um mestre*);
 5. **C**onsequência (*comeu a ponto de passar mal*);
 6. **C**onformidade (*agiu segundo as regras*).
* **FTP (Três circunstâncias iniciadas por F, T, P):**
 1. **F**inalidade (*estudou para a prova*);
 2. **T**empo (*sairemos amanhã* / *pela manhã*);
...
* **Advérbio (Morfologia):** Vocábulo único de valor circunstancial (*muito*, *cedo*, *amanhã*, *talvez*). Como classe gramatical, o advérbio é estritamente **invariável** (não flexiona em gênero nem número).
* **Locução Adverbial (Morfologia):** Conjunto de duas ou mais palavras (tipicamente preposição + substantivo/adjetivo) exercendo papel circunstancial adverbial (*pela manhã*, *com a amiga*, *às vezes*, *para o parque*).
...
3. Se veicular circunstância $\rightarrow$ **Adjunto Adverbial** (termo acessório).
4. Se não veicular circunstância e apenas fechar o sentido transitivo do verbo exigido por regência $\rightarrow$ **Objeto Indireto** (termo integrante).
...
1. **Ordem Direta:** Na estrutura natural da frase (*A aluna resolveu a questão com rapidez*), o adjunto modal *com rapidez* localiza-se ao final. Nessa posição canônica, o emprego de vírgula não é utilizado.
2. **Adjunto Deslocado:** Quando a circunstância é antecipada (*Com rapidez, a aluna resolveu a questão*) ou intercalada (*A aluna, com rapidez, resolveu a questão*), altera-se a topologia sintática padrão, o que ativa as regras específicas de pontuação (obrigatoriedade ou facultatividade do isolamento por vírgulas conforme a extensão do termo).
3. **Relevância Pedagógica:** O domínio do reconhecimento semântico do adjunto é pré-requisito mandatório para não errar pontuação nas provas de concurso.

* **Aplica-se em:** Pontuação e sintaxe do período.
...
1. **Artigo (Morfologia):** Artigos definidos (*o, a, os, as*) e indefinidos (*um, uma, uns, umas*) exercem função de adjunto adnominal ao determinar ou indeterminar o substantivo (*O aluno*, *Um campo*).
2. **Numeral (Morfologia):** Numerais adjetivos que delimitam a quantidade ou ordem do substantivo (*Dois alunos*, *Primeiro colocado*).
...
* No objeto direto *o amigo*, *amigo* é o núcleo e *o* é adjunto adnominal interno ao objeto.
* A regra de ouro é: "Onde houver substantivo, antes ou depois do verbo, pode haver adjunto adnominal".
...
### Tabela-resumo de formulações canônicas consolidadas

| Conceito / Regra | Âncora Sintática | Natureza Estrutural | Classes Morfológicas Correspondentes | Identificador Temático |
|:------------------------------ |:------------------------------------- |:--------------------------------------------- |:-------------------------------------------------------------- |:------------------------------------- |
| **Adjunto Adverbial** | Verbo (*), Adjetivo ou Advérbio | Termo Acessório (Fofoca / Circunstância) | Advérbio (1 palavra) ou Locução Adverbial (2+ palavras) |  |
| **Adjunto Adnominal** | Substantivo exclusivamente | Termo Acessório (Satélite / Enfeite do Nome) | Artigo, Numeral, Adjetivo, Locução Adjetiva, Pronome Adjetivo |  |
| **Objeto Indireto** | Verbo Transitivo Indireto (VTI / VTDI) | Termo Integrante (Complemento Verbal) | Substantivo/Pronome regido por Preposição Gramatical |  |
| **Predicativo do Objeto** | Objeto Direto / Indireto (via Verbo) | Termo Necessário da Predicação | Adjetivo ou Expressão Adjetivada (com/sem preposição) |  |
...
Início da Análise do Termo
 │
 ▼
[Passo 1: Conversar com a Frase & Lançar a SETA]
 │ Interrogar a estrutura da oração para descobrir a qual palavra exata o termo em análise se subordina.
 │ Traçar visualmente a seta do termo emissor para o vocábulo receptor.
 │
 ▼
[Passo 2: Identificar a Classe da Palavra Receptora]
 │ Classificar morfologicamente a palavra que recebeu a ponta da seta:
 │ ├── Se recebeu seta em VERBO, ADJETIVO ou ADVÉRBIO + denota circunstância → ADJUNTO ADVERBIAL
 │ └── Se recebeu seta em SUBSTANTIVO → ADJUNTO ADNOMINAL (ou Predicativo)
 │
 ▼
[Passo 3: Dupla Etiquetagem Morfossintática]
 │ Definir Função Sintática (nível relacional) + Classe Gramatical (nível morfológico).
 │
 ▼
Fim do Procedimento
```
...
Termo Preposicionado Ligado a Verbo
 │
 ▼
[Etapa 1] Traçar a seta do termo preposicionado até o verbo regente/referente.
 │
 ▼
...
[Etapa 3] Teste Semântico: "A expressão tem CHEIRO DE CIRCUNSTÂNCIA?"
 ...
 │ │
 │ ▼
 │ [Etapa 4A] Classificar como ADJUNTO ADVERBIAL (Termo Acessório / Fofoca).
 │
 └── NÃO (Preposição é GRAMATICAL: completa o verbo sem carga adverbial própria)
 │
 ▼
 [Etapa 4B] Classificar como OBJETO INDIRETO (Termo Integrante / Complemento Verbal).
```
...
Varredura do Período
 │
 ▼
[Passo 1: Localizar o SUBSTANTIVO NÚCLEO]
 │ Varrer o período identificando todos os substantivos que encabeçam funções sintáticas
 │ (estejam dentro do sujeito, objetos, predicativos, complementos nominais, etc.).
 │
 ▼
[Passo 2: Rastrear os TERMOS SATÉLITES]
 │ Inspecionar o entorno imediato do substantivo núcleo em busca de modificadores diretos.
 │
 ▼
[Passo 3: Validar a Classe do Satélite]
 │ Verificar se o modificador pertence a uma das 5 classes:
 │ [Artigo | Numeral | Pronome Adjetivo | Adjetivo | Locução Adjetiva]
 │
 ▼
[Passo 4: Teste de Acessoriedade]
 │ Confirmar que o termo não atua como predicativo indispensável à predicação verbal.
 │
 ▼
Classificação Concluída: ADJUNTO ADNOMINAL
```
...
| Critério de Comparação | Adjunto Adverbial | Objeto Indireto |
|:----------------------------------- |:----------------------------------------------------------------------------------------- |:--------------------------------------------------------------------------------------- |
| **Status Sintático** | Termo**Acessório** (periférico / dispensável). | Termo**Integrante** (complemento obrigatório por regência). |
| **Natureza da Preposição** | Preposição**Nocional** (carrega semântica própria de modo, causa, tempo, lugar). | Preposição**Gramatical** (mero conector imposto pelo verbo transitivo indireto). |
| **Critério Decisivo** | Apresenta**"cheiro de circunstância"** (fofoca oracional). | **Completa** a predicação de um VTI sem constituir valor adverbial. |
...
|:----------------------------------- |:--------------------------------------------------------------- |:---------------------------------------------------------------- |
| **Termo Modificado (Âncora)** | **Substantivo** exclusivamente. | **Verbo**, **Adjetivo** ou **Advérbio**. |
| **Papel Semântico** | Delimitar, individuar, determinar e restringir o substantivo. | Expressar circunstância (tempo, lugar, modo, intensidade, etc.). |
| **Classes Morfológicas** | Artigo, Numeral, Adjetivo, Locução Adjetiva, Pronome Adjetivo. | Advérbio (1 palavra) ou Locução Adverbial (2+ palavras). |
...
|:--------------------------------- |:--------------------------------------------------------- |:------------------------------------------------------------------------------------------------- |
| **Natureza na Predicação** | Termo**acessório** dispensável. | Termo**essencial** integrante da predicação verbo-nominal. |
| **Vínculo com o Verbo** | Não afeta a transitividade nem o sentido do verbo. | Altera a acepção lexical e a predicação verbal se for suprimido. |
| **Teste da Supressão** | Sua remoção preserva a ação e o significado verbal. | Sua remoção descaracteriza o sentido do verbo (ex.:*qualificar* $\rightarrow$ *convocar*). |
| **Exemplo de Contraste** | *Chamou o amigo sincero* (*sincero* = Adj. Adnominal). | *Chamou o amigo de ingrato* (*de ingrato* = Predicativo do Objeto). |
...
* **Classificação Morfossintática:** Morfologia: Advérbio de intensidade | Sintaxe: Adjunto Adverbial de intensidade.
...
* **Classificação Morfossintática:** Morfologia: Advérbio de intensidade | Sintaxe: Adjunto Adverbial de intensidade (intensificador de adjetivo).
...
* **Análise das 3 Locuções:**
 1. `para o parque`: aponta para *Foi* (Verbo) $\rightarrow$ Locução Adverbial de Lugar | Adjunto Adverbial de Lugar.
 2. `com a amiga`: aponta para *Foi* (Verbo) $\rightarrow$ Locução Adverbial de Companhia | Adjunto Adverbial de Companhia.
 3. `pela manhã`: aponta para *Foi* (Verbo) $\rightarrow$ Locução Adverbial de Tempo | Adjunto Adverbial de Tempo.
...
* **c) *Talvez seja melhor sairmos.*** $\rightarrow$ *Talvez* aponta para *seja* (V.) $\rightarrow$ Adjunto Adverbial de dúvida (Advérbio). (*Melhor* é adjetivo predicativo).
* **d) *Sairemos muito tarde.*** $\rightarrow$ *tarde* aponta para *Sairemos* (V., Adj. Adv. Tempo) e *muito* aponta para *tarde* (Adv., Adj. Adv. Intensidade).
...
* **Classificação:** **Adjunto Adverbial de causa** (o verbo *morrem* é VI).
...
* **Classificação:** **Adjunto Adverbial de modo** (*o problema* é objeto direto de *resolver*).
...
* **c) *A aluna resolveu a questão com rapidez.*** $\rightarrow$ *com rapidez* (modo) $\rightarrow$ **Adjunto Adverbial de modo**.
* **d) *Aquelas pessoas carecem de atenção.*** $\rightarrow$ *de atenção* (completa VTI *carecer*) $\rightarrow$ **Objeto Indireto**.
* **e) *“Entre por essa porta agora...”*** $\rightarrow$ *por essa porta* (lugar/ponto de passagem) $\rightarrow$ **Adjunto Adverbial de lugar**.
...
* *Aluno inteligente*: *inteligente* (Adjetivo) $\rightarrow$ Adjunto Adnominal.
* *Aluno de inteligência*: *de inteligência* (Locução Adjetiva) $\rightarrow$ Adjunto Adnominal.
* *Meu aluno* / *Aquele aluno* / *Algum aluno*: *Meu* / *Aquele* / *Algum* (Pronomes Adjetivos) $\rightarrow$ Adjuntos Adnominais.
* *Invasão dos mosquitos*: *dos mosquitos* (Locução Adjetiva) $\rightarrow$ Adjunto Adnominal do substantivo *invasão*.
...
* **Correção:** Dialogar logicamente com a frase: a pessoa *foi com a amiga* (a companhia qualifica o ato verbal *foi*). A seta deve apontar para o verbo.
...
Ao concluir o estudo desta unidade**, o estudante de concursos públicos deve dominar com precisão cirúrgica a arquitetura dos **termos acessórios modificadores**:
