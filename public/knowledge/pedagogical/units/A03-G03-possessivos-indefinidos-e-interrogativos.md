...
NÚCLEO TEMÁTICO esta unidade: POSSESSIVOS, INDEFINIDOS E INTERROGATIVOS
 ...
 │
 └── 5. COMPORTAMENTOS POSICIONAIS E SEMÂNTICOS
 ├── Anteposto ao Substantivo = Pronome Indefinido (certo senhor, bastante tempo, vários deputados)
 ├── Posposto ao Substantivo = Adjetivo (senhor certo, tempo bastante, deputados vários)
 ├── Posição de "Algum": alguma parte (indeterminada) vs. parte alguma (nenhuma / negação)
 └── Vocábulo "Mais" (FGV):
 ├── Seta para Verbo/Adjetivo ──► Morfologia: Advérbio ────────► Semântica: Intensidade
 └── Seta para Substantivo ────► Morfologia: Pronome Indef. ──► Semântica: Quantidade
```
...
```text
 ...
 │ (aponta para)
 ▼
 "sua" (Feminino Singular ── CONCORDA COM) ──► [mãe] (Feminino Singular)
```
...
> *"<u>Todo</u> **dia** ela faz <u>tudo</u> sempre igual."*
...
- *"Havia <u>muita</u> **preocupação**..."* $\rightarrow$ `muita` acompanha `preocupação` (subst.) $\rightarrow$ Pronome Adjetivo.
- *"Chegarão <u>mais</u> **livros**..."* $\rightarrow$ `mais` acompanha `livros` (subst.) $\rightarrow$ Pronome Adjetivo.
...
|:--------------------------- |:------------------------------------- |:--------------------------------: |:-------------------------------------------------------- |:------------------------------------------------------ |
| **ADJETIVO** | **Substantivo** | **VARIÁVEL** | Qualifica / Caracteriza (equivale a*suficiente*) | *"Tinha amigos **bastantes**."* (= suficientes) |
...
Pronome Indefinido (Ideia Vaga) ≠ Adjetivo (Qualificador / Especificador)

• certo senhor (senhor qualquer) • senhor certo (senhor correto/adequado)
• bastante dinheiro (muito dinheiro) • dinheiro bastante (dinheiro suficiente)
...
SEMÂNTICA: INTENSIDADE ◄─────────────► QUANTIDADE
 ▲ ▲
 │ │
MORFOLOGIA: ADVÉRBIO ◄─────────────► PRONOME INDEFINIDO
...
[Palavra em Análise] ──► Trace a Seta ──► [Termo-Alvo Modificado]
 ...
 ▼ ▼
 ADVÉRBIO ┌──────────────────┴──────────────────┐
 (Invariável / Intensidade) ▼ ▼
 ADJETIVO PRONOME INDEFINIDO
...
### 1. Pronome Pessoal vs. Pronome Possessivo na Coesão Textual

| Critério de Análise | Pronome Pessoal (Reto / Oblíquo) | Pronome Possessivo (*meu, seu, nosso*) |
|:----------------------------------------- |:-------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------------------------- |
| **Concordância de Gênero/Número** | Faz-se**diretamente com o referente** (nome retomado). | Faz-se com o**substantivo posposto** (coisa possuída). |
...
|:---------------------------- |:------------------------------- |:-------------------------------------- |:---------------------------- |:------------------------------------ |
| **"jornais da manhã"** | $de + a$ (com artigo definido) | Aponta para o substantivo`jornais` | **Locução Adjetiva** | Caracteriza a edição/tipo do jornal |
| **"leio de manhã"** | $de$ (sem artigo definido) | Aponta para o verbo`leio` | **Locução Adverbial** | Indica o tempo/horário em que se lê |
...
Item: *A expressão “suas relações” (l.22) refere-se às relações da “democracia ateniense” (l.21).*
 Certo
 Errado
...
Item: *Nas expressões “seu preconceito” (l.45) e “seu sarcasmo” (l. 45 e 46), o pronome possessivo remete a referentes distintos.*
 Certo
 Errado
...
Item: *Do período “O agregado é a sua caricatura” (l. 23 e 24), é correto inferir que o agregado é uma caricatura de si próprio.*
 Certo
 Errado
...
Item: *O vocábulo “Quanta” (l.6) classifica-se, na oração em que ocorre, como pronome interrogativo.*
 Certo
 Errado
...
Item: *No texto, tanto o termo “todo” (l.1) quanto “todo o” (l.5) expressam totalidade.*
 Certo
 Errado
