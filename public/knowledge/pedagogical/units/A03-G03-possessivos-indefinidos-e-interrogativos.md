# Possessivos Indefinidos e Interrogativos

---

> **Objetivo de aprendizagem**
>
> Compreender e definir os princípios normativos e conceituais de Possessivos Indefinidos e Interrogativos. Aplicar regras canônicas e procedimentos decisórios de Possessivos Indefinidos e Interrogativos na resolução de questões. Analisar o papel de Possessivos Indefinidos e Interrogativos no eixo Conexão forte e reconhecer armadilhas e variações de bancas.
...
**Conexão forte:** Possessivos, indefinidos e interrogativos combinam morfologia, função e referenciação; a SuVeCA localiza o papel sintático, enquanto o contexto resolve referente e valor.
...
- Morfologia Básica: Identificação segura de substantivos, adjetivos, verbos, advérbios e artigos definidos.
- Pessoas do Discurso: Domínio das três pessoas gramaticais (1ª: emissor; 2ª: interlocutor; 3ª: referente/assunto).
...
- Todo: Acompanha o substantivo expresso dia $\rightarrow$ Pronome Indefinido Adjetivo.
- tudo: Ocupa sozinho o papel de objeto direto da oração, sem substantivo ao lado $\rightarrow$ Pronome Indefinido Substantivo.

Outros exemplos estruturais:

- "Havia muita preocupação..." $\rightarrow$ muita acompanha preocupação (subst.) $\rightarrow$ Pronome Adjetivo.
- "Chegarão mais livros..." $\rightarrow$ mais acompanha livros (subst.) $\rightarrow$ Pronome Adjetivo.
...
| Classe Gramatical | Termo ao qual se refere | Flexão / Variabilidade | Função Semântica | Exemplo Paradigma combastante |
| --- | --- | --- | --- | --- |
| ADJETIVO | Substantivo | VARIÁVEL | Qualifica / Caracteriza (equivale asuficiente) | "Tinha amigos bastantes." (= suficientes) |
| ADVÉRBIO | Verbo, Adjetivo ou Advérbio | INVARIÁVEL | Intensifica / Modifica (equivale amuito/demais) | "Falaram bastante de você." (= muito) |
| PRONOME INDEFINIDO | Substantivo | Variável ou Invariável | Quantidade vaga / Indeterminação (equivale amuitos) | "Tinha bastantes amigos." (= muitos) |
...
1. Interrogação Indireta: Pergunta incorporada sob forma declarativa, encerrada com ponto final (.), construída mediante verbos de conjectura, dúvida ou desconhecimento (desconheço, não sei, quero saber, pergunto-me).
...
[ANTES DO SUBSTANTIVO] [DEPOIS DO SUBSTANTIVO] Pronome Indefinido (Ideia Vaga) ≠ Adjetivo (Qualificador / Especificador)

• certo senhor (senhor qualquer) • senhor certo (senhor correto/adequado) • bastante dinheiro (muito dinheiro) • dinheiro bastante (dinheiro suficiente) • vários deputados (muitos deputados) • deputados vários (deputados diversos/variados)
...
1. "TODO" como Advérbio Variável (Exceção Gramatical Única):
...
1. Quebra de Paradigma Contextual pelo CESPE (Questão TRE-BA):
...
Esta seção condensa as regras mestras consolidadas para consulta rápida e recuperação direta:

1. Regra de Concordância do Possessivo: O pronome possessivo concorda em gênero e número com a coisa possuída (substantivo posposto) e aponta semanticamente para o possuidor (referente) .
2. Dicotomia Pronome Adjetivo vs. Substantivo: Pronome adjetivo acompanha substantivo expresso; pronome substantivo substitui o substantivo e opera como núcleo oracional .
3. Regra de Exclusão do Advérbio: Advérbio modifica verbo, adjetivo ou advérbio. Advérbio jamais se refere a substantivo .
...
1. Regra Posicional de "Algum":

1. Equivalência Morfossemântica do "Mais" (FGV):
...
1. Regra de Flexão do Advérbio "Todo": É o único advérbio que admite concordância facultativa com o adjetivo modificado (ela é todo / toda poderosa) .
2. Regra de "Todo" com vs. sem Artigo:
...
3. Formular a Pergunta de Posse: Pergunte à oração: "De quem é [substantivo posposto]?".
4. Substituição Diagnóstica por "Dele(s) / Dela(s)": Reescreva mentalmente a expressão substituindo o possessivo por dele, dela, deles ou delas (ex.: "suas relações" $\rightarrow$ "as relações dela").
5. Reconstrução da Cadeia Coesiva Linha a Linha: Se a substituição exigir "dela", busque no período anterior qual substantivo feminino (singular ou plural) responde por essa referência, rastreando pronomes demonstrativos e pessoais intermediários.
6. Julgamento do Item: Verifique se o termo apontado pela banca é o possuidor originário ou apenas um elemento gramatical próximo inserido para induzir ao erro.
...
1. Desempate entre Adjetivo e Pronome Indefinido:
...
1. Validação: Se a conversão mantiver a coerência e a intenção interrogativa, o vocábulo é Pronome Interrogativo.
...
| Critério de Análise | Pronome Pessoal (Reto / Oblíquo) | Pronome Possessivo (meu, seu, nosso) |
| --- | --- | --- |
| Concordância de Gênero/Número | Faz-sediretamente com o referente (nome retomado). | Faz-se com osubstantivo posposto (coisa possuída). |
| Identificação do Referente | Possui o mesmo gênero/número do pronome. | Pode possuir gênero e númerocompletamente distintos do pronome. |
...
| --- | --- | --- | --- |
| Bastante | "motivos bastantes" (= suficientes) | "estudou bastante" (= muito/intensamente) | "bastantes motivos" (= muitos motivos) |
| Mais | — (Não atua como adjetivo típico) | "mais paciente" / "corra mais" (Intensidade) | "mais paciência" / "mais livros" (Quantidade) |
| Menos | — (Não atua como adjetivo típico) | "fale menos" (Invariável / Intensidade) | "menos disposição" (Invariável / Quantidade) |
...
| --- | --- | --- | --- | --- |
| "jornais da manhã" | $de + a$ (com artigo definido) | Aponta para o substantivojornais | Locução Adjetiva | Caracteriza a edição/tipo do jornal |
| "leio de manhã" | $de$ (sem artigo definido) | Aponta para o verboleio | Locução Adverbial | Indica o tempo/horário em que se lê |
...
1. "Seu país tem 13,5 milhões de miseráveis?"
2. "Sim."
3. "Não é de cortar o coração?" / "Quando as pessoas tinham coração, era."
...
(VUNESP - TJ-PA - Analista Judiciário) Trecho: "Meu amigo lusitano, Diniz, está traduzindo... por conta de palavras e gírias comuns no meu Pará..." O pronome possessivo em – "meu Pará" – atribui ao termo Pará a ideia de que se trata de um lugar:
A) estimado pelo autor.
B) abandonado pelo autor.
C) desdenhado pelo autor.
...
- ... suas financiadoras (1º parágrafo)
...
3. seu caráter mais violento $\rightarrow$ No contexto ("onde o trabalho de abstração assume seu caráter mais violento"), o pronome remete a trabalho de abstração.

- Gabarito: D

(CESPE - MPE-CE - Analista Ministerial) Texto: "Desde os alvores da democracia ateniense, são sobejamente conhecidas as suas relações com a argumentação e a retórica..." Item: A expressão “suas relações” (l.22) refere-se às relações da “democracia ateniense” (l.21). Certo Errado
...
(CESPE - Instituto Rio Branco - Diplomata) Texto: "Foi neste momento que a surpreendeu Machado de Assis, mal inclinado a ela por força de seu preconceito, nutrido de tradição. No seu sarcasmo, ferindo-a de zombarias e risos, ele vê um mundo que cresce à sua frente..." Item: Nas expressões “seu preconceito” (l.45) e “seu sarcasmo” (l. 45 e 46), o pronome possessivo remete a referentes distintos. Certo Errado
...
(CESPE - Instituto Rio Branco - Diplomata) Texto: "Esquematizando, pode-se dizer que a colonização produziu... três classes de população: o latifundiário, o escravo e o 'homem livre'... Entre os primeiros dois a relação é clara, é a multidão dos terceiros que nos interessa. Nem proprietários nem proletários, seu acesso à vida e a seus bens depende... O agregado é a sua caricatura." Item: Do período “O agregado é a sua caricatura” (l. 23 e 24), é correto inferir que o agregado é uma caricatura de si próprio. Certo Errado
...
- c) ( 3 ) Precisou de muito dinheiro para comprar a casa. $\rightarrow$ Muito modifica o substantivo dinheiro (Pronome indefinido adjetivo).
- d) ( 2 ) Beijo pouco, falo menos ainda. $\rightarrow$ Pouco modifica o verbo beijo; menos modifica o verbo falo (Advérbios de intensidade).
- e) ( 3 ) Hoje disponho de pouco tempo para diversão; e o que é pior, de menos disposição. $\rightarrow$ Pouco modifica o substantivo tempo; menos modifica o substantivo disposição (Pronomes indefinidos adjetivos).
- f) ( 2 ) Cantava bem baixo para ninguém ouvi-lo. $\rightarrow$ Baixo modifica o verbo cantava (advérbio); bem modifica o advérbio baixo (Advérbio de intensidade).
- g) ( 3 ) Tinha bastante orgulho da irmã. $\rightarrow$ Bastante anteposto ao substantivo orgulho, equivalendo a muito (Pronome indefinido adjetivo).
- h) ( 2 ) Era uma pessoa bastante orgulhosa. $\rightarrow$ Bastante modifica o adjetivo orgulhosa (Advérbio de intensidade).
- i) ( 1 ) Depositava confiança bastante no bom senso da filha. $\rightarrow$ Bastante posposto ao substantivo confiança, equivalendo a suficiente (Adjetivo).
- j) ( 3 ) Tenha mais paciência. $\rightarrow$ Mais modifica o substantivo paciência (Pronome indefinido adjetivo).
- k) ( 2 ) Seja mais paciente. $\rightarrow$ Mais modifica o adjetivo paciente (Advérbio de intensidade).
- l) ( 1 ) Sempre leio os jornais da manhã. $\rightarrow$ Da manhã (com artigo) liga-se ao substantivo jornais (Locução Adjetiva).
- m) ( 2 ) Sempre leio os jornais de manhã. $\rightarrow$ De manhã (sem artigo) liga-se ao verbo leio (Locução Adverbial de tempo).

(AOCP - Prefeitura de Juiz de Fora - MG - Assistente de Administração) Em “[...] Com as infinitas informações veiculadas pela Internet, um certo senhor virtual armou-se de estetoscópio [...]”, o termo em destaque é classificado morfologicamente como:
A) substantivo.
B) adjetivo.
C) pronome.
D) conjunção.
...
(VUNESP - Prefeitura de Campinas - SP - Agente Administrativo) Assinale a alternativa em que o primeiro pronome destacado tem um referente posposto a ele, e o segundo expressa sentido genérico.
A) Ela encontra nas redes sociais o seu lugar... /... e serve para apontar algum sofrimento psíquico.
B) Toda paixão nos torna cegos... / Nesse momento de nossa experiência com as redes sociais...
C)... e ela também procura seu lugar. /... que fizesse bem a quem delas participa...
...
2. Segundo Pronome ("algum"): O termo algum em "algum sofrimento psíquico" atua como pronome indefinido expressando valor genérico e indeterminado.

- Gabarito: A

(VUNESP - PC-SP - Escrivão de Polícia Civil) Na passagem — Problema de lixo não tinham; podia ser atirado em qualquer parte, embora não conviesse atirá-lo em parte alguma... — os pronomes destacados expressam, correta e respectivamente, as ideias de:
...
(FGV - AL-BA - Técnico de Nível Superior) “Já desde Platão sabemos que ela é sensível à ação dos demagogos. E, quanto mais avançamos no conhecimento do cérebro e da psicologia humana, descobrimos novas e mais sutis maneiras de influenciar os eleitores, que usam muito mais a emoção do que a razão na hora de fazer suas escolhas”. Sobre as três ocorrências do vocábulo “mais”, assinale a afirmativa correta:
...
- 3º "mais" ("usam muito mais a emoção"): Liga-se ao verbo usam ("usam mais") $\rightarrow$ Advérbio (o artigo "a" impede a conexão direta com o substantivo).
- Conclusão: Todas as três ocorrências são advérbios.
- Gabarito: A

(FGV - IBGE - Recenseador) No texto, há três ocorrências do vocábulo “mais”: (1) “...joga mais luz sobre a origem da vida”; (2) “...uma das mais importantes publicações científicas” e (3) “...será o mais antigo registro de vida na Terra”. Sobre essas ocorrências, é correto afirmar que em:
...
- Ocorrência (3) ("mais antigo"): Liga-se a antigo (adjetivo) $\rightarrow$ Advérbio $\rightarrow$ Valor de Intensidade.
- Gabarito: C

(CESPE - SEDF) Texto: "Quanta inútil retórica se tem desperdiçado para provar que todos os nossos males ficariam resolvidos..." Item: O vocábulo “Quanta” (l.6) classifica-se, na oração em que ocorre, como pronome interrogativo. Certo Errado
...
(CESPE - TRE-BA - Técnico Judiciário) Texto: "Quase todo mundo conhece os riscos de se ter os documentos usados de forma indevida... Mas um sistema que começou a ser implantado na Bahia pode resolver o problema em todo o país." Item: No texto, tanto o termo “todo” (l.1) quanto “todo o” (l.5) expressam totalidade. Certo Errado
...
Ao concluir o estudo deste grupo temático (esta unidade), o estudante domina a transição entre o reconhecimento morfológico e a análise sintático-semântica aplicada a concursos públicos:

1. Domínio dos Pronomes Possessivos: O candidato não confunde mais a flexão morfológica com a recuperação do referente. Sabe que o pronome concorda estritamente com o termo que vem depois dele (coisa possuída) e rastreia com segurança o possuidor (termo antecedente, catafórico ou elíptico no verbo) através do teste substitutivo por dele(s)/dela(s).
2. Discriminação Categórica Universal: O aluno internaliza que qualquer pronome pode operar como adjetivo (se acompanhar substantivo) ou como substantivo (se substituir o substantivo).
3. Domínio da Matriz Multiclasse: Através da técnica das setas de modificação, o aluno distingue com clareza matemática se palavras como bastante, mais, menos, pouco, muito e todo atuam como adjetivos, advérbios ou pronomes indefinidos, sabendo que advérbio jamais se refere a substantivo.
4. Comportamento Posicional e Semântico: Compreende o impacto da anteposição e posposição de vocábulos (certo senhor vs. senhor certo; alguma parte vs. parte alguma) e a relação direta de classes estabelecida pela FGV para o vocábulo mais (Advérbio = Intensidade; Pronome Indefinido = Quantidade).
5. Reconhecimento de Interrogações Indiretas e Particularidades do CESPE: Identifica pronomes interrogativos mesmo em frases sem sinal gráfico ? e compreende que a banca CESPE analisa a totalidade pragmático-semântica no mundo real em expressões consagradas como "todo mundo".
