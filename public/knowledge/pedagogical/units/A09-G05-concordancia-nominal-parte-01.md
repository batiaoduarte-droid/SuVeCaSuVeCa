...
**Método central:** Na concordância nominal, conecte determinantes e qualificadores aos núcleos que controlam gênero e número, distinguindo adjunto e predicativo.
...
- **Classes Gramaticais**: Diferenciação entre substantivo (núcleo) e classes determinantes (artigo, adjetivo, pronome adjetivo, numeral adjetivo).
...
│
└── 5. Nuances de Prova e Reescrita
 ├── Inversão de termos mantendo o adjetivo posposto → preserva sentido geral
 ├── Deslocamento do adjetivo para o meio dos substantivos → restringe sentido ao primeiro núcleo
 └── "Relação de concordância" (FGV) → exige apontar todos os substantivos modificados no texto
```
...
- O **substantivo** opera como núcleo comandante e centro sintático.
- Os **determinantes** gravitam em torno desse núcleo, sendo obrigados a refletir suas propriedades morfológicas.
- Quando múltiplos substantivos coordenados dividem um único adjetivo na função de adjunto adnominal, a posição sintática relativa do adjetivo (anteposto ou posposto) determina o regime de flexão admitido pela norma culta.
...
- Para haver restrição semântica deliberada a apenas um dos elementos, a ordem sintática precisaria isolar o modificador (ex.: antepondo-o diretamente ao substantivo pretendido: *"cabelos e branca barba"*).
...
- Estruturas no plural genérico anteposto a substantivo singular (ex.: *\*Desconhecidos clima e terra*, *\*Espaçosos sala e quarto*, *\*Contaminados mães e pais*) constituem **erro gramatical absoluto**.
...
- Na oração *"A destruição de biomas e a redução da biodiversidade aceleradas"*, os núcleos são *destruição* ($F$) e *redução* ($F$). Os termos preposicionados *de biomas* ($M.\text{pl.}$) e *da biodiversidade* ($F.\text{s.}$) não exercem atração sobre o adjetivo posposto, que deve flexionar-se no feminino plural (*aceleradas*).
...
- Por outro lado, em *"...característica ou estilo barroco"*, o adjetivo *barroco* qualifica ambos os núcleos (*característica* e *estilo*), mesmo estando no masculino singular por concordância atrativa. A indicação `barroco / característica ou estilo` é **correta**.
...
| ID Canônico | Conceito / Regra | Formulação Canônica | Restrições e Limites |
|:----------------- |:--------------------------------------------------- |:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |:----------------------------------------------------------------------------------------------- |
|  | **Princípio Fundamental** | Determinantes (artigo, adjetivo, pronome adj., numeral adj.) flexionam-se para harmonizar em gênero e número com o substantivo determinado. | O substantivo atua como núcleo incondicional do sintagma nominal. |
|  | **Adjunto Posposto a Múltiplos Núcleos** | Admite**Concordância Total** (plural do gênero comum ou masculino plural para gêneros mistos) ou **Concordância Atrativa** (gênero e número do núcleo mais próximo). | Na concordância total com gêneros diferentes ($M+F$), é proibida a flexão feminina plural. |
|  | **Extensão Semântica Posposta** | A alternância entre concordância total e atrativa com adjetivo posposto**não altera o sentido** original da frase. | Ambas as formas qualificam a totalidade dos substantivos antecedentes. |
|  | **Referenciação Semântica Exclusiva (FGV)** | Se o adjetivo for logicamente incompatível com um dos núcleos, a concordância total é proibida; concorda-se apenas com o núcleo compatível. | Aplica-se a contextos pragmáticos claros (*preço baixo*, *pão torrado*). |
|  | **Adjunto Anteposto a Múltiplos Núcleos** | Admite**obrigatoriamente apenas a Concordância Atrativa**, flexionando com o primeiro substantivo imediatamente posterior. | É proibida a concordância total no plural para adjetivo anteposto. |
|  | **Farejador de Núcleos** | A flexão do adjetivo/particípio rege-se pelo substantivo-núcleo sem preposição, descartando modificadores preposicionados intercalados. | Impede atrações morfológicas indevidas por adjuntos plurais internos. |
|  | **Relação de Concordância (FGV)** | Mapeamento do conjunto integral de substantivos aos quais o modificador atribui estado ou atributo no texto. | A alternativa que omite um dos núcleos qualificados comete erro conceitual. |
...
[Início: Analisar a sentença proposta]
 │
 ├── 1. Identificar a Posição Sintática do Adjetivo:
 │ │
 │ ├── SE ANTEPOSTO:
 │ │ └── Aplicar OBRIGATORIAMENTE a CONCORDÂNCIA ATRATIVA:
 │ │ - Identificar o gênero e o número do 1º substantivo (o mais próximo).
 │ │ - Flexionar o adjetivo em estrita concordância com ele.
 │ │ - ELIMINAR qualquer alternativa com plural total na anteposição.
 │ │
 │ └── SE POSPOSTO:
 │ └── Passo 2: Testar a Coerência Semântica Contextual:
 │ │
 │ ├── O adjetivo cabe logicamente a APENAS UM substantivo?
 │ │ │
 │ │ ├── SIM (Restrição Semântica / Ex.: preço baixo, pão torrado):
 │ │ │ └── Concordar EXCLUSIVAMENTE com o substantivo pertinente.
 │ │ │
 │ │ └── NÃO (Qualificação Geral / Ex.: cabelos e barba, sala e quarto):
 │ │ └── Aplicar a DUPLA POSSIBILIDADE:
 │ │ ├── Opção 1 (Concordância Total):
 │ │ │ - Mesmo gênero → Plural desse gênero.
 │ │ │ - Gêneros diferentes → Masculino Plural.
 │ │ └── Opção 2 (Concordância Atrativa):
 │ │ - Concordar com o substantivo imediatamente adjacente.
 │
 └── [Fim do procedimento]
```
...
3. **Identificar o(s) núcleo(s) substantivo(s)** sem preposição que encabeçam a estrutura sintática.
...
| Critério de Comparação | Adjetivo Posposto a Múltiplos Substantivos | Adjetivo Anteposto a Múltiplos Substantivos |
|:----------------------------------------------- |:------------------------------------------------------------------------------------ |:----------------------------------------------------------------------------------------- |
| **Concordância Total ($M.\text{pl.}$)** | **Permitida** (*"sala e quarto espaçosos"* / *"cabelos e barba brancos"*). | **Proibida** (*"\*espaçosos sala e quarto"* / *"\*brancos cabelos e barba"*). |
| **Concordância Atrativa** | **Permitida** (*"sala e quarto espaçoso"* / *"cabelos e barba branca"*). | **Obrigatória** (*"espaçosa sala e quarto"* / *"desconhecido clima e terra"*). |
| **Extensão Semântica** | Abrange todos os núcleos antecedentes em ambas as concordâncias. | Abrange os núcleos subsequentes por contiguidade inicial. |
| **Peculiaridade de Bancas** | FGV bloqueia a concordância total se houver incompatibilidade lógica. | Bancas exploram o erro de candidatos que tentam "somar" no plural. |

### Matriz de Contrastes Semânticos e Sintáticos em Reescrita

| Estrutura Sintática | Status Gramatical | Impacto Semântico em Relação ao Original |
|:-------------------------------- |:-----------------: |:--------------------------------------------------------------------------------------------------------------------- |
| `Roupas e calçados masculinos` | Correto | Ambos são masculinos (concordância total ou atrativa). |
| `Calçados e roupas masculinas` | Correto | Ambos continuam masculinos por extensão semântica na inversão. |
| `Roupas masculinas e calçados` | Correto | **Alteração semântica**: apenas *roupas* são caracterizadas como masculinas; *calçados* fica genérico. |
| `Masculinos roupas e calçados` | **Incorreto** | Erro de concordância nominal (anteposição não admite plural masculino se o primeiro núcleo é feminino). |
...
- **Análise Semântica**: Ambas informam textualmente que tanto os cabelos quanto a barba eram brancos.
...
|:---------: |:----------------------------------------------------- |:------------------------------ |:----------------------- |:-------------------------------------------- |
| **1** | `Faca e navalha _______ (afiado)` | $F.\text{s.} + F.\text{s.}$ | `afiadas` | `afiada` |
| **2** | `...estética e época _______ (tedioso)` | $F.\text{s.} + F.\text{s.}$ | `tediosas` | `tediosa` |
| **3** | `Amor e agradecimento _______ (eterno)` | $M.\text{s.} + M.\text{s.}$ | `eternos` | `eterno` |
| **4** | `Códigos e senhas _______ (alterado)` | $M.\text{pl.} + F.\text{pl.}$ | `alterados` | `alteradas` |
| **5** | `Mãe e pai _______ (moderno)` | $F.\text{s.} + M.\text{s.}$ | `modernos` | `moderno` |
| **6** | `Argumentos e justificativas _______ (pífio)` | $M.\text{pl.} + F.\text{pl.}$ | `pífios` | `pífias` |
| **7** | `Rio consome frutas e legumes _______ (contaminado)` | $F.\text{pl.} + M.\text{pl.}$ | `contaminados` | `contaminados` *(convergência gráfica)* |
...
|:----------: |:---------------------------------------- |:------------------------------ |:--------------------------- |:----------------------- |
| **09** | `_______ clima e terra. (desconhecido)` | *clima* ($M.\text{s.}$) | `Desconhecido` | *\*Desconhecidos* |
| **10** | `_______ faca e navalha. (afiado)` | *faca* ($F.\text{s.}$) | `Afiada` | *\*Afiadas* |
| **11** | `_______ atitudes e gestos. (belicoso)` | *atitudes* ($F.\text{pl.}$) | `Belicosas` | *\*Belicosos* |
...
- **Formas Corretas**: *Desconhecido clima e terra*, *Espaçosa sala e quarto*, *Contaminadas mães e pais*.
