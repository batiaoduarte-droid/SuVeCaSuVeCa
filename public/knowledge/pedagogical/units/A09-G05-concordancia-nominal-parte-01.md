...
>
> Compreender e definir os princípios normativos e conceituais de Concordância Nominal - Parte 01. Aplicar regras canônicas e procedimentos decisórios de Concordância Nominal - Parte 01 na resolução de questões. Analisar o papel de Concordância Nominal - Parte 01 no eixo Método central e reconhecer armadilhas e variações de bancas.
...
1. Substantivos de gêneros diferentes ($M + F$ ou $F + M$):
...
- Estrutura sintática: $\text{Substantivo}1 + \text{Substantivo}2 + \dots + \text{Adjetivo}$.
...
|  | Adjunto Posposto a Múltiplos Núcleos | AdmiteConcordância Total (plural do gênero comum ou masculino plural para gêneros mistos) ou Concordância Atrativa (gênero e número do núcleo mais próximo). | Na concordância total com gêneros diferentes ($M+F$), é proibida a flexão feminina plural. |
|  | Extensão Semântica Posposta | A alternância entre concordância total e atrativa com adjetivo pospostonão altera o sentido original da frase. | Ambas as formas qualificam a totalidade dos substantivos antecedentes. |
...
|  | Adjunto Anteposto a Múltiplos Núcleos | Admiteobrigatoriamente apenas a Concordância Atrativa, flexionando com o primeiro substantivo imediatamente posterior. | É proibida a concordância total no plural para adjetivo anteposto. |
...
| --- | --- | --- | --- | --- |
| 1 | Faca e navalha  (afiado) | $F.\text{s.} + F.\text{s.}$ | afiadas | afiada |
| 2 | ...estética e época  (tedioso) | $F.\text{s.} + F.\text{s.}$ | tediosas | tediosa |
| 3 | Amor e agradecimento  (eterno) | $M.\text{s.} + M.\text{s.}$ | eternos | eterno |
| 4 | Códigos e senhas  (alterado) | $M.\text{pl.} + F.\text{pl.}$ | alterados | alteradas |
| 5 | Mãe e pai  (moderno) | $F.\text{s.} + M.\text{s.}$ | modernos | moderno |
| 6 | Argumentos e justificativas  (pífio) | $M.\text{pl.} + F.\text{pl.}$ | pífios | pífias |
| 7 | Rio consome frutas e legumes  (contaminado) | $F.\text{pl.} + M.\text{pl.}$ | contaminados | contaminados (convergência gráfica) |

1. Supermercado X: Supermercado X: qualidade e preço  (baixo)
...
1. Café da Manhã: Café da manhã com leite e pão  (torrado)
...
| --- | --- | --- | --- | --- |
| 09 | clima e terra. (desconhecido) | clima ($M.\text{s.}$) | Desconhecido | \*Desconhecidos |
| 10 | faca e navalha. (afiado) | faca ($F.\text{s.}$) | Afiada | \*Afiadas |
| 11 | atitudes e gestos. (belicoso) | atitudes ($F.\text{pl.}$) | Belicosas | \*Belicosos |
...
1. Plano Semântico vs. Plano Gramatical:
...
1. Peculiaridades de Bancas de Elite:
