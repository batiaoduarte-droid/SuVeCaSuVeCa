...
1. Classes Variáveis que NÃO Atraem no Cebraspe:
...
1. Ênclise Hifenizada ao Verbo Auxiliar: ERRADO / PROIBIDO. A presença de palavra atrativa proíbe a ênclise ao auxiliar (não estou-a entendendo / não poderia-se casar = Erro grave).
2. Mesóclise no Auxiliar com Atrativo: PROIBIDO. A presença da palavra atrativa anula a mesóclise (não poder-se-ia casar = Erro grave).
...
O Método do Verbo Irregular (Fazer / Dizer): Para diagnosticar se a forma verbal terminada em -r é Infinitivo ou Futuro do Subjuntivo, substitua o verbo regular por fazer ou dizer:
...
1. Passo 2 — Teste da Regra Geral (Palavra Invariável Anteposta):
...
1. Passo 3 — Teste das 2 Exceções Soberanas:

1. Passo 4 — Decisão pelo Princípio do "Não Proibido":
...
| Teste Fazer/Dizer | Substitui-se porfazer ou dizer | Substitui-se porfizer ou disser |
