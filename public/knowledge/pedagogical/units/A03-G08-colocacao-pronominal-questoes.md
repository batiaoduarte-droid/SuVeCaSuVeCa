...
**Método central:** Nas questões de colocação, delimite a oração, identifique verbo e pronome, teste atração, início oracional e locuções, e só então julgue próclise, mesóclise ou ênclise.
...
- Reconhecimento dos pronomes oblíquos átonos (`me`, `te`, `se`, `nos`, `vos`, `o/a/os/as`, `lhe/lhes`).
...
SISTEMA DE COLOCAÇÃO PRONOMINAL AVANÇADA (CEBRASPE)
 ├── 1. AS TRÊS PROIBIÇÕES ABSOLUTAS
 ...
 │
 └── 5. PONTUAÇÃO E INÍCIO DE ORAÇÃO
 ├── Adjunto Adverbial Antecipado no Início: Oração principal começa após vírgula -> Próclise PROIBIDA
 └── Intercalação Entre Vírgulas Casadas: Oração iniciou antes -> Próclise PERMITIDA (facultativa)
```
...
- **Próclise Obrigatória (Palavra atrativa anteposta):**
...
- `Eu não estou entendendo-a.` $\rightarrow$ **CORRETO** (Ênclise ao gerúndio distante).
- `Eu não estou-a entendendo.` $\rightarrow$ **INCORRETO / PROIBIDO** (Ênclise ao auxiliar).
- `Como não se poderia casar.` $\rightarrow$ **CORRETO** (Próclise ao auxiliar).
- `Como não poderia se casar.` $\rightarrow$ **CORRETO** (Próclise ao infinitivo).
- `Como não poderia casar-se.` $\rightarrow$ **CORRETO** (Ênclise ao infinitivo "todo-poderoso").
- `Como não poder-se-ia casar.` $\rightarrow$ **INCORRETO / PROIBIDO** (Mesóclise com atrativo).
...
**O Método do Verbo Irregular (*Fazer* / *Dizer*):**
Para diagnosticar se a forma verbal terminada em `-r` é Infinitivo ou Futuro do Subjuntivo, substitua o verbo regular por *fazer* ou *dizer*:
...
$$
\text{Sujeito} + \text{Palavra Negativa} + \text{Pronome Oblíquo} + \text{Verbo} \quad (\text{Ex.: } \textit{"João não me chamou"})
$$

Na Apossínclese, o pronome é anteposto ao próprio termo atrativo negativo:

$$
\text{Sujeito} + \text{Pronome Oblíquo} + \text{Palavra Negativa} + \text{Verbo} \quad (\text{Ex.: } \textit{"João me não chamou"})
$$

Outro padrão de apossínclese ocorre com dois atratores em sequência:

$$
\text{Atrator 1} + \text{Pronome Oblíquo} + \text{Atrator Negativo 2} + \text{Verbo} \quad (\text{Ex.: } \textit{"Ninguém me nunca disse isso"})
$$
...
|:------------------------------------------ |:------------------------------------------- |:----------------------------------------: |:---------------------------------------------------------------------------------------------------- |
| `[Adjunto Antecipado], [Verbo...]` | **Início da Oração Principal** | **PROIBIDA** (Ênclise obrigatória) | *Em um contexto..., **verifica-se*** (BACEN 2024: *"se verifica"* = ERRADO) |
| `[Sujeito], [Intercalação], [Verbo...]` | **Meio da Oração Já Iniciada** | **PERMITIDA** (Facultativa) | *Estes, muitas vezes, **se situam / situam-se*** (Petrobras 2024: Válida, não obrigatória) |
| `[Oração 1], [Verbo Oração 2...]` | **Início da 2ª Oração Coordenada** | **PROIBIDA** (Ênclise obrigatória) | *João acordou cedo, **encontrou-me*** (*"me encontrou"* = ERRADO) |
...
1. Não há início de oração (há o sujeito *"O justo"*).
2. O verbo não está no futuro nem no particípio.
3. O substantivo *"justo"* não é palavra atrativa obrigatória.
...
| Código da Regra / Definição | Enunciado Canônico Síntese |
| :------------------------------------- | :---------------------------------------------------------------------------------------------------------------------- |
| **Regra da Anteposição** | Palavra invariável só atrai se estiver antes do verbo; pós-verbal não atrai. |
| **Classes Variáveis Atrativas** | Apenas Pronomes Relativos e Pronomes Indefinidos atraem mesmo variando. |
| **Locução com Atrativo** | Próclise ao auxiliar, ao principal e ênclise ao principal são válidas; ênclise com hífen ao auxiliar é proibida. |
| **Infinitivo "Todo-Poderoso"** | O infinitivo sempre aceita ênclise, superando a atração antecedente. |
| **Futuro do Subjuntivo** | Não aceita ênclise sob atração; exige próclise obrigatória. |
| **Apossínclese** | Colocação do pronome antes da palavra negativa invariável é válida no Cebraspe. |
| **Oração Desenvolvida** | Conjunções subordinativas atraem o pronome mesmo havendo sujeito intercalado. |
| **Hierarquia do Futuro** | Sem atrator = próclise/mesóclise; com atrator = próclise obrigatória (mesóclise proibida). |
| **Adjunto Antecipado** | Vírgula que fecha adjunto no início abre a oração principal: próclise proibida. |
| **Intercalação** | Vírgulas casadas no meio da oração não marcam início: próclise permitida. |
| **Regra do Não Proibido** | Não havendo atração nem proibição expressa, próclise e ênclise são corretas. |
...
3. **Próclise ao Principal sem hífen (`não pode me ver`):** Sempre CORRETO.
4. **Ênclise ao Principal (`não pode ver-me` / `não está vendo-me`):** Sempre CORRETO (distanciamento no gerúndio / soberania do infinitivo).
5. **Apossínclese (`me não pode ver`):** Válido no Cebraspe.
6. **Ênclise com hífen ao Auxiliar (`não pode-me ver`):** **ELIMINE (ÚNICA FORMA PROIBIDA)**.
7. **Mesóclise no Auxiliar (`não poder-me-á ver`):** **ELIMINE (PROIBIDO POR ATRAÇÃO)**.
...
### Tabela 1: Futuro do Subjuntivo versus Infinitivo Pessoal

| Critério Comparativo | Infinitivo Pessoal | Futuro do Subjuntivo |
|:---------------------------------- |:----------------------------------------------------------------------- |:------------------------------------------------------------------------- |
| **Natureza Morfossintática** | Forma nominal do verbo (expressa a ação) | Modo verbal finito (expressa eventualidade/hipótese) |
| **Teste Fazer/Dizer** | Substitui-se por*fazer* ou *dizer* | Substitui-se por*fizer* ou *disser* |
...
|:-------------------------------------- |:---------------------------------------------------------------------------------- |:---------------------------------------------------------------- |
| **Estrutura no Período** | `[Adjunto Adverbial Antecipado], [Verbo...]` | `[Sujeito], [Adjunto Intercalado], [Verbo...]` |
| **Início da Oração** | Inicia-se imediatamente após a vírgula | Iniciou-se antes da primeira vírgula (no sujeito) |
| **Próclise ao Verbo** | **PROIBIDA** (Violaria o início de oração) | **PERMITIDA** (Oração já está em curso) |
...
|:------------------------- |:---------------------------------------------- |:--------------------------------------------------------------- |:--------------------------------------- |
| **Cebraspe / CESPE** | Palavra variável (flexiona em número/gênero) | **Não atrai obrigatoriamente** quando sujeito/intercalado | Aceita ênclise (*Estes... situam-se*) |
| **FGV** | Elemento de valor mostrativo/atrator | **Atrai obrigatoriamente** | Exige próclise (*Estes... se situam*) |
...
- **Item:** *No trecho “a par do que se trata” (terceiro parágrafo), a anteposição da partícula “se” ao verbo justifica-se pela presença do vocábulo “que”.*
- **Gabarito:** **CERTO**
- **Justificativa Consolidada:** O vocábulo `que` atua como pronome relativo antecedendo o verbo. Como pronomes relativos são classes atrativas obrigatórias no Cebraspe, a próclise da partícula `se` é plenamente justificada pela presença do `que`.
...
- **Item:** *Em “poderiam até se valer de um salvo-conduto” (último período), a próclise do pronome “se” é obrigatória, haja vista o emprego do vocábulo “até”.*
- **Gabarito:** **ERRADO**
- **Justificativa Consolidada:** Embora `até` seja palavra invariável, o verbo principal `valer` está no **infinitivo** (*poderiam até dizer/fazer*). O infinitivo é soberano e aceita ênclise em qualquer hipótese (`até valer-se`). Portanto, a próclise é **facultativa**, e não obrigatória.
...
- **Item:** *No primeiro período do texto, a ênclise do pronome “se” à forma verbal “desvela”, escrevendo-se desvela-se, seria gramaticalmente correta.*
- **Gabarito:** **CERTO**
- **Justificativa Consolidada:** O sujeito *"O justo"* não é fator de atração obrigatória. A ênclise *"desvela-se"* não viola nenhuma das 3 proibições (não inicia oração, não está no futuro/particípio). Pelo Princípio do Não Proibido, a substituição é perfeitamente correta.
...
- **Item:** *Estaria mantida a correção gramatical do quarto período caso a partícula “se”, em “verifica-se”, fosse deslocada para a posição proclítica – se verifica.*
- **Gabarito:** **ERRADO**
- **Justificativa Consolidada:** O bloco inicial é um extenso adjunto adverbial antecipado. A oração principal inicia-se após o travessão em `verifica-se`. A próclise *"se verifica"* violaria a proibição absoluta de iniciar orações com pronome oblíquo átono.
...
- **Item:** *Em “Estes, muitas vezes, se situam em regiões remotas”, é obrigatória a próclise do pronome “se” em razão da expressão adverbial “muitas vezes”.*
- **Gabarito:** **ERRADO**
- **Justificativa Consolidada:** A oração já se iniciou em `Estes`. O termo `muitas vezes` é adjunto intercalado entre vírgulas casadas e não atrai. A próclise é válida, porém **facultativa** (admitindo-se também *"situam-se"*). O erro do item está em afirmar que é *obrigatória*.
...
- **Item:** *Seria gramaticalmente correta a colocação da forma pronominal “as” em ênclise à forma de gerúndio “levando” — levando-as.*
- **Gabarito:** **CERTO**
- **Justificativa Consolidada:** Na locução `está levando`, o verbo principal no gerúndio está fisicamente distante do atrator `que`. Ocorre o relaxamento da atração sobre o verbo principal, tornando a ênclise `está levando-as` perfeitamente correta.
...
- **Item:** *A correção gramatical do primeiro período do texto seria mantida se a forma pronominal 'se' fosse deslocada para imediatamente antes da forma verbal 'valeu' $\rightarrow$ se valeu.*
- **Gabarito:** **CERTO**
- **Justificativa Consolidada:** A conjunção subordinativa `quando` exige próclise obrigatória na oração desenvolvida, sobrepondo-se à intercalação do sujeito `Otaviano`.
...
- **Item:** *A próclise pronominal em 'se deslocava' justifica-se pelo caráter desenvolvido da oração subordinada em que tal trecho se insere.*
- **Gabarito:** **CERTO**
- **Justificativa Consolidada:** A conjunção integrante `que` introduz oração subordinada substantiva desenvolvida, impondo a próclise mesmo com o sujeito intercalado *"o homem pré-histórico"*.
...
- **Justificativa Consolidada:** Pronomes retos (`Nós`, `Elas`) são variáveis e não atraem pronomes oblíquos, mantendo a colocação facultativa.
...
3. Não há atrator obrigatório?
 Se respondeu NÃO às 3 perguntas, a construção proposta **ESTÁ CORRETA**.
...
- **Forma Correta:** `Como não se poderia casar` / `Não lhe darei o livro`.
- **Explicação:** A palavra atrativa anula e proíbe a mesóclise.
...
- **Explicação:** A ênclise ao futuro constitui proibição absoluta na língua portuguesa.
...
- **Forma Correta:** `Assim que eu a encontrar` (*assim que eu fizer* = Futuro do Subjuntivo $\rightarrow$ Próclise obrigatória).
...
Ao concluir o estudo deste grupo temático consolidado, o estudante deve dominar com segurança operacional:

1. **A Mecânica da Atração:** Compreender que a palavra invariável exige estar anteposta ao verbo para atrair, e que apenas pronomes relativos e indefinidos atraem entre as classes variáveis no Cebraspe.
2. **A Flexibilidade da Locução Verbal:** Reconhecer que em locuções com atrator prévio existem três colocações válidas (próclise ao auxiliar, próclise ao principal e ênclise ao principal) e uma única proibição formal: a ênclise hifenizada ao auxiliar.
3. **O Diagnóstico do Infinitivo vs. Subjuntivo:** Aplicar instantaneamente o macete do verbo irregular (*Fazer/Dizer*) para diferenciar o infinitivo soberano (que aceita ênclise) do futuro do subjuntivo (que exige próclise com atrator).
4. **O Domínio da Apossínclese e Orações Desenvolvidas:** Não estranhar a anteposição do pronome ao advérbio negativo e reconhecer que conjunções subordinativas impõem próclise mesmo através de sujeitos intercalados.
5. **O Algoritmo 3-1-2 e a Pontuação:** Julgar qualquer questão de concurso em menos de 30 segundos verificando as 3 proibições, a regra geral e as 2 exceções, sabendo distinguir perfeitamente a pontuação de adjunto antecipado (que veda a próclise) da pontuação de intercalação (que preserva a próclise facultativa).
