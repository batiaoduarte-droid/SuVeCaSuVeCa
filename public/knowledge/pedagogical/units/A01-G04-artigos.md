...
>
> Compreender e definir os princípios normativos e conceituais de Artigos. Aplicar regras canônicas e procedimentos decisórios de Artigos na resolução de questões. Analisar o papel de Artigos no eixo Apoio estrutural e reconhecer armadilhas e variações de bancas.
...
**Apoio estrutural:** O artigo é reconhecido morfologicamente e observado dentro do sintagma nominal; a SuVeCA mostra a função do conjunto, não transforma o artigo em componente autônomo do mapa.
...
1. Artigo Indefinido e a Semântica de Não Exclusividade:
...
- Não exclusividade: "Em uma visão contemporânea..." (Indica a existência de outras abordagens) versus "Na visão contemporânea..." (Indica visão exclusiva/única).
...
| --- | --- | --- | --- |
| Artigo | Determina e subordina-se a um substantivo. | Verifica-se se a seta aponta para um substantivo (explícito ou implícito). | "Desejava a felicidade." |
| Pronome Pessoal Oblíquo | Substitui um substantivo/pessoa na função de objeto. | Substitui-se o termo por"ela" (ou "ele"). | "Não a encontrei." $\rightarrow$ "Não encontrei ela." |
...
- Preposição: "Aspirava a dias melhores." (a = conector invariável exigido pelo VTI aspirar; dias é masculino plural).
- Pronome Demonstrativo: "Esta música é boa, mas prefiro a do álbum anterior." (a = aquela [música]).
...
- DA / DO: Preposição DE + Artigo Definido A / O (ou plurais DAS / DOS).
...
- Regra do Vínculo Obrigatório com o Substantivo: O artigo não possui vida sintática autônoma; ele antecede e concorda incondicionalmente com um substantivo explícito ou implícito .
- Regra da Tolerância à Intercalação: Adjetivos e modificadores intermediários não quebram a regência morfológica do artigo sobre o substantivo .
- Classificação Semântica do Artigo Definido: Marca realidade determinada, notória e conhecida, seja por anáfora textual ou por repertório histórico-cultural (conhecimento de mundo) .
- Classificação Semântica do Artigo Indefinido: Marca realidade indeterminada, genérica ou não exclusiva, assinalando que o elemento é uma possibilidade entre várias .
- Regra de Invariabilidade da Preposição diante de Plural: A forma singular "a" diante de um substantivo plural é prova definitiva de preposição pura .
- Regra de Decomposição Morfológica das Contrações: Toda contração do tipo da/do, na/no, pela/pelo contém formalmente um artigo definido acoplado a uma preposição .
...
3. Teste de Substituição Pronominal: Se a forma "a/o" estiver acoplada a um verbo como objeto e não houver substantivo imediato regido, substitua-a pelo pronome reto "ela" (ou "ele").
4. Conclusão: Se a substituição mantiver a coerência indicando a pessoa/objeto da ação ("Não a encontrei" $\rightarrow$ "Não encontrei ela"), classifique como Pronome Pessoal Oblíquo Átono.
...
3. Conclusão: Havendo perfeita equivalência e resgate de termo anafórico ("prefiro a do álbum anterior" $\rightarrow$ "prefiro aquela do álbum anterior"), classifique o termo como Pronome Demonstrativo.
...
3. Aplicação da Regra de Concordância: Se o substantivo seguinte estiver no plural (ex.: alternativas, pessoas) e a forma "a" permanecer no singular, o termo é 100% Preposição Pura (pois preposições são invariáveis, enquanto o artigo feminino plural seria as ou fundir-se-ia em às).
4. Verificação do Termo Regente: Confirme se o vocábulo anterior (verbo ou adjetivo) exige preposição (aberto a, obediente a, aspirar a).
...
1. Validação da Parte I: Verifique no texto se a premissa descritiva é rigorosamente verdadeira (do = de + o).
2. Validação da Parte II: Avalie se o conceito semântico deduzido é linguisticamente válido para aquela classe no contexto (artigo definido pressupõe conhecimento de mundo/prévio).
3. Julgamento Global: Se ambas as partes forem corretas, marque CERTO. Se qualquer uma das frações apresentar inconsistência, marque ERRADO.
...
| Critério Comparativo | Artigo Definido | Pronome Pessoal Oblíquo | Preposição | Pronome Demonstrativo |
| --- | --- | --- | --- | --- |
| Função Morfossintática | Determinante nominal | Substituto de pessoa/objeto | Conectivo sintático | Determinante anafórico |
| Alvo da Relação | Substantivo núcleo | Ação verbal (objeto direto) | Termo regido (substantivo/oração) | Termo oracional posterior (que/de) |
| Variabilidade | Variável (a, as) | Variável (a, as) | Invariável (a) | Variável (a, as) |
...
| --- | --- | --- |
| Status da Realidade | Realidade determinada, específica, conhecida. | Realidade indeterminada, vaga, genérica. |
...
| Exclusividade / Unicidade | Expressa unicidade ou foco específico ("a visão" = a visão exclusiva). | Expressanão exclusividade ("uma visão" = uma entre várias possíveis). |
...
| Conhecimento de Mundo (Extratextual) | O referente nunca apareceu no texto, mas é patrimônio histórico/cultural do leitor. | "...fazia parte do projeto civilizador oitocentista." |
...
1. uma: Antecede e determina o substantivo proposta. Classe: Artigo Indefinido.
2. a: Introduzido por exigência regencial do adjetivo aberto (quem se acha aberto, acha-se aberto a algo). Antecede o substantivo plural várias alternativas sem flexionar. Classe: Preposição.
3. Como pertencem a classes distintas (Artigo $\neq$ Preposição), o item é falso.
...
1. Parte I (Morfossintaxe): do é a contração de preposição de + artigo definido o, que determina projeto civilizador oitocentista (Verdadeiro).
2. Parte II (Semântica): O termo não foi citado no 1º parágrafo. O uso do artigo definido o ancora-se no repertório histórico/enciclopédico do leitor (conhecimento de mundo), pressupondo ciência prévia daquele contexto oitocentista (Verdadeiro).
...
1. O vocábulo uma atua como artigo indefinido modificando visão.
2. Semântica do indefinido: denota abertura e não exclusividade. Ao grafar "uma visão", o texto explicita que se trata de uma perspectiva entre várias possíveis, admitindo a coexistência de outras abordagens educacionais. Se quisesse indicar unicidade, utilizaria o artigo definido ("Na visão contemporânea").
...
Ao concluir esta unidade, o estudante deve dominar com precisão a classe gramatical dos artigos em seus três eixos fundamentais:

1. Eixo Morfossintático: Reconhecer que o artigo é uma classe dependente que aponta incondicionalmente para o substantivo ("regra da seta"), superando as armadilhas de adjetivos intercalados ("O lindo menino") e de elipses textuais em estruturas coordenadas ("O homem inteligente e o [homem] educado").
2. Eixo Semântico-Discursivo: Compreender que o artigo definido não depende unicamente de anáfora textual para especificar um termo, podendo ancorar-se no conhecimento de mundo (repertório sociocultural e histórico dos interlocutores); e assimilar que o artigo indefinido atua como marcador de não exclusividade, indicando a existência de outras possibilidades além daquela mencionada.
3. Eixo Diferencial de Homônimos: Distinguir com rapidez e segurança a palavra "a/o" entre Artigo (aponta para substantivo), Pronome Pessoal Oblíquo (troca-se por ela), Preposição (conectivo invariável exigido por regência que não flexiona diante de plural) e Pronome Demonstrativo (antecede que/de equivalendo a aquela/aquele/aquilo), além de identificar e decompor os artigos presentes no interior de contrações prepositivas (da, do, na, no, pelo, pela).
