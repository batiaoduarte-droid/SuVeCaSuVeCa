...
**Método central:** Predicativos e particípios exigem setas para sujeito ou objeto; o mapa evita concordância mecânica com o termo mais próximo.
...
- Compreensão da estrutura oracional e diferenciação entre termos determinantes/modificadores e termos regentes.
...
```text
 ...
 (Termo Acessório) (Termo Integrante) (Termo Integrante)
 Refere-se ao substantivo Ligado por Verbo Atribui estado ao O.D./O.I.;
 diretamente, sem verbo de Ligação/Estado Indispensável ao sentido
 │ │ │
 ┌────────┴────────┐ ┌────────┴────────┐ ┌────────┴────────┐
 ▼ ▼ ▼ ▼ ▼ ▼
Posposto: Anteposto: Posposto: Anteposto: Posposto: Anteposto:
C.T. ou C.A. Apenas C.A. Apenas C.T. SEGUE O C.T. ou C.A. C.T. ou C.A.
 VERBO (Semântica =) (Semântica =)
```
...
```text
 ...
 ┌─────────────────────────┴─────────────────────────┐
 ▼ ▼
 TEMPOS COMPOSTOS VOZ PASSIVA ANALÍTICA
 (Auxiliares TER / HAVER) (Auxiliares SER / ESTAR)
 Particípio = Verbo Principal Puro Particípio = Natureza Adjetiva
 INVARIÁVEL (Terminação fixa em -o) VARIÁVEL (Concorda com Sujeito Paciente)
 Ex.: "Tinham pintado as paredes" Ex.: "As paredes foram pintadas"
```
...
```text
 ...
 ┌─────────────────────────┼─────────────────────────┐
 ▼ ▼ ▼
 CORREÇÃO GRAMATICAL SENTIDO ORIGINAL COERÊNCIA TEXTUAL
 Conformidade formal com Preservação das ideias e Lógica interna e não
 a norma-padrão culta. conteúdos originais do texto contradição contextuais.
 │ │ │
 └─────────────────────────┼─────────────────────────┘
 ▼
 ...
 ┌─────────────────────────┴─────────────────────────┐
 ▼ ▼
 REGRA GERAL EXCEÇÃO CANÔNICA
 Muda Seta = MUDA SENTIDO Coletivos Partitivos / Quantificadores
 (Pode manter Correção e Coerência) (A maioria de... / Bilhões de pessoas...)
 Muda Seta = MANTÉM O SENTIDO
```
...
- **Parte 1 (Sintática / Referenciação):** Exige raciocínio sintático estruturado, isolamento de núcleos substantivos e traçado de setas de concordância. É o foco predominante de bancas de alto nível conceitual (Fundação Getulio Vargas - FGV, Cebraspe/CESPE e Fundação Carlos Chagas - FCC).
- **Parte 2 (Casos Especiais / Morfológica):** Foca no comportamento morfológico de vocábulos específicos (diferenciação entre classes invariáveis como advérbios e variáveis como adjetivos/pronomes), sendo o modelo predileto de bancas municipais e de menor porte.
...
- *Eram **brancos** a neve e o jardim.* (Correto - verbo no plural impõe C.T.)
- *Era **branca** a neve e o jardim.* (Correto - verbo no singular impõe C.A. com *neve*)
- *Era **branco** a neve e o jardim.* (Incorreto - desarmonia com o primeiro núcleo feminino)
...
1. **Referenciação semântica ao objeto:** A seta sintática aponta para o objeto direto ou indireto, expressando um estado, atributo ou condição resultante ou concomitante ao processo verbal.
2. **Indispensabilidade contextual (Termo Integrante):** Se for retirado da oração, a estrutura sintático-semântica é desfigurada (o verbo altera seu significado de constatação de estado para mera localização de objeto).

Regras de flexão:

- **Posposto ao Objeto:** *Encontrei a janela (F) e o portão (M) [**abertos** (C.T. M.Pl.) / **aberto** (C.A. M.Sg. com 'portão')].*
- **Anteposto ao Objeto:** *Encontrei [**abertos** (C.T. M.Pl.) / **aberta** (C.A. F.Sg. com 'janela')] a janela (F) e o portão (M).*
- **Identidade Semântica:** A opção pela concordância atrativa não restringe a qualificação apenas ao substantivo vizinho. Em *encontrei aberta a janela e o portão*, afirma-se categoricamente que ambos os elementos estavam abertos.

- **Procedimento associado:**  (Teste de Retirada).
...
|:---------------------------------- |:------------------------------------------------------------------------------ |:------------------------------------------------------------------------------ |
| **1. Adjunto Adnominal** | **C.T.** (Concordância Total) ou **C.A.** (Concordância Atrativa) | **Apenas C.A.** (Concordância Atrativa com o 1º núcleo) |
...
3. **Soma de gêneros na Concordância Total:** Substantivo Masculino + Substantivo Feminino = Adjetivo no Masculino Plural ($M + F \rightarrow M.Pl.$).
...
1. **Regra Geral (Tempos Compostos da Voz Ativa — Auxiliares *ter / haver*):** O particípio é o verbo principal e permanece **absolutamente invariável** (terminação fixa em *-o*), enquanto o verbo auxiliar assume as flexões de tempo, modo, número e pessoa.
2. **Exceção (Voz Passiva Analítica — Auxiliares *ser / estar / ficar*):** O particípio adquire valor adjetivo e **concorda compulsoriamente em gênero e número** com o sujeito paciente.

```text
Tempo Composto Ativo: [Sujeito] + [Auxiliar Ter/Haver flexionado] + [PARTICÍPIO INVARIÁVEL em -o] + [Objeto]
...
- *As paredes deviam ser **pintadas**.* (Correto - voz passiva concorda com *paredes*)
- *Plantas (F) e frutos (M) foram **elogiados** (M.Pl.).* (Correto - voz passiva com sujeitos mistos)

- **Expandido por:**  (Particípios Abundantes).
...
3. **Desarmar falsos sujeitos compostos:** A presença da conjunção aditiva *"e"* dentro de um adjunto preposicionado não torna o sujeito composto (*A retirada [do lixo das casas e praias] era feita...* $\rightarrow$ Núcleo: *retirada* [Singular]).
4. **Expressões com numerais/partitivos:** Em *As 560 toneladas de lixo eram retiradas*, o núcleo é *toneladas* (F.Pl.), impondo a flexão *eram retiradas*.
...
```text
[empresas] de [conteúdo] [independentes] --> Seta em "empresas" (Plural) = Sentido A (Correto)
...
1. **Correção Gramatical:** Conformidade formal estrita com as regras da norma-padrão culta da língua portuguesa.
...
Se uma reescrita altera o substantivo qualificado pelo adjetivo, gerando uma nova frase lógica e gramaticalmente correta, o item que afirma *"preserva a correção e a coerência"* é **CORRETO**; se o mesmo item afirmar que *"preserva a correção e o sentido original"*, será **ERRADO**.
...
"ferramentas de pedra primitivas" (ferramentas primitivas) ≠ "ferramentas de pedra primitiva" (pedra primitiva)

Exceção Partitiva (Mantém sentido):
"4,5 bilhões de pessoas [...] desprovidas" (pessoas) = "4,5 bilhões de pessoas [...] desprovidos" (bilhões)
```
...
- **Concordância Total (Gramatical):** Flexão do adjetivo no plural que abrange a totalidade dos núcleos substantivos, aplicando-se a prevalência do masculino plural na presença de gêneros mistos ($M + F \rightarrow M.Pl.$) — .
- **Concordância Atrativa (Parcial):** Flexão do adjetivo que espelha estritamente o gênero e o número do núcleo substantivo gramaticalmente mais próximo no espaço oracional — .
- **Predicativo do Sujeito:** Termo que qualifica o sujeito mediado por um verbo de ligação ou estado. Posposto exige Concordância Total; anteposto "segue o verbo" — .
- **Predicativo do Objeto:** Termo integrante que qualifica o objeto direto/indireto, sendo indispensável à estrutura semântica do predicado. Admite C.T. ou C.A. em qualquer posição sem alteração de sentido — .
- **Particípio em Tempos Compostos:** Verbo principal puro acompanhado dos auxiliares *ter* ou *haver*, invariável com terminação em *-o* — .
- **Particípio em Voz Passiva Analítica:** Verbo com função adjetiva acompanhado de auxiliares de estado (*ser, estar, ficar*), com flexão obrigatória em concordância com o sujeito paciente — .
- **Particípios Abundantes:** Bipartição funcional entre particípio regular (*-do*, com *ter/haver*) e particípio irregular/curto (*incluso, ganho, pago*, com *ser/estar* ou como adjetivo autônomo) — .
- **Bloqueio Preposicional:** Princípio segundo o qual nenhum substantivo regido por preposição pode atuar como núcleo de sujeito ou governar concordância — .
- **Unidirecionalidade:** Princípio que determina que modificadores concordam com substantivos; substantivos nunca concordam com substantivos nem com adjetivos — .
- **Tríade do Cebraspe:** Diferenciação funcional entre Correção Gramatical (norma), Sentido (ideias) e Coerência (lógica) — .
- **Coletivo Partitivo em Concordância Nominal:** Expressões quantitativas com especificador plural que autorizam dupla concordância com preservação simultânea de correção e sentido — .
...
1. **Localizar o termo flexionado:** Identificar a palavra sob análise (adjetivo, particípio, pronome adjetivo).
2. **Perguntar ao termo qualificador:** Formular a pergunta *"Quem/O que é [qualificador]?"*.
3. **Eliminar barreiras preposicionadas:** Riscar mentalmente adjuntos adnominais e complementos nominais introduzidos por preposição (*de, do, da, em, com, por*).
...
### Tabela Comparativa das Funções Sintáticas e Comportamentos Flexionais

| Função Sintática | Relação com o Substantivo | Posição Posposta | Posição Anteposta | Impacto Semântico na Concordância Atrativa |
|:------------------------------- |:------------------------------------------------------------ |:--------------------- |:----------------------------------------------------- |:----------------------------------------------------------------------------- |
| **Adjunto Adnominal** | Direta (sem intermédio verbal); termo acessório | **C.T. ou C.A.** | **Apenas C.A.** | Na C.A., qualifica prioritariamente o substantivo mais próximo. |
...
|:------------------------------------------- |:------------------------------------------------------- |:------------------------------------------------------------------------- |
| **Verbos Auxiliares Típicos** | *Ter* e *Haver* | *Ser*, *Estar*, *Ficar* (e equivalentes) |
| **Papel do Sujeito** | Sujeito Agente (pratica a ação) | Sujeito Paciente (sofre a ação) |
| **Função e Natureza do Particípio** | Verbo Principal puro | Adjetivo Participial |
...
|:------------------------------------------ |:-------------------------------------------------- |:------------------------------------------------------: |:---------------------------------------------: |
| **"Mantém a Correção Gramatical"** | Obediência formal às normas cultas | **Sim** (se a nova flexão for válida) | Sim |
| **"Mantém o Sentido Original"** | Preservação das ideias e informações originais | **Não** (mudou a seta, mudou o sentido) | **Sim** (mantém o sentido em partitivos) |
| **"Mantém a Coerência Textual"** | Preservação da lógica e inteligibilidade textual | **Sim** (pode mudar o sentido e continuar lógico) | Sim |
...
- **Resolução:** Exige obrigatoriamente **Concordância Total** no masculino plural.
- **Forma correta:** *A neve e o jardim eram **brancos**.*
...
- **Resolução:** O predicativo anteposto segue o verbo. Verbo no plural impõe **Concordância Total**.
- **Forma correta:** *Eram **brancos** a neve e o jardim.*
...
- **Resolução:** O predicativo anteposto segue o verbo. Verbo no singular impõe **Concordância Atrativa** com o primeiro núcleo (*neve* $\rightarrow$ feminino singular).
- **Forma correta:** *Era **branca** a neve e o jardim.*
...
- **Resolução:** Admite livremente Concordância Total ou Concordância Atrativa.
- **Formas corretas:** *Encontrei a janela e o portão **abertos*** (C.T.) / *Encontrei a janela e o portão **aberto*** (C.A. com *portão*).
...
- **Resolução:** Admite livremente Concordância Total ou Concordância Atrativa com o primeiro núcleo.
- **Formas corretas:** *Encontrei **abertos** a janela e o portão* (C.T.) / *Encontrei **aberta** a janela e o portão* (C.A. com *janela*).
...
- **Par contrastivo analisado:**
 ...
 2. *A mulher tinha **pintado** a parede do quarto.* (Tempo composto da voz ativa: particípio invariável com o auxiliar *tinha*).
...
- **Análise:** Rastreamento direto de seta: particípios em função adnominal concordando com o antecedente *queixas*.
...
- **Análise:** Predicativo do sujeito substantivado assumindo flexão plural em referência aos dois núcleos do sujeito composto.
- **Gabarito Oficial:** **Certo**.
...
- **Análise:** O particípio anteposto concorda exclusivamente com os núcleos do sujeito (*ética* e *valorização*). O segmento *de identidades e culturas* é complemento nominal e não participa da concordância.
...
- **Análise:** O adjetivo *fortes* é predicativo do sujeito elíptico *nós* (*para nós ficarmos mais fortes*), e não qualificador do objeto *os bíceps*.
- **Gabarito Oficial:** **Errado**.
...
- **Análise:** A flexão no singular *existente* é gramaticalmente aceita, mas a mudança de referente altera obrigatoriamente o sentido original. O item erra ao afirmar que o sentido seria mantido.
- **Gabarito Oficial:** **Errado**.
...
- **Análise:** Adjetivo concorda exclusivamente com substantivo (*crescimento*), sendo sintática e semanticamente impossível concordar com adjetivos adjuntos.
- **Gabarito Oficial:** **Errado**.
...
- **Análise:** O teste do "ler o que vem depois" (*ao longo da história*) evidencia que apenas *saberes* podem ser historicamente formulados, tornando a troca semanticamente incoerente.
- **Gabarito Oficial:** **Errado**.
...
- **Análise:** A substituição é coerente e gramatical, mas altera a relação sintática (de adjunto de *navegação* para adjunto de *ciberespaço*) e a relação semântica. O erro do item está em afirmar que seriam "mantidas".
- **Gabarito Oficial:** **Errado**.
...
- **Análise:** No masculino, o particípio qualificaria *costume* em vez de *expressão da legalidade*. Mantém a correção, mas altera o sentido original.
- **Gabarito Oficial:** **Errado**.
...
- **Análise:** Assertiva conceitualmente impecável que descreve perfeitamente a manutenção da gramática com mudança de relações sintáticas e semânticas.
- **Gabarito Oficial:** **Certo**.
...
- **Análise:** A troca preserva a correção gramatical e a lógica textual (**coerência**). Como a banca não exigiu a manutenção do sentido estrito, o item é correto.
- **Gabarito Oficial:** **Certo**.
...
- **Análise:** Aplicação exata da exceção do quantificador com especificador plural: a alternância de flexão preserva simultaneamente a correção gramatical e o sentido original.
- **Gabarito Oficial:** **Certo**.
...
- **Análise:** A flexão no feminino ancora o particípio da oração reduzida no sujeito da oração principal subsequente (*impressão digital*), mantendo a correção e aperfeiçoando a coesão.
- **Gabarito Oficial:** **Certo**.
...
- **Concordância Nominal por Referenciação:** Mecanismo sintático em que modificadores adjetivos e determinantes adaptam seus traços morfológicos de gênero e número para espelhar exatamente o substantivo específico a que atribuem estado ou qualificação — .
- **Predicativo do Sujeito:** Termo que expressa estado ou qualidade transitória/permanente do sujeito por intermédio de verbo de ligação ou de ação — .
- **Predicativo do Objeto:** Termo integrante que qualifica o objeto direto ou indireto, indispensável à integridade semântica da predicação verbal — .
- **Particípio Abundante:** Forma nominal dupla de verbos que possuem uma variante regular terminada em *-do* e uma variante irregular curta contraída — .
- **Voz Passiva Analítica:** Estrutura formada por verbo auxiliar de estado conjugado (*ser/estar*) + particípio com valor adjetivo, que concorda obrigatoriamente com o sujeito paciente — .
- **Correção Gramatical:** Conformidade de uma estrutura oracional com as regras formais prescritas pela norma-padrão culta, independentemente do sentido — .
- **Sentido Original:** Conteúdo informacional, semântico e relacional veiculado pelo texto na sua redação original de partida — .
- **Coerência Textual:** Propriedade que assegura a lógica interna, a ausência de contradições e a compreensibilidade do texto dentro do seu contexto comunicativo — .
- **Coletivo Partitivo:** Estrutura formada por expressão indicadora de fração ou quantidade acoplada a um termo especificador plural — .
...
1. **A Matriz Sintática da Concordância Nominal:** Sabe identificar se o adjetivo atua como Adjunto Adnominal, Predicativo do Sujeito ou Predicativo do Objeto, aplicando as flexões corretas nas posições posposta e anteposta.
