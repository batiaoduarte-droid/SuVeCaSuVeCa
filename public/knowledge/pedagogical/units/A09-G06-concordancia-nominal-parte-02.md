...
>
> Compreender e definir os princípios normativos e conceituais de Concordância Nominal - Parte 02. Aplicar regras canônicas e procedimentos decisórios de Concordância Nominal - Parte 02 na resolução de questões. Analisar o papel de Concordância Nominal - Parte 02 no eixo Método central e reconhecer armadilhas e variações de bancas.
...
Tempo Composto Ativo: [Sujeito] + [Auxiliar Ter/Haver flexionado] + [PARTICÍPIO INVARIÁVEL em -o] + [Objeto] Voz Passiva Analítica: [Sujeito Paciente] + [Auxiliar Ser/Estar flexionado] + [PARTICÍPIO CONCORDANDO em Gên/Núm]
...
[empresas] de [conteúdo] [independentes] --> Seta em "empresas" (Plural) = Sentido A (Correto) [empresas] de [conteúdo] [independente] --> Seta em "conteúdo" (Singular) = Sentido B (Correto)
...
Regra Geral (Muda sentido): "ferramentas de pedra primitivas" (ferramentas primitivas) ≠ "ferramentas de pedra primitiva" (pedra primitiva)

Exceção Partitiva (Mantém sentido): "4,5 bilhões de pessoas [...] desprovidas" (pessoas) = "4,5 bilhões de pessoas [...] desprovidos" (bilhões)

- Exceção aplicada em:  (Cebraspe / DPE-DF).
- Regra geral aplicada em: , , .
...
- Estrutura analisada: A neve (F) e o jardim (M) eram . (branco)
...
- Estrutura analisada: Eram  a neve e o jardim. (branco)
...
- Estrutura analisada: Era  a neve e o jardim. (branco)
...
- Estrutura analisada: Encontrei a janela (F) e o portão (M)  / . (aberto)
...
- Estrutura analisada: Encontrei (aberto)  /  a janela (F) e o portão (M).
...
- SER / ESTAR / Sem Auxiliar $\rightarrow$ Exigem forma curta/irregular com flexão (foi incluso, segue anexa).
