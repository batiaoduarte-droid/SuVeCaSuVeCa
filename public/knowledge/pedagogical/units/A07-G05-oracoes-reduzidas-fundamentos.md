...
│
└── 5. FRONTEIRA E SEGMENTAÇÃO ORACIONAL
 ├── Oração Principal: Retém seus termos nucleares e complementos imediatos
 └── Oração Reduzida: Inicia-se estritamente na forma nominal ou na preposição introdutória
```text
...
### Tabela 1: Matriz Comparativa Tripartite — Desenvolvidas vs. Reduzidas
...
| **Adjetiva** | Seta referencial para o**Substantivo Antecedente** | Qualifica, restringe ou explica núcleo nominal da oração principal | 2 tipos: Restritiva (sem vírgula) e Explicativa (pontuada) | *Vi a menina chorando na praça.* (chorando $\rightarrow$ menina $\rightarrow$ Restritiva) |
| **Adverbial** | Apreensão semântica do**"Cheiro de Circunstância"** | Exerce papel de adjunto adverbial do verbo da oração principal | 9 circunstâncias: Mnemônico`6C + FTP` | *Chegada a hora, saiu rapidamente.* (Chegada $\rightarrow$ Tempo) |
...
Ao concluir o estudo do grupo `esta unidade`, o estudante deve dominar com precisão e segurança:
