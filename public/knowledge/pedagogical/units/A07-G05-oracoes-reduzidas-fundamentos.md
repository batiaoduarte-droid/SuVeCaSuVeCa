...
text SINTAXE DO PERÍODO COMPOSTO: ORAÇÕES REDUZIDAS ➔ 1. ESTATUTO COMPARATIVO
- ➔ Oração Desenvolvida: Conectivo explícito + Verbo conjugado finito (Pres/Pret/Fut)
➔ Oração Reduzida: Sem conectivo oracional / Com preposição + Forma nominal do verbo
- ➔ 2. MECANISMOS DE INTRODUÇÃO E CONECTIVOS
➔ Introdução Assindética: Iniciação direta pelo verbo na forma nominal
- ➔ Introdução Preposicional: Preposição pura (a, de, em, para, por, ao, sem)
➔ Oposição Estrutural de Locuções:
- ➔ Locução Conjuntiva: Termina com conjunção ("que") -> Oração Desenvolvida
➔ Locução Prepositiva: Termina com preposição ("de", "para") -> Oração Reduzida
- ➔ 3. PARADIGMA DAS FORMAS NOMINAIS
➔ Infinitivo: Terminações em -ar, -er, -ir (pessoal ou impessoal)
- ➔ Gerúndio: Terminações em -ando, -endo, -indo (-ndo)
➔ Particípio: Formas regulares (-ado, -ido) e irregulares (-to, -so, etc.)
- ➔ 4. TAXONOMIA SINTÁTICA EM CONCURSOS (ESTRITAMENTE SUBORDINADAS)
➔ Subordinadas Substantivas Reduzidas
- ➔ Teste de Equivalência: Substituição integral pelo pronome neutro "ISSO"
➔ Funções Sintáticas: Subjetiva, O.D., O.I., C.N., Predicativa, Apositiva
- ➔ Subordinadas Adjetivas Reduzidas
➔ Critério Identificador: Modificação de Substantivo/Pronome Antecedente
- ➔ Subdivisão por Pontuação: Restritiva (sem vírgula) vs. Explicativa (pontuada)
➔ Subordinadas Adverbiais Reduzidas
- ➔ Critério Identificador: Apreensão semântica de circunstância ("cheiro de circunstância")
➔ Tipologia Circunstancial: 9 tipos (6C + FTP)
- ➔ 5. FRONTEIRA E SEGMENTAÇÃO ORACIONAL ➔ Oração Principal: Retém seus termos nucleares e complementos imediatos ➔ Oração Reduzida: Inicia-se estritamente na forma nominal ou na preposição introdutória
