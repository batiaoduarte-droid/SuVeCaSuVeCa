# Revisão cumulativa · Classes de palavras II
...
- Seja dia útil, seja feriado, sempre
...
Conclusivo
(Deslocado)
Ex. Estudou muito, passou, pois, bem
rápido.
E
Aditivo
...
Conclusivo
Ex. Esforçou-se e passou em primeiro lugar.
...
- **Ex. Desde que casei, não joguei mais poker.**
- **Ex. Você poderá sair, desde que arrume o seu quarto.**
- **Escrevi à caneta. (instrumento)**
- **Meu violão é de mogno. (matéria)**
- **Fui ao cinema com ela. (companhia)**
- **Fiquei chocado com a novidade. (causa)**
- **Estou morrendo de frio. (causa)**
- **Não fale de/sobre corrupção aqui. (assunto)**
- **Vou para um lugar melhor. (direção; vai e fica lá; definitivo)**
- **Vou a um lugar melhor. (direção; vai e volta; provisório)**
- **Estudo para passar em primeiro lugar. (finalidade)**
- **Para Freud, o sonho é um desejo reprimido. (conformidade)**
- **Devolva-me o livro do aluno. (posse)**
- **Feri-me com a faca. (instrumento)**
- **Vivo de aluguéis e investimentos. (meio)**
- **Vivo só com a renda da aposentadoria. (meio)**
- **Estudo com gana. (modo)**
- **Sou contra o populismo. (oposição)**
- **O prazo para posse é de 30 dias. (tempo)**
- **Não sou de Campinas. (origem)**
- **Com mais um minuto, resolveria aquele problema. (tempo)**
- **Resolvi a questão com um macete. (instrumento)**
- **Fui ao cinema com ela. (companhia)**
