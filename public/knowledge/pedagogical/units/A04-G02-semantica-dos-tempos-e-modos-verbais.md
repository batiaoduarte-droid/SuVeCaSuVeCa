...
**Método central:** O mapa localiza o verbo e seus participantes; a camada semântico-discursiva determina hipótese, certeza, ordem, possibilidade, habitualidade e demais valores contextuais.
...
- Distinção básica entre as formas nominais (infinitivo, gerúndio e particípio) e as formas flexionadas.
...
**SEMÂNTICA DOS TEMPOS E MODOS VERBAIS (A04-esta unidade)       1. Metodologia de Operação em Provas (#ANOTAAÍ)**

1. Redução ao Infinitivo
2. Teste das Palavras Mágicas (Hoje, Ontem, Antigamente, Tinha + Part.)
3. Fatiamento da Assertiva (Morfossintaxe vs. Semântica)
...
3. Semântica dos Tempos e Modos Verbais (Emprego no Contexto): Análise do sentido, valor aspectual e expressividade temporal que o verbo assume no discurso (ex.: presente com valor de futuro, pretérito imperfeito como hábito).
4. Tempos Compostos: Reconhecimento de correlações e substituições de locuções com particípio (ter/haver + particípio) pela forma simples correspondente do mais-que-perfeito (tinha estudado = estudara).
5. Reescritura de Verbos: Nível culminante de prova, que exige o equilíbrio rigoroso entre correção gramatical (norma-padrão), semântica (preservação do sentido original) e coerência (manutenção da lógica textual).
...
3. Presente com Valor de Futuro: Indica evento futuro próximo tido como certo pelo falante ("Vou amanhã para Búzios" = irei).
...
1. Fato vindouro em relação ao presente: Ação posterior ao momento da fala ("Viajarei amanhã").
2. Dúvida / Incerteza no presente: Empregado em estruturas interrogativas diretas ou reflexivas para exprimir hesitação atual ("Haverá alguém em casa?").

- Futuro do Pretérito (4 Valores Semânticos):

1. Fato futuro em relação ao passado (Ação posterior ao pretérito): Projeção temporal vista a partir de um momento pretérito ("Eu prometi que passaria no concurso" / "Os acordos foram firmados contra a garantia de que nenhum governo seria reconhecido").
2. Dúvida / Incerteza: Expressão de hesitação ou questionamento sobre circunstâncias ("Quem estaria lá?" / "torna difícil indicar quem seria o responsável"). Alerta: não denota fato consumado no passado.
3. Hipótese / Possibilidade / Teoria Científica: Formulação de teses, modelos ou suposições ("Para a pesquisadora, a doença seria transmitida..." / "algoritmos que se reajustariam"). Alerta: não denota ação "prestes a acontecer no passado" (iminência).
4. Polidez / Cortesia / Suavização Pragmática: Atenuação delicada de pedidos, perguntas ou ofertas no convívio social, afastando o tom imperativo ("Aceitaria um café?" / "Gostaria de uma informação").
...
MATRIZ DE VALORES SEMÂNTICOS NO CEBRASPE
- ➔

1. HIPÓTESE / POSSIBILIDADE 2. DÚVIDA / INCERTEZA 3. IMPOSSIBILIDADE

(+ comum) (- comum) (Mais raro) Fato factível, potencial, Tese contestada pelo Condição contrafactual, tese teórica ou científica. autor ou hesitação real. anulada por impedimento. Ex: "a célula seria..." Ex: "descenderiam... Ex: "Jantaria amanhã, A verdade é outra" mas tenho de estudar"
...
1. Dúvida = Incerteza (Menos comum):
...
1. Impossibilidade / Fato Contrafactual (Raro em textos de prova):
...
3. Coerência Textual: Manutenção da não contradição e da harmonia lógica global do texto. Um texto reescrito pode alterar o sentido original e, ainda assim, permanecer perfeitamente coerente.
...
- Os 5 Valores do Presente do Indicativo: Presente Atual (1), Presente Histórico/Narrativo (2), Presente com Valor de Futuro (3), Presente Habitual/Atemporal (4) e Presente Durativo (5) [].
- Aspecto Pontual vs. Aspecto Durativo: O Pretérito Perfeito é pontual (ação delimitada que começa e conclui no passado); o Pretérito Imperfeito é durativo/contínuo (ação prolongada ou repetida no passado) [].
- Anterioridade do Pretérito Mais-que-Perfeito: Ação passada anterior a outro fato passado, referindo-se estritamente à cronologia real dos eventos, sem relação com a posição física dos verbos no texto [].
- Equivalência Simples x Composto no Mais-que-Perfeito: $\text{Verbo em } -ra \iff \text{Tinha/Havia } + \text{Particípio}$ (ex.: estudara = tinha estudado) [, ].
- Os 4 Valores do Futuro do Pretérito: Fato posterior a outro no passado (1), Dúvida/Incerteza (2), Hipótese/Possibilidade (3) e Polidez/Cortesia (4) [].
- Regra Canônica de Hipótese: Expressa indistintamente pelo Modo Subjuntivo OU pelo Futuro do Pretérito do Indicativo [].
- Equação Semântica de Prova: $\text{Hipótese} = \text{Possibilidade} \neq \text{Impossibilidade}$ [, ].
- A Tríade da Reescritura: $\text{Correção Gramatical (Norma)} \neq \text{Semântica (Sentido)} \neq \text{Coerência (Lógica)}$ [].
...
1. Teste de Conjunções para o Subjuntivo:
...
1. Checagem de Sujeito e Referenciação Anafórica:
...
1. Confronto Semântico: Valide se o sentido pretendido condiz com a aspectualidade real do texto, eliminando interpretações meramente intuitivas.
...
1. Aplique a Regra "O Que Vem Depois Salva":
...
1. Verifique Existência de Impedimento Real:
...
| Tempo Verbal | Desinência Típica | Aspecto Verbal | Palavra Mágica | Sentido Primário | Pegadinha do Cebraspe |
| --- | --- | --- | --- | --- | --- |
| Pretérito Perfeito | Desinências perfeitas (-ei, -ou, -i) | Pontual (concluído) | Ontem | Ação que começa e termina no passado | Tentar igualar a processos habituais contínuos. |
| Pretérito Imperfeito | -va (1ª conj.) / -ia (2ª e 3ª conj.) | Durativo / Habitual | Antigamente | Ação contínua, hábito ou desejo frustrado | Afirmar que indica oinício da ação (aspecto inchoativo). |
...
| --- | --- | --- | --- | --- |
| Hipótese / Possibilidade | Fato factível, tese teórica ou definição científica | Muito Alta | "a empatia seria..." / "tudo se sanearia..." | Banca afirma falsamente que éimpossível $\rightarrow$ ERRADO. |
| Dúvida / Incerteza | Relativização de tese alheia contestada pelo autor | Média | "descenderiam... A verdade é outra" | Banca afirma que o autor considera a teseduvidosa $\rightarrow$ CERTO. |
| Impossibilidade | Fato contrafactual anulado por impedimento real | Baixa | "Jantaria com você, mas tenho que estudar" | Banca tenta aplicar a frases de simples hipótese teórica. |
...
- Presente por Futuro: "Vou amanhã para Búzios." (Vou expressa futuro certo e imediato: irei).
- Presente Habitual: "Maria estuda todos os dias." (Ação rotineira e frequente).
- Presente Durativo: "Moro em Berlim desde 2014." (Iniciado no passado e ativo no presente pelo marcador desde).
...
- Assertiva: "No segundo parágrafo, as formas verbais “vinha”, “apertava” e “avisava” (quarto período) expressam ações que “um homem modesto” (terceiro período) desempenhava repetidamente em tempo passado."
- Análise: Vinha, apertava, avisava estão no Pretérito Imperfeito do Indicativo (antigamente vinha), denotando ações habituais/repetidas. As setas de sujeito confirmam que o agente é "um homem modesto" (3ª pessoa).
- Gabarito: CERTO.
...
- Assertiva: "O tom memorialista do primeiro parágrafo manifesta-se pelo uso predominante de formas verbais que denotam o início de determinadas ações, das quais são exemplos “Jantava” e “almoçava”, ambas na linha 10, e “Vivia” (l.20)."
- Análise: Jantava, almoçava, vivia são Pretérito Imperfeito do Indicativo. Expressam continuidade e hábito passado, e nunca o início (aspecto inchoativo) de ações.
- Gabarito: ERRADO.
...
- Assertiva: "No quinto parágrafo, as formas verbais “aprendera”, “acontecera” e “atendera” estão flexionadas no pretérito mais-que-perfeito do modo indicativo e denotam ações que ocorreram em momento anterior ao da ocorrência de outras ações no passado, expressas, no texto, pelas formas verbais “abriu” e “Explicou”."
- Análise: As formas em -ra expressam fatos pretéritos que antecederam cronologicamente os atos de abrir e explicar. A anterioridade é da cronologia real da história, não da ordem gráfica no papel.
- Gabarito: CERTO.
...
- Assertiva: "Em relação a aspectos linguísticos do trecho..., o tempo em que está flexionada a forma verbal “Habituara” projeta essa ação para o futuro."
- Análise: Habituara está no Pretérito Mais-que-Perfeito do Indicativo (passado anterior a senti); não possui qualquer projeção futurista.
- Gabarito: ERRADO.
...
- Assertiva: "O emprego do presente do indicativo... sinaliza que as ações apresentadas tiveram início no passado e se estendem até o momento atual."
- Análise: As formas no presente expressam definições atemporais e genéricas. Sem marca durativa (desde), não exprimem ação iniciada no passado e contínua no presente.
- Gabarito: ERRADO.
...
- Assertiva: "O tempo verbal em que se encontra flexionada a forma “seria” (antepenúltimo período) indica uma possibilidade futura vislumbrada a partir do passado."
- Análise: Seria está no Futuro do Pretérito do Indicativo, projetando um plano/possibilidade futura vinculada a fatos pretéritos (foram firmados).
- Gabarito: CERTO.
...
- Assertiva: "No segundo período do segundo parágrafo, o tempo verbal em “seria” indica que se trata de um acontecimento que se deu no passado posteriormente a outro também ocorrido no passado."
- Análise: Seria expressa dúvida, incerteza e indagação teórica decorrente de "torna difícil indicar". Não expressa um fato real consumado no passado.
- Gabarito: ERRADO.
...
- Assertiva: "No primeiro período do último parágrafo, as formas verbais “reajustariam” e “revisariam” expressam ações que estavam prestes a acontecer no passado."
- Análise: Em contexto de projeção algorítmica, o Futuro do Pretérito expressa hipótese e possibilidade técnica, e não ações iminentes ("prestes a acontecer").
- Gabarito: ERRADO.
...
- Assertiva: "O emprego da forma verbal “devesse” (l.13) no subjuntivo justifica-se pelo sentido hipotético da primeira oração do período."
- Análise: Devesse é Pretérito Imperfeito do Subjuntivo (se eu devesse). O advérbio Talvez justifica plenamente a oração com sentido de hipótese (= possibilidade).
- Gabarito: CERTO.
...
- Assertiva: "O futuro do pretérito empregado na forma verbal “descenderiam”, no contexto do quarto período do primeiro parágrafo do texto, permite concluir que o autor considera duvidosa a percepção de que Estado e família se confundem, o que se confirma na defesa categórica do exato oposto no período seguinte."
- Análise: O autor usa descenderiam para citar terceiros com distanciamento/dúvida. A postura duvidosa confirma-se no período seguinte quando afirma com certeza categórica que "A verdade, bem outra, é que pertentem a ordens diferentes".
- Gabarito: CERTO.
...
- Assertiva: "Em “tudo se sanearia desde casas abertas” (primeira estrofe), a forma verbal é empregada no futuro do pretérito no modo indicativo para expressar a certeza da impossibilidade do saneamento."
- Análise: O poema trata da capacidade transformadora da arquitetura. Sanearia expressa possibilidade e hipótese positiva, e não "certeza da impossibilidade".
- Gabarito: ERRADO.
...
- Assertiva: "No segmento “que as aproxime desse instrumento cultural” (quarto parágrafo), o emprego do modo subjuntivo denota a ocorrência de um fato improvável."
- Análise: Aproxime é Presente do Subjuntivo (que aproxime). A locução antecedente podem construir prova que o fato é viável e possível. Rotulá-lo como "fato improvável" (quase impossível) deturpa o texto.
- Gabarito: ERRADO.
...
- Assertiva: "No texto CG1A2-I, o emprego da forma verbal “seria” (L.23) expressa algo impossível de se realizar."
- Análise: O especialista utiliza seria para enunciar uma definição conceitual / hipótese teórica sobre a empatia. A empatia é um fenômeno humano perfeitamente realizável.
- Gabarito: ERRADO.
...
1. Procure qualquer tempo do Modo Subjuntivo (que vença, se devesse, quando chegar);
2. Procure formas do Futuro do Pretérito do Indicativo (seria, descenderiam, sanearia, passaria).
...
Ao concluir o estudo consolidado desta unidade (Semântica dos Tempos e Modos Verbais), o estudante domina:

1. A Arquitetura de Cobrança das Bancas: Compreende que bancas como a Vunesp priorizam a conjugação mecânica pura de verbos irregulares, enquanto o Cebraspe privilegia a semântica contextual, a identificação morfossintática ágil e a reescritura textual baseada na tríade correção-sentido-coerência.
2. A Polivalência do Modo Indicativo: Reconhece que o Presente transita entre 5 valores contextuais (pontual, histórico, futuro, habitual e durativo); que os Pretéritos opõem-se pelo aspecto (perfeito = pontual/concluído; imperfeito = habitual/duradouro/desejo frustrado; mais-que-perfeito = anterioridade cronológica fática); e que os Futuros modulam desde projeções cronológicas e polidez social até dúvidas e hipóteses científicas.
3. A Desconstrução da Exclusividade Hipotética: Supera o mito tradicional de que apenas o Subjuntivo indica hipótese, dominando a regra de ouro de que o Futuro do Pretérito (Modo Indicativo) também expressa plenamente hipótese e possibilidade em concursos.
4. A Matriz Semântica Cebraspe e seus Procedimentos: Domina os métodos práticos #ANOTAAÍ (infinitivo + palavras mágicas hoje, ontem, antigamente), o fatiamento de assertivas e a regra "o que vem depois salva", tornando-se imune às pegadinhas recorrentes da banca que rotulam hipóteses teóricas factíveis como "certeza da impossibilidade", "fato improvável" ou "início de ações".
