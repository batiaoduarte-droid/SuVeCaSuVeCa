...
1. HIPÓTESE / POSSIBILIDADE 2. DÚVIDA / INCERTEZA 3. IMPOSSIBILIDADE
 (+ comum) (- comum) (Mais raro)
Fato factível, potencial, Tese contestada pelo Condição contrafactual,
tese teórica ou científica. autor ou hesitação real. anulada por impedimento.
Ex: "a célula seria..." Ex: "descenderiam... Ex: "Jantaria amanhã,
...
### Tabela 1: Oposição Aspectual dos Pretéritos do Indicativo
...
|:---------------------------------- |:------------------------------------------------------- |:------------------- |:--------------------------------------------------- |:------------------------------------------------------------------------------------- |
| **Hipótese / Possibilidade** | Fato factível, tese teórica ou definição científica | **Muito Alta** | *"a empatia seria..."* / *"tudo se sanearia..."* | Banca afirma falsamente que é*impossível* $\rightarrow$ **ERRADO**. |
| **Dúvida / Incerteza** | Relativização de tese alheia contestada pelo autor | **Média** | *"descenderiam... A verdade é outra"* | Banca afirma que o autor considera a tese*duvidosa* $\rightarrow$ **CERTO**. |
