# Crase - Aprofundamento e Questões
...
**Método central:** Casos proibidos, facultativos e questões de crase são resolvidos combinando regência, estrutura do termo seguinte, paralelismo e preservação de sentido.
...
| | REGRA 1: FENÔMENO FONÉTICO (FF) REGRA 2: LOCUÇÕES FEMININAS (LF) (Preposição A + Artigo/Pronome A) (Expressões pluriverbais de núcleo feminino)
...
| CARACTERÍSTICAS QUATRO TIPOS DE LOCUÇÃO

| | |

| - Não decorre de regência 1. Adverbiais (tempo, modo, lugar)

| - Acento diferencial 2. Adjetivas (ref. a substantivo)

| - Desfaz ambiguidades 3. Conjuntivas (terminam em conjunção)

| - Exige núcleo feminino 4. Prepositivas (terminam em preposição)
...
| Ensino a distância Locuções de Instrumento

| (Bancas: SEM crase (Controvérsia: SEM crase

| se for genérico) em bancas como IDECAN)
...
| Núcleo Feminino Núcleo Masculino

| (COM crase direta: (Crase SOMENTE se

| bife à parmegiana) "à moda de" implícito)

| MÉTODO DE RESOLUÇÃO (PASSO A PASSO)

1. Houve Fenômeno Fonético (Preposição + Artigo)?
...
ESTUDO DE CRASE │ ┌────────────────┬──────────────┴───────────────┬────────────────┬────────────────┐ ▼ ▼ ▼ ▼ ▼ 2 REGRAS 3 CASOS DE CRASE CRASE NO PLURAL CRASE PROIBIDA CRASE E PARALELISMO FUNDAMENTAIS FACULTATIVAS (Regras de Uso) (Vedações do (Simetria Sintática) │ Acento) ├─────────────────────────────┐ ▼ ▼ FENÔMENO FONÉTICO (FF) LOCUÇÃO FEMININA (LF) (Fusão da Preposição
A) (Adverbial, Prepositiva, │ Conjuntiva) ├─► + A (Artigo Feminino) ├─► + A QUAL / AS QUAIS (Pronomes Relativos) ├─► + AQUILO / AQUELE(
A) (Pronomes Demonstrativos) └─► + A (Pronome Demonstrativo antes de 'QUE' ou 'DE')
...
> "Quando a banca pergunta se é obrigatório, ela está perguntando, em outras palavras, se ele poderia sair ou não. Ele poderia sair? Não... se eu retirar o acento vai ficar só o artigo... só o artigo pode? Não pode!... Antes do plural, ou eu uso esse 'às' com acento, ou só o 'a' preposição."

- No esquemas da Questão 1, A abordagem didática puxa uma seta de às e escreve: as (só o artigo) NÃO PODE!.
- No esquemas da Questão 3, A abordagem didática escreve à e coloca um "X" vermelho em cima, anotando acima às (prep + art) e a (prep).
...
1. Se o comando da questão indaga unicamente se a substituição "manteria a correção gramatical do texto", o item é CERTO, pois ambas as estruturas respeitam a norma culta.
2. Caso a questão afirmasse que o sentido original seria preservado, o item seria ERRADO, pois o artigo restringe e especifica o conjunto.

> "A banca pergunta se essa substituição manteria a correção gramatical do texto. Vejam, se tanto faz, se as duas são corretas, então tá certo, manteria... O sentido muda? Muda, eu vou de um sentido geral, sem artigo... e com artigo... Mas reparem que a banca tem o cuidado de falar só em correção gramatical. Ela não entra na seara do sentido..."

No esquemas da Questão 5, A abordagem didática esquematiza:

- com relação a -> regência: pede preposição A
- centenas -> feminino plural -> artigo facultativo
- a centenas = só preposição (sem artigo)
- às centenas = preposição + artigo
...
No trecho original analisado: $$\text{"Esse comando é subjacente [a todas] [as relações da República]"}$$

- O complemento imediato no texto original é a locução a todas. O artigo as subsequente acompanha o substantivo relações.
- Ao suprimir a todas, o adjetivo subjacente passa a reger diretamente o substantivo relações:

$$\text{subjacente} + \text{a (preposição)} + \text{as (artigo de relações)} \longrightarrow \text{subjacente às relações}$$

- A presença do acento grave no vocábulo as torna-se estritamente obrigatória. A grafia subjacente as relações acarretaria erro de regência nominal por omissão da preposição obrigatória.

> "Esse 'a todas', que era complemento de subjacente, saiu. Saindo, agora o complemento de subjacente é 'as relações'. Ora, subjacente exige complemento nominal, exige preposição... Mas o 'as' de relações, a banca pergunta se deveria ser necessariamente obrigatório. Então, sim, item certo."

No esquemas da Questão 6, A abordagem didática risca a expressão a todas no texto e faz a derivação manuscrita na parte inferior da tela: SUBJACENTE ÀS RELAÇÕES. Ela desenha setas indicando A (PREP.) advinda de subjacente e AS (ART.) pertencente a relações.
...
A abordagem didática relata que muitos alunos sentem dificuldade porque tentam aplicar a lógica da Regra 1 (procurar preposição exigida por verbo ou nome) dentro de contextos que pertencem exclusivamente à Regra 2 (estruturas fixas de base feminina).

Abertura da aula com esquemas intitulado "LOCUÇÃO FEMININA"  e anotação esquemática manuscrita no canto superior esquerdo:

- DUAS REGRAS
- FF (Fenômeno Fonético)
- LF (Locução Feminina)
- Símbolo de diferença: (FF) != (LF).
...
Exemplo 1: "Chego à noite."

- Análise de Regência: O verbo "chegar" (no sentido de chegar a algum momento) não rege preposição A para tempo; "quem chega, chega" (verbo intransitivo).

- Trata-se de uma Locução Adverbial de Tempo Feminina (núcleo: "noite"). Logo, recebe acento grave obrigatório.

Exemplo 2: "À medida que a vida passa, ficamos mais maduros."

- Trata-se de uma Locução Conjuntiva Proporcional Feminina (núcleo: "medida"). Logo, recebe acento grave obrigatório.

Exemplo 3: "Vive às custas dos amigos."

- Trata-se de uma Locução Prepositiva Feminina (núcleo: "custas"). Logo, recebe acento grave obrigatório.

A abordagem didática enfatiza textualmente: "Na regra das locuções femininas, não foi um 'A' preposição que se encontrou com o 'A' artigo... Não é regência!"

No esquemas , A abordagem didática puxa setas sobre os exemplos:

- Marca V.I. (Verbo Intransitivo) acima de Chego e escreve que à noite é uma expressão feminina de tempo.

- Registra manuscrito: "Como não confundir a regra de CRASE do FF com a regra da LF? Na regra do acento das locuções femininas, não foi um 'A' (PREP.) que se encontrou com o 'A' (ART.)".
...
1. Locuções Adjetivas Femininas: qualificam um substantivo antecedente.

- Exemplo: encontro às avessas (às avessas qualifica o substantivo encontro).

1. Locuções Conjuntivas Femininas: conectam orações e terminam com a conjunção que.

- Exemplos: à medida que, à proporção que.

1. Locuções Prepositivas Femininas: desempenham papel de preposição composta e terminam com a preposição de (ou a/com).
...
- LOC. ADJETIVAS $\rightarrow$ Encontro às avessas (puxa seta ligando às avessas a encontro, anotando substantivo)
- LOC. CONJUNTIVAS $\rightarrow$ À medida que (À medida que cresce...)
- LOC. PREPOSITIVAS $\rightarrow$ À força de (À força do ódio, escreveu a carta)
...
| --- | --- | --- |
| Comeu à francesa. | Comeu a francesa. | Com crase: locução adverbial de modo (modo francês). Sem crase: a francesa torna-se objeto direto (consumiu a mulher francesa). |
| O astrônomo estuda à noite. | O astrônomo estuda a noite. | Com crase: locução adverbial de tempo (estuda durante o período noturno). Sem crase: a noite é o objeto direto da pesquisa astronômica. |
| Comprei à vista. | Comprei a vista. | Com crase: locução adverbial de modo de pagamento. Sem crase: objeto direto literal (adquiriu o sentido da visão/olhos em um banco de órgãos). |

A abordagem didática explica: "O acento das locuções femininas é chamado de diferencial... Ele marca, distingue a locução feminina do que não seria uma locução... Por que o acento é obrigatório? Por causa das ambiguidades da vida!"

Anotação manuscrita na tela :

1. O acento das locuções femininas é chamado de diferencial (DISTINGUE A LF / DESFAZ AMBIGUIDADES).
2. Quadro contrastivo:
...
- 2) Controvérsias gramaticais:
- ENSINO A DISTÂNCIA (SEM CRASE)
- Escreveu a mão (loc. femininas de instrumento - sem crase)
...
1. Prato com Núcleo Masculino: Por regra geral, NÃO OCORRE CRASE diante de palavras masculinas. A crase somente será admitida se a expressão à moda de estiver comprovadamente implícita (homenagem ou estilo específico criado por uma figura histórica/personalidade).
...
- NOME DE COMIDA / DE PRATO:
- USO CRASE -> LOCUÇÃO FEMININA (núcleo feminino): bife à parmegiana; à milanesa
...
3. Crase no Plural: Regras de presença ou ausência do acento grave diante de palavras plurais (distinção entre a no singular diante de plural e às no plural).
4. Crase Proibida: O rol taxativo de situações em que não pode ocorrer o acento grave (por ausência de artigo, presença de palavras masculinas, verbos, etc.).
5. Crase e Paralelismo: A manutenção da simetria gramatical na regência e no uso de determinantes em sequências coordenadas ou correlações.

A abordagem didática introduz afirmando que se trata de uma matemática simples e elenca pausadamente cada um dos 5 pontos enquanto os escreve na tela digital.

Construção manuscrita progressiva em tinta vermelha no quadro digital branco , contendo o título central "Crase" e os 5 tópicos ordenados.
...
3. Preposição A + Pronomes Demonstrativos AQUILO / AQUELE(S) / AQUELA(S): O acento indicativo de crase incide sobre a vogal inicial A- do próprio pronome demonstrativo (àquilo, àquele, àquela).
4. Preposição A + Pronome Demonstrativo A (equivalente a "aquela"): Ocorre tipicamente antes do conectivo QUE ou da preposição DE (ex.: "Sua atitude é igual à de seu irmão" / "Esta caneta é superior à que comprei").

A abordagem didática enumera detalhadamente cada uma das 4 vertentes: "o encontro da preposição A com o A artigo, A de a qual / as quais, o A de aquilo / aquele / aquela e o A pronome demonstrativo antes de que e de".

No quadro digital, ao lado de FF, A abordagem didática abre uma chave e escreve: A + { A (ARTIGO) | A QUAL / AS QUAIS | AQUILO / AQUELE(A) | A (PRON. DEMONS.) ANTES DE QUE / DE }.
...
"Sem teoria não se faz prova. Não esqueça isso, tá bom? [...] Não é estudando a teoria que você vai aprender a fazer prova. Você vai aprender a resolver questões resolvendo questões. Mas se não tiver uma teoria assim, organizada na mente, não consegue.".
...
Ambas as modalidades geram acento obrigatório (salvo os casos clássicos de crase facultativa: diante de pronome possessivo feminino singular, nome próprio feminino e após a preposição até).

> "Existem duas regras que justificam o acento: ou é fenômeno, ou é locução. Então quando a banca pergunta se é obrigatório, ela quer saber se é uma dessas duas regras...".

Anotação esquemática manuscrita no esquemas:
...
1. Locuções Adverbiais de Tempo:

- Possuem acento obrigatório. A banca tenta induzir que seriam facultativas, o que torna a assertiva falsa.

1. Locuções / Expressões Cristalizadas de Modo ou Estado:

> "À direita... isso aqui é uma locução feminina. De núcleo feminino. É obrigatório? É, porque é uma locução. O acento das locuções é obrigatório.". "A hora da passagem do ano... é uma locução feminina de tempo... Se é uma locução feminina, então o acento é obrigatório... Então o item está errado.".
...
1. Condições estritas para a facultatividade:
...
- 2) Antes de pron. possessivo fem. sing. + substantivo
- Por quê? -> O artigo é facultativo
...
1. Pronome Possessivo no Plural: Se o pronome estiver no plural (minhas, suas) e o termo regente exigir preposição a:
...
1. Avaliar a tentativa de retirada do acento em às:

1. Avaliar a tentativa de substituição mútua (a por às ou às por a):
...
4. Verifique a fusão: se o regente pede a e o termo remanescente tem artigo as, a fusão resulta obrigatoriamente em às.
...
| PASSO 1: VERIFICAÇÃO DE FENÔMENO FONÉTICO (FF) |

| - Há termo regente anterior exigindo a preposição "A"? |

| - O termo seguinte admite o artigo definido "A(S)" ou é pronome? | +-------------------------------------------------------------------+

| +---> [SIM: Houve FF] ------------> CRASE OBRIGATÓRIA (Regra 1)

| +---> [NÃO: Não houve FF]

| v +-------------------------------------------------------------------+

| PASSO 2: VERIFICAÇÃO DE ESTRUTURA LOCUTIVA |

| - O bloco em análise constitui uma expressão/locução pluriverbal? |

| (adverbial, conjuntiva, prepositiva ou adjetiva) | +-------------------------------------------------------------------+

| +---> [NÃO: Palavra isolada/artigo simples] -> SEM CRASE

| +---> [SIM: Trata-se de locução]

| v +-------------------------------------------------------------------+

| PASSO 3: VERIFICAÇÃO DO GÊNERO DO NÚCLEO |

| - Isole o substantivo que atua como núcleo da locução. |

| - Teste o gênero do substantivo colocando o artigo definido: |

| "A [palavra]" (feminino) ou "O [palavra]" (masculino). | +-------------------------------------------------------------------+

| +---> [NÚCLEO MASCULINO] ---------> SEM CRASE (Regra Geral)

| (Exceto "à moda de" implícito)
...
1. Passo 2 — Identificar o Termo Regido (no caso de FF):
...
1. Passo 3 — Checar as Restrições Específicas:
...
1. Verificar a ausência de regência: Observar que o verbo anterior não rege preposição a (ex.: verbos transitivos diretos como ver, acordar, trazer).
2. Analisar a natureza do bloco: Verificar se a expressão atua como adjunto adverbial (lugar, tempo, modo) ou expressão cristalizada (à direita, à hora de, à tona, à toa).
3. Avaliar o gênero do núcleo: Certificar-se de que o núcleo é feminino (direita, hora, tona).
...
1. Passo 2 (Possessivo no Singular): Verificar se o substantivo feminino está explícito ao lado (função adjetiva) ou omitido (função substantiva).
...
1. Passo 3 (Possessivo no Plural): Verificar a forma da letra "a" que o antecede.
...
- Afirmação da Banca: "É obrigatório o emprego do acento indicativo de crase no vocábulo 'às' em 'às regras gerais da administração pública'."
- Resolução: O verbo submeter-se rege a preposição a (submeter-se a algo). O substantivo regras está antecedido do artigo as. Se retirássemos o acento grave, restaria as, que é somente artigo, violando a regência do verbo. Como não se pode usar as sem crase, o acento no vocábulo às é obrigatório.
...
- Afirmação da Banca: "No segundo período do terceiro parágrafo, o emprego do sinal indicativo de crase no trecho 'ainda existe uma enorme dificuldade de acesso às coisas do direito' é obrigatório."
- Resolução: O substantivo acesso exige a preposição a (acesso a algo). Diante do substantivo feminino plural coisas, temos a fusão $a + as = às$. Caberiam as formas às coisas ou a coisas. A forma as coisas (sem crase) é incorreta por falta de preposição. Logo, o sinal em às é obrigatório.
- Gabarito oficial: Certo.
...
- Afirmação da Banca: "No trecho 'correspondem a novas ansiedades emergentes' (...), seria gramaticalmente correta a inserção do acento indicativo de crase no vocábulo 'a', haja vista a regência do verbo corresponder e a flexão da palavra 'novas' no feminino."
- Resolução: O verbo corresponder exige preposição a, mas o substantivo novas ansiedades não está precedido de artigo definido plural. O "a" está no singular. "A" no singular diante de palavra no plural não recebe crase em hipótese alguma.
- Gabarito oficial: Errado.

- Banca / Órgão / Ano: (Adaptado) CESPE / CEBRASPE — Pref. de Joinville - SC — 2024 (Prof. Bilíngue)
- Trecho de análise: "...ir a exposições..."
- Afirmação da Banca: "A inserção do acento indicativo de crase no trecho 'ir a exposições' (...) manteria a correção gramatical do texto, uma vez que seu emprego, nesse caso, é facultativo."
- Resolução: Em ir a exposições, o "a" está no singular diante do plural exposições. Inserir crase no "a" singular (ir à exposições) tornaria o período incorreto. A crase não é facultativa nessa posição.
- Gabarito oficial: Errado.
...
- Afirmação da Banca: "No trecho 'com relação a centenas de anos de pensamento científico', no quarto período do texto, a substituição do vocábulo 'a' por às manteria a correção gramatical do texto."
- Resolução: A locução com relação a exige a preposição a. Antes do substantivo feminino plural centenas, o artigo é facultativo. Pode-se usar apenas a preposição (a centenas) ou preposição + artigo (às centenas). Ambas as construções são gramaticalmente corretas.
- Gabarito oficial: Certo.
...
- Afirmação da Banca: "Caso a expressão 'a todas' fosse suprimida do terceiro período do primeiro parágrafo, o sinal indicativo de crase deveria ser necessariamente empregado no vocábulo 'as' que precede 'relações', para que a correção gramatical do texto fosse mantida."
- Resolução: No original, a preposição a introduz o pronome todas. Ao retirar a todas, o adjetivo subjacente rege diretamente o substantivo relações, que já possui o artigo as. A fusão $a + as$ resulta obrigatoriamente em às.
- Gabarito oficial: Certo.

- Frase: Chego à noite.
- Desenvolvimento da Resolução:

1. Passo 1 (FF): Quem chega, chega (verbo intransitivo). Não há termo regente pedindo preposição A.
2. Passo 2 (Locução): A noite funciona como adjunto adverbial de tempo (expressão de tempo).
3. Passo 3 (Gênero do Núcleo): Núcleo noite $\rightarrow$ palavra feminina (a noite).

- Conclusão: Crase obrigatória por se tratar de locução adverbial feminina.

- Frase: À medida que a vida passa, ficamos mais maduros.
- Desenvolvimento da Resolução:

1. Passo 1 (FF): Início de oração subordinada, sem regência anterior.
2. Passo 2 (Locução): À medida que é locução conjuntiva proporcional.
3. Passo 3 (Gênero do Núcleo): Núcleo medida $\rightarrow$ palavra feminina (a medida).

- Conclusão: Crase obrigatória por ser locução conjuntiva feminina.

- Frase: Vive às custas dos amigos.
- Desenvolvimento da Resolução:

1. Passo 1 (FF): Vive é intransitivo. Não há regência exigindo preposição.
2. Passo 2 (Locução): Às custas de é locução prepositiva.
3. Passo 3 (Gênero do Núcleo): Núcleo custas $\rightarrow$ substantivo feminino plural (as custas).

- Conclusão: Crase obrigatória por ser locução prepositiva feminina.
...
2. O astrônomo estuda à noite (tempo em que estuda = locução adverbial) vs. O astrônomo estuda a noite (objeto direto = objeto de pesquisa).

- Conceito Demonstrado: Função diferencial da crase em desfazer ambiguidade textual.
...
2. Bife a cavalo / Frango a passarinho: Cavalo e passarinho são palavras masculinas. Não existe "moda do cavalo" nem "moda do passarinho". Sem crase.

| Item | Frase Analisada | Gabarito Correto | Justificativa Sintática e Aplicação do Método |
| --- | --- | --- | --- |
| 1 | Chegou a/à uma hora em ponto. | à | Com crase. Não há FF. Trata-se de locução adverbial de tempo com núcleo substantivo feminino (hora). O termo uma funciona como numeral que especifica a hora. |
| 2 | Admirei os quadros a/à óleo. | a | Sem crase. Não há FF. Trata-se de locução com núcleo masculino (o óleo). |
| 3 | Quincas Borba vivera a/à míngua... | à | Com crase. Não há FF. À míngua é locução adverbial feminina (núcleo: a míngua). |
| 4 | A/À semelhança do que ocorre... | À | Com crase. Não há FF. À semelhança de é locução prepositiva de núcleo feminino (a semelhança). |
| 5 | Saiu de casa após as dez horas a fim de ir à praia. | as / a | Ambos sem crase. Após as dez horas: já existe a preposição após, sendo as apenas artigo definido. A fim de: locução prepositiva de núcleo masculino (o fim). |
| 6 | Precisou sair as/às pressas. | às | Com crase. Não há FF. Às pressas é locução adverbial de modo feminina (núcleo: as pressas). |
| 7 | Andei a/à cavalo nas minhas férias. | a | Sem crase. Não há FF. A cavalo é locução adverbial de núcleo masculino (o cavalo). |
| 8 | Era bonito o entardecer a/à beira do lago. | à | Com crase. Não há FF. À beira de é locução prepositiva feminina (núcleo: a beira). |
| 9 | A/À medida que aprendia mais... | À | Com crase. Não há FF. À medida que é locução conjuntiva proporcional feminina (núcleo: a medida). |
| 10 | Nada mudou..., a/à despeito de alguns... | a | Sem crase. Não há FF. A despeito de é locução prepositiva de núcleo masculino (o despeito). |
...
> Regra prática: "A no singular diante de palavra no plural: crase nem a pau!" Se o vocábulo for apenas a letra a (no singular) e a palavra seguinte estiver no plural (a novas, a exposições, a pessoas, a regras), nunca haverá acento grave. Para haver crase diante de plural, o vocábulo obrigatoriamente tem de estar no plural: às.
...
3. Até: Após a preposição até (até a/à).
...
- Forma correta: Se a palavra escrita for as (no plural), o acento é estritamente obrigatório (às), pois as sem acento é apenas artigo e causaria erro de regência. A alternância facultativa só existe entre às (prep + art) e a (prep pura no singular), jamais entre às e as.
...
- Forma Correta: Compreender que locuções femininas recebem crase pela Regra 2 (estrutural/locutiva), e não pela Regra 1 (regência).
...
1. No contexto de horário determinado, uma não é artigo indefinido, mas numeral cardinal.
2. A expressão à uma hora é uma locução adverbial de tempo feminina (núcleo: hora). A crase é obrigatória.
...
- Exceção Única: A preposição até admite crase facultativa diante de substantivos femininos e horas (Foi até a praia / Foi até à praia; Ficou até as dez / até às dez).
...
- A reunião foi marcada para as 15h. (Crase proibida: preposição para + artigo as).
...
O material aborda o padrão recorrente e previsível da banca Cebraspe (CESPE) sobre crase diante de termos femininos no plural. A abordagem didática demonstra que, diante de substantivo feminino no plural regido por termo que exige preposição "a", há apenas duas formas gramaticais aceitáveis:

1. às + substantivo plural (com crase obrigatória e sentido determinado).
2. a + substantivo plural (sem crase, com sentido genérico).

As bancas tentam induzir o candidato ao erro afirmando que o acento em às não seria obrigatório (o que é falso, pois tirar o acento deixaria as sem preposição, violando a regência) ou que seria possível crasear o a no singular antes de plural (à novas, o que é terminantemente proibido).

Por fim, analisa-se a substituição de a por às (que preserva a correção gramatical, embora mude o sentido) e a supressão de pronomes intervenientes (como a todas), que obriga a fusão da preposição do regente com o artigo do substantivo seguinte (subjacente às relações).

A Profª. Adriana Figueiredo apresenta a Segunda Regra Geral de Crase, que determina o uso do acento grave nas locuções femininas. A premissa central é que toda a crase da Língua Portuguesa resume-se a apenas duas regras: o Fenômeno Fonético (Preposição A + Artigo/Pronome A) e as Locuções Femininas.

Nas locuções femininas, o acento não decorre de regência verbal ou nominal antecedente. Trata-se de uma marcação sintática e semântica fixa em expressões pluriverbais cujo núcleo substantivo é feminino. As locuções dividem-se em:

1. Adverbiais (à tarde, às pressas);
2. Adjetivas (às avessas);
3. Conjuntivas (à medida que);
4. Prepositivas (à força de, às custas de, à beira de).

A função primordial desse acento é atuar como acento diferencial para desambiguação, impedindo que adjuntos adverbiais sejam interpretados como objetos diretos (como na distinção clássica entre comeu à francesa e comeu a francesa, ou o astrônomo estuda à noite e o astrônomo estuda a noite).

No campo das controvérsias de prova:

- Ensino a distância: As bancas consagram a grafia sem crase quando a palavra distância não estiver numericamente especificada.
- Locuções de instrumento (escreveu a mão): Há divergência doutrinária; o concurseiro deve atuar estrategicamente eliminando erros mais graves.
- Nomes de pratos: Se o núcleo for feminino, a crase é obrigatória (bife à parmegiana, frango à milanesa). Se for masculino, só haverá crase se houver a elipse inequívoca de "à moda de" (bife à Osvaldo Aranha); pratos comuns com substantivos masculinos não levam crase (bife a cavalo, frango a passarinho).

A aula consolida um algoritmo de 3 passos para resolver crase em expressões: (1) Verificar se houve Fenômeno Fonético; (2) Se não houve, verificar se é locução; (3) Se for locução, checar o gênero do núcleo (feminino = com crase; masculino = sem crase). O método é comprovado na resolução comentada de 10 exercícios práticos de fixação.

nesta unidadeda Aula 10, A abordagem didática apresenta uma síntese esquemática da matéria de crase, estruturando o conteúdo em 5 grandes eixos:

1. Duas Regras Gerais: Fenômeno Fonético (FF) e Locuções Femininas (LF).
2. Três Casos de Crase Facultativa.
3. Crase no Plural.
4. Crase Proibida.
5. Crase e Paralelismo Sintático.

Ao detalhar a regra do Fenômeno Fonético, o esquema visual formaliza a fusão da preposição A com quatro possibilidades: o artigo feminino A, os pronomes relativos A QUAL / AS QUAIS, os pronomes demonstrativos AQUILO / AQUELE / AQUELA e o pronome demonstrativo A que antecede as palavras QUE ou DE.

Por fim, A abordagem didática destaca a importância metodológica do equilíbrio entre teoria e resolução de questões, ressaltando que a prática desenvolve a agilidade de prova, mas apenas a teoria estruturada confere a segurança necessária para eliminar a sorte e garantir a aprovação.

Neste material, A abordagem didática resolve 6 questões da banca CEBRASPE com foco na diferenciação precisa das causas que justificam o emprego do acento grave.

Ficou consolidado que o acento indicativo de crase se divide estritamente em Fenômeno Fonético (fusão preposição + artigo) e Locuções Femininas (crase fixa em expressões adverbiais, prepositivas e conjuntivas de núcleo feminino).

No caso de deixar o pão à porta do apartamento, o acento é obrigatório pelo fenômeno fonético decorrente da regência contextual de deixar a (indicação de proximidade física). Nas locuções à direita, à hora da passagem do ano e à tona, o acento é obrigatório pela regra das locuções femininas, sendo falso afirmar que se trata de caso facultativo.

Na célebre questão do INSS 2022 (ver à porta a cara do mascate), desmascarou-se a pegadinha da banca que atribuía a crase à regência do verbo ver (que na verdade é transitivo direto). Por fim, na prova da PG-DF 2021, confirmou-se que a locução a granel não admite crase por possuir núcleo masculino, de modo que a inserção do acento grave prejudicaria a correção gramatical do texto.
...
1. As Quatro Armadilhas Críticas (Exceções):
...
1. Prática: Aplicação em lista de 9 itens, consolidando a capacidade de distinguir casos facultativos de casos obrigatórios (locuções femininas, regências plenas) e proibidos (palavras masculinas, preposição singular diante de plural).
