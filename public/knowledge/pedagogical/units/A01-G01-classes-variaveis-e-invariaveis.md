...
│
└── 2. CLASSES INVARIÁVEIS (Forma fixa; sem flexão de gênero e número)
 ├── Advérbio: Modifica Verbo, Adjetivo ou outro Advérbio; indica circunstância.
 │ ├── Locução Adverbial: Expressão preposicionada com valor adverbial (invariável).
 │ └── [Exceção] Advérbio "Todo/Toda": Admite concordância atípica com adjetivo feminino.
 ├── Conjunção: Conectivo; liga orações ou termos de mesma função sintática.
 │ └── Locução Conjuntiva: Expressão conectiva; TERMINA OBRIGATORIAMENTE EM CONJUNÇÃO.
 ├── Preposição: Conectivo; liga termos (palavras) ou orações reduzidas.
 │ └── Locução Prepositiva: Expressão conectiva; TERMINA OBRIGATORIAMENTE EM PREPOSIÇÃO.
 └── Interjeição: Palavra/expressão invariável que exprime emoções, sentimentos e sensações.
```
...
### Quadro Sinótico de Classes e Flexibilidade
...
### 1. Palavra Simples vs. Locução Correspondente (Comportamento de Flexão)

| Estrutura | Categoria | Comportamento no Plural | Exemplo no Singular | Exemplo no Plural |
|:---------------------------- |:-------------- |:---------------------------------------- |:--------------------- |:------------------------------- |
| **Adjetivo** | Palavra simples | **Variável** (concorda com o nome) | Homem inteligente | Homens inteligente**s** |
| **Locução Adjetiva** | Expressão fixa | **Invariável** (mantém a forma) | Homem de inteligência | Homens**de inteligência** |
...
|:------------------------------ |:------------------------------------ |:---------------------------------------------------- |:----------------------------------------------------- |
| **Preposição** | Termos ou Orações | Palavra invariável relacional | Blusa**de** Maria / Estudo **para** vencer |
| **Locução Prepositiva** | Termos ou Orações | **Termina em Preposição** | Estudo**a fim de** passar |
...
| **De mais** | Preposição*de* + quantificador de nome (*"mais café"*) | Prep. + Pronome indefinido | **Invariável** |
...
| **Só** | Equivale a*sozinho* (*"Fez o trabalho só"*) | Adjetivo | **Variável** |
| **Só** | Equivale a*apenas* (*"Maria só arrumou"*) | Advérbio de exclusão | **Invariável** |
...
| *"Meu aluno chegou."* | `Meu` | Pronome Possessivo | **Pronome Adjetivo** | Acompanha e determina o substantivo*aluno*. |
| *"Os dois chegaram."* | `dois` | Numeral Cardinal | **Numeral Substantivo** | Ocupa sozinho a função de sujeito. |
| *"Os dois meninos chegaram."* | `dois` | Numeral Cardinal | **Numeral Adjetivo** | Manda seta quantificadora para o substantivo*meninos*. |
...
|:------------------------------------------------------------- |:-------------: |:----------------: |:-----------------------: |:------------------------------------------------------------------------ |
| 1.*"A gente não deseja **mais** viver."* | `mais` | Advérbio de tempo | **(I) Invariável** | Modifica o verbo*deseja* antecedido de negação (ideia de cessação). |
| 2.*"Os pagamentos **realizados** foram feitos ontem."* | `realizados` | Adjetivo | **(V) Variável** | Particípio com valor adjetivo caracterizando*pagamentos*. |
| 3.*"**Amanhã**, irei às compras."* | `Amanhã` | Advérbio de tempo | **(I) Invariável** | Modifica a oração/verbo indicando circunstância de tempo. |
| 4.*"Não se **fez** de rogado."* | `fez` | Verbo | **(V) Variável** | Flexão do verbo*fazer* (terceira pessoa do pretérito perfeito). |
...
| 6.*"Eles não se davam **bem**."* | `bem` | Advérbio de modo | **(I) Invariável** | Modifica o verbo*davam*, indicando a circunstância de modo. |
...
- Terminou na conjunção **QUE** $\rightarrow$ **Locução Conjuntiva** (*visto que, à medida que, a fim de que*).
...
- Palavra **isolada** (sem substantivo ao lado) = Função **Substantiva** (*"Alguém chegou"*, *"Os dois chegaram"*).
- Palavra **acompanhada** (colada a um substantivo) = Função **Adjetiva** (*"Meu aluno"*, *"Dois meninos"*).
...
Ao concluir o estudo consolidado do grupo `esta unidade`, o estudante deve:
