...
**Apoio estrutural:** Variabilidade e invariabilidade são propriedades morfológicas. O mapa ajuda a mostrar como cada classe realiza funções diferentes, sem identificar classe e função.
...
- Adjetivo Simples: Flexiona-se harmoniosamente com o substantivo. Exemplo: "homem inteligente" $\rightarrow$ "homens inteligentes".
...
- Locução Adjetiva: Como princípio transversal da morfologia, as locuções são expressões cristalizadas e, em regra geral, permanecem invariáveis. Exemplo: "homem de inteligência" $\rightarrow$ "homens de inteligência" (a flexão "homens de inteligências" é incorreta).
- Locução Cristalizada Excepcional: A locução "a sós" qualifica termos nominais ("As duas estão a sós"), sendo classificada como locução adjetiva estritamente invariável.
...
1. Pronome Substantivo: Fica isolado, ocupando o lugar do nome na estrutura sintática (ex.: "Alguém chegou").
2. Pronome Adjetivo: Posiciona-se adjacente a um substantivo explícito, apontando uma relação de dependência direta para ele (ex.: "Meu aluno chegou").

Nota de Flexão: Embora o pronome integre as classes variáveis, existem pronomes indefinidos/pessoais específicos intrinsecamente invariáveis (ex.: alguém, ninguém, tudo, mais em certos contextos).
...
1. Advérbio "Mais" Antecedido de Negação: Em construções como "não mais" ou "nunca mais" ("A gente não deseja mais viver"), o vocábulo mais modifica o verbo e expressa circunstância de tempo (cessação temporal: "de agora em diante"), sendo invariável.
2. Advérbio "Menos": Ao modificar adjetivos ("menos condenável"), expressa intensidade e permanece estritamente invariável (a forma "menas" é inexistente no padrão culto).
3. A Exceção de "Todo/Toda": Ao intensificar adjetivo, o advérbio todo admite duas construções cultas equivalentes:
...
1. Diferenciação Estrutural de Locuções:
...
1. "De mais" (separado): Ocorre quando a regência exige a preposição de e o vocábulo mais quantifica um substantivo.
...
| Classe Gramatical | Natureza | Função Básica no Enunciado | Teste / Critério Diagnóstico | ID Detalhado |
| --- | --- | --- | --- | --- |
| Substantivo | Variável | Nomeia seres, ações, conceitos | Admite anteposição de artigo | KB-...-002 |
| Artigo | Variável | Determina ou generaliza o substantivo | Antepõe-se ao nome | KB-...-001 |
| Adjetivo | Variável | Caracteriza o substantivo | Varia em gênero/número com o nome | KB-...-003 |
| Pronome | Variável | Substitui ou acompanha o substantivo | Substantivo (isolado) / Adjetivo (com nome) | KB-...-004 |
| Numeral | Variável | Quantifica, ordena, multiplica, divide | Substantivo (isolado) / Adjetivo (com nome) | KB-...-005 |
| Verbo | Variável | Expressa ação, estado, fenômeno | Flexiona em tempo, modo, pessoa, número | KB-...-006 |
| Advérbio | Invariável | Modifica verbo, adjetivo ou outro advérbio | Indica circunstância; não se liga a nome | KB-...-007 |
| Conjunção | Invariável | Liga orações ou termos da mesma oração | Conector puro | KB-...-008 |
| Preposição | Invariável | Liga termos da oração ou orações reduzidas | Conector subordinante | KB-...-008 |
| Interjeição | Invariável | Expressa sentimentos e reações imediatas | Palavra exclamativa autônoma | KB-...-009 |
...
- Locução Prepositiva: Expressão conectiva que termina em preposição (KB-...-008).
...
3. Se a estrutura acolher o artigo mantendo a higidez gramatical e o sentido, a palavra funciona contextualmente como Substantivo.
...
1. Confirmação: Teste a flexão passando a oração para o plural/feminino.
...
| Estrutura | Categoria | Comportamento no Plural | Exemplo no Singular | Exemplo no Plural |
| --- | --- | --- | --- | --- |
| Adjetivo | Palavra simples | Variável (concorda com o nome) | Homem inteligente | Homens inteligentes |
| Locução Adjetiva | Expressão fixa | Invariável (mantém a forma) | Homem de inteligência | Homensde inteligência |
...
| --- | --- | --- | --- |
| Preposição | Termos ou Orações | Palavra invariável relacional | Blusade Maria / Estudo para vencer |
| Locução Prepositiva | Termos ou Orações | Termina em Preposição | Estudoa fim de passar |
| Conjunção | Orações ou Termos da mesma oração | Palavra invariável coordenativa/subordinativa | Chegoue dormiu / José e João |
| Locução Conjuntiva | Orações | Termina em Conjunção (geralmente que) | Estudoa fim de que passe |

| Vocábulo | Contexto Sintático | Classe Gramatical | Flexibilidade |
| --- | --- | --- | --- |
| Demais | Modifica verbo ("Gosta demais") | Advérbio de intensidade | Invariável |
| De mais | Preposiçãode + quantificador de nome ("mais café") | Prep. + Pronome indefinido | Invariável |
| Claro | Modifica substantivo ("Dia claro") | Adjetivo | Variável |
| Claro | Modifica oração/verbo ("Claro que vou") | Advérbio de afirmação | Invariável |
| Menos | Modifica adjetivo ("Menos condenável") | Advérbio de intensidade | Invariável |
| Só | Equivale asozinho ("Fez o trabalho só") | Adjetivo | Variável |
| Só | Equivale aapenas ("Maria só arrumou") | Advérbio de exclusão | Invariável |
| A sós | Expressão fixa ("Elas estão a sós") | Locução adjetiva | Invariável |

---

## Exemplos comentados

- Construção A: "Ele é homem inteligente." $\rightarrow$ Plural: "Eles são homens inteligentes." (O adjetivo simples flexiona no plural).
...
| --- | --- | --- | --- | --- |
| "Alguém chegou." | Alguém | Pronome Indefinido | Pronome Substantivo | Ocupa sozinho o núcleo do sujeito. |
| "Meu aluno chegou." | Meu | Pronome Possessivo | Pronome Adjetivo | Acompanha e determina o substantivoaluno. |
| "Os dois chegaram." | dois | Numeral Cardinal | Numeral Substantivo | Ocupa sozinho a função de sujeito. |
| "Os dois meninos chegaram." | dois | Numeral Cardinal | Numeral Adjetivo | Manda seta quantificadora para o substantivomeninos. |
...
| --- | --- | --- | --- | --- |
| 1."A gente não deseja mais viver." | mais | Advérbio de tempo | (I) Invariável | Modifica o verbodeseja antecedido de negação (ideia de cessação). |
| 2."Os pagamentos realizados foram feitos ontem." | realizados | Adjetivo | (V) Variável | Particípio com valor adjetivo caracterizandopagamentos. |
| 3."Amanhã, irei às compras." | Amanhã | Advérbio de tempo | (I) Invariável | Modifica a oração/verbo indicando circunstância de tempo. |
| 4."Não se fez de rogado." | fez | Verbo | (V) Variável | Flexão do verbofazer (terceira pessoa do pretérito perfeito). |
| 5."Hoje, apenas 1,6% vive na zona rural." | zona | Substantivo | (V) Variável | Nome antecedido de artigo; o sublinhado restringe-se ao núcleo. |
| 6."Eles não se davam bem." | bem | Advérbio de modo | (I) Invariável | Modifica o verbodavam, indicando a circunstância de modo. |
| 7."Estive em algumas praias pela manhã." | em | Preposição | (I) Invariável | Conector que liga o verbo ao adjunto. |
| 8."Desse valor, R$ 1,25 milhão é oriundo..." | milhão | Numeral cardinal | (V) Variável | Quantificador de valor substantivo que admite flexão (milhões). |

- Texto 1: "— Claro que estou indo à festa. — respondi."
- Texto 2: "... e, claro, eu estava dormindo."
- Enunciado: Em ambos os casos, a palavra "claro" classifica-se como:

- Resolução Comentada: No Texto 1, claro modifica a locução estou indo; no Texto 2, modifica estava dormindo. Ambos exprimem certeza/obviedade e modificam estruturas verbais, funcionando como advérbios (invariáveis).
- Gabarito Oficial: C

- Enunciado: Em "... o sujeito passa a se achar menos condenável que os outros por ser poderoso [...]", a palavra "menos":

- Resolução Comentada: Condenável é adjetivo que caracteriza sujeito. A palavra menos modifica o adjetivo condenável, atuando como advérbio de intensidade. Advérbio é classe invariável.
- Gabarito Oficial: A
...
1. só (1) refere-se a Ângela (= sozinha) $\rightarrow$ Adjetivo (variável).
2. só (2) refere-se ao verbo arrumou (= apenas) $\rightarrow$ Advérbio (invariável).
3. a sós (3) refere-se a duas $\rightarrow$ Locução adjetiva, mas por ser locução é invariável.
...
- Terminou em preposição (DE, A, EM, COM) $\rightarrow$ Locução Prepositiva (a fim de, por causa de, em vez de).
...
Ao concluir o estudo consolidado desta unidade, o estudante deve:

1. Dominar a Divisão Estrutural das Classes: Compreender que a morfologia se divide em 6 classes variáveis (substantivo, adjetivo, pronome, numeral, verbo, artigo) e 4 invariáveis (advérbio, conjunção, preposição, interjeição), sabendo que variação é estritamente flexão de número e gênero.
2. Distinguir Palavras Simples de Locuções: Reconhecer que, enquanto o adjetivo simples varia (homens inteligentes), as locuções correspondentes e expressões preposicionadas formam unidades sintagmáticas cristalizadas invariáveis (homens de inteligência, as duas estão a sós).
3. Diferenciar Funções Substantivas e Adjetivas: Identificar que pronomes e numerais que acompanham nomes operam como adjetivos, enquanto os que ocupam isoladamente o lugar do nome operam como substantivos.
4. Distinguir Locuções Conectivas pela Terminação: Identificar imediatamente uma locução prepositiva por terminar em preposição (a fim de) e uma locução conjuntiva por terminar em conjunção (a fim de que).
5. Aplicar o Método das Setas: Abandonar a memorização estática de listas isoladas e analisar toda palavra dentro do enunciado, verificando o termo ao qual ela se conecta para definir sua classe e invariabilidade em palavras polissêmicas (claro, menos, demais, de mais, só, a sós).
