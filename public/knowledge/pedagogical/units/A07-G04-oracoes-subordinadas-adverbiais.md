...
│
└── 4. Polissemia e Casos Especiais de Conectivos
 ├── "Assim como": Termos = Aditivo | Orações = Comparativo
 ├── "Como": Início = Causal | Meio comparativo = Comparativo | Conformidade = Conformativo
 ├── "Desde que": + Subjuntivo = Condicional | + Indicativo = Temporal
 └── "Sem que": Concessivo/Condicional com polaridade negativa (ideia de privação/ausência)
```
...
### Tabela Sintética das 9 Subclasses Adverbiais (6C + FTP)
...
### 1. Causa vs. Condição vs. Consequência
