...
- Onde x Aonde
- Ortografia
- país, reúnem, saúde, egoísmo. Caso contrário, não acentue
- Piauí, tuiuiú. Decore
- Por que
- Porque
- Porque x Por que x Por quê x Porquê
- Prefixos “Sub” e “sob” + R/B
- Regra do Hiato
- Regras Gerais para (não) uso do hífen
- Restaram só
- Se não
- •Se tiver Ditongo Aberto
- Seção
- Senão
- “Senão x Se não”
- Sessão
...
- Observação: antes de pontuação virá
...
- conteúdo integrado, autoaprendizagem, coautor, infraestrutura, semianalfabeto> Usa-se para vogais iguais:
...
POR QUE
Interrogação
- Direta: com ponto de interrogação.
Ex.: Por que estudas?
...
Por + Que (pron. Relativo)
Só eu sei as esquinas por que passei (pelas
quais)
PORQUE
Conjunção causal
...
numeral...)
Ainda não sei o porquê de toda essa
confusão.
Se fez isso, deve ter algum porquê.
...
- **fácil, hífen, álbum, cadáver, álbuns, tórax, júri, lápis, vírus, bíceps, órfão** — •Todas, exceto terminadas em A(s),E(s),O(s),Em(s),
- **Indivíduos, precárias, série, história, imóveis, água, distância, primário, indústria, rádio** — •Terminadas em ditongo (Regra cobradíssima)
- **líquida, pública, episódica, anencéfalo, período** — • Todas. Sempre.
- **Por que estudas?**
- **Gostaria de saber por que estudas.**
- **Estudas tanto por quê?**
- **Se não revisar regularmente, esquecerá o conteúdo.** — Se não: Se (Conjunção Condicional) + Não (Adv. Negação).
- **João perguntou se não haveria aula.** — Se não: Se (Conjunção Integrante) + Não (Adv. Negação).
- **Há verdades que se não dizem. (que não são ditas- Essa colocação pronominal “estranha” é muito formal e se chama apossínclise)** — Se não: Se (Pronome apassivador) + Não (Adv. Negação).
- **“Venha, senão vai se arrepender”** — Senão: do contrário, mas, mas também, mas sim, a não ser, exceto...
- **O jantar foi mal preparado pelo cozinheiro.** — Mal: oposto de “bem”. Advérbio. Geralmente acompanha um verbo ou adjetivo.
- **Mal cheguei, fui interrogado.** — Também temos “mal” como conjunção temporal, com sentido de “logo que”.
- **Morreu de um mal súbito.** — Como sinônimo de “doença, coisa ruim”, mal é substantivo.
- **Não passou porque era um mau candidato.** — “maligno".
- **Há dias em que sinto falta de fumar. Há dez anos não fumo.** — Há: Verbo impessoal haver, sentido de existir; tempo passado.
- **O cinema fica a 2km daqui. Chegaremos daqui a 15 minutos.** — A: preposição, sentido de limite, distância ou futuro.
- **Estou aqui a fim de te orientar sobre seu estudo.** — A fim de: locução prepositiva com sentido de “propósito”, “para”.
- **Matemática e estatística são matérias afins.** — Afim: Semelhante, correlato.
- **Onde você mora? Moro em Caxias.** — Onde: Usado para verbos que pedem a preposição “em”.
- **Aonde quer que eu vá, eu levo você no olhar.** — Aonde: Usado para verbos que pedem a preposição “a”.
- **Ela come muito, mas não engorda.** — Mas: Conjunção adversativa, como “porém”.
- **Estudei um pouco de manhã; à noite estudei mais.** — Mais: Oposto de menos.
- **Estudo porque sei que minha hora vai chegar.** — anterior.
- **Por que você é grosseiro? (por que motivo) – Interrogativa direta, com ponto de interrogação (?) /  Não sei por que você se foi... (por que motivo) - Interrogativa indireta, sem ponto de**
- **Nunca fumou e morreu de câncer. Por quê?** — pausa. O macete é pensar que a pausa ou pontuação final “atraem” o circunflexo.
- **Não foi aprovado e ninguém sabe o porquê. (ninguém sabe o motivo) / Deve haver algum porquê (alguma razão)** — determinante).
- **Não estou a par desse novo edital.** — A par: Informado.
- **Sonhei que o dólar estava ao par do real.** — Ao par: Equivalente em valor.
- **Discutiremos acerca do aumento de seu salário.** — Acerca: Sobre, assunto.
- **A cerca não resistiu ao vento e desabou.** — A cerca: Artigo a + substantivo cerca.
- **Chegou aqui há cerca de duas horas. / Estamos a cerca de dois KM de sua cidade.** — verbo haver.
- **A piada não foi inteligente, tampouco engraçada.** — Tampouco: advérbio equivalente a “também não, nem”.
- **Como tão pouco, não sei por que engordo... / Não sabia que havia tão pouco petróleo naquele país.** — sentido de quantidade, intensidade.
- **Vou assinar um contrato de cessão de direitos com você.** — Cessão: Ato de ceder.
- **A sessão legislativa vai atrasar de novo.** — Sessão: Período de tempo que dura uma reunião.
- **Procure seu liquidificador na seção de eletrodomésticos.** — Seção: ponto ou local onde algo foi cortado ou dividido.
- **Ao invés de se entregar ao nervosismo, permaneceu calmo.** — Ao invés de: fazer o contrário, o inverso, usado com antônimos.
- **Em vez de você ficar pensando nele, pense em mim!** — Em vez de: uma coisa no lugar da outra.
- **Não acho nada de mais desse filme.** — De mais: oposto a “de menos”.
- **Esse filme é bom demais! / O líder fala, os demais ouvem.** — Demais: muito; o restante.
- **O carro desgovernou-se e foi de encontro a um muro. / Minhas ideias inovadoras vão de encontro a** — De encontro A: contra; em sentido contrário; sentido de choque, oposição, discordância.
- **A criança, toda feliz, correu ao encontro de seu pai! / Se tudo der certo, a decisão irá ao encontro de nossas** — Ao encontro de: a favor, no mesmo sentido de; ideia de concordância.
