...
**Conexão forte:** Hiperônimos e hipônimos podem construir coesão e referenciação entre orações; a SuVeCA localiza as funções, e a hierarquia lexical explica a retomada.
...
- Morfologia Básica: Classes de palavras (substantivo, adjetivo, pronome pessoal/demonstrativo, conjunção).
...
ANÁLISE LINGUÍSTICA E RELAÇÕES SEMÂNTICO-COESIVAS ➔ 1. Critérios de Análise
- ➔ Morfologia (Classe da palavra isolada)
➔ Semântica (Sentido, valor discursivo e relações de significado)
- ➔ Sintaxe (Função estrutural/relacional na oração)
➔ 2. Relações Semânticas Lexicais
- ➔ Hiperonímia (Hiperônimo: Geral / Gênero / Superordenado / Ampla Extensão)
➔ Hiponímia (Hipônimo: Específico / Espécie / Subordenado / Restrita Extensão)
- ➔ Chave de Validação: Teste Lógico-Categorial "TIPO DE"
➔ 3. Fronteiras e Distinções Semânticas Críticas
- ➔ Hiperonímia / Hiponímia (Níveis hierárquicos assimétricos: Geral ↔ Específico)
➔ Sinonímia Contextual (Mesmo nível semântico: Equivalência sem relação "tipo de")
- ➔ Campo Semântico (Mesmo domínio temático sem subordinação taxonômica ou sinonímia)
➔ 4. Aplicações em Mecanismos Coesivos
- ➔ Vetores Direcionais Básicos
➔ Elemento Coesivo ("Manda a Seta" / Emissor)
- ➔ Referente ("Recebe a Seta" / Alvo)
➔ Anáfora (Vetor Retrospectivo: Aponta para trás / Antes)
- ➔ Catáfora (Vetor Prospectivo: Aponta para frente / Depois)
➔ Tipologia Coesiva Lexical
- ➔ Anáfora por Hiperônimo (Termo Geral retoma Termo Específico antecedente)
➔ Anáfora Especificativa / Especificadora (Hipônimo retoma e particulariza Hiperônimo)
- ➔ Anáfora Associativa (Retomada por contiguidade temática de Campo Semântico)
➔ Sumarização / Encapsulamento (Termo sintético condensa enumeração prévia)
- ➔ Distinções Funcionais de Coesão
➔ Coesão por Substituição Real (Termo anafórico ocupa o lugar do referente)
- ➔ Coesão Explicativa / Aposição (Termo geral coexiste lado a lado com o nome próprio)
➔ Coesão Pronominal (Morfológica) vs. Coesão Lexical (Semântica)
- ➔ 5. Aplicações Lexicográficas e em Provas ➔ Estrutura de Verbetes: [Entrada] — [Hiperônimo de Abertura] + [Particularizações] ➔ Direcionalidade Obrigatória: [Específico -> Geral = Hiponímia] vs. [Geral -> Específico = Hiperonímia] ➔ Distinção CEBRASPE: Adjetivação Sintagmática (Qualificação) ≠ Coesão Lexical por Hiperonímia
...
- Morfologia: Enquadra o vocábulo em uma das dez classes gramaticais formais.
- Semântica: Analisa a carga significativa contextual, a intenção discursiva e os valores assumidos (objetivo, opinativo, modalizador).
- Sintaxe: Determina a função relacional exercida pelo termo na estrutura oracional (sujeito, predicativo, adjunto, etc.).
...
➔ HIPERÔNIMO (Geral)
- ex.: Animais, Veículo, Alimento
➔ engloba / inclui
- ➔ HIPÔNIMO (Específico)
➔ > Teste: "Pássaro é um
- ex.: Pássaros, Carro, Gelatina
TIPO DE animal" ➔
...
- Caso 3 (Hiperonímia Autêntica — Batata vs. Legume): "A batata foi cara... O legume está raro."

Batata é categoricamente um "tipo de" legume $\rightarrow$ Hiperonímia (o termo geral retoma o termo específico).
...
Elemento Coesivo: Este (pronome demonstrativo). Referente: a aprovação. Vetor: Prospectivo $\rightarrow$ Catáfora.
...
Referente: frutas (geral). Elemento coesivo: banana (específico particularizado) $\rightarrow$ Anáfora Especificativa / Coesão por Hipônimo.
...
- Sinonímia: $A = B$ (mesmo nível semântico, equivalência contextual).
...
3. A Pegadinha Clássica de Concursos — Doença vs. Febre:Febre não é uma doença; febre é um sintoma, sinal clínico ou resposta do sistema imunológico a uma patologia. Logo, doença não é hiperônimo de febre. Trata-se unicamente de associação por campo semântico médico/patológico.
4. Educação e Sociedade: Alunos e crianças (nem todo aluno é criança; há alunos adultos/idosos); história e conhecimento; luz e calor; líquido e refeição.
...
1. Substituição Real (Gabarito Correto): Cita-se a enumeração frutas, sal, mariscos, farinha e, em seguida, utiliza-se a expressão hiperonímica diversos outros alimentos para englobá-los e substituí-los no fluxo do texto.
2. Aposto Explicativo Imediato (Distrator Errado): Em "O Rio de Janeiro, de hoje, cidade abastecida...", a palavra cidade não substitui Rio de Janeiro; ambos coexistem na mesma unidade sintática em que cidade funciona como aposto explicativo imediato.
3. Qualificação Predicativa (Distrator Errado): Em "o peixe como principal elemento de abastecimento", a palavra elemento atua como qualificador/predicativo do peixe, sem qualquer substituição textual.
4. Coordenação Aditiva (Distrator Errado): Em "punir os emigrantes e liberar os imigrantes", os parônimos/antônimos emigrantes e imigrantes estão somados por conjunção aditiva ("e"), designando grupos distintos no mundo real; um não substitui o outro.
...
- Mesa — imóvel [...] $\rightarrow$ Incorreto: mesa é um móvel (objeto), não um imóvel.
- Biblioteca — construção [...] $\rightarrow$ Incorreto: biblioteca categoriza-se formalmente como lugar / local / espaço, não mera construção.
- Cubo — desenho [...] $\rightarrow$ Incorreto: cubo é uma figura geométrica tridimensional / sólido, não um desenho.
- Livraria — casa editorial [...] $\rightarrow$ Incorreto: livraria é um estabelecimento comercial / loja; casa editorial é uma editora.
- Caderno — utensílio [...] $\rightarrow$ Incorreto: utensílio aplica-se a cozinha/ferramentas; caderno é material escolar.
- Martelo — objeto [...] $\rightarrow$ Incorreto: hiperônimo vago demais; a categoria funcional exata é ferramenta.
...
- Na Questão 15 da FGV (pede Geral $\rightarrow$ Específico): a opção serrote / ferramenta foi eliminada porque apresentava Específico $\rightarrow$ Geral.
...
1. O Adjetivo Categorial como Hiperônimo (Item CERTO):Em "...memória periférica da Ceilândia", o adjetivo periférica (noção espacial/social abrangente) funciona contextualmente como hiperônimo da cidade específica Ceilândia (hipônimo).
2. Enumeração Concreta como Hipônimos de Termo Abstrato (Itens CERTOS):
...
| Conceito / Regra | Definição Canônica | Critério de Validação | ID Detalhado |
| --- | --- | --- | --- |
| Hiperonímia (Hiperônimo) | Termo superordenado de sentido amplo/geral que engloba outros seres ou classes (gênero). | É a categoria inclusiva que responde à fórmula:[Espécie] é um tipo de [Gênero]. |  |
| Hiponímia (Hipônimo) | Termo subordenado de sentido restrito/específico contido no hiperônimo (espécie). | É o elemento particularizador que ocupa a posição de "tipo de". |  |
| Sinonímia Contextual | Relação de equivalência de sentido entre termos que operam nomesmo patamar semântico. | Não há subordinação de classe nem relação de "tipo de" ($A = B$). |  |
| Campo Semântico (Anáfora Associativa) | Conexão referencial estabelecida por termos domesmo domínio temático sem sinonímia ou inclusão. | As palavras compartilham o mesmo universo discursivo sem relação de "tipo de". |  |
| Anáfora Especificativa | Retomada anafórica em que umhipônimo específico particulariza um hiperônimo geral antecedente. | Sentido: Geral$\rightarrow$ Específico ($HIPER \longrightarrow HIPO$). |  |
| Retomada por Hiperônimo | Retomada anafórica em que umhiperônimo geral engloba um hipônimo específico antecedente. | Sentido: Específico$\rightarrow$ Geral ($HIPO \longrightarrow HIPER$). |  |
| Sumarização / Encapsulamento | Processo coesivo em que um termo sintético (hiperônimo ou pronome "tudo") condensa uma lista prévia. | Capacidade de sintetizar em um único elemento múltiplos referentes antecedentes. |  |
| Substituição Coesiva Real | O termo anafórico ocupa de fato o lugar do antecedente para evitar repetição. | Distingue-se de aposto explicativo imediato, qualificação e coordenação aditiva. |  |
| Regra do Verbete (FGV) | A definição lexicográfica deve abrir-se pelo hiperônimo de gênero mais adequado antes das diferenças. | [Entrada] — [Hiperônimo Válido] + [Particularizações]. |  |
| Regra da Direcionalidade | A classificação semântica é regida estritamente pelo papel doprimeiro termo citado no comando. | Específico$\rightarrow$ Geral = Hiponímia; Geral $\rightarrow$ Específico = Hiperonímia. |  |
...
**Início: Identificar Termo 1 (T1) e Termo 2 (T2)**

1. Avaliar Equivalência Semântica T1 e T2 estão no mesmo patamar de sentido no contexto da frase? SIM NÃO SINONÍMIA Ir para Passo 2 (ex.: ceia/jantar telas/quadros)
2. Aplicar Teste Lógico "TIPO DE" "T1 é tipo de T2" OU "T2 é tipo de T1"? SIM NÃO Passo 2b: Checar Direcionalidade
3. Avaliar Campo Semântico - Se T1=Específico e T2=Geral: T1 e T2 pertencem ao mesmo tema > HIPONÍMIA sem relação taxonômica de gênero? - Se T1=Geral e T2=Específico: > HIPERONÍMIA SIM NÃO CAMPO SEMÂNTICO Relações Lógicas Anáfora Distintas Associativa (Antonímia, (ex.: febre/ Paronímia, doença; pista/ Coordenação) aeroporto)
...
1. Isolar a Alternativa Diferencial: A única alternativa restante que apresenta a relação assimétrica requerida pelo enunciado ($\text{Hiperonímia}$ ou $\text{Hiponímia}$) será o gabarito.
2. Validar a Ordem Final: Certifique-se de que a alternativa isolada respeita a ordem exigida no comando ($\text{Hipo} \rightarrow \text{Hiper}$ ou $\text{Hiper} \rightarrow \text{Hipo}$).
...
1. Ignorar o Sedutor Texto Final se o Início Estiver Errado: Nunca valide uma alternativa apenas porque a explicação final é bonita se o hiperônimo inicial for ontologicamente falso.
2. Considerar a Amplitude Dicionarizada: Lembre-se de que palavras como personagem possuem acepção ampla no dicionário (figura de destaque em qualquer meio), não se limitando à dramaturgia.
...
| Critério / Fenômeno | Hiperonímia / Hiponímia | Sinonímia Contextual | Anáfora Associativa (Campo Semântico) | Sumarização / Encapsulamento |
| --- | --- | --- | --- | --- |
| Estrutura Relacional | Assimétrica / Hierárquica ($A \subset B$ ou $B \supset A$). | Simétrica / Equivalente ($A = B$). | Contígua / Temática ($A, B \in \text{Tema } D$). | Sintética / Condensadora ($\{A, B, C\} \rightarrow S$). |
| Teste de Validação | Responde afirmativamente a:X é um tipo de Y. | Responde a:X equivale a Y no cotexto. | Não responde a "tipo de"; pertencem ao mesmo domínio. | Um vocábulo único resume a lista anterior. |
| Exemplo Típico da Aula | Animal ↔ Pássaros; Aeronave ↔ Jatinho. | Jantar ↔ Ceia; Telas ↔ Quadros. | Pista ↔ Aeroporto; Doença ↔ Febre. | Banana, pera, uva ↔ Tudo. |
| Direção Coesiva | Geral retoma Específico OU Específico retoma Geral. | Termo equivalente substitui termo anterior. | Termo do mesmo universo retoma por afinidade. | Termo hiperonímico condensa múltiplos termos. |
| Pegadinha Frequente | Inversão da ordem pedida no comando. | Achar que exige sinônimo perfeito fora do texto. | Achar quefebre é espécie de doença. | Confundir sumarização com mera sinonímia. |
...
- Conceito Consolidado: Aplicação direta do teste do "tipo de" .
...
- Conceito Consolidado: Distinção entre sinonímia e hierarquia hiperonímica .
...
- Conceito Consolidado: Retomada do específico pelo geral .
...
- Conceito Consolidado: Mecanismo básico anafórico .
...
- Conceito Consolidado: Mecanismo básico catafórico .
...
- Conceito Consolidado: Retomada particularizadora do geral pelo específico .
...
- Julgamento: Errado
- Justificativa: Não há substituição/retomada anafórica; trata-se de adjetivação sintagmática qualificadora interna ao sintagma .

- Item: Na expressão "memória periférica da Ceilândia", o adjetivo "periférica" assume a função de hiperônimo de "Ceilândia".
- Julgamento: Certo
- Justificativa: Periférica define a categoria espacial ampla da periferia da qual Ceilândia é espécie/exemplar específico .
...
- Julgamento: Certo
- Justificativa: Os elementos cotidianos concretos ilustram e particularizam o hiperônimo abstrato detalhe .

- Item: O termo "elementos" funciona como hiperônimo de "divulgação científica", "informações" e "conhecimentos".
- Julgamento: Certo
- Justificativa: Elementos opera como hiperônimo sintetizador e englobador dos hipônimos coordenados antecedentes .
...
Ao concluir o estudo integrado deste grupo temático, o estudante deve ter desenvolvido as seguintes competências conceituais e procedimentais:

1. Dominar a Análise Integrada: Compreender que Morfologia, Semântica e Sintaxe coexistem e se acumulam nas questões modernas de concurso.
...
1. Dominar a Coesão Lexical Anafórica:

1. Decodificar Pegadinhas Específicas de Bancas:
