...
│
└── 5. INTERAÇÕES SISTÊMICAS E REESCRITA
 ├── Proibição Absoluta: VTD + Conjunção Integrante ("que" = "isso") não admite vírgula nem dois-pontos
 ├── Supressão de Travessões: Não pode ser "pura"; exige reposição de vírgulas de isolamento
 └── Colocação Pronominal: Troca de "e" por ";" cria limite oracional e veda próclise no início da nova oração
```
...
8. **Travessão Duplo:** Inserção de Informação = Fato objetivo; Inserção de Comentário = Opinião/julgamento .
9. **Dois-Pontos:** Antecedidos por *verbum dicendi* $\rightarrow$ introduzem fala; antecedidos por nome/ideia geral $\rightarrow$ introduzem explicação .
10. **Exemplo vs. Enumeração vs. Explicação:**

11. **Dois-Pontos $\rightarrow$ Travessão Simples:** Válido em fim de período (`:....` $\rightarrow$ `—....`) .
12. **Ponto e Vírgula:** Usado exclusivamente em enumerações com vírgulas internas e orações coordenadas; **nunca decorre de intercalação** .
13. **"Agora" Adversativo:** Quando equivale a *mas/porém*, encabeça oração coordenada e aceita ponto e vírgula antecedente .
14. **Segmentação por Ponto Final:** Exige que a nova oração possua verbo e sentido autônomo completo .
15. **Ponto e Vírgula e Próclise:** A troca de "e" por ";" cria início de nova oração, vedando a próclise e exigindo ênclise .
...
### Quadro Comparativo de Sinais e Funções Textuais
...
| **Dois-Pontos** | Anuncia fala direta, enumeração ou explicação. | Após*verbum dicendi* (fala); após termo geral (explicação). | Confundir enumeração (fechada por "e") com exemplificação (rol aberto). |
