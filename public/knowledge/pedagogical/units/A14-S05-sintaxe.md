...
- conjunções). Seu verbo vem numa forma nominal
- d) Condicionais
- d) Predicativas
- Diferenças
...
- O termo preposicionado tem sentido agente
- O termo preposicionado tem sentido paciente, de alvo
- Objeto Direto
- Objeto Indireto
- Oculto/Desinencial
- OD Pleonástico
...
- **Fogo! Socorro!** — Frase é o enunciado que tem sentido completo, mesmo sem verbo.
- **Choveu ontem**
- **Anoiteceu.**
...
- **Está quente aqui.**
- **Deve haver mil pessoas aqui.**
- **Fulana é bonita (VL)**
- **Ele tornou-se chefe (VL)**
- **João saiu contente (VI)**
- **Ele morreu por amor. (adjunto adverbial de motivo)**
- **Ele morreu assim que chegou. (oração adverbial de tempo)**
...
- **Uma boa alimentação é necessária ao bom desenvolvimento. ("ao bom desenvolvimento" complementa o adjetivo "necessária")**
- **A Prefeitura iniciou a construção de sua nova sede. ("de sua nova sede" complementa o substantivo "construção")**
- **Ele tinha a necessidade de chamar a atenção. ("de chamar a atenção" é um complemento nominal oracional de "necessidade")**
- **1Espero 2que os alunos sejam aprovados e 3que sejam nomeados logo.**
- **Acordei atrasado para o trabalho. (sentido completo)**
- **Saí. (sentido completo)**
- **Sem tomar café. (sentido incompleto)**
- **Cheguei ao trabalho no horário. (sentido completo)**
- **Apesar de ter esse contratempo... (sem sentido; fragmento; falta algo...)**
- **Estudei pouco, por conseguinte não passei.**
- **Estude muito, porque não vai vir fácil a prova.**
- **Comprei não só frutas como legumes.**
- **Estudei pouco, não obstante passei no concurso.**
- **Ou você mergulha no projeto ou desiste de vez. Seja por bem, seja por mal.**
- **Ex. Meu amigo que trabalha no TRT me ligou. (restringiu: há vários amigos, um deles é do TRT).**
