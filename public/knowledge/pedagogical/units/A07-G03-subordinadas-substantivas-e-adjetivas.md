...
**Método central:** Orações substantivas ocupam posições de Su, C ou outras funções; adjetivas ligam-se a um nome. O mapa torna visível o encaixe de cada subordinada.
...
- Transitividade Verbal e Regência: Domínio das distinções entre VTD, VTI, VTDI e Verbos de Ligação (VL), bem como regência nominal de substantivos abstratos.
...
- ➔ SUBSTANTIVAS ADJETIVAS ADVERBIAIS (Equivalem a "ISSO") (Iniciadas por Relativo) (6 Cs + FTP)
➔ Subjetiva (Sujeito) ➔ Função Externa: SEMPRE Adjunto Adnominal ➔ Obj. Direta (OD)
- ➔ Obj. Indireta (OI) ➔ Classificação Semântico-Pontual:
Prep. FACULTATIVA
- Restritiva (sem vírgula / particulariza) ➔ Compl. Nominal (CN)
Explicativa (com vírgulas / generaliza)
- Prep. OBRIGATÓRIA
➔ Predicativa (Predicativo) ➔ Sintaxe Interna do Pronome Relativo: ➔ Apositiva (Aposto) Método dos 3 Passos (Isolar->Substituir->Ordem Direta) Pontuação assinalada Independência da OP (Evitar "Recaída Sintática") "Onde" = Sempre Adjunto Adverbial de Lugar
...
1. Substantivas: Exercem funções sintáticas típicas de um substantivo (sujeito, objeto direto, objeto indireto, complemento nominal, predicativo ou aposto). Podem ser integralmente substituídas pelo pronome demonstrativo neutro ISSO.
...
- Contraexemplo: "O homem [que trabalha]..." $\rightarrow$ "O homem [isso]..." (Sentido truncado $\rightarrow$ Não é substantiva; trata-se de adjetiva: "o homem [o qual] trabalha").
...
1. Verbos Unipessoais na 3ª pessoa do singular: Verbos como urgir, convir, cumprir, importar, parecer, acontecer, seguidos de conectivo integrante ou infinitivo ("Urge que você chegue" $\rightarrow$ "Isso urge").
...
3. Substitui-se a oração por ISSO e monta-se a ordem direta: $\text{ISSO (Sujeito)} + \text{Verbo} + \text{Complemento / Predicativo}$.
...
$$
\text{"Necessito de que me ajudem"} \iff \text{"Necessito que me ajudem"}
$$
...
1. Oração Subjetiva: $\text{Verbo de Ligação} + \text{Predicativo} + \text{[Oração Substantiva Subjetiva]}$
...
1. Preposição Acidental: Atua como conectivo em locução verbal de obrigação/necessidade com verbo no infinitivo, equivalendo exatamente a de ("Tivemos que reduzir custos" = "Tivemos de reduzir custos").
2. Pronome Interrogativo: Introduz orações interrogativas diretas ou indiretas ("O que é a felicidade?").
...
- A palavra que atua rigorosamente como pronome relativo (= o qual), introduzindo oração adjetiva que qualifica o pronome demonstrativo antecedente ("plantamos aquilo [o qual] colhemos").
...
| --- | --- | --- |
| Semântica | Delimita, particulariza ou restringe o universo do antecedente a um subconjunto. | Generaliza, universaliza ou acrescenta uma qualidade adicional/acessória a todos os elementos. |
| Pontuação | SEM pontuação de isolamento (sem vírgulas). | OBRIGATORIAMENTE isolada por vírgulas, travessões ou parênteses. |
...
- que / o qual (e flexões): Relativo universal para pessoas ou coisas.
- quem: Empregado exclusivamente para pessoas ou seres personificados, sempre preposicionado quando atua como objeto ("o adulto com quem convivem").
- cujo / cuja / cujos / cujas: Expressa relação de posse entre o antecedente e o termo consequente; concorda em gênero e número com a coisa possuída e nunca admite artigo subsequente ("A menina cuja mãe é professora").
- onde: Empregado unicamente para indicar lugar físico/espacial concreto.
- quanto / quanta (e flexões): Empregado após pronomes indefinidos (tudo, tanto, todos).
- como / quando: Podem atuar como pronomes relativos quando retomam substantivos de valor modal (a maneira como...) ou temporal (o dia quando...).
...
- Não existe correspondência necessária entre as duas funções. Buscar a função do relativo analisando o verbo da oração principal constitui o erro metodológico denominado "recaída sintática".

- Procedimento validador:
...
- Oração Subordinada Substantiva: Oração que equivale a um substantivo e aceita substituição integral por ISSO .
- Sujeito Oracional (Subjetiva): Ocorre com verbos na 3ª pessoa do singular (unipessoais, voz passiva ou VL + predicativo) em que a oração subordinada atua como sujeito .
- Regra da Preposição no Objeto Indireto Oracional: Preposição estritamente facultativa antes de conjunção integrante em verbos transitivos indiretos .
- Regra da Preposição na Completiva Nominal: Preposição estritamente obrigatória na complementação de substantivos, adjetivos ou advérbios .
- Oração Completiva (Sentido Amplo): Categoria de bancas examinadoras que abrange completivas verbais (OD/OI) e completivas nominais .
- Função Sintática Externa das Adjetivas: Toda oração subordinada adjetiva (restritiva ou explicativa) exerce a função sintática de Adjunto Adnominal .
- Oração Adjetiva Restritiva: Sem pontuação de isolamento; restringe e particulariza o universo do antecedente .
- Oração Adjetiva Explicativa: Isolada por vírgulas, travessões ou parênteses; generaliza e fornece dado acessório .
- Função Sintática do "Onde": Quando retoma lugar físico, atua invariavelmente como Adjunto Adverbial de Lugar .
- Regra de Blindagem da Recaída Sintática: A função sintática do pronome relativo pertence à oração adjetiva; a função do antecedente pertence à oração principal .
...
1. Identifique a função sintática de ISSO perante a oração principal para classificar a substantiva (Sujeito $\rightarrow$ Subjetiva; Objeto Direto $\rightarrow$ Objetiva Direta; etc.).
...
3. Passe a primeira barra divisória (|) antes do pronome relativo.
...
1. ISOLAR A ORAÇÃO ADJETIVA] Inserir barra  antes do pronome relativo e no fim da oração adjetiva. Realçar com marca-texto (bloquear visualmente a Oração Principal). [
2. SUBSTITUIR PELO ANTECEDENTE] Localizar o núcleo nominal antecedente na OP. Reescrever a oração adjetiva inserindo o substantivo no lugar do pronome relativo. [
3. ORDEM DIRETA (S - V - C) E ANÁLISE] Organizar: Sujeito + Verbo + Complemento / Adjunto. Fazer a análise sintática do substantivo perante o verbo da oração adjetiva. A função obtida É A FUNÇÃO SINTÁTICA DO PRONOME RELATIVO.
...
| Critério | Oração Subordinada Substantiva Apositiva | Oração Subordinada Adjetiva Explicativa |
| --- | --- | --- |
| Natureza Morfológica | Valor de Substantivo. | Valor de Adjetivo. |
| Conectivo Introdutor | Conjunção Integrante (que, se). | Pronome Relativo (que, o qual, quem, cujo). |
| Teste de Substituição | Troca por"ISSO" ("Desejo isto: [isso]"). | Troca por"O QUAL / A QUAL" ("..., a qual é..."). |
...
| --- | --- | --- |
| Elemento Regente | VERBO Transitivo Indireto (VTI). | NOME (Substantivo abstrato / Adjetivo). |
...
| --- | --- | --- |
| Localização Estrutural | Pertence àOração Principal (OP). | Pertence àOração Subordinada Adjetiva. |
| Verbo Determinante | Vinculado ao verbo da Oração Principal. | Vinculado ao verbo da Oração Adjetiva. |
| Independência | Exemplo:"As roupas (Sujeito) já estavam passadas". | Exemplo:"[que (Objeto Direto)] ia vestir". |
...
1. ( 6 ) Reafirmo meu desejo: que todos tenham boa sorte. $\rightarrow$ Explica o substantivo desejo: após dois-pontos = Apositiva.
2. ( 3 ) Lembrou-se de que a reunião fora adiada. $\rightarrow$ Completa o VTI lembrou-se = Objetiva Indireta.
3. ( 1 ) É indispensável que todos entendam o problema. $\rightarrow$ Ordem direta: "Isso é indispensável" (VL + Predicativo) = Subjetiva.
4. ( 4 ) Tenho a impressão de que mentiste para mim. $\rightarrow$ Completa o substantivo impressão = Completiva Nominal.
5. ( 2 ) O pai esperava que o filho reagisse. $\rightarrow$ Completa o VTD esperava ("esperava isso") = Objetiva Direta.
6. ( 5 ) O desejo da família era que se formasse logo. $\rightarrow$ Sujeito expresso (O desejo) + VL (era) = Predicativa.
7. ( 1 ) Parece que a decisão foi justa. $\rightarrow$ Verbo unipessoal inicial; ordem direta: "Isso parece" = Subjetiva.
8. ( 2 ) Peço a todos que não se atrasem. $\rightarrow$ Verbo bitransitivo (pedir algo a alguém): a todos = OI; que não se atrasem = Objetiva Direta.
...
- Resolução: A locução pode decidir é transitiva direta ("decidir [isso]"). A oração introduzida por se funciona como objeto direto oracional (completiva verbal). Como a banca Cebraspe emprega "oração completiva" em sentido amplo para abranger complementos verbais e nominais, o item é verdadeiro.
- Gabarito: CERTO.
...
- Q3 (VUNESP 2018 / Pref. Buritizal): "Quase não havia cabelos brancos entre os poucos [que sobreviviam]" $\rightarrow$ poucos os quais $\rightarrow$ Pronome Relativo retomando pronome substantivo indefinido poucos (Gabarito: C).
- Q4 (FCC 2019 / Pref. São José do Rio Preto): "Os adolescentes [que namoram]..." $\rightarrow$ adolescentes os quais $\rightarrow$ Pronome Relativo (Gabarito: A). (Nota: C = tanto... que consecutiva; D = contanto que condicional; E = Que realce).
- Q5 (FCC 2018 / SEGEP-MA): "...tentando evitar [que os brancos as caçassem]" $\rightarrow$ evitar [isso] $\rightarrow$ Conjunção Integrante (Gabarito: D).
- Q6 (INSTITUTO AOCP 2020 / Pref. Cariacica): "Lembrei-me das cólicas [que minha cadela nunca teve]" $\rightarrow$ cólicas as quais $\rightarrow$ Pronome Relativo anafórico (Gabarito: A).
- Q7 (FGV / CODEBA): Busca por sequência de Pronome Relativo + Conjunção Integrante: "O otimista é um cara [que (1)] acredita [que (2)] o que está para acontecer..." $\rightarrow$ (1) cara o qual = Pronome Relativo; (2) acredita [isso] = Conjunção Integrante (Gabarito: E).
...
- Q10 (INSTITUTO AOCP 2020 / Pref. Novo Hamburgo): "[...] uma comunidade [em que as pessoas se sentem agradecidas]..." $\rightarrow$ Sem vírgulas = Adjetiva Restritiva (Gabarito: B).
- Q11 (INSTITUTO AOCP 2019 / Pref. Vitória): "...programa 'Hospital Beds', [que construiu canteiros]..." $\rightarrow$ Com vírgula = Adjetiva Explicativa (Gabarito: D).
- Q12 (INSTITUTO AOCP / Pref. Juiz de Fora): "...uma série de informações [que antes não tinha]" $\rightarrow$ Sem vírgulas = Adjetiva Restritiva (Gabarito: C).
- Q13 (INSTITUTO AOCP / Pref. Paranavaí): "A primeira coisa [que chamou minha atenção]..." $\rightarrow$ Adjetiva Restritiva com função de Adjunto Adnominal (Gabarito: D).
- Q14 (INSTITUTO AOCP 2019 / SEECT-PB): "[...] um adulto [com quem mantenham uma relação]..." $\rightarrow$ Relativo quem preposicionado, sem vírgulas = Adjetiva Restritiva (Gabarito: C).
- Q15 (INSTITUTO EXCELÊNCIA 2018 / Pref. São Luís do Paraitinga): "A menina, [cuja mãe é professora], passou..." $\rightarrow$ Relativo cuja entre vírgulas = Adjetiva Explicativa (Gabarito: B).
- Q16 (INSTITUTO AOCP 2019 / UFRB): "Mariana — [cuja barragem pertencia à Samarco] — deveria ter servido..." $\rightarrow$ Relativo cuja isolado por travessões = Adjetiva Explicativa (Gabarito: C).
...
1. Frase 2: "Aquele era o lugar onde as pessoas tomavam chá."
...
1. Frase 3: "As roupas que ia vestir já estavam passadas."
...
Ao concluir o estudo consolidado deste grupo temático (esta unidade — conteúdo integrado), o estudante atinge o domínio pleno de dois dos eixos centrais da sintaxe do período composto:

1. Orações Subordinadas Substantivas: Compreensão de que a oração substantiva equivale funcionalmente a um substantivo e é identificável pelo teste da troca por ISSO. Domínio das 6 funções sintáticas (Subjetiva, Objetiva Direta, Objetiva Indireta, Completiva Nominal, Predicativa e Apositiva), com segurança para aplicar a regra da preposição facultativa exclusiva no objeto indireto oracional e para interpretar o termo amplo "oração completiva" em bancas como Cebraspe.
2. Morfossintaxe da Palavra "QUE": Capacidade de executar a triagem conectiva imediata da palavra que, distinguindo com precisão o pronome relativo da conjunção integrante, da partícula/expressão de realce (testável por supressão), das locuções conjuntivas adverbiais e da preposição acidental (ter que = ter de).
3. Orações Subordinadas Adjetivas: Compreensão de que toda oração adjetiva atua sintaticamente como adjunto adnominal do antecedente. Domínio da distinção semântica e pontual entre restritivas (sem vírgulas, delimitam subconjuntos essenciais) e explicativas (com vírgulas/travessões/parênteses, generalizam e acrescentam dados acessórios), dominando a técnica de corte em orações intercaladas.
4. Sintaxe Interna do Pronome Relativo: Aplicação mecânica e segura do Método dos Três Passos (Isolar $\rightarrow$ Substituir pelo antecedente $\rightarrow$ Ordem direta S-V-C e análise) para encontrar a função sintática de qualquer relativo (sujeito, objeto direto, objeto indireto, adjunto adverbial, etc.), mantendo-se imune ao erro da "recaída sintática" e utilizando o atalho semântico-sintático do pronome onde (sempre Adjunto Adverbial de Lugar).
