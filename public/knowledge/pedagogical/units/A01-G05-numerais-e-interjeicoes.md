...
[ AULA 01 — MORFOLOGIA: NUMERAIS E INTERJEIÇÕES ]
 ...
 │
 └── 2. CLASSE DAS INTERJEIÇÕES (Invariáveis & Sem Função Sintática)
 ...
 │
 └── 2.3 Padrões de Questões em Concursos
 ├── Modelo I: Identificação Morfológica & Derivação Imprópria
 ...
 │
 └── Modelo II: Valor Semântico Contextual (Análise da Sequência Textual)
 ├── Realce / Enfatização (ex.: "Ah, que minha história...")
 ├── Chamamento / Função Apelativa (ex.: "Ei! Vamos embora!" -> "Ei!" = chamamento)
 ├── Desejo / Esperança (ex.: "Oxalá" = "Tomara que")
 ├── Surpresa / Espanto (ex.: "Puxa! Não esperava você aqui!")
 └── Alerta (ex.: "Cuidado com o carro!")
```
...
### Quadro Resumo de Regras Canônicas
...
| **Segundo (Conformativo)** | Preposição Acidental / Conjunção Conformativa | Equivale a*de acordo com* ou *conforme*; introduz conformidade. |
...
### Tabela Comparativa de Fronteiras Gramaticais Críticas
...
Ao concluir o grupo temático `esta unidade`, o estudante deve dominar as seguintes competências práticas e teóricas:
