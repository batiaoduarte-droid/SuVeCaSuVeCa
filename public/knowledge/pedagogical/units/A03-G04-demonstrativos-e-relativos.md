...
**Conexão forte:** Demonstrativos exigem rastreamento contextual, e relativos exigem reconstruir a lacuna na oração subordinada; o mapa liga referente e função sem confundi-los.
...
- Classes Gramaticais Básicas: Noção clara sobre substantivos, adjetivos, verbos, advérbios e numerais.
...
- ➔ PRONOMES DEMONSTRATIVOS PRONOMES RELATIVOS (este/isto, esse/isso, aquele/aquilo) (que, quem, cujo, onde, o qual, etc.)
➔ ➔ ESPAÇO TEMPO TEXTO RECONHECIMENTO ANTECEDENTE DISTINÇÕES DE (Dêixis)(Dêixis) (Endofórica) (2 Passos) (Natureza Subst.) "QUE"
- 1ª P. Presente/ Anáfora (esse/isso) Retoma Substantivo C. Integrante
(Este)
- Fut. Próx. (Este) Catáfora (este/isto)
Subst. Pron. Subst.
- ("ISSO")
Passado 2 Antecedentes: Troca

Recente (Esse)
- Este (próximo) / Aquele (distante) por Numeral Subst. Prep. Acidental
(Esse) Pass./Fut. 3+ Antecedentes: "o qual"
- ("milhões") Consecutiva
Distante (Aquele) Este (último) / Aquele (1º) / Ordinais (meio) Cujo: Posposto (Concord.) ("tanto... que") 3ª P. vs Antecedente (Ref.) (Aquele)
...
1. No Espaço: Regula a posição física dos seres/objetos em relação aos interlocutores da comunicação (1ª, 2ª ou 3ª pessoa).
...
- Exemplo no Tempo: "Este mês é o meu preferido" (o pronome aponta diretamente para o mês presente em que se enuncia a frase = Tempo / Presente).

- Subdivide-se em:  (Espaço),  (Tempo) e  (Texto).
...
1. ISTO / ESTE(S) / ESTA(S): Próximo do falante/emissor (1ª pessoa). Correlaciona-se com os advérbios aqui e cá.
...
- Para referir-se ao próprio documento ou à unidade em que o redator atua: usar ESTE ("Encaminho este e-mail para solicitar...", "Nesta seção...").
- Para referir-se a processos ou elementos em posse do órgão destinatário: usar ESSE ("Solicitamos o envio desse processo que tramita em sua vara...").

- Macetes associados:  (Advérbios correlatos).
...
1. Dois antecedentes explícitos no texto:
...
1. Três ou mais antecedentes explícitos (Proibição do "Esse" intermediário):
...
1. O Cisma Gramatical: Prova Objetiva vs Redação Discursiva:
...
- Desafio 1 (Reconhecimento da Classe): Saber identificar se a palavra (em especial o vocábulo que) é um pronome relativo, diferenciando-a de outras classes homônimas.
- Desafio 2 (Localização do Antecedente): Saber determinar o termo exato de natureza substantiva retomado pelo pronome no período anterior.
- Desafio 3 (Emprego dos Relativos Específicos): Dominar as exigências semântico-sintáticas de cada pronome relativo (que, quem, cujo, onde, o qual, quanto, como).
- Desafio 4 (Regência com Pronome Relativo): Identificar a necessidade de preposição antecedendo o relativo em função da regência exigida pelo verbo ou nome da oração subordinada.
...
- "...corre em meu sangue um veneno... veneno que tem teu nome." $\rightarrow$ que retoma veneno (= o qual tem teu nome).
...
3. Expressão Expletiva ou de Realce (é que): Empregada para ênfase estilística; pode ser retirada da oração sem qualquer prejuízo sintático ou semântico ("Quando é que você vai?" $\rightarrow$ "Quando você vai?").
4. Preposição Acidental: Ocorre em locuções verbais com verbos auxiliares (como ter e haver), equivalendo à preposição "de" ("Tivemos que reduzir custos" $\rightarrow$ "Tivemos de reduzir custos").
5. Conjunção Subordinativa Adverbial Consecutiva: Aparece acoplada a vocábulos intensificadores antecedentes (tanto, tão, tal, tamanho), introduzindo uma oração de consequência e não exercendo papel anafórico ("Insistiu tanto com Teresa que ela se afastou").

- Possui macete em:  (Macete "ISSO" x "O QUAL").
...
1. Substantivo: Nome pleno do ser ("o livro que li").
2. Pronome Substantivo: Pronome que substitui o substantivo, ocupando de forma autônoma o núcleo da oração ("aquilo que comprei"). Diferencia-se do Pronome Adjetivo, que apenas acompanha um substantivo existente ("meus amigos").
3. Numeral Substantivo: Numeral que substitui o substantivo, atuando como cabeça do sintagma ("os dois que chegaram"). Diferencia-se do Numeral Adjetivo, que quantifica um substantivo contíguo ("dois alunos chegaram").

Em estruturas onde o vocábulo que vem precedido imediatamente por o, a, os, as (ou contrações do, da, dos, das, ao, aos):

1. É ótimo o livro que você comprou. -> "que" retoma o SUBSTANTIVO "livro"
2. É ótimo aquilo que você comprou. -> "que" retoma o PRONOME SUBSTANTIVO "aquilo"
3. É ótimo o que você comprou. -> "que" retoma o PRONOME DEMONSTRATIVO "o" (= aquilo)
4. Gostei do que você comprou. -> "que" retoma o PRONOME "o" dentro de "do" (= daquilo)

- Possui macete em:  (Teste da troca por aquilo/aqueles).
...
- Concordância Morfossintática: Flexiona-se em gênero e número com o substantivo posposto (a coisa possuída).
- Referência Anafórica (Antecedente): Retoma e substitui o substantivo antecedente (o possuidor).

[ Termo ANTECEDENTE (Possuidor) ]  [ Termo POSPOSTO (Possuído) ] Ex.: "Programa" "cuja" "base"
...
| Fenômeno Gramatical | Regra Canônica / Estrutura |
| --- | --- |
| Pergunta Tripla | Antes de escolher o demonstrativo, identificar se o plano éEspaço, Tempo ou Texto. |
| Demonstrativo no Espaço | Este = 1ª P. (aqui); Esse = 2ª P. (aí); Aquele = 3ª P. (lá). |
| Demonstrativo no Tempo | Este = presente / futuro próximo (um dia destes); Esse = passado recente (um dia desses); Aquele = tempo remoto. |
| Demonstrativo no Texto | Esse = anáfora (termo único / redação); Este = catáfora; 2 antecedentes = este (próximo) e aquele (distante); 3 antecedentes = ordinais no meio. |
| Reconhecimento do Relativo | Retoma antecedente de natureza substantiva + troca-se poro qual, a qual, os quais, as quais. |
| Relativo vs Conjunção Integrante | Relativo = troca por o qual; Conjunção Integrante = troca a oração por ISSO. |
| Elemento de Natureza Substantiva | Compreende Substantivo, Pronome Substantivo (aquilo, o/os) e Numeral Substantivo (milhões, os dois). |
| Estruturas "o que" / "dos que" | o/os = pronome demonstrativo substantivo (antecedente); que = pronome relativo. |
| Paralelismo Sintático ("e que...") | Relativos coordenados pela conjunçãoe compartilham obrigatoriamente o mesmo antecedente. |
| Pronome "Cujo/Cuja" | Concorda com o substantivoposposto (possuído), mas retoma o antecedente (possuidor). |
| Regra da Seta de Referência | Mudança de seta = Mudança de sentido. Trocar o referente anafórico altera o sentido original. |
...
1. Passo 3 — Validação de Flexão e Contração: Ajuste gênero/número e realize contrações prepositivas (de + este = deste; em + esse = nesse; de + aquele = daquele).
...
3. Teste de Substituição Canônica: Troque o que por o qual / a qual / os quais / as quais. Se o período mantiver a correção e o sentido, o pronome relativo está confirmado.
...
3. Interrogação do Verbo Adjetivo: Pergunte ao verbo da oração adjetiva: Quem ou o que pratica/sofre a ação expressa por este verbo no contexto do texto?
4. Análise de Concordância Sintática: Verifique a flexão de número do verbo posterior (ex.: verbo no plural estouraram ou chegaram elimina candidatos no singular).
5. Encaixe e Confirmação: Substitua o antecedente eleito no lugar do pronome relativo e confirme a coerência textual.
...
| Pronomes | No Espaço (Dêixis) | No Tempo (Dêixis) | No Texto (Endofórica) |
| --- | --- | --- | --- |
| Isto / Este(s) / Esta(s) | Perto do emissor/falante (1ª P. /aqui). | Presente ou futuro próximo (um dia destes). | Catáfora (virá adiante) / Antecedente mais próximo (em listas de 2). |
...
| --- | --- | --- | --- |
| Pronome Relativo | Retoma antecedente substantivo; introduz oração adjetiva. | Substituir poro qual / a qual. | "A própria terra que piso..." |
| Conjunção Integrante | Conecta oração substantiva sem valor anafórico. | Substituir a oração porISSO. | "Eu vi que a senhora tem uma sapucaia." |
| Expressão de Realce | Dá ênfase enfática/estilística (é que). | Eliminar da oração sem prejuízo. | "Quando é que vou poder colher?" |
| Preposição Acidental | Liga verbos em locuções modais/aspectuais. | Substituir pela preposiçãode. | "Tivemos que reduzir custos." |
| Conjunção Consecutiva | Introduz consequência ligada a intensificador. | Par correlativo comtanto/tão/tal. | "Insistiu tanto com Teresa que ela se afastou." |

| Classe Gramatical | Modalidade Adjetiva (Acompanha o Nome) | Modalidade Substantiva (Substitui o Nome / Núcleo) |
| --- | --- | --- |
| Pronomes | Pronome Adjetivo: Determina um substantivo explícito.Ex.: "Meus amigos chegaram." | Pronome Substantivo: Substitui o substantivo sozinho.Ex.: "Eles chegaram." / "O que comprei" (o = aquilo). |
| Numerais | Numeral Adjetivo: Quantifica um substantivo contíguo.Ex.: "Dois alunos chegaram." | Numeral Substantivo: Assume o papel de núcleo substantivo.Ex.: "Os dois chegaram." / "120 milhões de reais". |

---

## Exemplos comentados

1. livro que estás lendo é infantil? $\rightarrow$ Esse (Espaço: nas mãos do ouvinte / 2ª pessoa).
2. Não.  livro que estou lendo é sobre política. $\rightarrow$ Este (Espaço: nas mãos do falante / 1ª pessoa).
3. Guilherme, traga-me  CD que ficou lá no seu quarto. $\rightarrow$ aquele (Espaço: distante de ambos / advérbio lá).
4. Um dia  visitarei o seu pai. $\rightarrow$ destes (Tempo: futuro do presente visitarei $\rightarrow$ futuro próximo).
5. Guilherme, dê-me  CD que está aí. $\rightarrow$ esse (Espaço: perto do ouvinte / advérbio aí).
6. Luísa,  é o Eduardo? $\rightarrow$ esse / aquele (Espaço: descontextualizado; se perto de Luísa = esse, se longe de ambos = aquele).
7. ano que passou foi muito proveitoso para mim. $\rightarrow$ Esse (Tempo: pretérito recente passou).
8. mês que passou choveu muito. Para  mês que começa, porém, a previsão é de tempo bom. $\rightarrow$ Nesse / este (Tempo: passado recente vs futuro próximo).
9. aqui são meus primos. $\rightarrow$ Estes (Espaço: proximidade do falante / advérbio aqui).
10. O que foi combinado aqui não pode sair d sala. $\rightarrow$ desta (Espaço: sala do falante / advérbio aqui).
11. "Qual é a relação entre dialética e retórica? A  pergunta Aristóteles responde..." $\rightarrow$ essa (Texto: anáfora / resgate de pergunta anterior).
12. é a pergunta que Aristóteles responde desde a primeira frase: qual é a relação...? $\rightarrow$ Esta (Texto: catáfora / anúncio prévio).
13. Ao comparar os diversos rios do mundo com o Amazonas, defendia a proeminência d sobre cada um d. $\rightarrow$ deste / daqueles (Texto: 2 antecedentes $\rightarrow$ deste retoma Amazonas [mais próximo]; daqueles retoma rios [mais distante]).
14. Atentem para : o que se guarda no coração jamais se esquece. $\rightarrow$ isto (Texto: catáfora antecipatória).
15. Homens e mulheres participaram das festividades. , simpáticas e elegantes. , sérios e tímidos. $\rightarrow$ Estas / Aqueles (Texto: 2 antecedentes $\rightarrow$ Estas = mulheres [próximo]; Aqueles = Homens [distante]).
...
- Questão 10 (CESPE - TJ-DFT): "...Programa [...] Viver Direito, cuja base é a Agenda..." $\rightarrow$ A banca afirmou que o antecedente de cuja era base. "Base" é o termo posposto com o qual concorda; o antecedente é Programa. Gabarito: ERRADO.
- Questão 11 (CESPE - TCE-PA): "...governos estaduais cujas despesas [...] já alcançaram nível preocupante ou que estouraram o limite de gastos..." $\rightarrow$ Quem estourou o limite de gastos foram os governos estaduais, não as despesas. Gabarito: ERRADO.
- Questão 12 (CESPE - FUB): "...Programa de Avaliação Seriada (PAS), criado como alternativa ao vestibular, em que candidatos são avaliados..." $\rightarrow$ A oração adjetiva descreve a avaliação no Programa (PAS), e não no vestibular (que está em oração intercalada). Gabarito: ERRADO.
- Questão 13 (CESPE - MPE-CE): "...objetos sobre os quais informava..." e "...mudança da situação sobre a qual se informava..." $\rightarrow$ os quais retoma objetos (não portadores físicos); a qual retoma mudança (não situação). Gabarito: ERRADO.
- Questão 14 (Quadrix - CRN-9): "...evidencia assimetrias importantes, quando comparado ao trabalho masculino, as quais reservam..." $\rightarrow$ Proposta de trocar as quais por o qual alegando que manteria os sentidos originais. A troca altera o referente de assimetrias para trabalho masculino, mudando o sentido ("Mudança de seta = Mudança de sentido"). Gabarito: ERRADO.
...
- ESTE / ISTO $\longleftrightarrow$ AQUI / CÁ (1ª pessoa)
...
Ao concluir o estudo deste grupo temático consolidado, o estudante deve ter internalizado com segurança:

1. O Domínio Operacional dos Demonstrativos: Aplicar automaticamente o teste "Espaço, Tempo ou Texto?" antes de qualquer resolução. Saber usar este para proximidade do falante, presente e futuro próximo (um dia destes); esse para proximidade do ouvinte, passado recente (um dia desses) e anáfora textual; e aquele para distanciamento físico, tempo remoto e o termo mais antigo em listas comparativas.
2. A Segurança em Redação Discursiva: Não cometer o vício de usar este/isto para retomar termos únicos na redação, dominando os conectivos anafóricos de norma culta (diante disso, isso posto). Compreender a diferença pragmática do Cebraspe em provas objetivas versus discursivas.
3. A Resolução de Listas Múltiplas: Saber que para 2 termos usa-se este (próximo) e aquele (distante); para 3 termos usa-se este (último), aquele (primeiro) e numerais ordinais para os do meio — banindo o esse isolado dessa função.
4. O Reconhecimento Instantâneo de Pronomes Relativos: Testar a substituição por o qual / a qual e diferenciar imediatamente o pronome relativo da conjunção integrante (troca por "ISSO"), das expressões de realce (é que), das preposições acidentais (ter que = ter de) e das conjunções consecutivas (tanto... que).
5. A Identificação de Antecedentes Complexos: Reconhecer elementos de natureza substantiva mesmo quando não forem substantivos óbvios, especialmente a estrutura demonstrativa o que (= aquilo o qual) e o numeral substantivo núcleo (milhões).
6. A Bússola da Leitura Posterior do Verbo: Desarmar pegadinhas de bancas com múltiplos substantivos anteriores ou termos intercalados lendo o predicado da oração subordinada adjetiva posterior para checar o agente e a concordância.
7. A Mecânica de Cujo/Cuja e o Princípio Semântico: Saber que cujo/cuja concorda com o termo posposto e retoma o antecedente; e que qualquer alteração de flexão pronominal que desloque o referente anafórico resulta obrigatoriamente em alteração de sentido original ("Mudança de seta = Mudança de sentido").
