...
**Apoio estrutural:** Na exposição e argumentação, a SuVeCA esclarece proposições e conectores; tese, argumentos, modalização e estratégia discursiva pertencem à camada textual.
...
- Compreensão básica de estrutura oracional e classes de palavras (adjetivos, verbos modais e conectivos).
...
(Acontecimentos no tempo) (Atributos e estados) (Discussão de um assunto)
 │
 ┌──────────────────────────────────────────────────┴───────────────────────┐
 ▼ ▼
 DISSERTAÇÃO EXPOSITIVA / INFORMATIVA DISSERTAÇÃO ARGUMENTATIVA
 ├─ Intenção: Transmitir / explicar saberes ├─ Intenção: Persuadir / convencer o leitor
 ├─ Objeto: Conceitos, teorias, fatos da ciência ├─ Objeto: Tese controversa / tomada de posição
 ├─ Relação com Dados: Dado é o próprio conteúdo ├─ Relação com Dados: Dado fundamenta a tese
 ├─ Tolerância a Modalizadores: Pontuais (não alteram tipo) ├─ Recursos: Argumentos lógicos, refutações
 ├─ Fatos Normativos: Trata ideais legais como fatos da ordem └─ Fecho Textual: Arremate conclusivo persuasivo
...
- Exposição de conceitos abstratos, relações de causa/efeito ou defesa de teses sobre um tema -> **Dissertação**.
...
> *"O que o autor veio fazer neste texto? Qual é o objetivo primordial dele: expor o que sabe sobre determinado assunto ou convencer-me da sua própria opinião?"*

A análise deve identificar se os recursos linguísticos (exemplos, dados, citações, explicações) estão estruturados como **fim informativo em si mesmos** ou como **meio probatório a serviço de uma tese**.
...
3. **Desconstrução de Pegadinhas:** Bancas exploram a memorização mecânica de candidatos desatentos. Na redação discursiva e nos textos de concurso, citar dados é técnica fundamental de fundamentação argumentativa.
...
- **Critério Decisório:** Deve-se avaliar a **predominância da função comunicativa**. Um professor ou cientista pode avaliar determinado fenômeno histórico como "importante", "complexo" ou "relevante" dentro de uma dissertação estritamente expositiva, sem que isso configure a defesa de uma tese polêmica pessoal.
...
| ID da Unidade | Conceito / Regra | Formulação Canônica Consolidada | Classificação / Tipo |
|:----------------- |:----------------------------- |:--------------------------------------------------------------------------------------------------------------------------------- |:--------------------- |
|  | Macro-Tipologias Textuais | Narração (ações no tempo), Descrição (qualificação de estados) e Dissertação (discussão de tema). | `CLASSIFICATION` |
|  | Dissertação Expositiva | Texto que discute um assunto expondo e explicando conhecimentos e fatos consolidados, sem finalidade persuasiva. | `DEFINITION` |
|  | Dissertação Argumentativa | Texto que discute um assunto defendendo uma tese por meio de argumentos logicamente articulados para persuadir o leitor. | `DEFINITION` |
|  | Princípio da Intencionalidade | A classificação tipológica é determinada soberanamente pelo objetivo comunicativo pretendido pelo autor do texto. | `CONCEPT` |
|  | Regra do Uso de Dados | A presença de dados estatísticos não torna o texto expositivo; na argumentação, os dados atuam como sustentação de tese. | `DISTINCTION` |
|  | Regra dos Modalizadores | Modalizadores isolados em textos teóricos expressam avaliação pontual do expositor e não convertem o gênero em argumentativo. | `DISTINCTION` |
|  | Regra do Discurso Doutrinário | Vocabulário axiológico constitucional representa fatos institucionais e conceitos do Direito, caracterizando texto expositivo. | `CONCEPT` |
...
[Início: Texto Dissertativo em Prova]
 ...
 │ └─ Ler título, introdução, conclusão e referência da fonte (livro didático, jornal, doutrina).
 │
 ├─► PASSO 2: Aplicar a Pergunta-Guia de Intencionalidade Autoral
 │ └─ "O autor quer me convencer de sua tese OU veio expor/explicar um conhecimento?"
 │
 ├─► PASSO 3: Rastrear Presença de Tese Explícita vs. Explicação Conceitual
 │ ├─ Há tomada de posição em debate polêmico (ex.: dever, proibição, crítica a correntes)?
 │ │ └─ SIM: Candidato a Argumentativo.
 │ └─ NÃO (apenas definições, histórico, funcionamento teórico): Candidato a Expositivo.
 │
 ├─► PASSO 4: Avaliar Elementos Ambíguos (Dados e Modalizadores)
 │ ├─ Dados estatísticos presentes? -> Verificar se são conteúdo puro (Expositivo) ou suporte probatório (Argumentativo).
 │ └─ Modalizadores presentes? -> Verificar se são avaliação didática pontual (Expositivo) ou defesa de tese (Argumentativo).
 │
 └─► PASSO 5: A Inspeção Decisória do Parágrafo Conclusivo ("O Final Matador")
 ├─ Fecho arremata argumentos com tom persuasivo/conclusivo de tese? -> DISSERTATIVO-ARGUMENTATIVO.
...
### Tabela Comparativa Central: Exposição versus Argumentação

| Critério de Comparação | Dissertação Expositiva / Informativa | Dissertação Argumentativa |
|:------------------------------------------------ |:----------------------------------------------------------------------------------------- |:--------------------------------------------------------------------------- |
| **Intenção Primordial do Autor** | Transmitir conhecimentos, explicar conceitos, instruir sobre um tema. | Persuadir, convencer o interlocutor a aderir a uma opinião/tese. |
| **Elemento Estruturador Central** | Conceito, fenômeno teórico, fato histórico ou doutrinário. | Tese explícita (juízo de valor subjetivo/crítico). |
| **Papel dos Dados Numéricos** | Próprio conteúdo da informação veiculada. | Evidência empírica / argumento de autoridade para sustentar a tese. |
| **Presença de Modalizadores** | Podem ocorrer de forma pontual/didática sem descaracterizar o gênero. | Articulam diretamente a tomada de posição e a pressão persuasiva. |
| **Textos Jurídicos / Constitucionais** | Exposição da lei posta, da doutrina e dos fins institucionais do Estado. | Defesa de corrente jurídica polêmica contraposta a teses adversárias. |
| **Parágrafo Conclusivo ("Final Matador")** | Encerra a cadeia informativa/didática sem juízo de cobrança ideológica. | Arremata a argumentação para selar a vitória retórica e o convencimento. |
| **Exemplos Canônicos das Aulas** | Construção de Brasília , Fiorin , Cavalieri Filho . | Terceira dose de vacina , Foro privilegiado . |
...
- **Ausência de Persuasão:** O enunciador não emite juízo sobre se foi benéfico ou prejudicial erguer a cidade naquele local; relata os fatos objetivamente.
- **Classificação Consolidada:** **Dissertativo-Expositivo**.
...
- **Função dos Dados:** A menção a *"estudos americanos"* e ao percentual de *"90%"* atua como **argumento probatório** para fundamentar a tese, comprovando que textos argumentativos utilizam rotineiramente dados estatísticos.
- **Classificação Consolidada:** **Dissertativo-Argumentativo**.
...
3. **Exame do Fecho:** O parágrafo final encerra definindo conceitos técnicos de dialogismo e enunciação, confirmando o caráter didático-explicativo.
...
3. **Fecho Persuasivo ("Final Matador"):** A conclusão defende que tribunais superiores são mais resistentes a pressões locais do que juízos de primeira instância, consolidando a defesa da tese.
...
3. **Julgamento da Assertiva:** A asserção erra ao rotular o texto doutrinário como argumentativo.

- **Gabarito Oficial da Assertiva:** **ERRADO**.
...
- **Como evitar:** Analisar a subordinação sintático-discursiva do dado: se o dado quantitativo serve para justificar um verbo modal (*"devem tomar"*) ou provar um ponto controverso, ele é argumento de sustentação de um texto **argumentativo**.
...
- **Como evitar:** Verificar se o modalizador sustenta um projeto de convencimento global ou se é mera ênfase explicativa de um professor/doutrinador.
...
- **Como evitar:** Reconhecer que esses termos expressam preceitos positivados na Constituição e na doutrina jurídica consolidada, constituindo **fatos da ordem legal**, o que caracteriza dissertação **expositiva**.
...
### Tipologia Textual (Modos de Organização Discursiva)
...
Ao concluir este grupo temático, o estudante deve ter internalizado as seguintes competências e conhecimentos:

1. **Domínio Taxonômico:** Reconhecer a dissertação como discussão temática e distinguir nitidamente a dissertação expositiva (informar/explicar saberes) da dissertação argumentativa (persuadir/defender tese).
