...
│
└── 5. Tipologia Semântica e Padrões de Bancas
 ├── Substantivas: Teste do "ISSO" → Conjunção Integrante ("que", "se")
 ├── Adjetivas: Seta no antecedente substantivo → Pronome Relativo ("que") | Fato (indicativo) vs. Hipótese
 ...
 │ └── Particípio Imediato: "assim que", "logo que"
 ├── Adverbiais Concessivas: Quebra de expectativa / antítese contextual ("embora", "ainda que")
 ├── Adverbiais Causais: Ordem cronológica (1º fato = causa) / Causa pretérita com efeito no presente
 └── Adverbiais Consecutivas: Verbos de resultado ("gerar", "acarretar") e aposto resumitivo ("o que deve...")
```
...
### Quadro de referências canônicas compactas
...
### Matriz comparativa de estruturas e armadilhas
...
| *"não obstante **apresentar-se**"* | *"embora **seja apresentado**"* (passivação indevida) | *"embora **se apresente**"* (voz ativa pronominal) | O pronome*se* em *apresentar-se* é PIV, não PA; bloqueia conversão para passiva analítica. |
...
| *"**ao estabelecer** normas..."* | Permuta por*"porque estabeleceu"* / *"por estabelecer"* | *"**quando estabeleceu** normas..."* | A construção*ao + infinitivo* possui valor fixo e exclusivo de tempo; não admite permuta causal. |
