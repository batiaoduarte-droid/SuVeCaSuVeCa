...
>
> Compreender e definir os princípios normativos e conceituais de Desenvolvimento das Orações Reduzidas. Aplicar regras canônicas e procedimentos decisórios de Desenvolvimento das Orações Reduzidas na resolução de questões. Analisar o papel de Desenvolvimento das Orações Reduzidas no eixo Método central e reconhecer armadilhas e variações de bancas.
...
**Método central:** Desenvolver uma oração reduzida é explicitar conectivo e forma verbal sem alterar seu encaixe funcional nem as relações com a oração principal.
...
- Morfologia Verbal: Domínio das três formas nominais do verbo (infinitivo em -ar, -er, -ir; gerúndio em -ndo; particípio em -do, -da, -tos, -tas ou formas irregulares) e conjugação nos modos indicativo e subjuntivo.
...
1. Estrutura Desenvolvida: Apresenta obrigatoriamente um conector gramatical subordinativo e desdobra o verbo nominal em uma forma verbal finita conjugada.
...
- Contraexemplo (Falsa Desenvolvida): "É urgente o reconhecimento da necessidade..." (nominalização/sintagma nominal, não é oração desenvolvida).
...
1. Passo 4 — Inserir o conectivo adequado:

- Substantiva $\rightarrow$ Conjunção Integrante (C.I.): que (ou se).
- Adjetiva $\rightarrow$ Pronome Relativo (P.R.): que (o qual, a qual).

1. Passo 5 — Desnominalizar e conjugar o verbo: Flexionar o verbo considerando obrigatoriamente a correlação com o "verbo amigo" e a manutenção estrita do sujeito.
2. Passo 6 — Classificar a oração reduzida: Atribuir a nomenclatura sintática oficial completa da oração original.

- Condensado por:  (Método Simplificado de 3 Passos).
- Detalhado em:  (Princípios do Passo 5).
...
3. Passo 3 — Desdobramento e Flexão Verbal: Retirar a forma nominal e flexionar o verbo em modo, tempo, número e pessoa, mantendo a concordância com o sujeito da subordinada e a harmonia com o verbo da oração regente.
...
1. Eixo Pessoal (Preservação do Sujeito):
...
a) Voz Ativa com Sujeito Indeterminado: verbo na 3ª pessoa do plural (ex.: "que reconheçam a necessidade"; "que cruzem fronteiras"). b) Voz Passiva Sintética (Pronominal): VTD acompanhado da partícula apassivadora "se", exigindo concordância obrigatória com o sujeito paciente (ex.: "que se reconheça a necessidade"; "que se critiquem as viagens"). c) Voz Passiva Analítica: verbo auxiliar flexionado + particípio (ex.: "que seja reconhecida"; "que sejam criticadas").
...
1. Gerúndio Temporal Concomitante: Expressa simultaneidade temporal durativa com a oração principal. Desenvolve-se por enquanto associado ao pretérito imperfeito ("respondeu... enquanto farejava").
2. Gerúndio com Valor Adjetivo: Ocorre quando o gerúndio modifica diretamente um substantivo antecedente ("manda a seta"), equivalendo a oração adjetiva introduzida por que.
...
1. Gerúndio Consecutivo e Aposto Resumitivo: Ocorre com verbos que trazem carga inerente de resultado (gerar, acarretar, implicar). Pode ser desenvolvido pela estrutura "o que deve + infinitivo", em que o pronome demonstrativo "o" opera como aposto oracional resumitivo que retoma o fato anterior.
...
3. Particípio Temporal Imediato: Expressa um evento concluído no exato instante anterior ao da oração principal. Desenvolve-se perfeitamente por conectivos de imediatismo como assim que ou logo que ("Baixados os arquivos..." $\rightarrow$ "Assim que são baixados os arquivos...").
...
| Categoria | Regra / Conceito | Formulação Canônica | ID Detalhado |
| --- | --- | --- | --- |
| Definição | Oração Reduzida | Oração desprovida de conectivo formal, estruturada com verbo no infinitivo, gerúndio ou particípio. |  |
| Definição | Oração Desenvolvida | Oração introduzida por conjunção subordinativa ou pronome relativo, com verbo em forma finita conjugada. |  |
| Método | Algoritmo dos 6 Passos | Sequência analítica: Verbos$\rightarrow$ Barra $\rightarrow$ Natureza (ISSO/seta/circunstância) $\rightarrow$ Conector $\rightarrow$ Flexão $\rightarrow$ Nome. |  |
| Método | Algoritmo dos 3 Passos | Sequência simplificada: Diagnóstico categorial$\rightarrow$ Conector canônico $\rightarrow$ Desdobramento e flexão verbal. |  |
| Regra | Verbo Amigo (Tempo) | A flexão verbal da desenvolvida deve correlacionar-se harmoniosamente com o tempo da oração regente. |  |
| Regra | Sujeito Indeterminado | Infinitivo impessoal desenvolve-se na 3ª pessoa do plural (ativa) ou em voz passiva sintética/analítica. |  |
| Regra | Transposição Concessiva | Locuções prepositivas (apesar de) devem ser substituídas por conjunções (embora) ou conjuntivas (apesar de que). |  |
| Regra | Próclise Subordinativa | Conjunções subordinativas são fatores de próclise obrigatória ("embora se apresente"). |  |
| Distinção | PIV vs. PA | Verbo pronominal com PIV não admite passivação analítica ("apresentar-se" $\neq$ "ser apresentado"). |  |
| Regra | Gerúndio Causal e "Assim" | "Assim" adjacente a gerúndio atua como advérbio de modo ("deste modo"), preservando a causalidade. |  |
| Regra | Ao + Infinitivo | Fórmula estrutural com semântica fixa e exclusiva de tempo (quando), vedada a permuta por causa. |  |
| Regra | Deslocamento Adverbial | A mudança de posição de adjunto adverbial que altere o verbo de referência invalida itens de reescrita. |  |
...
1. Acrescentar o Conectivo Canônico:

1. Conjugar o Verbo (Atenção Crítica):
...
1. Classificar Sintaticamente: Formule a nomenclatura gramatical completa da oração reduzida original.
...
3. Flexão Verbal e Correlação: Desdobrar a forma nominal conjugando o verbo em pessoa (sujeito) e tempo/modo (harmonia com o verbo amigo).
...
3. Monte mentalmente a estrutura de validação: "O fato de [Oração A] faz com que [Oração B]".
4. Se a sentença for semanticamente sólida e a [Oração A] constituir o fato gerador, a oração é classificada com segurança como Adverbial Causal, desenvolvendo-se por conjunções causais (porque, visto que, já que, como).
...
| Estrutura de Origem | Tentativa / Forma Incorreta | Forma Desenvolvida Correta | Critério Decisivo de Distinção |
| --- | --- | --- | --- |
| "É urgente reconhecer a necessidade" | "É urgente reconheçamos..." (invenção de sujeito "nós") | "É urgente que se reconheça a necessidade" / "que reconheçam" | Infinitivo impessoal impõe sujeito indeterminado; deve-se usar 3ª plural ativa ou voz passiva. |
| "Criticar as viagens... parece..." | "Que se critique as viagens..." (verbo singular) | "Que se critiquem as viagens..." / "Que sejam criticadas..." | Na voz passiva sintética, "as viagens" é sujeito paciente no plural; concordância obrigatória no plural. |
| "Sua palavra foi a primeira a perder..." | "Sua palavra foi a primeira isso" (falsa substantiva) | "Sua palavra foi a primeira que perdeu o significado" | A oração qualifica o numeral antecedente "a primeira"; oração adjetiva restritiva com pronome relativo. |
| "Apesar de ser torcedor..." | "Apesar de é torcedor..." / "Apesar de seja..." | "Embora seja torcedor..." / "Apesar de que seja..." | Apesar de é locução prepositiva; o desenvolvimento exige conjunção (embora) ou locução conjuntiva. |
| "não obstante apresentar-se" | "não obstante apresente-se" (ênclise incorreta) | "não obstante se apresente" / "embora se apresente" | Conjunções subordinativas concessivas são palavras atrativas e exigem próclise pronominal. |
| "não obstante apresentar-se" | "embora seja apresentado" (passivação indevida) | "embora se apresente" (voz ativa pronominal) | O pronomese em apresentar-se é PIV, não PA; bloqueia conversão para passiva analítica. |
| "paulista, trabalhando pesado, vê..." | "que trabalhe pesado" (modo subjuntivo) | "que trabalha pesado" (modo indicativo) | A narrativa descreve uma realidade factual incontestável do personagem, exigindo o modo Indicativo. |
| "promovendo assim um ciclo..." | Desenvolvimento com conjunção consecutiva (portanto) | "[...] porque promove, assim, um ciclo..." | "Assim" é advérbio de modo ("deste modo"); a relação interoracional primária é de causalidade. |
| "ao estabelecer normas..." | Permuta por"porque estabeleceu" / "por estabelecer" | "quando estabeleceu normas..." | A construçãoao + infinitivo possui valor fixo e exclusivo de tempo; não admite permuta causal. |
| "no qual se inclui vários trabalhos" | Aceitar a frase por ler o verbo antes do sujeito | "no qual se incluem vários trabalhos" | "Vários trabalhos" é sujeito paciente posposto; concordância passiva obrigatória no plural. |
| "começava, ao mesmo tempo, a fazer..." | "ficava cheirando a cebola ao mesmo tempo" | Manter"ao mesmo tempo" associado a "começava" | Mover o adjunto adverbial para o fim da oração altera o verbo de referência e distorce o sentido original. |
...
1. Verbos: "É" (1) e "reconhecer" (2).
2. Barra: É urgente / reconhecer a necessidade de um trabalho mais efetivo com a palavra.
...
1. Barra: Sua palavra foi a primeira / a perder o significado.
2. Natureza: Refere-se a "a primeira" (numeral substantivo antecedente) $\rightarrow$ Oração Subordinada Adjetiva Restritiva.
3. Conectivo: Pronome Relativo (que).
4. Conjugação: "foi" (pretérito perfeito). O verbo "perder" conjuga-se no pretérito perfeito (perdeu) ou mais-que-perfeito (perdera), com sujeito "a primeira" (ela) $\rightarrow$ "Sua palavra foi a primeira que perdeu (perdera) o significado."

- Classificação da reduzida: Oração subordinada adjetiva restritiva reduzida de infinitivo.

- Frase original: "Nada conseguindo, a mais nova fugiu."
- Aplicação do Método:

1. Natureza: O insucesso foi a causa da fuga $\rightarrow$ Oração Subordinada Adverbial Causal.
2. Conectivo: Conjunções causais (já que, visto que, porque, uma vez que, como).
3. Conjugação: "fugiu" (pretérito perfeito). Verbo conjugado no pretérito mantendo sujeito "a mais nova" $\rightarrow$ "Já que nada conseguiu (conseguira), a mais nova fugiu."

- Classificação da reduzida: Oração subordinada adverbial causal reduzida de gerúndio.

- Frase original: "Se dependesse de mim, teria vetado a roda por não se parecer nada com o pé."
- Aplicação do Método:

1. Natureza: A preposição "por" indica a causa do veto $\rightarrow$ Oração Subordinada Adverbial Causal.
2. Conectivo: Conjunção causal (visto que, uma vez que, já que).
3. Conjugação: "teria vetado" (futuro do pretérito) / "dependesse" (imperfeito do subjuntivo). Flexão no pretérito imperfeito do indicativo mantendo sujeito elíptico "a roda" $\rightarrow$ "...uma vez que não se parecia nada com o pé."

- Classificação da reduzida: Oração subordinada adverbial causal reduzida de infinitivo.
...
1. Natureza: Ao + Infinitivo = Circunstância Temporal.
2. Conectivo: Conjunção temporal quando.
3. Conjugação: "pensa" (presente do indicativo). Verbos desenvolvidos no presente com sujeito "o liberalismo" $\rightarrow$ "O liberalismo pensa estar defendendo o indivíduo quando nega a primazia do social ou quando diz que..."

- Classificação da reduzida: Orações subordinadas adverbiais temporais reduzidas de infinitivo.
...
1. Diagnóstico: "Peço-te [ISSO]" $\rightarrow$ Oração Substantiva Objetiva Direta.
2. Conector: Conjunção integrante "que".
3. Flexão: "Peço" (presente). O pronome "te" marca 2ª pessoa (tu) $\rightarrow$ "Peço-te que saias da minha vida!"

- Classificação da reduzida: Oração subordinada substantiva objetiva direta reduzida de infinitivo (OSSODRI).

- Frase original: "Terminada a aula, todos se retiraram."
- Aplicação do Método:

1. Diagnóstico: Circunstância temporal $\rightarrow$ Oração Adverbial Temporal.
2. Desenvolvimento: Conjunção temporal "quando" + pretérito perfeito $\rightarrow$ "Quando a aula terminou, todos se retiraram."

- Classificação da reduzida: Oração subordinada adverbial temporal reduzida de particípio (OSATRP).

- Frase original: "Há muitos alunos estudando com afinco."
- Aplicação do Método:

1. Diagnóstico: "estudando com afinco" restringe o substantivo "alunos" $\rightarrow$ Oração Adjetiva Restritiva.
2. Conector e Flexão: Pronome relativo "que" + presente do indicativo $\rightarrow$ "Há muitos alunos que estudam com afinco."

- Classificação da reduzida: Oração subordinada adjetiva restritiva reduzida de gerúndio (OSARRG).

- Frase original: "Apesar de ser torcedor fanático, não vai aos estádios."
- Aplicação do Método:

1. Diagnóstico: Circunstância concessiva $\rightarrow$ Oração Adverbial Concessiva.
2. Conector e Flexão: Troca-se a locução prepositiva "apesar de" pela conjunção "embora" + presente do subjuntivo $\rightarrow$ "Embora seja torcedor fanático, não vai aos estádios" (ou "Apesar de que seja...").

- Classificação da reduzida: Oração subordinada adverbial concessiva reduzida de infinitivo (OSACRI).
...
1. Conector: "não obstante" mantido como conjunção subordinativa concessiva (ou substituído por embora/conquanto).
2. Próclise: Conjunção subordinativa atrai o pronome PIV $\rightarrow$ "não obstante se apresente" / "embora se apresente".
...
1. Questão 52 (FGV — ALERJ): Trecho "...implica poder decifrar...".
...
1. Questão 53 (FGV — IBGE): Frase "O que pode ser feito para evitar um novo racionamento?".
...
1. Questão 54 (FGV — Pref. Salvador): Trecho "Um paulista, trabalhando pesado... vê...".
...
1. Questão 55 (CESGRANRIO — Banco do Brasil): Trecho "...coincidências envolvendo o número...".
...
1. Questão 57 (FGV 2019): Trecho "— Esterco — respondeu Oscar, farejando aborrecimento...".
...
1. Questão 58 (FCC — TJ-RJ): Trecho "Nascidas do povo mais humilde do Brasil, as Escolas afirmam a vocação [...] para a grandeza".

- Resolução: Antítese entre "povo humilde" e "afirmam grandeza" estabelece concessão $\rightarrow$ "Ainda que tenham nascido".
- Gabarito Oficial: Letra C.

1. Questão 59 (VUNESP 2020): Trecho "Desenvolvida para uma chave amigo-inimigo, nossa mente tende a rotular...".
...
1. Questão 61 (CESPE — TRT 10ª): Permuta de "ao estabelecer" indistintamente por "quando estabeleceu, por estabelecer, porque estabeleceu, estabelecendo".

- Julgamento: Errado.
- Justificativa: "Ao + infinitivo" expressa exclusivamente tempo, não admitindo permuta por construções causais.

1. Questão 62 (CESPE — TCE-RO): Substituição de "Baixados os arquivos" por "Assim que são baixados os arquivos".

- Julgamento: Certo.
- Justificativa: Particípio expressa tempo imediato, desenvolvido perfeitamente por "Assim que".

1. Questão 63 (CESPE — TST): Substituição de "podendo optar" por "que pode optar".

- Julgamento: Certo.
- Justificativa: Gerúndio qualifica o substantivo "capital" (adjetiva) e expressa fato permanente no presente do indicativo.

1. Questão 64 (CESPE 2021 — IBGE): Substituição de "gerando" por "o que deve gerar".

- Julgamento: Certo.
- Justificativa: Gerúndio consecutivo; o pronome "o" atua como aposto oracional resumitivo do fato anterior.

1. Questão 65 (CESPE — MC): Substituição de "satisfazendo" por "visto que satisfazem".

- Julgamento: Certo.
- Justificativa: Pela ordem cronológica, a satisfação das necessidades é a causa/precondição da atuação complementar.

1. Questão 66 (CESPE — SEAD-PA): Substituição de "Ao delegar" por "Quando delega".

- Julgamento: Certo.
- Justificativa: Equivalência temporal estrita de "ao + infinitivo".

1. Questão 67 (CESPE 2021 — PF / Escrivão): Reescrita de "Quando anoitecia, toda aquela vizinhança começava, ao mesmo tempo, a fazer bife, e o ar ficava cheirando a cebola e alho" por "Ao anoitecer, toda aquela vizinhança começava a fazer bife e o ar ficava cheirando à cebola e alho ao mesmo tempo.".
...
3. Fórmula Fixa "Ao + Infinitivo = Tempo e Sou Feliz": Estrutura de valor temporal absoluto, convertida canonicamente por quando + verbo flexionado.
4. Voz Passiva como Válvula de Escape em Sujeito Indeterminado: Ao desenvolver infinitivo impessoal, a voz passiva sintética ("que se reconheça", "que se critiquem") é a solução preferida e mais elegante em provas de concurso.
...
- Como evitar: Investigue quem pratica a ação do próprio verbo subordinado ("Quem reconhece?"). No infinitivo impessoal, o sujeito é indeterminado, exigindo a 3ª pessoa do plural ou voz passiva.
...
Ao concluir este grupo temático, o estudante domina com precisão teórica e segurança operacional o processo de transformação de orações reduzidas em desenvolvidas (e vice-versa), sendo capaz de:

1. Reconhecer e Isolar: Identificar formas nominais (infinitivo, gerúndio e particípio) e estabelecer a fronteira sintática da oração subordinada por meio da barra delimitadora.
2. Diagnosticar e Conectar: Aplicar os testes do "ISSO" (substantivas $\rightarrow$ conjunção integrante), da seta no antecedente (adjetivas $\rightarrow$ pronome relativo) e da circunstância lógica (adverbiais $\rightarrow$ conjunções específicas).
3. Harmonizar e Preservar: Conjugar o verbo em harmonia temporal com o "verbo amigo" e respeitar rigidamente o sujeito da oração reduzida, operando com desenvoltura a 3ª pessoa do plural ativa ou as vozes passivas sintética e analítica diante de infinitivos impessoais.
4. Dominar Casos Especiais: Substituir locuções prepositivas por conjuntivas em orações concessivas, aplicar próclise obrigatória decorrente de conjunções subordinativas, bloquear passivações indevidas com PIV e reconhecer a invariabilidade temporal estrita da fórmula ao + infinitivo.
5. Resolver Provas de Alto Nível: Neutralizar armadilhas recorrentes de bancas examinadoras (FGV, CESPE, FCC, VUNESP, CESGRANRIO, Instituto AOCP), tais como o descarte de falsas nominalizações, a distinção entre fato (indicativo) e hipótese (subjuntivo), a desmistificação do "assim" modal e a detecção de quebra de paralelismo e mudança de referente por deslocamento adverbial.
