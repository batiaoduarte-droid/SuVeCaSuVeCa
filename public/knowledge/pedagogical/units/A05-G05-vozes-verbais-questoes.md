# Vozes Verbais - Questões

---

> **Objetivo de aprendizagem**
>
> Compreender e definir os princípios normativos e conceituais de Vozes Verbais - Questões. Aplicar regras canônicas e procedimentos decisórios de Vozes Verbais - Questões na resolução de questões. Analisar o papel de Vozes Verbais - Questões no eixo Método central e reconhecer armadilhas e variações de bancas.
...
**Método central:** Nas questões de voz, verifique transitividade, papel do “se”, sujeito paciente, concordância e agente antes de aceitar qualquer classificação.
...
- Transitividade Verbal: Domínio pleno da distinção entre Verbo Transitivo Direto (VTD), Transitivo Direto e Indireto (VTDI), Transitivo Indireto (VTI), Intransitivo (VI) e Verbo de Ligação (VL).
- Morfologia dos Verbos: Reconhecimento imediato das formas de particípio regular (-ado, -ido) e irregular (feito, posto, esquartejado, morto), tempos do modo indicativo e subjuntivo, e valores do verbo auxiliar ser.
...
1. Razão Gramatical Intrínseca (Padrão FGV): O objetivo técnico da voz passiva é "permitir a indicação adequada do sujeito como paciente". Alegações que inferem dificuldades psicológicas do enunciador (ex.: "evitar a difícil indicação dos agentes") constituem erros de extrapolação textual não respaldados pela gramática.
...
- Estrutura Sintática Real: Na oração "São excluídos do cálculo os desligamentos por transferências...", o verbo está flexionado na 3ª pessoa do plural (São excluídos) em concordância estrita com o núcleo do Sujeito Paciente Determinado Posposto (os desligamentos).
...
3. Se a banca afirmar que a oração "não tem sujeito", classifique o item como ERRADO. Se afirmar que "o agente da ação está indeterminado", classifique como CORRETO.
...
1. O Distrator do Verbo SER sem Particípio: Frases como "Comte não era cientista, mas filósofo" ou "É diversão certa" contêm o verbo ser, porém desacompanhado de particípio. Trata-se de verbo de ligação conectando o sujeito a substantivos predicativos na voz ativa.
2. O Distrator do Verbo "Virar" (Mudança de Estado): Em "Clarice virou cidadã brasileira", o verbo virar expressa alteração de estado civil/condição, funcionando como verbo de ligação com predicativo na voz ativa.
...
| --- | --- | --- | --- | --- |
| "Somos feitos de poeira" | somos (Auxiliar SER) | feitos (Particípio de fazer) | Locução Verbal Passiva | Passiva Analítica |
| "Era margeado por grama" | era (Auxiliar SER) | margeado (Particípio de margear) | Locução Verbal Passiva | Passiva Analítica |
| "Podem ser amados" | podem ser (Loc. Auxiliar) | amados (Particípio de amar) | Locução Verbal Passiva | Passiva Analítica |
| "Não era cientista" | era (Verbo SER) | cientista (Substantivo) | Verbo de Ligação + Predicativo | Voz Ativa |
| "Estão destinados" | estão (Verbo ESTAR) | destinados (Particípio Adjetivado) | Verbo de Ligação + Predicativo | Voz Ativa |
| "Virou cidadã" | virou (Mudança de Estado) | cidadã (Substantivo Predicativo) | Verbo de Ligação + Predicativo | Voz Ativa |
...
A passiva sintética atende a um princípio de economia linguística: elimina a locução com o verbo auxiliar ser e habitualmente omite o agente da passiva. Para certificar a legitimidade da estrutura e afastar confusões com sujeito indeterminado ou verbos pronominais:
...
1. Concordância Obrigatória: O verbo na passiva sintética concorda obrigatoriamente em número e pessoa com o sujeito paciente ("Vendem-se limões" = Limões são vendidos; "Mencionam-se espécies" = Espécies são mencionadas).
...
1. Parte Integrante do Verbo (PIV) $\rightarrow$ Voz Ativa:
...
1. Índice de Indeterminação do Sujeito (IIS) $\rightarrow$ Voz Ativa:

- Exemplo: "Ali se trabalha como escravo" (trabalhar é VI; se é IIS; voz ativa com sujeito indeterminado).

1. Pronome Reflexivo / Recíproco $\rightarrow$ Voz Reflexiva / Recíproca:
...
3. A Especificidade da Voz Recíproca: Exige sujeito composto ou no plural e estabelece reciprocidade de ação. Em "Os perfumes, as cores e os sons correspondem-se", a equivalência textual é "correspondem uns aos outros", configurando reciprocidade que a impede de ser classificada como passiva sintética ou reflexiva individual.
...
| VTDI | SIM | SIM | "Adaptou a prensa a uma nova função" $\rightarrow$ "A prensa foi adaptada..." |

| VTI | NÃO (rege O.I.) | NÃO | "Não se queixam da distância" (preposição de impede passiva) |

| VI | NÃO (sem objeto) | NÃO | "A mãe falecera na noite de Natal" (adjunto de tempo) |

| VL | NÃO (rege Predicativo) | NÃO | "São inúmeras as consequências" (inúmeras é predicativo) |
...
1. Desarme do Sujeito Posposto em Orações Invertidas:
...
1. Particularidade do Verbo "Chegar" na FCC:
...
- Todavia, por ser oração sem sujeito na ativa, não existe sujeito agente que possa ser convertido em agente da passiva. A tentativa de transposição geraria formas anômalas e agramaticais no padrão culto da língua ("Uma razão óbvia era havida...").
- Classificação de Voz da Oração: Conforme diretriz prática para provas, uma oração estruturada com o verbo haver impessoal não é passiva nem reflexiva; portanto, classifica-se tecnicamente na Voz Ativa.
- Atenção em Provas: Ao buscar uma frase que admita transposição para a passiva, a alternativa contendo o verbo haver impessoal deve ser sumariamente descartada, pois se trata de uma pegadinha clássica destinada a punir quem aplica a regra do VTD sem considerar o veto semântico do haver.

- Restringe:  (exceção à regra de que todo VTD admite passiva).
...
> "O regime trabalhista, ao adotar estratégias de proteção à saúde do trabalhador, institui mecanismos de monitoração dos indivíduos..."

- Na Estrutura Ativa Original: O sujeito do verbo institui é "O regime trabalhista", que também opera como sujeito lógico da oração reduzida temporal intercalada "ao adotar estratégias de proteção..." (o regime adota estratégias e o regime institui mecanismos). A lógica argumentativa é perfeita.
- Na Proposta de Transposição Passiva do CESPE:

> "Mecanismos de monitoração dos indivíduos, ao adotar estratégias de proteção à saúde do trabalhador, são instituídos..."
...
| Identificador | Conceito / Regra | Formulação Sintética Canônica | ID Detalhado |
| --- | --- | --- | --- |
|  | Voz Passiva Analítica | Locução verbal dinâmica formada obrigatoriamente porSER (auxiliar) + Particípio (principal), em que o sujeito é paciente da ação verbal. |  |
|  | Voz Passiva Sintética | Estrutura formada porVTD/VTDI na 3ª pessoa + SE (PA) + Sujeito Paciente, validada categoricamente pela conversão analítica SER + Particípio. |  |
|  | Equação Sujeito vs. Agente | Sujeito Paciente ≠ Agente da Passiva. O sujeito paciente é determinado e nuclear; a ausência de preposição indica agente omitido, não ausência de sujeito. |  |
|  | Falsa Passiva de Ligação | ESTAR/FICAR + Particípio e SER + Substantivo/Adjetivo constituem Verbo de Ligação + Predicativo do Sujeito na Voz Ativa. |  |
|  | Parte Integrante do Verbo (PIV) | Pronome acoplado a verbos pronominais de sentimento, afeto ou evento (dar-se, acomodar-se, queixar-se); integra o verbo na Voz Ativa. |  |
|  | Regra Fundamental de Transposição | A transposição ativa$\rightarrow$ passiva analítica exige a presença de Objeto Direto (VTD ou VTDI). Verbos VI, VTI e VL não admitem transposição. |  |
|  | Exceção do Verbo Haver | O verbohaver no sentido existencial é VTD impessoal, mas não admite voz passiva analítica por restrição semântica absoluta. |  |
|  | Voz Reflexiva (Critério CESPE) | A voz reflexiva valida-se quando o pronome oblíquo equivale contextualmente a"a si mesmo / a si próprio". |  |
...
1. Passo 4 — Checagem Semântica Lexical: Verifique se o verbo não é acidentalmente pronominal (dar-se = acontecer; acomodar-se = conformar-se). Se a versão analítica corromper o sentido original, o se é PIV na voz ativa. Se a transposição for fluida e expressar processo sofrido, confirma-se Voz Passiva Sintética.
...
3. Passo 3 — Filtro da Exceção do Verbo Haver: Se o verbo for haver no sentido de existir, mesmo sendo VTD, descarte a alternativa.
4. Passo 4 — Confirmação do Objeto Direto: Localizado o substantivo, pronome substantivo ou pronome relativo que sem preposição vinculado a VTD/VTDI, marque a opção como a única que admite transposição.
...
1. Passo 4 — Conclusão de Transitividade: Constatado que o substantivo pós-verbal é sujeito, conclui-se que o verbo não possui objeto direto e não pode ir para a voz passiva.
...
| Critério Comparativo | Sujeito Sintático Paciente | Agente da Passiva |
| --- | --- | --- |
| Função Semântica | Ser que sofre o processo verbal | Ser que efetivamente executa o processo na voz passiva |
| Função Sintática | Termo essencial da oração com o qual o verbo concorda | Termo integrante da oração preposicionado |
| Preposição | Não é regido por preposição obrigatória | Introduzido regimentalmente porpor (pelo/pela) ou de |
| Obrigatoriedade | Obrigatório e determinado na voz passiva padrão | Termo acessório/integrante que pode ser omitido/indeterminado |
| Exemplo nesta unidade | "Os desligamentos" em "São excluídos os desligamentos..." | Ausente / Indeterminado na referida oração |

| Parâmetro Estrutural | Voz Passiva Analítica | Voz Passiva Sintética (Pronominal) |
| --- | --- | --- |
| Estrutura Morfológica | Verbo Auxiliar SER + Particípio do Verbo Principal | VTD / VTDI na 3ª pessoa + Pronome SE (PA) |
| Extensão Textual | Perífrase analítica desdobrada | Construção sintética e econômica |
| Presença do Agente | Admite agente explícito (pelas crianças) ou omitido | Quase invariavelmente apresenta agente omitido |
| Concordância Verbal | O auxiliar concorda com o sujeito (foram contadas) | O verbo concorda com o sujeito (escravizam-se pessoas) |
| Exemplo Típico | "As histórias tinham sido contadas" | "Sepultou-se o passado beligerante" |

| Parâmetro de Distinção | Locução Passiva Analítica (SER + Particípio) | Verbo de Ligação + Predicativo (ESTAR/VL + Part./Adj.) |
| --- | --- | --- |
| Verbo Empregado | Verbo auxiliarSER (em qualquer tempo/modo) | VerboESTAR, FICAR, VIRAR ou SER isolado |
| Valor do Particípio | Forma verbal de ação sofrida pelo sujeito | Adjetivo / Atributo indicando estado ou condição |
| Classificação de Voz | Voz Passiva Analítica | Voz Ativa |
| Critério em Bancas | Padrão unânime em todas as bancas examinadoras | Pegadinha clássica daFGV (ex.: estão destinados) |
| Exemplo Contrastivo | "Os resultados são valorizados" (Passiva Analítica) | "Eles estão preocupados" (Voz Ativa com VL + PS) |
...
- Análise Técnica: Em "será julgado" temos locução passiva analítica (SER + particípio) e em "pelas crianças" temos o Agente da Passiva Explícito/Expresso introduzido pela contração prepositiva por + as. As demais opções omitiram o agente.
- Gabarito Oficial: C
...
- Julgamento: CERTO. A primeira é passiva analítica e a segunda é passiva sintética; em ambas os sujeitos pacientes estão determinados (o talian e ucraniano), e em ambas o agente que pratica a fala foi omitido.
...
- Julgamento: ERRADO. A oração é passiva analítica, mas possui Sujeito Sintático Paciente determinado e perfeitamente identificado: "os desligamentos por transferências...", que se encontra posposto ao verbo. O que está destituído é o Agente da Passiva.
...
- Julgamento: ERRADO. A alteração sintática desloca mecanismos de monitoração para o papel de sujeito, que passa a ser o referente lógico da oração intercalada ao adotar estratégias..., tornando o argumento textual absurdo e incoerente.
...
- Não caia na pegadinha: ver o verbo ser sozinho não significa voz passiva!
...
Problema: O candidato analisa uma oração passiva analítica ou sintética sem agente explícito (ex.: "São excluídos os registros", "fala-se ucraniano") e julga que se trata de "sujeito indeterminado" ou "oração sem sujeito". Consequência: Erro grave em itens de julgamento do CESPE/CEBRASPE. Como Evitar: Lembre-se de que na voz passiva o sujeito sintático está presente e determinado (o paciente). O que está indeterminado/omitido é unicamente o Agente da Passiva.

Problema: Classificar perífrases estativas formadas por estar/ficar + particípio (ex.: "estão destinados", "ficaram preocupados") como voz passiva analítica. Consequência: Erro fatal no padrão da FGV, que restringe a passiva analítica estritamente à locução SER + particípio. Como Evitar: Reconhecer que estar + particípio expressa estado/atributo, configurando Verbo de Ligação + Predicativo do Sujeito na Voz Ativa.

Problema: Deixar de reconhecer a locução passiva analítica quando a banca insere adjuntos adverbiais longos entre o auxiliar e o particípio (ex.: "O prêmio foi duas vezes concedido"). Consequência: Analisar apenas o verbo foi isolado e confundi-lo com verbo de ligação. Como Evitar: Ao encontrar qualquer forma do verbo ser, examine os termos posteriores na oração para identificar se há particípio conectado ao sujeito paciente.

Problema: Forçar a conversão passiva em verbos pronominais ou acidentalmente pronominais que indicam sentimentos, atitudes ou acontecimentos espontâneos (dar-se, acomodar-se, sair-se, sentir-se). Consequência: Tratar uma estrutura da voz ativa com PIV como se fosse passiva sintética. Como Evitar: Aplique o teste da passiva analítica: se gerar ilogicidade ou frases agramaticais ("cientistas não são saídos", "a resistência não é dada por acaso"), o se é Parte Integrante do Verbo (PIV) na Voz Ativa.

Problema: Localizar o verbo haver em orações como "Havia motivos suficientes", classificá-lo corretamente como VTD com O.D. (motivos suficientes) e concluir que ele admite transposição passiva. Consequência: Erro certo em questões da FCC e de bancas congêneres. Como Evitar: Fixe a exceção: o verbo haver no sentido de existir é VTD, mas nunca admite transposição para a passiva analítica por restrição semântica e ausência de agente.

Problema: Em orações que se iniciam por verbo (ex.: "Resulta disso tudo uma espécie de código"), fazer a pergunta genérica "o quê?" e classificar o substantivo pós-verbal como objeto direto. Consequência: Tratar verbos intransitivos ou transitivos indiretos como se fossem VTDs e achar erroneamente que admitem passiva. Como Evitar: Sempre faça a pergunta do sujeito em primeiro lugar (O que é que resulta?). Coloque a frase na ordem direta antes de classificar a predicação verbal.

Problema: Validar a conversão da voz ativa para a passiva analítica apenas analisando a oração principal isoladamente, sem verificar os termos periféricos do parágrafo no texto original. Consequência: Não perceber que a troca de sujeito transfere indevidamente a referência lógica de orações reduzidas intercaladas, destruindo a coerência argumentativa do texto. Como Evitar: Leia sempre o período completo com a modificação proposta no contexto textual amplo da prova do CESPE.
...
Ao concluir este grupo temático, o estudante desenvolve competência técnica para:

1. Compreender a Dimensão Semântico-Discursiva: Reconhecer que a voz passiva promove o paciente a sujeito sintático e que a omissão do agente é um instrumento deliberado de impessoalização, atenuação de responsabilidade e foco temático.
2. Dominar a Diferenciação Sujeito vs. Agente: Desarmar a clássica pegadinha de bancas como o CESPE, afirmando categoricamente que a ausência de agente da passiva não torna a oração "destituída de sujeito sintático".
3. Classificar Estruturas com Rigor Morfossintático: Diferenciar locuções passivas analíticas verdadeiras (SER + particípio) de estruturas com verbos de ligação (ESTAR/FICAR + predicativo ou SER + substantivo/adjetivo), bem como identificar se a partícula se funciona como pronome apassivador (PA), índice de indeterminação do sujeito (IIS), parte integrante do verbo (PIV) ou pronome reflexivo/recíproco.
4. Executar a Análise de Transposição com Velocidade: Aplicar o atalho da transitividade (exigência indispensável de VTD/VTDI com Objeto Direto) para resolver itens de transposição em segundos, descartando opções preposicionadas (VTI), intransitivas (VI), de ligação (VL) e a exceção semântica absoluta do verbo impessoal haver.
5. Superar Armadilhas Estruturais e de Coerência Textual: Desarmar inversões sintáticas com sujeitos pospostos, identificar pronomes relativos na função de objeto direto e avaliar o impacto da transposição sobre o vínculo lógico de orações intercaladas em textos dissertativos complexos.
