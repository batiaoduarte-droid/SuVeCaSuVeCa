# Revisão cumulativa · Concordância
...
determinante
(O verbo concorda com o próprio
numeral ou com o determinante. Se o
numeral
vier
determinado,
a
...
determinante)
20% do eleitorado ficou revoltado.
20% do eleitorado ficaram revoltados.
1 milhão de torcedores assistiram à Copa do
Mundo.
1 milhão de torcedores assistiu à Copa do
Mundo.
...
COM O
NUMERAL
Mais de um, menos de dois, cerca de,
menos de... + NUMERAL
...
OBRIGATÓRIA
NO PLURAL
Numeral decimal não determinado,
teremos a concordância obrigatória no
...
- **Casas são vendidas no Grajaú = Vendem-se casas no Grajaú (suj. pac. = casas)**
- **Casa é vendida no Grajaú = Vende-se casa no Grajaú (suj. pac. = casa)**
- **Tenho alunos e alunas dedicadas./Tenho alunos e alunas dedicados.**
- **Consumi bons vinhos, comidas e livros./Consumi boa comida, vinhos e livros.**
