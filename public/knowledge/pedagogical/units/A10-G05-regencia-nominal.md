...
>
> Compreender e definir os princípios normativos e conceituais de Regência Nominal. Aplicar regras canônicas e procedimentos decisórios de Regência Nominal na resolução de questões. Analisar o papel de Regência Nominal no eixo Método central e reconhecer armadilhas e variações de bancas.
...
**Método central:** A regência nominal amplia C para completar substantivos, adjetivos e advérbios; o mapa explicita o núcleo regente e o termo preposicionado que o completa.
...
- Morfologia: Reconhecimento das classes de palavras (substantivo, adjetivo, advérbio, preposição, artigo, pronome relativo e conjunção integrante).
...
SINTAXE DE REGÊNCIA ➔ Regência Verbal (Verbo -> Complementos Diretos / Indiretos) ➔ REGÊNCIA NOMINAL (Nome -> Complemento Nominal)
- ➔ 1. Natureza e Estrutura
➔ Termo Regente: NOME (Substantivo, Adjetivo ou Advérbio)
- ➔ Termo Regido: COMPLEMENTO NOMINAL (Sintagma ou Oração)
➔ Conector: SEMPRE mediado por PREPOSIÇÃO OBRIGATÓRIA
- ➔ 2. Tipos de Regimes Preposicionais
➔ Regência Simples (exigência de preposição unívoca)
- ➔ contrário a, capaz de, responsável por, depois de, alusão a, restrito a
➔ passível de, sensível a, suscetível a, sujeito a, eficaz em, combate a
- ➔ Pluralidade / Dupla Regência (preposições alternativas equivalentes)
➔ acostumado a / com | adaptado a / de / para | capacidade de / para
- ➔ querido de / por | satisfeito com / de / em / por
➔ aversão a / por | propenso a / para | imune a / de
- ➔ ávido por / de | desejo de / por | orgulho de / por
➔ curioso por/para/de| avesso a / em | receoso de / em
- ➔ relacionada com / a| intenção de / em
➔ 3. Estruturas Sintáticas Especiais
- ➔ Oração Completiva Nominal: Proibição de omissão do "de" (ex.: dúvida de que)
➔ Pronome Relativo Preposicionado: Método da ordem direta (ex.: do qual integrar -> incorreto)
- ➔ Verbo Preferir (VTDI): [OD sem prep.] + [a + OI] com inversão estilística
➔ 4. Fenômenos de Intersecção ➔ Determinação Semântica: Prep. simples (genérico) vs. Prep. + Artigo / Crase (determinado) ➔ Pronome Possessivo Feminino: Artigo facultativo (de nossas vs. das nossas) ➔ Paralelismo Sintático: Recurso de ênfase (FGV) vs. Vício de redação (CEBRASPE)
...
Ao contrário da regência verbal — que admite complementação direta não preposicionada (objeto direto) ou indireta preposicionada (objeto indireto) —, a regência nominal não admite ligação direta sem preposição na norma-padrão. Sempre que um termo completa o sentido de um substantivo abstrato, de um adjetivo ou de um advérbio de base relacional, essa ligação é feita por uma preposição simples ou contraída com artigo. Trata-se de um fato linguístico eminentemente convencional ("é porque é"), decorrente da evolução histórica e da consagração do uso pelos autores cultos, não se submetendo a regras de dedução lógica de causa e efeito.
...
1. Adjetivo: Expressa característica, qualidade ou estado atribuído a um substantivo (apto a, responsável por, furioso com, propenso a/para, imune a/de, contrário a, capaz de, ávido por/de, sensível a, inútil para/a, desejoso de, curioso por/para/de, avesso a/em, receoso de/em, passível de, suscetível a, sujeito a, eficaz em, restrito a, inconsciente de, necessário a, relacionado com/a).
2. Advérbio: Modifica verbo, adjetivo ou outro advérbio, exprimindo circunstância; quando possui base nominal ou temporal/espacial relacional, comanda complemento preposicionado (longe de, perto de, depois de).
...
- Incorreto: É difícil ignorar a sensação estamos sendo vigiados.
- Correto: É difícil ignorar a sensação de que estamos sendo vigiados.
- Correto: Não houve a necessidade de que outros clientes fossem contatados.
...
| --- | --- | --- | --- |
| Acostumado | Adjetivo | a / com | acostumado a acordar cedo / acostumado com a rotina |
| Adaptado | Adjetivo | a / de / para | adaptado ao clima / adaptado do original / adaptado para crianças |
| Capacidade | Substantivo | de / para | capacidade de liderança / capacidade para o trabalho |
| Querido | Adjetivo | de / por | querido de todos / querido por seus colegas |
| Satisfeito | Adjetivo | com / de / em / por | satisfeito com o salário / satisfeito de/em/por vencer |
| Aversão | Substantivo | a / por (rejeita de) | aversão a pessoas superficiais / aversão por injustiças |
| Propenso | Adjetivo | a / para | propenso a maus hábitos / propenso para o vício |
| Imune | Adjetivo | a / de | imune a crises / imune de impostos |
| Ávido | Adjetivo | por / de | ávidos por condições / ávidos de poder |
| Curioso | Adjetivo | por / para / de | curioso por/para/de conhecer a verdade |
| Desejo / Orgulho | Substantivo | de / por | desejo de/por vencer / orgulho de/por seu ofício |
| Avesso / Receoso | Adjetivo | a ou de / em | avesso à/em rotina / receoso de/em errar |
| Inútil | Adjetivo | para / a | inútil para a reutilização / inútil à reutilização |
| Relacionado(a) | Adjetivo | com / a | relacionada com a disciplina / relacionada à disciplina |
| Intenção | Substantivo | de / em | intenção de difamar / intenção em difamar |
...
1. Preposição Diante de Pronomes Possessivos Femininos:
...
1. Formação de Crase por Regência Nominal em Substituições:
...
1. Combinação Prepositiva Masculina:
...
1. Precisão Semântica das Preposições: Distinguir pares parônimos:
...
1. O Erro Normativo Inconteste nas Correlações:
...
| Código / Referência | Conceito / Regra Canônica | Formulação Sintética da Norma-Padrão | Unidade Temática |
| --- | --- | --- | --- |
|  | Mediação Preposicional Obrigatória | Todo complemento de nome (substantivo, adjetivo, advérbio) liga-se ao termo regente por preposição. |  |
|  | Tríade Nominal | "Nome" para a sintaxe compreende exclusivamente substantivos, adjetivos e advérbios. |  |
|  | Obrigatoriedade de "De" em Completivas | Substantivos abstratos exigem a preposiçãode antes de orações introduzidas por que (dúvida de que). |  |
|  | Invariância Semântica na Dupla Regência | A alternância entre preposições autorizadas para um mesmo nome não altera o sentido nuclear. |  |
|  | Crase em Regência Nominal | Preposiçãoa exigida pelo nome + artigo feminino a resulta em crase obrigatória (à). |  |
|  | Regência do VerboPreferir | VTDI: exige OD sem preposição e OI com preposiçãoa (rejeita "mais que", "do que"). |  |
|  | Simetria Correlativa Obrigatória | Correlações exigem simetria absoluta:de... a... (sem crase) ou da... à... (com crase). |  |
...
3. Classificar a Natureza Morfossintática do Regente:

1. Confrontar com o Regime Padrão Dicionarizado: Verificar se a preposição usada é a exigida pela norma culta ou se pertence ao rol de dupla regência legítima.
2. Verificar a Ocorrência de Fusão com Artigo (Crase ou Combinação): Se o nome reger a e o termo regido for substantivo feminino com artigo, validar a crase (à); se masculino, validar a combinação (ao).
...
3. Se a inserção mantiver a naturalidade e a correção morfossintática (a certeza, a necessidade, a ampliação), o vocábulo é categoricamente um substantivo.
...
| Eixo de Comparação | Conceito / Estrutura A | Conceito / Estrutura B | Critério Decisivo de Diferenciação |
| --- | --- | --- | --- |
| Regência Verbal vs. Nominal | Regência Verbal: rege complementos verbais diretos (sem prep.) ou indiretos (com prep.). | Regência Nominal: rege complemento nominal sempre intermediado por preposição. | A regência nominal jamais admite complementação direta sem preposição na norma culta. |
| Semântica de Preposições | Sobre: indica posição superior, incidência de impacto ou assunto (impacto sobre). | Sob: indica posição inferior física, tutela ou subordinação (sob o comando). | O impacto de um projeto ou evento incidesobre a sociedade (não sob). |
| Extensão Semântica do Artigo | Preposição Pura (a + plural): expressa generalização (aversão a pessoas). | Crase (às + plural): expressa determinação e especificação (aversão às pessoas). | A inclusão do artigo restringe e determina o universo referencial do substantivo. |
| Paralelismo em Bancas | FGV / Gramática Tradicional: considera a quebra de simetria recurso estilístico legítimo. | CEBRASPE / CESPE: tende a punir a quebra de simetria formal como erro de redação. | Na FGV, prioriza-se a regência e pontuação; no CEBRASPE, exige-se simetria rígida. |
| Contexto Técnico vs. Geral | Comum a / de: obrigatório no domínio técnico gramatical (comum de dois gêneros). | Comum em: aceito exclusivamente em sentido locativo/circunstancial (comum em festas). | O domínio conceitual da frase restringe a escolha da preposição cabível. |

---

## Exemplos comentados

- Item A: "A entidade responsável  fazer o estudo..." $\rightarrow$ por (responsável = Adjetivo).
- Item B: "Depois  um longo período..." $\rightarrow$ de (depois = Advérbio).
- Item C: "Ficou furioso  os alunos." $\rightarrow$ com (furioso = Adjetivo).
- Item D: "Não houve a necessidade  que outros clientes fossem contatados." $\rightarrow$ de (necessidade = Substantivo).
- Item E: "Foi anunciada a ampliação  nossas reservas..." $\rightarrow$ de ou das (ampliação = Substantivo; artigo facultativo diante de possessivo).
- Item F: "Não há dúvida  que os números são bons." $\rightarrow$ de (dúvida = Substantivo).
- Item G: "Tinha aversão  pessoas superficiais." $\rightarrow$ a ou por (aversão = Substantivo de dupla regência; rejeita de).
- Item H: "Era propenso  maus hábitos." $\rightarrow$ a ou para (propenso = Adjetivo de dupla regência).
- Item I: "Estamos imunes  crises existenciais." $\rightarrow$ a ou de (imunes = Adjetivo de dupla regência).
...
- Gabarito Consolidado: Letra E (ávidos por conhecer).
...
- Gabarito Consolidado: Letra B (estruturas passíveis de rompimento).
...
- Gabarito Consolidado: Letra D (maneiras eficazes no combate à pobreza).
...
- Gabarito Consolidado: Letra A (regência nominal).
...
- Gabarito Consolidado: Letra A (de que).
...
- Q12 (Pref. São Cristóvão): Em "necessários ao bom andamento", "ao" é a fusão de preposição "a" (exigida por necessários) com artigo "o". $\rightarrow$ Certo.
- Q13 (MPU): A substituição de "relacionada com" por "relacionada à", embora mantivesse o sentido, prejudicaria a correção gramatical. $\rightarrow$ Errado (a dupla regência mantém a correção e o sentido).
- Q14 (PGE-PE): Em "intenção de difamar", a troca de "de" por "em" mantém a correção gramatical. $\rightarrow$ Certo (dupla regência legítima).
...
Ao concluir o estudo deste grupo temático consolidado, o estudante adquire as seguintes competências práticas e teóricas:

1. Identificar com Precisão a Regência Nominal: Reconhecer a subordinação mediada por preposição obrigatória entre nomes (substantivos, adjetivos e advérbios) e seus complementos.
2. Aplicar Testes Diagnósticos Rápidos: Usar o teste do artigo anteposto para confirmar a natureza substantiva do termo regente e reordenar orações relativas para expurgar preposições indevidas.
3. Dominar Casos de Dupla Regência: Conhecer o repertório dos nomes que aceitam preposições alternativas (acostumado a/com, aversão a/por, relacionada com/a, intenção de/em) e não reprovar opções cultas legítimas.
4. Exigir a Preposição em Completivas Nominais: Detectar e corrigir a omissão indevida da preposição de antes de orações iniciadas pela conjunção integrante que (dúvida de que, sensação de que).
5. Diferenciar Sentido Genérico e Determinado com Crase: Compreender a mecânica da preposição pura no singular diante de plurais (generalização) contra a ocorrência de crase (especificação).
6. Compreender as Nuances das Bancas Examinadoras: Identificar as preferências da FGV (tolerância ao estilo e ênfase no verbo preferir) contra o rigor de simetria do CEBRASPE e as pegadinhas em concessivas falsas.
