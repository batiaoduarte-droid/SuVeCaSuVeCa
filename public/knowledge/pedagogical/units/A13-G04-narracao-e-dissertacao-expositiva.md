...
```text
 ...
 ┌─────────────────────────────┴─────────────────────────────┐
 ▼ ▼
 (Contar uma História / (Discorrer sobre um TEMA /
 Relato de Acontecimentos) Conceituar e Esclarecer)
 │ │
 ┌────────┴────────┐ ┌────────┴────────┐
 ▼ ▼ ▼ ▼
PROGRESSÃO TEMPOS VERBAIS EXPOSITIVO ARGUMENTATIVO
TEMPORAL PREDOMINANTES (Impessoal / (Defesa de tese
(Sucessão de • Pretérito Perfeito Sem persuasão) pessoal autoral)
ações em antes • Presente Histórico │
e depois) ┌────────┴────────┐
 ▼ ▼
 ...
 (Macroestrutura expositiva
 com microestrutura narrativa)
```
...
|:--------------------------------------------- |:----------------------------------------------------------------------------- |:----------------------------------------------------------------- |:-------------------------------------------------------------------------- |:--------------------------------------------------------------- |
| **Finalidade Primária** | Contar uma história / relatar fatos particulares vivenciados por agentes | Apresentar, conceituar e explicar noções gerais sobre um assunto | Transmitir dados, pesquisas e fatos que trazem**novidades** ao leitor | Defender uma tese autoral e persuadir o leitor |
...
| **Tratamento de Opiniões de Terceiros** | Falas de personagens (diálogos/discurso direto e indireto) | Citações teóricas conceituais | Declarações tratadas como**fato** noticiado pelo autor | Argumentos de autoridade a serviço da tese do autor |
| **Exemplo Típico da Aula** | Rotina de Cleber de Souza  / Drama familiar na guerra  | Conceito de*Smart Contracts*  | Benefícios do cochilo diurno  / IA na Educação  | Artigos de opinião com juízos de valor subjetivos explícitos |
...
Ao concluir o estudo do grupo `esta unidade`, o estudante deve dominar a distinção categórica entre **Narração** e **Dissertação Expositiva/Informativa**, compreendendo que:
