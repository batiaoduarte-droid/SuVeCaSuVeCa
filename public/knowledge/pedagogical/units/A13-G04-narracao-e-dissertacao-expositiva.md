# Narração e Dissertação Expositiva

---

> **Objetivo de aprendizagem**
>
> Compreender e definir os princípios normativos e conceituais de Narração e Dissertação Expositiva. Aplicar regras canônicas e procedimentos decisórios de Narração e Dissertação Expositiva na resolução de questões. Analisar o papel de Narração e Dissertação Expositiva no eixo Apoio estrutural e reconhecer armadilhas e variações de bancas.
...
**Apoio estrutural:** Mapear verbos, participantes e relações ajuda a comparar narração e exposição, sem substituir critérios de organização, finalidade e progressão textual.
...
1. Predomínio de verbos no Pretérito Perfeito do Indicativo: Emprego de formas verbais que expressam fatos pontuais concluídos no passado (ex.: morreu, serviram, desapareceram na narração; criou, representou, foi relacionada, mostraram na dissertação expositiva).
2. Sucessão Cronológica de Ações: Organização dos eventos em uma linha temporal encadeada por relações de anterioridade e posterioridade (antes e depois).
3. Marcadores Temporais e Cronológicos: Presença de adjuntos adverbiais de tempo, datas e anos específicos (ex.: em 2016, em 11 de fevereiro, nos primeiros meses da guerra).
...
1. Intenção Narrativa (Contar História): O autor tem o objetivo primordial de relatar acontecimentos vivenciados por personagens específicos situados no tempo e no espaço, compondo um enredo/trama com início, meio e desfecho (ex.: o drama existencial de uma família durante a guerra).
...
- Eixo Temporal Dinâmico: Encadeamento de ações em linha sucessiva de anterioridade e posterioridade (antes e depois).
- Tempo Verbal Canônico (Pretérito Perfeito): Utilização preferencial de verbos no pretérito perfeito do indicativo para indicar ações pontuais concluídas no passado (acordou, vestiu, partiu, pagou, criou).
- Recurso do Presente Histórico (ou Narrativo): Possibilidade de flexionar os verbos no tempo presente do indicativo com o valor funcional de passado (introduz a chave, a porta não abre, o funcionário chega). Esse recurso confere dinamicidade, vivacidade e atualidade ao relato sem retirar dele o estatuto de narrativa cronológica.
- Foco Discursivo: Relatar os desdobramentos de fatos particulares vivenciados por indivíduos (reais ou fictícios).
...
3. Equivalência Terminológica em Concursos: A banca Cebraspe frequentemente utiliza a expressão simplificada "texto informativo" para designar a dissertação expositivo-informativa. Todo texto informativo é, por definição tipológica, um texto dissertativo expositivo.
...
- Regra Operacional: A presença de pontos de vista citados não transforma a exposição em argumentação autoral.
...
- Critério da Intenção Comunicativa:  estabelece que a classificação tipológica soberana depende da finalidade do autor (relatar fatos particulares de personagens $\rightarrow$ Narração; expor e esclarecer conhecimentos $\rightarrow$ Dissertação Expositiva).
- Regra da Vinculação ao Tema:  define que texto que orbita em torno de um tema central conceitual é dissertativo, ainda que contenha datas e cronologia pretérita.
- Regra da Equivalência Expositivo-Informativa:  define que todo texto informativo é, em sua essência discursiva, uma dissertação expositiva caracterizada pela veiculação de novidades ao público.
- Regra da Opinião de Terceiros:  estipula que a menção a pontos de vista ou declarações de autoridades externas é tratada pelo autor como dado factual, não descaracterizando a dissertação expositiva.
- Regra do Hibridismo Tipológico:  estabelece a coexistência hierarquizada entre a tipologia predominante do texto global (macroestrutura) e a tipologia de sequências internas ilustrativas (microestrutura).
...
1. Verificar a Presença do Tema ("Mantra"): Identificar o núcleo conceitual reiterado no texto. Havendo tema condutor (leis, tecnologias, eventos científicos), trata-se de dissertação.
2. Validar as Marcas Linguísticas sem Mecanicismo:
...
1. Avaliar Eventual Hibridismo: Se o texto global for dissertativo, mas um parágrafo narrar um caso particular/hipotético de uma personagem, reconhecer a convivência de microestrutura narrativa em macroestrutura dissertativa.
...
| Critério de Comparação | Texto Narrativo | Dissertação Expositiva Pura | Dissertação Expositivo-Informativa | Dissertação Argumentativa |
| --- | --- | --- | --- | --- |
| Finalidade Primária | Contar uma história / relatar fatos particulares vivenciados por agentes | Apresentar, conceituar e explicar noções gerais sobre um assunto | Transmitir dados, pesquisas e fatos que trazemnovidades ao leitor | Defender uma tese autoral e persuadir o leitor |
| Eixo Organizador | Enredo, personagens, tempo e espaço cronológicos | Tema central conceitual | Tema central articulado a descobertas e dados novos | Tese e juízos de valor subjetivos do autor |
| Tempos Verbais Típicos | Pretérito Perfeito ou Presente Histórico (sucessão) | Presente do Indicativo ou Pretérito Perfeito (contextual) | Pretérito Perfeito (relato de estudos) e Presente | Presente e Pretérito articulados a modalizadores argumentativos |
| Tratamento de Opiniões de Terceiros | Falas de personagens (diálogos/discurso direto e indireto) | Citações teóricas conceituais | Declarações tratadas comofato noticiado pelo autor | Argumentos de autoridade a serviço da tese do autor |
| Exemplo Típico da Aula | Rotina de Cleber de Souza  / Drama familiar na guerra  | Conceito deSmart Contracts  | Benefícios do cochilo diurno  / IA na Educação  | Artigos de opinião com juízos de valor subjetivos explícitos |
...
- Intenção do autor: Relatar episódios dramáticos vivenciados por integrantes de sua própria família.
- Classificação: Texto Narrativo.
...
- Intenção do autor: Apresentar e esclarecer a origem e a importância de uma data temática internacional.
- Tema central: Dia Internacional das Mulheres e Meninas na Ciência.
- Classificação: Dissertação Expositiva (não é narração, apesar das datas e verbos no passado).
...
Ao concluir o estudo desta unidade, o estudante deve dominar a distinção categórica entre Narração e Dissertação Expositiva/Informativa, compreendendo que:

1. A análise morfológica de superfície (verbo no pretérito perfeito + marcadores temporais) é enganosa, pois ambos os tipos textuais podem relatar acontecimentos passados encadeados cronologicamente.
2. O critério decisório absoluto é a intenção comunicativa do autor: relatar uma história centrada em personagens vivenciando peripécias particulares ($\rightarrow$ Narração) versus expor conhecimentos, contextualizar marcos históricos ou explicar um tema conceitual ($\rightarrow$ Dissertação Expositiva).
3. Todo texto informativo é, por natureza estrutural, dissertativo expositivo focado em novidades ao leitor.
4. Citações de opiniões de terceiros em artigos científicos ou notícias constituem relato factual para o autor, não transformando o texto em dissertativo argumentativo.
5. A narração admite com frequência o uso do presente histórico, mantendo seu caráter de sucessão de ações dinâmicas.
6. Em textos complexos, é comum o hibridismo tipológico, no qual um texto predominantemente dissertativo utiliza um parágrafo narrativo subordinado como ilustração didática.
