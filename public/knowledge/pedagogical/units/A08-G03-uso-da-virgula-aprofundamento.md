...
**Método central:** Casos avançados de vírgula exigem comparar posição canônica, deslocamento, intercalação, coordenação, subordinação e mudança de sentido.
...
- Reconhecimento das classes de palavras: substantivo, adjetivo, verbo, pronome relativo, conjunção integrante, conjunções subordinativas adverbiais e conjunções coordenativas.
...
A08-esta unidade: USO DA VÍRGULA — APROFUNDAMENTO
 ├── 1. ESTRUTURA SINTÁTICA FUNDAMENTAL (PROIBIÇÕES DO SVC)
 │ ├── Proibição de vírgula entre Sujeito e Verbo (Simples, Composto em enumeração ou Oracional/Extenso)
 │ └── Proibição de vírgula entre Verbo e Complementos (Objeto Direto/Indireto simples ou Oracional)
 ...
 │ │ └── Retirar vírgula ──► ERRO GRAMATICAL / INCOERÊNCIA.
 │ └── Só Pode Ser Restritiva (Contexto textual fixa multiplicidade prévia)
 │ └── Inserir vírgula ──► ERRO GRAMATICAL / INCOERÊNCIA.
 ├── 3. TERMOS E EXPRESSÕES DE ISOLAMENTO OBRIGATÓRIO
 ...
 │ └── Vírgula Sobrecarregada (Dupla Função): Fecha aposto e oração adverbial concorrente.
 ├── 4. TERMOS E ORAÇÕES ADVERBIAIS (MNEMÔNICO 6C + FTP)
 ...
 ├── 5. CASUÍSTICA DA CONJUNÇÃO ADITIVA "E" (5 CASOS)
 ...
 │ └── 5. Polissíndeto (repetição estilística e enfática) ──► OBRIGATÓRIA
 └── 6. MATRIZ CONSOLIDADA DE VÍRGULA FACULTATIVA (QUESTÕES DE SUPRESSÃO)
 ├── Caso 1: Termos e orações adverbiais na ordem direta (ao final do período)
 ├── Caso 2: Adjunto adverbial curto deslocado (até 2 palavras)
 ├── Caso 3: Conjunção "e" entre sujeitos diferentes ou com valor adversativo/conclusivo
 └── Caso 4: Orações adjetivas explicativas em contextos de referente múltiplo (altera sentido)
```
...
- *Reduzida de Gerúndio:* `O aluno [dedicando-se aos estudos] atinge seu objetivo.` (= *que se dedica*)
...
- **Contrasta:** Restrição vs. Explicação
- **Mnemônico associado:**
- **Citado em:**
...
- **Explicar:** Consiste em manter/reiterar a declaração antecedente, apresentando-a sob outra formulação ou esclarecendo seu alcance sem substituir o conteúdo (*"A corrupção era identificada com vícios, ou seja, tudo aquilo que causa caos social"*).
- **Retificar:** Consiste em corrigir, emendar ou substituir uma informação inexata ou incompleta anteriormente proferida (*"Chegamos às dez horas, ou melhor, às dez e meia"*).
...
1. **Sujeito Composto em Enumeração:** As vírgulas separam os núcleos coordenados entre si, mas é **proibido** inserir vírgula após o último núcleo imediatamente antes do verbo (*"As discussões, os relatórios, as publicações apontaram..."* -> colocar vírgula após *publicações* quebra a ligação com *apontaram*).
...
- *Incorreto (Objeto Oracional):* `O diretor afirmou, que todos seriam promovidos.` (Vírgula proibida após afirmou).
...
3. **Caso 3 — Orações coordenadas aditivas com SUJEITOS DIFERENTES:** **FACULTATIVA**.*Exemplo:* *A abordagem didática ministrou a aula, e os alunos tomaram notas.* (Sujeito 1: *A abordagem didática*; Sujeito 2: *os alunos*. A vírgula é facultativa estilisticamente para evitar ambiguidade; **nunca é obrigatória**).
4. **Caso 4 — Conjunção "e" com valor ADVERSATIVO (= mas) ou CONCLUSIVO (= portanto):** **FACULTATIVA** (mesmo com sujeitos idênticos).*Exemplo:* *Estudou dia e noite, e não conseguiu a vaga.* (= *mas não conseguiu*; vírgula facultativa).
5. **Caso 5 — Polissíndeto (repetição estilística e enfática do conectivo):** **OBRIGATÓRIA**.
 *Exemplo:* *E chora, e grita, e corre, e desespera-se.* (Vírgula obrigatória antes de cada "e" repetido).

- **Dica mnemônica:**
- **Recomendação de redação discursiva:**
- **Alerta crítico:**
- **Aplicação:**
- **Glossário:**
...
1. **Termos e Orações Adverbiais na Ordem Direta:** Posicionados ao final do período (após a oração principal ou verbo).*Ex:* *Ligue-me amanhã.* / *Ligue-me, amanhã.* | *Avisem-me caso haja mudanças.* / *Avisem-me, caso haja mudanças.*
2. **Adjunto Adverbial Curto Deslocado:** Expressão circunstancial não oracional composta por até 2 palavras no início ou meio da oração.*Ex:* *Pela manhã, ele saiu.* / *Pela manhã ele saiu.*
3. **Conjunção "E" entre Sujeitos Diferentes ou com Valor Adversativo/Conclusivo:***Ex:* *A chuva cessou, e o sol reapareceu.* / *A chuva cessou e o sol reapareceu.*
4. **Orações Adjetivas Explicativas em Contexto de Dupla Leitura:**
 Casos em que o antecedente admite multiplicidade fática. A retirada da vírgula transforma a oração em restritiva: preserva a correção gramatical e a coerência, alterando apenas o sentido.
...
| Elemento Canônico | Regra / Classificação Sintática | Padrão de Pontuação | Impacto da Supressão / Alteração | ID de Detalhe |
|:-------------------------------------------------------- |:---------------------------------------------------- |:----------------------------------------------------------- |:--------------------------------------------- |:----------------- |
| **Ordem Canônica SVC** | Sujeito-Verbo-Complemento | **Proibida** qualquer vírgula interna no nexo | Inserção gera erro gramatical grave |  |
| **Oração Adjetiva Restritiva** | Delimita subgrupo ("Somente" / Há mais de um) | **Sem vírgulas** | Inserção muda sentido para explicativa |  |
| **Oração Adjetiva Explicativa** | Caracteriza totalidade ("Só há um") | **Isolada por vírgulas** (ou travessões/parênteses) | Retirada muda sentido para restritiva |  |
| **Adjetiva em Referente Único** | Antecedente único no universo (*Homem*, *Mãe*) | **Obrigatória** (Explicativa) | Retirada gera erro gramatical e incoerência |  |
| **Adjetiva em Contexto Múltiplo Fixado** | Contexto declara pluralidade (*Tenho 2 irmãos*) | **Proibida** (Restritiva) | Inserção gera erro gramatical e incoerência |  |
| **Expressões Explicativas/Retificativas** | *Ou seja*, *isto é*, *ou melhor*, *a saber* | **Obrigatórias** entre vírgulas | Supressão gera erro gramatical |  |
| **Vírgula Vicária (Elipse Verbal)** | Marca supressão anafórica de verbo anterior | **Obrigatória** no lugar do verbo | Supressão gera agramaticalidade/ambiguidade |  |
| **Aposto Explicativo** | Núcleo substantivo explicando outro substantivo | **Obrigatória** (Vírgulas/Travessões/Parênteses) | Alternância de sinais mantém coerência |  |
| **Oração Adverbial na Ordem Direta** | Posicionada ao final do período (6C+FTP) | **Facultativa** | Supressão mantém correção e coerência |  |
| **Oração Adverbial Deslocada** | Posicionada no início ou intercalada (6C+FTP) | **Obrigatória** (qualquer extensão) | Supressão gera erro gramatical |  |
| **Adjunto Adverbial Curto Deslocado** | Circunstância com até 2 palavras no início/meio | **Facultativa** | Supressão mantém correção e coerência |  |
| **Adjunto Adverbial Longo Deslocado** | Circunstância com 3 ou mais palavras | **Obrigatória** | Supressão gera erro gramatical |  |
| **Conjunção "E" em Enumeração / Mesmo Sujeito** | Ligação de termos ou orações de sujeito idêntico | **Proibida** | Inserção gera erro gramatical |  |
| **Conjunção "E" com Sujeitos Distintos** | Sujeito 1 diferente do Sujeito 2 | **Facultativa** (Nunca obrigatória) | Supressão mantém correção e coerência |  |
| **Conjunção "E" em Polissíndeto** | Repetição enfática e reiterada do conectivo | **Obrigatória** antes de cada elemento | Supressão desfaz a figura de linguagem |  |
...
```text
 ...
 │
 Fazer o Teste de Unicidade do Referente:
 "No contexto, pode haver mais de um elemento?"
 │
 ┌───────────────────────┴───────────────────────┐
 ▼ ▼
 SIM (Referente Múltiplo) NÃO (Referente Único)
 [Cenário 1: Duas Leituras] [Cenário 2: Leitura Única]
 │ │
 ┌────────────────┴────────────────┐ ┌────────────────┴────────────────┐
 ▼ ▼ ▼ ▼
Com Vírgulas Sem Vírgulas Antecedente Único Contexto Múltiplo
(Explicativa) (Restritiva) (Homem, Tejo, Mãe) Declarado no Texto
 │ │ │ │
 └────────────────┬────────────────┘ ▼ ▼
 │ SÓ PODE SER EXPLICATIVA SÓ PODE SER RESTRITIVA
 ▼ (Exige vírgulas) (Proíbe vírgulas)
 VÍRGULAS SÃO OPCIONAIS │ │
 • Inserir/retirar vírgulas: ▼ ▼
 ✔ MANTÉM a correção gramatical Alterar pontuação: Alterar pontuação:
 ❌ ALTERA o sentido do texto ❌ GERA ERRO GRAMATICAL ❌ GERA ERRO GRAMATICAL
 ❌ GERA INCOERÊNCIA ❌ GERA INCOERÊNCIA
```
...
4. Adjetiva explicativa em contexto de referente múltiplo. aposto, polissíndeto, etc.)
 │ │
 ▼ ▼
 VÍRGULA É FACULTATIVA VÍRGULA É OBRIGATÓRIA
 • Supressão NÃO prejudica a correção • Supressão PREJUDICA a correção
 • Se o item diz "prejudica" -> ERRADO • Se o item diz "prejudica" -> CERTO
 • Se o item diz "mantém correção" -> CERTO • Se o item diz "mantém correção" -> ERRADO
```
...
| Critério Comparativo | Oração Adjetiva Restritiva | Oração Adjetiva Explicativa |
|:-------------------------------------- |:---------------------------------------------- |:-------------------------------------------------------- |
| **Pontuação** | **Sem vírgulas** | **Isolada por vírgulas** (travessões/parênteses) |
| **Chave Semântica** | **"SOMENTE"** | **"SÓ HÁ UM"** / Totalidade |
| **Pressuposto de Referente** | Há mais de um elemento no grupo de referência | Elemento único ou propriedade universal da classe |
| **Função no Texto** | Delimita e restringe um subgrupo | Acrescenta explicação/característica geral acessória |
| **Efeito em Referente Múltiplo** | Restringe a declaração ao subgrupo | Aplica a declaração a todos os membros |
| **Efeito em Referente Único** | Inadmissível (gera erro lógico/gramatical) | Canônica e obrigatória |
...
|:-------------------------------- |:------------------------------------------------ |:---------------------------------------------- |
| **Objetivo Comunicativo** | Reiterar a ideia anterior com outras palavras | Corrigir ou emendar uma informação imprecisa |
| **Substituição de Dado** | Não substitui; esclarece o dado | Substitui o termo anterior pelo termo corrigido |
| **Exigência de Vírgulas** | **Obrigatória** (isolada por vírgulas) | **Obrigatória** (isolada por vírgulas) |
| **Impacto da Supressão** | Prejudica a correção gramatical | Prejudica a correção gramatical |
...
|:----------------------------------- |:--------------------------------------------------------- |:---------------------------------------------- |
| **Natureza do Fenômeno** | Omissão de forma verbal expressa antes | Termo substantivo que explica outro substantivo |
| **Função da Vírgula** | Substituir o verbo elidido (função anafórica) | Isolar termo explicativo acessório |
| **Classe Gramatical do Termo** | **Adjetivo, Particípio ou Advérbio** (Predicativo) | **Substantivo** ou termo substantivado |
| **Mantra Diagnóstico** | Precede complemento/predicativo do verbo elidido | *"Aposto é caso de substantivo!"* |
| **Exemplo Típico** | *"suas tarefas, [forem] resolvidas"* | *"as tarefas, deveres do dia, foram feitas"* |
...
|:--------------------------------------- |:--------------------------------------------------- |:----------------------------------------------------------- |
| **Travessões duplos (`— —`)** | Conferem destaque visual e**ênfase** | Substituição por vírgulas mantém correção e coerência |
| **Parênteses ** | Conferem isolamento acessório e**desênfase** | Substituição por vírgulas mantém correção e coerência |
| **Vírgulas duplas `,,`** | Estilisticamente**neutras** | Podem ser substituídas por travessões ou parênteses |
...
|:------------------------------------------------- |:--------------------- |:---------------------------------------------------- |
| **Enumeração simples de termos** | **PROIBIDA** | O "e" já cumpre o papel conectivo aditivo final |
| **Orações com o MESMO sujeito** | **PROIBIDA** | Continuidade sintática do mesmo agente/sujeito |
| **Orações com SUJEITOS DIFERENTES** | **FACULTATIVA** | Evita ambiguidade; recomendada, mas não obrigatória |
| **Conjunção "e" adversativa / conclusiva** | **FACULTATIVA** | Equivale a*mas* ou *portanto* |
| **Polissíndeto (repetição enfática)** | **OBRIGATÓRIA** | Recurso estilístico de reiteração de conectivo |
...
- **Frase 3 (Reduzida de Gerúndio):** `O aluno [dedicando-se aos estudos] atinge seu objetivo.` -> Sem conectivo relativo; verbo no gerúndio descompactável em `que se dedica`.
...
- **Julgamento de Prova:** As vírgulas são **opcionais**. A alteração da pontuação mantém a correção gramatical e altera o sentido.
...
- **Resolução:** A propriedade de pôr ovos é universal para a espécie galinha. Suprimir as vírgulas implicaria criar um subgrupo inexistente ("somente as galinhas que põem ovos"), gerando incoerência semântica e erro gramatical.
- **Julgamento:** **ERRADO**.
...
- **Resolução:** O texto declarou previamente a existência de 2 irmãos e 3 processos. A oração adjetiva precisa obrigatoriamente restringir qual deles é o foco. Inserir vírgulas afirmaria que só existe um irmão/processo, contradizendo o texto.
- **Julgamento:** As vírgulas são **proibidas**. Inseri-las gera erro gramatical e incoerência.
...
- **Resolução:** O trecho equivale a `[que está] inserida...` (oração adjetiva reduzida de particípio). Como a "iniciativa Mãe Servidora" pode existir em múltiplos órgãos (referente múltiplo), admite explicação ou restrição. A supressão altera a sintaxe e o sentido, preservando a correção.
- **Gabarito:** **CERTO**.
...
- **Resolução:** No contexto comunicativo, o indivíduo tem apenas uma mãe (referente único). A oração `que lhe pede não mentir nunca` é estritamente explicativa. Retirar a vírgula restringe indevidamente o termo, gerando incoerência e erro gramatical.
- **Gabarito:** **ERRADO**.
...
- **Resolução:** Expressões explicativas e retificativas devem obrigatoriamente figurar isoladas por vírgulas. A supressão fere a norma padrão.
- **Gabarito:** **ERRADO**.
...
- **Resolução:** A vírgula substitui anaforicamente o verbo `é` expresso na oração anterior. A vírgula vicária é de uso obrigatório para assinalar a elipse.
- **Gabarito:** **CERTO**.
...
- **Resolução:** A vírgula marca a elipse do verbo `forem` (`suas tarefas [forem] resolvidas`). O termo `resolvidas` é particípio/adjetivo concordando com tarefas. Por não ser substantivo, não pode constituir aposto explicativo.
- **Gabarito:** **ERRADO**.
...
- **Resolução:** A conjunção `caso` introduz oração subordinada adverbial condicional situada no final do período (ordem direta). Na ordem direta, a vírgula é facultativa.
- **Gabarito:** **CERTO**.
...
- **Resolução:** O termo `as publicações` é o último núcleo do sujeito composto ligado diretamente ao verbo `apontaram`. É terminantemente proibido separar sujeito de verbo por vírgula.
- **Gabarito:** **ERRADO**.
...
- **Resolução:** Oração subordinada adverbial concessiva antecipada com verbo próprio (`possa imaginar`). Orações adverbiais deslocadas exigem vírgula obrigatória.
- **Gabarito:** **CERTO**.
...
- **Resolução:** O trecho é aposto explicativo (núcleo substantivo *suportes*). A vírgula pós-travessão já presente acumula a função de fechar o aposto e fechar a oração adverbial temporal antecipada iniciada por *Quando*. A troca mantém correção e coerência.
- **Gabarito:** **CERTO**.
...
- **Resolução:** `Em Alagoas` é adjunto adverbial de lugar deslocado composto por 2 palavras (curta extensão). Para adjuntos curtos, a vírgula é facultativa; sua supressão não prejudica a correção.
- **Gabarito:** **ERRADO**.
...
- **Resolução:** `saibam` é VTD e a oração iniciada por `que` é objeto direto oracional (*saibam isso*). A inserção violaria o princípio SVC.
- **Gabarito:** **CERTO**.
...
- **Resolução:** `O precursor do que viria a ser um jornal` é o sujeito completo de `foi`. É proibido separar sujeito de verbo por vírgula.
- **Gabarito:** **CERTO**.
...
- **O Mnemônico "Somente" vs. "Só Há Um":**Para saber se a frase exige ou dispensa vírgulas: encaixe mentalmente a palavra **"SOMENTE"** (se restringir um subgrupo em universo com mais de um elemento -> **Restritiva / Sem Vírgula**); se no contexto **"SÓ HÁ UM"** ou expressar verdade universal -> **Explicativa / Com Vírgula**.
- **Não "Viajar" em Hipóteses Esdrúxulas na Prova:**Não invente exceções biológicas, geográficas ou jurídicas fora do padrão textual (ex.: supor galinhas que não põem ovos ou bigamia). Bancas de concurso julgam a semântica padrão e o conhecimento compartilhado normal.
- **O Mantra do Aposto Explicativo:**Decore e repita: **"Aposto é caso de substantivo!"**. Se o elemento após a vírgula for adjetivo ou particípio (`resolvidas`, `inserida`), trata-se de predicativo por elipse verbal (vírgula vicária), nunca aposto.
- **Mnemônico das 9 Circunstâncias Adverbiais (6C + FTP):***6 C's:* Causal, Condicional, Comparativa, Conformativa, Concessiva, Consecutiva.*F-T-P:* Final, Temporal, Proporcional.Sentiu o "cheiro" de uma dessas conjunções: se estiver no final -> vírgula facultativa; se estiver deslocada -> vírgula obrigatória.
...
- **Confundir Adjetivo Simples com Oração Reduzida de Particípio:***Problema:* Classificar qualquer adjetivo terminado em `-do` (*aluno dedicado*) como oração reduzida.*Correção:* A oração reduzida retém transitividade e complementação verbal (*aluno dedicado aos estudos* = *que se dedica*).
- **Achar que Retirar Vírgulas de Adjetivas Nunca Gera Erro Gramatical:***Problema:* Decorar que a alteração de pontuação em oração adjetiva sempre é permitida.*Correção:* Em 20% das questões (leitura única), o antecedente é único (*O Tejo*, *O homem mortal*) ou fixado no texto (*Tenho 2 irmãos*). Nesses casos, alterar a vírgula provoca **erro gramatical e incoerência**.
- **Confundir "Alteração de Sentido" com "Erro Gramatical":***Problema:* Julgar como errada uma frase com referente múltiplo só porque mudou de explicativa para restritiva.*Correção:* Em termos que admitem multiplicidade (*a iniciativa Mãe Servidora*), a supressão altera o sentido, mas **a frase continua 100% correta gramaticalmente**.
- **Confundir Vírgula Vicária com Aposto Explicativo:***Problema:* A banca aponta uma vírgula entre sujeito e particípio (*tarefas, resolvidas*) e afirma que isola aposto.*Correção:* O aposto exige substantivo. Particípios e adjetivos atuam como predicativos sob elipse verbal.
- **Pegadinha da Enumeração no Sujeito Composto:***Problema:* Manter o ritmo de vírgulas da enumeração e colocar vírgula após o último núcleo (*As discussões, os relatórios, as publicações, apontaram*).*Correção:* O último núcleo liga-se diretamente ao verbo. A vírgula após o último item quebra o princípio SVC.
- **O Mito das "Duas Vírgulas Consecutivas" ao Substituir Travessão:***Problema:* Ver a estrutura `—,` e pensar que ao trocar o travessão por vírgula surgirão duas vírgulas seguidas (`,,`).*Correção:* A banca avalia o isolamento funcional. A vírgula existente assume dupla função (vírgula sobrecarregada).
- **Parâmetro Numérico de Curta Extensão (Regra das 2 Palavras):***Problema:* Dúvida sobre o limite de palavras para adjuntos adverbiais curtos.*Correção:* Padrão pacificado pelo Cebraspe: **até 2 palavras** = curto (facultativo); **3 ou mais palavras** = longo (obrigatório).
- **Mito da Vírgula Obrigatória Antes de "E" com Sujeitos Distintos:**
 *Problema:* Achar que sujeitos diferentes tornam a vírgula antes do "e" obrigatória.
 *Correção:* A vírgula é estritamente **facultativa**. Sua supressão nunca prejudica a correção gramatical.
...
- **Oração Subordinada Adjetiva Explicativa:** Oração que acrescenta uma qualidade acessória à totalidade do substantivo antecedente. Grafada **isolada por vírgulas** (sentido de "só há um" ou universalidade).
- **Oração Adjetiva Reduzida:** Oração adjetiva sem pronome relativo explícito cujo verbo surge flexionado no infinitivo, gerúndio ou particípio, passível de descompactação com pronome relativo.
- **Expressão Explicativa / Retificativa:** Locução conjuntiva ou adverbial (*ou seja*, *isto é*, *ou melhor*, *a saber*) empregada para esclarecer ou emendar uma declaração. Exige **isolamento obrigatório por vírgulas**.
- **Vírgula Vicária (Vírgula de Elipse):** Sinal de pontuação empregado obrigatoriamente para assinalar a elipse ou zeugma de um verbo expresso anteriormente no período, desempenhando função anafórica.
...
Ao concluir o estudo desta unidade (Uso da Vírgula - Aprofundamento)**, o estudante domina com precisão:

1. **A mecânica profunda das Orações Adjetivas:** Reconhecer orações adjetivas em suas formas desenvolvidas e reduzidas (gerúndio, infinitivo e particípio) por meio do teste da seta para o substantivo antecedente.
2. **A lógica semântica da pontuação:** Compreender que a vírgula é consequência gráfica do sentido: orações **restritivas** (sem vírgulas) expressam a ideia de *"SOMENTE"* em contextos de multiplicidade de elementos; orações **explicativas** (com vírgulas) expressam a ideia de *"SÓ HÁ UM"* ou aplicam-se à totalidade da classe.
3. **A tipologia de prova em bancas de alto nível:** Diferenciar questões de dupla leitura (80% dos casos — vírgulas facultativas com alteração de sentido e manutenção da correção gramatical) de questões de leitura única obrigatória (20% dos casos — termos universais/únicos exigem vírgulas e contextos prévios multiplicados proíbem vírgulas, sob pena de erro gramatical e incoerência).
4. **O isolamento de Expressões Explicativas e Retificativas:** Exigir o uso obrigatório de vírgulas em conectores como *ou seja*, *isto é* e *ou melhor*.
5. **O reconhecimento da Vírgula Vicária:** Identificar a vírgula que assinala a elipse de uma forma verbal anterior e distingui-la categoricamente do aposto explicativo por meio do princípio fundamental de que *"Aposto é caso de substantivo"*.
6. **A intangibilidade do padrão SVC:** Blindar o período contra a inserção indevida de vírgulas entre sujeito e predicado (mesmo em enumerações ou sujeitos extensos) e entre verbo transitivo e seu objeto (inclusive orações substantivas objetivas diretas).
7. **A regência posicional das Orações Adverbiais (6C + FTP):** Aplicar vírgula facultativa quando a oração adverbial estiver na ordem direta (ao final) e vírgula obrigatória quando antecipada ou intercalada.
8. **A dinâmica do Aposto e da Vírgula Sobrecarregada:** Operar a alternância entre travessões, parênteses e vírgulas reconhecendo que alterações de ênfase preservam a coerência e que uma única vírgula pode absorver dupla função sintática.
9. **A extensão de Adjuntos Adverbiais Deslocados:** Aplicar a regra objetiva de que até 2 palavras a vírgula é facultativa, tornando-se obrigatória a partir de 3 palavras.
10. **A casuística da conjunção "E":** Discernir as situações proibidas (enumeração e mesmos sujeitos), facultativas (sujeitos diferentes e valor adversativo) e obrigatórias (polissíndeto).
11. **O domínio do protocolo de Supressão:** Julgar com segurança itens que propõem a retirada de vírgulas confrontando-os com a matriz dos quatro casos de vírgula facultativa.
