...
1. Cenário 2 — Frases de Leitura Única Obrigatória (~20% dos casos — Alto Nível):
...
1. Identificar os Complementos: Formular a pergunta Verbo + quê/quem?.
...
1. Classificar Termos Adverbiais:
...
| --- | --- | --- |
| Travessões duplos (— —) | Conferem destaque visual eênfase | Substituição por vírgulas mantém correção e coerência |
| Parênteses | Conferem isolamento acessório edesênfase | Substituição por vírgulas mantém correção e coerência |
| Vírgulas duplas ,, | Estilisticamenteneutras | Podem ser substituídas por travessões ou parênteses |
...
| Conjunção "e" adversativa / conclusiva | FACULTATIVA | Equivale amas ou portanto |
...
Problema: Achar que sujeitos diferentes tornam a vírgula antes do "e" obrigatória. Correção: A vírgula é estritamente facultativa. Sua supressão nunca prejudica a correção gramatical.
