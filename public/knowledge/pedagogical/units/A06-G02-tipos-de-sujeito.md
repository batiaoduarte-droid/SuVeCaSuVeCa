...
>
> Compreender e definir os princípios normativos e conceituais de Tipos de Sujeito. Aplicar regras canônicas e procedimentos decisórios de Tipos de Sujeito na resolução de questões. Analisar o papel de Tipos de Sujeito no eixo Método central e reconhecer armadilhas e variações de bancas.
...
A localização do sujeito constitui o fundamento operacional de toda a sintaxe da oração, comandando as regras de concordância verbal, determinando a regência e estabelecendo as vedações de pontuação (proibição absoluta de separar sujeito e predicado por vírgula). O algoritmo opera nas seguintes fases:
...
A gramática unifica três formulações sinônimas: Sujeito Inexistente = Oração Sem Sujeito = Verbo Impessoal. Os três casos clássicos de impessoalidade são:
...
| --- | --- | --- | --- | --- | --- |
| 1. Sujeito Simples | SIM | Não há subdivisões | Apresentaexatamente um único núcleo substantivo explícito (inclusive se for pronome indefinido). | [O menino] chegou.[Alguém] acordou cedo. |  |
...
| 3. Sujeito Composto | SIM | Não há subdivisões | Apresentadois ou mais núcleos explícitos coordenados (e, nem, ou). | [João e Maria] chegaram.Andavam [bois, vacas e bezerros]. |  |
| 4. Sujeito Indeterminado | SIM (alguém) | (I) 3ª P. Plural(II) 3ª P. Sing. + SE(III) Infinitivo Impessoal | O agente existe, mas a estruturanão identifica quem é (sem referente prévio, com IIS ou infinitivo). | Chegaram cedo.Precisa-se de vendedores.É bom estudar. |  |
| 5. Sujeito Inexistente (Oração Sem Sujeito) | NÃO | (I) Haver = Existir(II) Fenômenos da Natureza(III) Haver/Fazer = Tempo | Construído comVerbos Impessoais (sem pessoa/agente). Verbo fixo na 3ª do singular. | Há alunos aqui.Chove muito. (literal)Faz dois anos que estudo. |  |
...
| --- | --- | --- | --- |
| "Eles acordaram cedo." | Sujeito Simples | O pronomeEles está expresso e grafado na oração como núcleo único. | Verbo na 3ª do plural com pronome explícito não é sujeito indeterminado. |
| "Eles acordaram e saíram." (análise de saíram) | Sujeito Oculto (Elíptico) | O verbosaíram não traz pronome ao lado, mas seu referente anafórico (Eles) está no contexto. | A existência de âncora textual prévia impede a indeterminação do sujeito. |
...
| "Alguém acordou cedo." | Sujeito Simples | O termoAlguém está grafado na frase como núcleo único (pronome indefinido substantivo). | O pronome é indefinido na morfologia; o sujeito é simples na sintaxe. |
...
| "Choveram elogios para ele." | Sujeito Simples | Verbo meteorológico em sentido figurado/conotativo (significaocorrer em abundância). | O termoelogios é o núcleo do sujeito simples; o verbo flexiona no plural. |
| "Houve duas rebeliões." | Sujeito Inexistente | Verbohaver com sentido de existir/ocorrer é impessoal; duas rebeliões = Objeto Direto. | Invariável no singular; erro grave tentar pluralizar ("houveram"). |
| "Ocorreram duas rebeliões." | Sujeito Simples | Verboocorrer é verbo pessoal pleno; duas rebeliões = Sujeito Simples posposto. | Flexiona compulsoriamente no plural para concordar com o núcleorebeliões. |
| "Alugam-se casas." | Sujeito Simples (Paciente) | Verbo transitivo direto comse PA; equivale a "Casas são alugadas". | Há sujeito expresso (casas); o verbo concorda obrigatoriamente no plural. |
| "Precisa-se de vendedores." | Sujeito Indeterminado | Verbo transitivo indireto comse IIS; o termo de vendedores é objeto indireto. | O termo é preposicionado e não pode ser sujeito; o verbo fica fixo no singular. |
...
> "Sujeito oracional é aquele que tem verbo." Se o bloco identificado como sujeito contém um verbo em seu interior (desenvolvido ou reduzido no infinitivo), a classificação sintática é compulsoriamente Oracional, independentemente da presença de conjunção integrante.
