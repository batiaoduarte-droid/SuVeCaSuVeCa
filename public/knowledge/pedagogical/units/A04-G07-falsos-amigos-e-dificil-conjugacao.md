# Falsos Amigos e Difícil Conjugação
...
1. Líderes e Bons Amigos (Irregulares): Verbos base (VER, VIR, PÔR, TER) e seus cognatos diretos (rever, advir/convir, depor, conter). Este grupo responde por 60% a 70% das questões de provas de concurso.
2. Falsos Amigos: Verbos que parecem derivados dos líderes, mas adotam paradigmas regulares distintos em vários tempos (PROVER e REQUERER).
3. Verbos de Difícil Conjugação: Grupo de alta incidência estatística caracterizado por anomalias, defectividades ou radicais atípicos (CABER, CRER, HAVER, IR, APRAZER, ADERIR).
4. Verbos em -EAR / -IAR e Defectivos: Regras ortográfico-flexionais de verbos em -EAR (macaquear, arrear), -IAR (maquiar, arriar) e defectivos especiais (REAVER, PRECAVER-SE).
...
1. A Única Irregularidade (Ditongação em "EI"):
...
1. O Macete "Se Perder a Fé, Use BEBER":
...
1. Verbo APRAZER (Defectivo de 3ª Pessoa):
...
| Verbo | Classificação | Paradigma / Líder | Formas Primitivas Decisivas | Derivações / Formas Críticas |
| --- | --- | --- | --- | --- |
| PROVER | Falso Amigo deVER | VER (Presentes) / BEBER (Demais) | Pres. Ind:provejo; Pret. Perf: proveu / proveram | Pres. Subj:proveja; Imp. Subj: provesse; Fut. Subj: prover |
| PROVIR | Bom Amigo deVIR | VIR (Todos os tempos) | Pres. Ind:provém / provêm; Pret. Perf: proveio / provieram | Imp. Subj:proviesse; Fut. Subj: provier |
| REQUERER | Falso Amigo deQUERER | BEBER (Geral) + Ditongo EI (Pres.) | Pres. Ind:eu requeiro / ele requer; Pret. Perf: requereu / requereram | Pres. Subj:requeira; Imp. Subj: requeresse; Fut. Subj: requererem |
| CABER | Irregular (2ª conj.) | Próprio / Derivação | Pres. Ind:eu caibo; Pret. Perf: coube / couberam | Pres. Subj:caiba; Mais-que-perf: coubera; Imp. Subj: coubesse; Fut. Subj: couber |
| CRER | Irregular (2ª conj.) | BEBER (Apoio) | Pres. Ind:eu creio; Pret. Perf: eu cri / eles creram | Pres. Subj:creia; Imp. Ind: cria; Particípio: crido |
| HAVER | Anômalo / Abundante | Próprio | Pres. Ind:hei, hás, há, havemos/hemos, haveis/heis, hão; Pret. Perf: houve / houveram | Pres. Subj:haja; Mais-que-perf: houvera; Imp. Subj: houvesse; Fut. Subj: houver |
| APRAZER | Defectivo (3ª pessoa) | HAVER (Pret. Perf.) | Pres. Ind:ele apraz / eles aprazem; Pret. Perf: aprouve / aprouveram | Mais-que-perf:aprouvera; Imp. Subj: aprouvesse; Fut. Subj: aprouver |
| IR | Anômalo | Próprio | Pres. Ind:vou, vais, vai, vamos, ides, vão; Pres. Subj: vá, vás, vá, vamos, vades, vão | Fut. Subj:for / fores / formos / fordes / forem; Particípio: ido |
| ADERIR | Irregular (Alternância) | FERIR | Pres. Ind:eu adiro / ele adere; Pret. Perf: aderiu / aderiram | Pres. Subj:adira, adiras, adira, adiramos, adirais, adiram |
...
2. Extraia a desinência terminal -o (caib-, crei-, adir-).
3. Adicione a vogal temática oposta: -a para 2ª/3ª conjugação (-ER/-IR) ou -e para 1ª conjugação (-AR).
4. Acople as desinências número-pessoais (-a, -as, -a, -amos, -ais, -am).

- Derivação 2 (Acesso aos Tempos do Passado e Futuro do Subjuntivo):
...
- Passo 3 — Anotar o Infinitivo ao Lado de Cada Opção: Registre -> TER, -> FAZER, -> VER, -> HAVER, -> VIR ao lado das alternativas para blindar a análise contra parônimos.
- Passo 4 — Teste Auditivo-Conceitual: Elimine alternativas com erro de pessoa (teve em vez de tive), radical deformado (fazerei em vez de farei) ou troca de base (virei de vir em vez de verei de ver).
...
| Critério Decisivo | Verbo PROVER | Verbo PROVIR |
| --- | --- | --- |
| Significado | Providenciar, abastecer, sustentar | Vir de, originar-se |
| Paradigma | Dois Líderes: VER (Presentes) / BEBER (Demais) | Líder Único: VIR (Todos os tempos) |
| Pretérito Perfeito | Ele proveu / Eles proveram | Ele proveio / Eles provieram |
...
| --- | --- | --- |
| Paradigma | Regular igual aBEBER (com ditongo EI nos presentes) | Irregular anômalo próprio |
| Pretérito Perfeito | Eu requeri / Ele requereu / Eles requereram | Eu quis / Ele quis / Eles quiseram |
| Imperfeito Subjuntivo | Se ele requeresse | Se ele quisesse |
...
| --- | --- | --- | --- |
| 1ª p. singular | Euvou | Que euvá | Radicais distintos (v- vs. vá) |
| 1ª p. plural | Nósvamos | Que nósvamos | FORMAS IDÊNTICAS (Atenção ao contexto!) |
| 2ª p. plural | Vósides | Que vósvades | DISTINÇÃO MÁXIMA (ides no Ind. / vades no Subj.) |

| Verbo no Infinitivo | Forma no Futuro do Presente | Exemplo de Aplicação |
| --- | --- | --- |
| VER | Eu verei | "Amanhã eu verei o espetáculo." |
| VIR | Eu virei | "Amanhã eu virei ao escritório." |

---

## Exemplos comentados

- Enunciado: Os pais  as necessidades dos filhos. (PROVER - pretérito imperfeito do indicativo)
- Resolução: Como não é presente, o líder é BEBER (Antigamente eles bebiam $\rightarrow$ Os pais proviam).
- Resposta: proviam (021 - ).

- Enunciado: O policiamento  a segurança da população. (PROVER - presente do indicativo)
- Resolução: Tempo do presente $\rightarrow$ líder VER (O policiamento vê $\rightarrow$ O policiamento provê).
- Resposta: provê (021 - ).

- Enunciado: O juiz deliberou que eu  assistência às vítimas. (PROVER - presente do subjuntivo)
- Resolução: Tempo do presente $\rightarrow$ líder VER (Que eu veja $\rightarrow$ Que eu proveja).
- Resposta: proveja (021 - ).

- Enunciado: Um filho  atenção integral. (REQUERER - presente do indicativo)
- Resolução: 3ª pessoa do singular não recebe a ditongação EI (que é exclusiva da 1ª p.). Forma regular: requer.
- Resposta: requer (021 - ).

- Enunciado: Os candidatos só poderão se inscrever no concurso se o . (REQUERER - futuro do subjuntivo)
- Resolução: Fora do presente $\rightarrow$ líder BEBER (Se eles beberem $\rightarrow$ Se eles requererem).
- Resposta: requererem (021 - ).

- Enunciado: Espero que ele  residência no exterior. (REQUERER - presente do subjuntivo)
...
- Enunciado: Reescrita correta segundo a norma culta:As pessoas sabem que pratico futebol... / O futebol tem mais importância que as artes. /... algo que me dá prazer.A) adiro o futebol / sobrepõem-se às artes / me aprazB) adero ao futebol / sobrepõe-se as artes / apraza-meC) adiro ao futebol / sobrepõe-se as artes / me aprazD) vou aderir ao futebol / sobrepõe-se as artes / me aprazeráE) adiro ao futebol / sobrepõe-se às artes / me apraz
- Resolução:
...
- Pretérito Imperfeito do Indicativo: Adicione mentalmente a palavra "Antigamente..." (Antigamente ele bebia $\rightarrow$ provia).
- Pretérito Perfeito do Indicativo: Adicione mentalmente a palavra "Ontem..." (Ontem ele bebeu $\rightarrow$ proveu / requereu).
- Presente do Subjuntivo: Adicione a partícula "Que..." (Que eu veja $\rightarrow$ proveja; Que eu requeira; Que eu caiba).
...
Verbo de conjugação regular ou amplamente dominada utilizado como matriz de substituição direta para guiar a flexão de verbos irregulares ou raros (ex.: BEBER para requerer; HAVER para aprazer; FERIR para aderir). Relações: , , , .

Tempos verbais que servem de matriz morfológica para a geração de outros tempos (1ª p. sing. do Presente do Indicativo e 3ª p. pl. do Pretérito Perfeito do Indicativo). Relações: .

Tempos verbais estruturados a partir da extração de desinências dos tempos primitivos (Presente do Subjuntivo; Pretérito Mais-Que-Perfeito; Pretérito Imperfeito do Subjuntivo; Futuro do Subjuntivo). Relações: .

Verbo que apresenta alterações profundas e heterogêneas no próprio radical ao longo da flexão, alterando sua estrutura fônica básica (ex.: HAVER, IR, SER). Relações: , .

Verbo que não possui conjugação completa em todas as pessoas, tempos ou modos gramaticais (ex.: APRAZER, restrito às 3ªs pessoas). Relações: .

Verbo que admite duas ou mais formas legítimas equivalentes para a mesma flexão (ex.: havemos / hemos; haveis / heis). Relações: .

Formas do verbo (Infinitivo, Gerúndio e Particípio) que, desprovidas de flexão de modo-tempo, desempenham papéis sintático-semânticos de nomes (substantivo, adjetivo ou advérbio). Relações: .

---

## Síntese para recuperação ativa

Ao concluir este grupo temático, o estudante deve compreender que a irregularidade verbal na Língua Portuguesa não é aleatória, mas estruturada em regras e analogias lógicas:

1. Falsos Amigos Dominados: O candidato sabe que PROVER só segue VER no presente (provejo / proveja), assumindo a forma regular de BEBER no passado (proveu / provesse / proveram), distinguindo-o de PROVIR (proveio / proviesse). Sabe também que REQUERER adota BEBER em quase tudo (requereu / requeresse / requereram), rejeitando formas como "requiz", aplicando o ditongo EI apenas no presente (eu requeiro / que ele requeira).
2. Mecânica do Paradigma Operacional: O candidato domina os dois primitivos e deriva com rapidez o Presente do Subjuntivo a partir da 1ª p. sing. do indicativo (caibo $\rightarrow$ caiba; adiro $\rightarrow$ adira) e os três tempos do passado/subjuntivo (-ra, -sse, -r) a partir da 3ª p. pl. do pretérito perfeito sem -ram (couberam $\rightarrow$ coubera, coubesse, couber; houveram $\rightarrow$ houvera, houvesse, houver; aprouveram $\rightarrow$ aprouvera, aprouvesse, aprouver).
3. Segurança diante de Formas Estranhas: Sabe aplicar o macete do verbo BEBER para chancelar a correção do imperfeito cria e dos particípios regulares crido (verbo crer) e podido (verbo poder).
