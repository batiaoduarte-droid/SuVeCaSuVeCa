...
1. LÍDERES E BONS AMIGOS (60%-70%) 2. FALSOS AMIGOS 3. DIFÍCIL CONJUGAÇÃO
 ...
 ┌───────────┴───────────┐ ┌───────────┼───────────┐
 ▼ ▼ ▼ ▼ ▼
 PROVER REQUERER CABER CRER HAVER
 (Pres: VER / (Geral: BEBER / (caibo -> (cri/creu; (Anômalo;
 Demais: BEBER) Pres: ditongo EI) caiba) crido) houve)
 │ │ │ │ │
 [vs. PROVIR = VIR] [≠ QUERER] └─────┬─────┴─────┬─────┘
 │ │
 ▼ ▼
 APRAZER IR / ADERIR
 (Defectivo; (IR: ides/vades;
 Líder: HAVER) ADERIR = FERIR)
 │
 ▼
 ...
 │ │
 ▼ (extrai "-o" + desinência subj.) ▼ (extrai "-ram" -> tema matriz)
 DERIVADO: Presente do Subjuntivo DERIVADOS:
 (ex: caib-o -> que eu caib-a) ├─ Pret. Mais-que-perfeito Ind. (-ra: coube-ra)
 (ex: adir-o -> que eu adir-a) ├─ Pret. Imperfeito Subjuntivo (-sse: coubes-se)
 └─ Futuro do Subjuntivo (-r: coube-r)
```
...
```text
 ...
 ┌────────────────────────────────────┴────────────────────────────────────┐
 ▼ ▼
PRIMITIVO 1: Presente do Indicativo PRIMITIVO 2: Pretérito Perfeito do Indicativo
(1ª pessoa do singular - "EU") (3ª pessoa do plural - "ELES")
 │ │
 ▼ (Extrai-se a desinência "-o") ▼ (Extrai-se a terminação "-ram")
OBTÉM-SE: Todo o Presente do Subjuntivo OBTÉM-SE: Tema Matriz do Pretérito
(Acrescenta-se "-e" p/ 1ª conj; "-a" p/ 2ª e 3ª conj) (Gera 3 tempos derivados fixos)
 ├─> Pret. Mais-Que-Perfeito Ind. (Tema + "-ra")
 ├─> Pret. Imperfeito Subjuntivo (Tema + "-sse")
...
### Tabela Canônica de Verbos Problemáticos

| Verbo | Classificação | Paradigma / Líder | Formas Primitivas Decisivas | Derivações / Formas Críticas |
|:----------------- |:----------------------- |:----------------------------------------- |:-------------------------------------------------------------------------------------------------- |:----------------------------------------------------------------------------------------------- |
| **PROVER** | Falso Amigo de*VER* | `VER` (Presentes) / `BEBER` (Demais) | Pres. Ind:*provejo*; Pret. Perf: *proveu / proveram* | Pres. Subj:*proveja*; Imp. Subj: *provesse*; Fut. Subj: *prover* |
| **PROVIR** | Bom Amigo de*VIR* | `VIR` (Todos os tempos) | Pres. Ind:*provém / provêm*; Pret. Perf: *proveio / provieram* | Imp. Subj:*proviesse*; Fut. Subj: *provier* |
| **REQUERER** | Falso Amigo de*QUERER* | `BEBER` (Geral) + Ditongo `EI` (Pres.) | Pres. Ind:*eu requeiro* / *ele requer*; Pret. Perf: *requereu / requereram* | Pres. Subj:*requeira*; Imp. Subj: *requeresse*; Fut. Subj: *requererem* |
...
|:------------------------------ |:---------------------------------------------------------------- |:-------------------------------------- |
| **Paradigma** | Regular igual a**BEBER** (com ditongo *EI* nos presentes) | Irregular anômalo próprio |
...
|:------------------------ |:--------------------------------------- |:-------------------------------------- |:-------------------------------------------------------------------- |
| **1ª p. singular** | Eu**vou** | Que eu**vá** | Radicais distintos (*v-* vs. *vá*) |
...
- *Ele bebia* $\rightarrow$ *Ele cria* (Imperfeito).
- *Ele tinha bebido* $\rightarrow$ *Ele tinha crido* (Particípio).
