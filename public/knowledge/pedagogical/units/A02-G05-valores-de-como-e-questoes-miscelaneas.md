...
- ➔ 1. O CONECTIVO POLISSÊMICO "COMO"
➔ Comparação: Confronto analógico entre seres/ações distintas (A é como B).
- ➔ Conformidade: Adequação a modelo, norma, citação ou plano ("nos conformes", "de acordo com").
➔ Causa: Fato motivador da oração principal (sempre causal; nunca explicativo).
- ➔ Adição: Estrutura correlativa somatória ("não só... como também" = E).
➔ Exemplificação: Transição do hiperônimo (geral) para hipônimos/exemplos (específico).
- ➔ 2. MECANISMOS DE COESÃO E PROGRESSÃO TEXTUAL
➔ Coesão Sequencial: Encadeamento de ideias por preposições, conjunções e pronomes.
- ➔ Progressão Textual: Avanço do fluxo argumentativo por conexões lógicas interparágrafos.
➔ 3. FAMÍLIAS PARADIGMÁTICAS DE CONECTORES
- ➔ Adversativas: mas, porém, contudo, todavia, no entanto, entretanto.
➔ Conformativas: conforme, consoante, de acordo com, segundo.
- ➔ Concessivas: embora, conquanto, posto que, ainda que, se bem que.
➔ Causais / Explicativas: porque, porquanto, visto que, já que, uma vez que, pois.
- ➔ Conclusivas: portanto, logo, por conseguinte, assim, desse modo.
➔ 4. ZONAS DE ALTO RISCO E DISTINÇÕES CRÍTICAS ➔ Porquanto (Causa/Explicação) vs. Conquanto (Concessão) ➔ Posto que (Concessão) vs. Visto que (Causa) ➔ Posição do "Pois" (Início de oração com intercalação vs. Posposto ao verbo) ➔ Pontuação Exemplificativa (como X vs., por exemplo, X)
