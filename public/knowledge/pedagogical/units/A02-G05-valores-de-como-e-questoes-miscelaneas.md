# Valores de Como e Questões Miscelâneas
...
**Conexão forte:** Os diferentes empregos de “como” e de outros conectores exigem uma SuVeCA por oração e uma segunda análise para a relação semântica entre os mapas.
...
SEMÂNTICA E SINTAXE DE CONECTORES EM CONCURSOS │ ├── 1. O CONECTIVO POLISSÊMICO "COMO" │ ├── Comparação: Confronto analógico entre seres/ações distintas (A é como
B). │ ├── Conformidade: Adequação a modelo, norma, citação ou plano ("nos conformes", "de acordo com"). │ ├── Causa: Fato motivador da oração principal (sempre causal; nunca explicativo). │ ├── Adição: Estrutura correlativa somatória ("não só... como também" =
E). │ └── Exemplificação: Transição do hiperônimo (geral) para hipônimos/exemplos (específico). │ ├── 2. MECANISMOS DE COESÃO E PROGRESSÃO TEXTUAL │ ├── Coesão Sequencial: Encadeamento de ideias por preposições, conjunções e pronomes. │ └── Progressão Textual: Avanço do fluxo argumentativo por conexões lógicas interparágrafos. │ ├── 3. FAMÍLIAS PARADIGMÁTICAS DE CONECTORES │ ├── Adversativas: mas, porém, contudo, todavia, no entanto, entretanto. │ ├── Conformativas: conforme, consoante, de acordo com, segundo. │ ├── Concessivas: embora, conquanto, posto que, ainda que, se bem que. │ ├── Causais / Explicativas: porque, porquanto, visto que, já que, uma vez que, pois. │ └── Conclusivas: portanto, logo, por conseguinte, assim, desse modo. │ └── 4. ZONAS DE ALTO RISCO E DISTINÇÕES CRÍTICAS ├── Porquanto (Causa/Explicação) vs. Conquanto (Concessão) ├── Posto que (Concessão) vs. Visto que (Causa) ├── Posição do "Pois" (Início de oração com intercalação vs. Posposto ao verbo) └── Pontuação Exemplificativa (como X vs., por exemplo, X)
...
- Concurso (CESPE): "era uma manhã risonha, e bela, como o rosto de um infante..." (Compara os atributos da manhã à beleza do rosto infantil).

- Diferenciado de:  (Exemplificação).
...
CONJUNÇÕES CAUSAIS: já que | visto que | uma vez que | porque | porquanto | COMO CONJUNÇÕES EXPLICATIVAS: pois | que | porque | porquanto (O "COMO" NUNCA ENTRA AQUI!)
...
- Fixação: "Como não viu o poste, colidiu com ele."
- Concurso (CESPE): "Como aprendemos a falar na mais tenra infância..., não nos damos conta do grande prodígio que é falar." $\rightarrow$ Admite substituição perfeita por "Visto que" (= causal).
...
- Concurso (CESPE): "...não apenas se vivencia uma ampliação... como também se observa a existência de robôs..."
- Concurso (CESPE): "...Citação 1... Mas não fica apenas nisso... Citação 2 com a palavra também..." (Adição).
...
Construção com "como": descrição de ações, como "subindo as escadas"... Construção com "por exemplo": descrição de ações, por exemplo, "subindo as escadas"...
...
- Concurso (CESPE): "quando as pessoas leem a descrição de ações, como 'subindo as escadas'..." (Incorreto substituir por conforme; correto substituir por , por exemplo,).
- Concurso (CESPE): "...situações..., como naquelas em que não foram realizadas atualizações..."
...
- Progressão Textual: Significa progredir / avançar na exposição de ideias.
- Tratamento unificado: Para o CEBRASPE, conjunções adversativas (no entanto), aditivas (além disso) e conformativas (de acordo com) operam todas sob a mesma função textual: mecanismos de coesão sequencial.
...
$$
\mathbf{PORQUANTO} = \mathbf{PORQUE} \quad (\text{Causal / Explicativo})
$$
...
No trecho: "...Ensiná-la não faz sentido, pois, nessa idade narcisista, ela responde a cada interferência...

1. A oração subordinada iniciada pelo conector é: "...pois ela responde a cada interferência...".
2. O conector "pois" ocupa a posição inicial da oração.
3. O segmento ", nessa idade narcisista," é um adjunto adverbial intercalado isolado por vírgulas.
4. O "pois" mantém seu valor explicativo/causal, sendo perfeitamente intercambiável por "porque".
...
- Comparativo : Estabelece analogia/semelhança entre termos autônomos. Teste: termo posterior comparado ao anterior.
- Conformativo : Indica acordo com modelo ou citação. Equivalentes: conforme, consoante, de acordo com, segundo.
- Causal : Indica o fato gerador/motivo. Teste: "O fato de X fez com que Y". Nunca explicativo.
...
3. Conexão Direta dos Núcleos: Ligue a oração subordinada inicial diretamente ao núcleo da oração principal.
4. Julgamento Semântico: Avalie a relação de causa/efeito ou conformidade nos núcleos desimpedidos.
...
| Par de Conectores | Conector 1 (Sentido / Família) | Conector 2 (Sentido / Família) | Critério Decisivo de Diferenciação |
| --- | --- | --- | --- |
| Comparação vs. Exemplificação | Como comparativo: Confronta dois seres autônomos sob mesma qualidade. | Como exemplificativo: Transita de um termo genérico para seus membros específicos. | Se o termo posterior for um espécime/membro do termo anterior, trata-se de exemplificação. |
| Porquanto vs. Conquanto | Porquanto: Causal / Explicativo (= porque, pois). | Conquanto: Concessivo (= embora, posto que). | Porquanto traz justificativa/motivo; Conquanto introduz contraste superável. |
| Posto que vs. Visto que | Posto que: Concessivo (= embora). | Visto que: Causal (= porque, já que). | Posto que com sentido causal é vício agramatical em provas de concurso. |
| Pois (Início) vs. Pois (Deslocado) | Pois explicativo/causal: Situado no início da oração (mesmo com intercalações). | Pois conclusivo: Deslocado para o meio ou fim da oração (após o verbo). | Analisar se as vírgulas pertencem a um adjunto intercalado ou ao deslocamento do conectivo. |
| Porquanto vs. Logo | Porquanto: Causa/Explicação (= porque). | Logo: Conclusão (= portanto). | Incompatibilidade absoluta: um justifica, o outro conclui. |

---

## Exemplos comentados

- Enunciado: Identifique o valor semântico da palavra sublinhada: "Os soldados agiam como seus inimigos".
...
- Enunciado: Identifique o valor semântico da oração sublinhada: "Como consta dos livros, deve-se a Euclides da Cunha a mais completa descrição do sertão brasileiro."
...
- Enunciado: Identifique o valor semântico da palavra sublinhada: "Como adotou atitudes de um político qualquer, o republicano ficou desmoralizado."
...
- Enunciado: Identifique o valor semântico da expressão sublinhada: "Alguns animais, como o leão e o tigre, são carnívoros."
...
- Enunciado: Identifique o valor semântico da palavra sublinhada: "Ele leu não só o livro como também a revista."
...
- Enunciado: Identifique o valor semântico da palavra sublinhada: "Como não viu o poste, colidiu com ele."
- Desenvolvimento: O fato de não ter visto o poste foi o motivo/causa da colisão.
- Gabarito oficial: CAUSA.
...
2. "...há evidentes situações [...], como naquelas em que não foram realizadas atualizações..."

- Assertiva: A classificação gramatical do vocábulo "como" na ocorrência 1 é distinta de sua classificação na ocorrência 2.
- Resolução: Ocorrência 1 = Adição (correlativa aditiva); Ocorrência 2 = Exemplificação. As classificações são de fato distintas.
- Gabarito: CERTO.
...
-  — Descomplique os Enunciados Pomposos do CEBRASPE: Ao encontrar assertivas que falem em "mecanismos de coesão sequencial que estabelecem relações entre partes do texto e garantem a progressão textual", traduza imediatamente para: "conectores que ligam frases e dão continuidade às ideias". Não se preocupe se o elemento é conjunção ou locução prepositiva. (014, )
...
-  — A Armadilha da Troca Cega por "Conforme": Nunca substitua a palavra "como" por "conforme" sem verificar se a frase expressa adequação a um plano/regra. No exemplo "fala como uma sereia", trata-se de comparação, e a substituição por "conforme" geraria absurdo semântico. (012, )
-  — O "Como" Causal Jamais é Explicativo: Conjunções causais e explicativas costumam compartilhar termos (porque, porquanto), mas o vocábulo "como" é restrito à causa. Jamais marque "explicativo" para o "como". (013, )
-  — Decoreba de Expressões Correlativas: Expressões correlativas não são unicamente alternativas nem unicamente aditivas. Verifique se os fatos se somam (tanto X quanto Y = Adição) ou se alternam no tempo (ora X, ora Y = Alternância). (012, )
-  — Confundir Comparação com Exemplificação: Ao encontrar termos isolados após o "como", avalie se eles representam espécimes pertencentes ao grupo anterior (animais, como leão e tigre = Exemplificação) ou se representam seres externos comparados (agiam como leões = Comparação). (012,; 013, )
...
-  — Conector / Conectivo: Vocábulo ou locução (conjunção, preposição, pronome relativo) que desempenha a função de ligar elementos da frase, orações ou parágrafos, estabelecendo nexos lógicos e garantindo a coesão textual.
-  — Coesão Sequencial: Mecanismo sintático de encadeamento linear do texto por meio de conectores que estruturam relações de causa, tempo, oposição, concessão, conformidade e adição, viabilizando a progressão textual.
-  — Conjunção Concessiva: Conectivo que introduz uma oração indicativa de um obstáculo, ressalva ou oposição que, embora existente, é insuficiente para anular o fato da oração principal (embora, conquanto, posto que).
-  — Conjunção Causal: Conectivo que introduz a oração indicativa do motivo, razão ou fato gerador do evento principal (porque, já que, visto que, como, porquanto).
-  — Conjunção Conformativa: Conectivo que expressa conformidade, acordo ou subordinação a uma regra, norma, pensamento ou modelo (conforme, consoante, de acordo com, segundo, como).
-  — Expressões Correlativas: Estruturas conjuntivas fixas e descontínuas que atuam aos pares (não só... como também, tanto... quanto, ora... ora), dividindo-se primordialmente entre os valores de Adição e Alternância.
-  — Porquanto: Conjunção causal ou explicativa equivalente a porque, pois, já que.
-  — Conquanto: Conjunção concessiva equivalente a embora, posto que, ainda que.
-  — Posto que: Locução conjuntiva concessiva equivalente a embora.
-  — Consoante: Conjunção ou preposição conformativa equivalente a conforme e de acordo com.
...
1. Aplicar Técnicas de Prova para Bancas Exigentes (CEBRASPE):
...
1. Evitar as Armadilhas Clássicas:
