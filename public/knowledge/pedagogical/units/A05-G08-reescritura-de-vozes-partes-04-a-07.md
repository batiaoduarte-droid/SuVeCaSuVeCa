...
- O verbo auxiliar primitivo (*começou a*) é mantido.
...
### Tabela Comparativa Global das Estruturas com a Partícula "SE"
...
| **Índice de Indeterminação (IIS/PIS)** | $\text{VI}$, $\text{VTI}$ (prep.) ou $\text{VL}$ | **Indeterminado** | **Indeterminado** | Fixo na**3ª pessoa do singular** | *Precisa-se de técnicos.* |
