...
[Oração Principal: Antecedente] + [Prep? + Pronome Relativo] + [Sujeito] + [Verbo Regente]
 ...
 │ │
 └──────── Passo 3: Encaixe ◄────────┘
 (Ordem Direta: Sujeito + Verbo + Prep + Antecedente)
```text

### Exemplos

- *Estrutura sob teste:* `A maioria dos problemas [ ______ ] lidamos são fáceis.`
...
## Regência Diferencial dos Verbos de Memória (Esquecer / Lembrar)
...
- **Construção Não Pronominal (VTD — Sem Preposição):**
 - O verbo atua desacompanhado de pronome reflexivo/oblíquo (*esquecer algo*, *lembrar algo*).
...
- **Construção Pronominal (VTI — Preposição "de"):**
 - O verbo vem acompanhado de pronome reflexivo integrante (*esquecer-se de*, *lembrar-se de*).
...
## Morfossintaxe e Regência do Pronome Relativo Possessivo "Cujo"
...
5. **Proibição diante de Verbos e Pronomes:** *Cujo* não pode preceder diretamente verbos (*em cujo se reproduz* — incorreto) nem pronomes (*de cuja ninguém escapa* — incorreto), pois isso descaracteriza a relação substantivo-substantivo.
...
## Regência e Restrições Semânticas dos Pronomes Relativos Locativos (Onde, Aonde, Donde)
...
### Restrição Crítica: Proibição para Referentes Abstratos
...
## Distinção de Regência entre Termos Cognatos (Simpatizar com vs. Simpatia por)
...
## Regência em Locuções Verbais (Regra do Verbo Principal)
...
2. Identificar a regência do último verbo (verbo principal):
 - **Locução com VTI:** *...graves riscos [ ______ ] podemos incorrer.* -> Verbo principal: *incorrer* (rege `em`: *incorrer em riscos*). Forma correta: *...graves riscos **nos quais** podemos incorrer.*
 - **Locução com Verbo de Ligação:** *...a pessoa [ ______ ] cada um aspira a ser.* -> Verbo principal: *ser* (não rege preposição). Forma correta: *...a pessoa **que** cada um aspira a ser.*
 - **Locução com VTI modalizador:** *...os problemas [ ______ ] devemos falar.* -> Verbo principal: *falar* (rege `de`: *falar dos problemas*). Forma correta: *...os problemas **de que** devemos falar.*
...
## Regência Verbal e Emprego dos Pronomes Oblíquos Átonos (O/A vs. Lhe)
...
2. **Verbo Transitivo Indireto com Preposição "A" (VTI com "a"):** Admite *lhe, lhes*.
 - Exemplo: *obedecer ao regulamento* -> *obedecer-lhe*.
 - Exemplo: *competir às pessoas* -> *competir-lhes* / *pessoas a quem compete*.
3. **Verbos Transitivos Indiretos com outras preposições (*de*, *em*, *com*, *por*) ou VTIs que rejeitam "lhe":**
 - Não admitem *lhe* nem *o/a*. Exigem formas tônicas preposicionadas (*a ele, de nós, com ele, a eles*).
...
## Catálogo Canônico de Regências Verbais do Grupo

### Sistematização dos Verbos e Padrões Preposicionais Analisados
...
### Tabela Comparativa de Estruturas Sintáticas Conflitantes

| Par Contrastivo | Construção Gramaticalmente Correta | Construção Incorreta / Vício Oral | Critério Decisório Fundamental |
|:-------------------------------------- |:----------------------------------------------------------------------------------------------- |:--------------------------------------------------------------------------------------- |:---------------------------------------------------------------------------------------------- |
| **Esquecer vs. Esquecer-se** | *Fatos **que** nunca esquecemos**Fatos **de que** nunca nos esquecemos* | *Fatos de que nunca esquecemos**Fatos que nunca nos esquecemos* | Sem pronome = VTD (sem prep.); Com pronome = VTI (rege*de*). |
| **Simpatizar vs. Simpatia** | *Ideias **com que** simpatizamos**Lya Luft, **por cujas** ideias temos simpatia* | *Ideias de que simpatizamos**Lya Luft, com cujas ideias temos simpatia* | O verbo rege*com*; o substantivo cognato rege *por*. |
| **Onde vs. Em que (Abstrato)** | *A cidade **onde** moro**A violência **em que** sucumbem* | *A violência **aonde** sucumbem**A situação **onde** nos encontramos* | *Onde* restringe-se a lugares físicos. Conceitos abstratos exigem *em que* / *no qual*. |
| **Aonde vs. Onde** | *A cidade **aonde** vou* | *A cidade **onde** vou* | Verbos de destino/movimento regem preposição*a* (*ir a* -> *aonde*). |
...
| **Objeto com VTD vs. VTI** | *Ideais quando não **os** perverte**Impulsos devemos **resistir a eles*** | *Ideais quando não lhes perverte**Impulsos devemos resisti-los* | VTD exige*o/a/os/as*; VTI com *a* que não admite *lhe* exige forma tônica (*a eles*). |
