...
Anotação no esquemas: 2) Com nomes de lugar: use VOLTAR -> Volta DA (CRASE NO 'A') / Volta DE (SEM ARTIGO: SEM CRASE). Exemplos escritos:
...
esquemas com esquema da caixa PREPOSIÇÃO + PRONOMES DEMONSTRATIVOS conectada a Dirigiu-se àquelas pessoas em tom emocionado. Anotação manuscrita: 2.a) A + aquele, aquela, aquilo -> àquele, àquela, àquilo. Exemplo complementar escrito: Chegou àquele encontro no horário certo (a + aquele).

- Dirigiu-se àquelas pessoas: quem se dirige, dirige-se a (prep.) + aquelas (pron.) = àquelas.
- Chegou àquele encontro: quem chega, chega a (prep.) + aquele (pron.) = àquele.
- Não queria ser associado àquilo: associado a (prep.) + aquilo (pron.) = àquilo.
...
esquemas anotado: 2.b) Prep. A + a (demonstrativo implícito, ANTES DE QUE/DE) (= aquela). Exemplos analisados no quadro:
...
esquemas com a caixa PREPOSIÇÃO + PRONOME RELATIVO A QUAL / AS QUAIS e o exemplo Essa é uma questão à qual o governo deveria dar mais atenção. Anotação no esquemas:
...
A abordagem didática anota no esquemas de abertura: $$\text{"Um } \underline{\text{A}} \text{ sozinho não faz fenômeno" (FF: } \text{A} + \text{A)}$$ E classifica no topo:  só preposição / artigo.
...
1. Expressões Temporais e Estruturas Correlativas (de... a... vs. da... à...):
...
No esquemas de anotações #ANOTAAÍ, A abordagem didática esquematiza:  Paralelismo do Uso do Artigo: [SEM ART. + SEM ART.] = Eles se encontraram frente a frente. (frente = sem art. / a = só prep. / frente = sem art.) [SEM ART. + SEM ART.] = A aula será de segunda a sexta. (de = só prep. / a = só prep.) [COM ART. + COM ART.] = A aula será da terça à sexta. (da = de + a / à = a + a)
...
1. A Exceção Canônica da Preposição "Até":
...
Anotação em destaque no esquemas #ANOTAAÍ: $$\text{MANTRA: "A única preposição que aceita outra depois dela é a prep. ATÉ"}$$ Com listagem das preposições essenciais (a, ante, até, após, com, contra, de, desde, para, perante...) e a anotação: Caso 6: O acento é proibido porque a PREPOSIÇÃO é proibida.
...
1. Topônimo especificado por determinante:
...
Anotação manuscrita comparativa ao lado do item 8 dos exercícios: $$\text{ foram à Londres dos meus sonhos} \rightarrow \text{Voltei DA Londres dos meus sonhos (com det. } \rightarrow \text{ com art.)}$$
...
- Expande:  (Detalhamento da Regra I)
...
Anotação manuscrita esquemática elaborada no esquemas: text  DICA: A troca de uma forma pela outra:
...
1. Erro 2: Apenas artigo plural sem preposição (as + substantivo plural):
...
Ao aplicar o teste de aceitação de artigo (iniciar uma oração com o termo como sujeito: Várias barragens são boas), constata-se que a inserção do artigo definido feminino plural gera agramaticalidade (As várias barragens são boas é semanticamente inadequado porque o artigo define o que o pronome indefiniu). Portanto:
...
- Obedeceu  vontade: substitui-se por menino $\rightarrow$ "Obedeceu ao menino". Houve "ao", logo o verbo pede a preposição a.
- Viu  menina: substitui-se por menino $\rightarrow$ "Viu o menino" (e não "viu ao menino"). Houve apenas "o", logo o verbo não pede preposição (VTD); portanto, a frase fica "Viu a menina" (sem crase).
...
Formulação: "A vontade dos pais é importante." $\rightarrow$ O artigo A foi admitido naturalmente. Conclusão: Havendo preposição (Passo 1) e havendo artigo (Passo 2), o acento grave é obrigatório.
...
1. Passo 2 (Olhar para a direita / Termo Regido):
...
1. Se o candidato já tiver pleno domínio da regência daquele termo, a substituição por menino torna-se dispensável.
...
1. Se a sentença com o artigo A inicial for natural e correta, conclui-se que o termo admite artigo.
2. Combine o resultado com o Passo 1: Preposição A + Artigo A = À (com acento grave).
...
Completar a lacuna com a, à, as ou às: "Não contesto que a medicina seja útil  alguns homens."
...
Completar a lacuna com a, à, as ou às: "A pesquisa mostrou os genes ativos associados  inflamação."
...
Completar a lacuna com a, à, as ou às: "Todas as áreas do conhecimento estão submetidas  prepotente teoria do achismo."
...
Completar a lacuna com a, à, as ou às: "Ela está disposta  fazer a decoração da festa em casa."
...
Completar a lacuna com a, à, as ou às: "Não cozinho no meu dia  dia."
...
Completar a lacuna com a, à, as ou às: "Assistiram  cena em silêncio."
...
Completar a lacuna com a, à, as ou às: "Espera-se que a greve termine daqui  uma semana."
...
Completar a lacuna com a, à, as ou às: "Os cientistas foram  Londres conhecer a Universidade de Oxford."
...
- Contraponto pedagógico demonstrado: Se houvesse determinante (Os cientistas foram  Londres dos meus sonhos), o retorno seria Voltei da Londres dos meus sonhos, resultando em crase obrigatória (à Londres dos meus sonhos).
- Resposta final: a (sem acento indicativo de crase). Justificativa visual: circular Londres (lugar sem artigo).

Completar a lacuna com a, à, as ou às: "Os pais podem pedir apoio  escola."
...
Completar a lacuna com a, à, as ou às: "A comissão visava  essa uniformização."
...
1. Identificação do termo regido: Substantivo comum terra.

- Teste do Passo 2: "A terra é boa."
- Resultado 2: Admite artigo definido feminino a.

1. Síntese: Preposição a + Artigo a = à.
...
1. Análise de Itália (Sentença B):
...
1. Preposição + Pronome Relativo (Código 3): Fusão da preposição a exigida na oração subordinada com o artigo presente exclusivamente nos pronomes a qual / as quais (formando à qual / às quais), destacando-se que pronomes relativos que não possuem artigo (que, quem, cujo) jamais admitem crase.
