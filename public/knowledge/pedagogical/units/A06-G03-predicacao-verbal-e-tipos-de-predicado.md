# Predicação Verbal e Tipos de Predicado
...
**Método central:** Predicação verbal e tipos de predicado organizam Ve, complementos e predicativos e mostram que a configuração real depende das relações, não de uma fórmula linear.
...
- Morfologia Básica: Reconhecimento de classes gramaticais: substantivo, pronome, adjetivo, verbo, advérbio, preposição e artigo.
...
➔ ➔ ➔ SUJEITO PREDICADO COMPLEMENTOS COMPLEMENTO ADJUNTO ADJUNTO
- (Obrigatório) VERBAIS NOMINAL ADVERBIAL ADNOMINAL
(OD / OI) (Circunstância) (Interno ao SN)
- ➔
PREDICAÇÃO VERBAL TIPOS DE PREDICADO
- ➔ ➔
VERBOS NOCIONAIS VERBOS DE ESTADO PREDICADO PREDICADO PREDICADO
- (Ação / Movimento) (Relacionais) NOMINAL VERBAL VERBO-NOMINAL
➔
- V.I. V.T.D. V.T.I. V.T.D.I. V. LIGAÇÃO
(Sem (Com (Com (Com OD
- Obj.) OD) OI) + OI)
➔
- PREDICATIVO DO SUJEITO ➔ (Atributo / Seta no Sujeito)
PREDICATIVO DO OBJETO ➔ (Atributo / Seta no Objeto)
- ➔

SINTAXE DA ORAÇÃO
- ➔ TERMOS ESSENCIAIS TERMOS INTEGRANTES TERMOS ACESSÓRIOS ➔ Sujeito ➔ Objeto Direto ➔ Adjunto Adnominal ➔ Predicado ➔ Objeto Indireto ➔ Adjunto Adverbial ➔ Complemento Nominal ➔ Aposto ➔ Agente da Passiva

ESTRUTURA ORACIONAL
- ➔ SUJEITO PREDICADO (Pode existir ou não existir) (Totalmente Obrigatório)
➔ EXISTENTE INEXISTENTE "TUDO MENOS O SUJEITO" ➔ Simples (Oração sem Sujeito / (Estruturado em torno ➔ Composto Verbos Impessoais) do Verbo Central) ➔ Oracional ➔ Indeterminado ➔ Oculto / Desinencial
- ➔ VERBOS DE AÇÃO / MOVIMENTO VERBOS DE ESTADO (Verbos Nocionais) (Verbos Relacionais)
➔ VERBO DE LIGAÇÃO INTRANS. TRANS. TRANS. TRANS. (V.L.) (V.I.) DIRETO INDIRETO DIR. E IND.
- (V.T.D.) (V.T.I.) (V.T.D.I.)
CRITÉRIO BIVALENTE:
1. Expressa ESTADO
- Exige Exige Exige 2. Exige PREDICATIVO
Objeto Objeto OD + OI DO SUJEITO
- Direto Indireto
TERMOS ACESSÓRIOS E QUALIFICADORES: ➔ Adjunto Adverbial (Circunstância / Seta no Verbo / Dispensável) ➔ Predicativo do Sujeito / do Objeto (Estado / Seta no Nome / Invariável vs. Variável)

➔ TIPOS DE PREDICADO
- ➔ PREDICADO NOMINAL PREDICADO VERBAL PREDICADO VERBO-NOMINAL (P.N.) (P.V.) (P.V.N.)
➔ Núcleo: Nome (Pred. Suj.) ➔ Núcleo: Verbo de Ação ➔ 2 Núcleos: ➔ Estrutura: VL + Pred. Suj. ➔ Estrutura: VI/VTD/VTI/VTDI Verbo de Ação + Predicativo sem Predicativo ➔ Predicativo do Sujeito OU Predicativo do Objeto
...
1. Condição de Oração: Não existe oração sem verbo. Se houver comunicação sem verbo (como a transcrição de um riso "kkk" ou interjeições), tem-se uma frase nominal/mensagem, mas não uma oração sintaticamente analisável.
2. Dependência Hierárquica: Todos os termos da oração articulam-se direta ou indiretamente ao redor do verbo. A correta identificação do sujeito, da regência, dos complementos e dos adjuntos decorre obrigatoriamente de interrogações estruturadas feitas à forma verbal.
3. Fundamento Epistêmico: Conforme lição do gramático Evanildo Bechara rememorada pela professora, o domínio da análise sintática e da estrutura do verbo é o pré-requisito nuclear para toda a gramática normativa (concordância, regência, crase e pontuação).

- Base estrutural para: , .
...
1. Sujeito Inexistente (Oração Sem Sujeito): Orações construídas com verbos impessoais (como haver significando existir/ocorrer, fazer indicando tempo decorrido ou verbos de fenômenos da natureza). Nessas frases, a oração coincide integralmente com o predicado ("Havia crianças no parque").
...
(Nocionais) (Relacionais)
- ➔ VERBO DE LIGAÇÃO V.I. V.T.D. V.T.I. (V.L.)
➔ V.T.D.I.
...
- Sujeito (V.I.) Adj. Adverbial de Lugar (Circunstância)
➔ (Seta aponta para o verbo)
...
VERBOS TRANSITIVOS
- ➔ TRANSITIVO DIRETO TRANSITIVO INDIRETO TRANSITIVO DIRETO E (V.T.D.) (V.T.I.) INDIRETO (V.T.D.I.)
(ou Bitransitivo)
- Complemento SEM Complemento COM preposição preposição Exige 2 complementos: (Objeto Direto) (Objeto Indireto) 1 SEM prep. (O.D.)
...
3. Verbo Transitivo Direto e Indireto (VTDI ou Bitransitivo): Rege simultaneamente dois complementos: um não preposicionado (OD) e outro preposicionado (OI) ("Ofereceram o cargo ao deputado").
...
1. Semântica de Estado/Qualidade: Não indica ação ou circunstância adverbial; descreve uma propriedade ou estado.
2. Morfologia Predominantemente Adjetiva: Manifesta-se como adjetivo (ou substantivo/locução adjetiva com função atributiva) que concorda morfossintaticamente em gênero e número com o termo a que se refere ("A menina chegou satisfeita" / "As meninas chegaram satisfeitas").
...
- Verbo da lista sem predicativo: Deixa de ser de ligação e vira intransitivo nocional ("O aluno está em casa" $\rightarrow$ estar indica localização acompanhado de adjunto adverbial de lugar = VI).
- Verbo de ação com semântica de estado e predicativo: Torna-se verbo de ligação ("Ela caiu doente" $\rightarrow$ caiu equivale a ficou + doente é predicativo do sujeito = VL).

1. "Ela caiu doente."

- Classificação: VERBO DE LIGAÇÃO (V.L.).
...
- Continuidade de Estado: permanecer, continuar ("As listas permaneciam abertas").
- Mudança de Estado: ficar, tornar-se, virar, cair ("Ficou feliz", "Virou fera", "Caiu doente").
- Estado Aparente: parecer ("Parece cansado").
...
3. Morfologia Adjetiva e Concordância: manifesta-se predominantemente como adjetivo (ou locução adjetiva / substantivo predicativo), flexionando-se em gênero e número para concordar com o sujeito ("Ela chegou apressada" $\rightarrow$ "Elas chegaram apressadas").
...
$$
\text{Verbo de Ligação} \iff \begin{cases} 1.\; \text{Indicar ESTADO / MUDANÇA DE ESTADO (Condição Semântica)} \\ 2.\; \text{Vir acompanhado de PREDICATIVO DO SUJEITO (Condição Sintática)} \end{cases}
$$

Se faltar o predicativo do sujeito ou se o verbo indicar ação/movimento, o verbo JAMAIS será de ligação.
...
- Classificação: VERBO DE LIGAÇÃO (V.L.) -> Predicado Nominal.
- "Ela caiu na rua."

- Classificação: VERBO INTRANSITIVO (V.I.) -> Predicado Verbal.

1. ESTUDO DO VERBO "ANDAR":

- "Ele andava preocupado."

- Classificação: VERBO DE LIGAÇÃO (V.L.) -> Predicado Nominal.
- "Ele andava no parque."

- Classificação: VERBO INTRANSITIVO (V.I.) -> Predicado Verbal.

- Permanente: ser, viver ("Ele é calmo", "Vivia triste");
- Transitório / Passageiro: estar, andar ("Estou cansado", "Anda preocupado");
- Mudança de Estado / Mutativo: ficar, tornar-se, virar, cair ("Ficou rico", "Caiu doente");
- Continuidade de Estado: permanecer, continuar ("Permaneceu calada");
- Aparente: parecer ("Parece cansado").
...
- Na frase "Acho sua atitude imperdoável", o sujeito é o pronome elíptico de 1ª pessoa (Eu). Logo, o predicado abrange a oração inteira: [Acho sua atitude imperdoável].
...
1. Com Predicativo do Objeto: $\text{Verbo de Ação Transitivo} + \text{Objeto} + \text{Predicativo do Objeto}$.
...
$$
\text{Se o Sujeito não está explícito} \implies \text{Predicado} = \text{Frase Inteira}
$$
...
| Conceito / Regra | Formulação Canônica Consolidada | Classificação / Tipo |
| --- | --- | --- |
| Centralidade do Verbo | "Verbo é tudo": a oração e o predicado existem estritamente em torno de uma forma verbal. | Axioma Sintático |
| Busca Operacional do Sujeito | Interrogar o verbo antes de qualquer análise:Quem é que / O que é que + VERBO?. | Método Prático |
| Equação do Predicado | $\text{Predicado} = \text{Oração} - \text{Sujeito}$ (tudo a partir do verbo, menos o sujeito). | Definição Estrutural |
| Dicotomia Primária dos Verbos | Verbos dividem-se em Verbos de Ação/Movimento (Nocionais) e de Estado (Relacionais). | Macroclassificação |
| Dispensabilidade do Adjunto Adverbial | Circunstâncias (onde, quando, como) modificam o verbo e podem ser suprimidas sem afetar a intransitividade verbal. | Regra Diagnóstica |
| Critério Bivalente do Verbo de Ligação | $\text{VL} \iff \text{Indicar Estado} \land \text{Ter Predicativo do Sujeito}$. | Mantra / Regra de Ouro |
| Predicado Nominal (PN) | $\text{PN} = \text{Verbo de Ligação} + \text{Predicativo do Sujeito}$ (Núcleo = Nome). | Tipo de Predicado |
| Predicado Verbal (PV) | $\text{PV} = \text{Verbo de Ação (VI/VTD/VTI/VTDI)}$ sem predicativo (Núcleo = Verbo). | Tipo de Predicado |
| Predicado Verbo-Nominal (PVN) | $\text{PVN} = \text{Verbo de Ação} + \text{Predicativo (do Sujeito ou Objeto)}$ (2 Núcleos). | Tipo de Predicado |
| Universalidade do Predicativo | O predicativo pode acompanhar qualquer verbo de ação, não sendo exclusivo do verbo de ligação. | Regra de Ocorrência |
...
[ INÍCIO: LOCALIZAR O VERBO ]
- Etapa 1: "VIVA O VERBO" (Isolar o Sujeito) Pergunta: "Quem é que / O que é que + VERBO?"
Etapa 2: Delimitar o Predicado Equação: Predicado = Oração - Sujeito
- Etapa 3: "A GRANDE SACADA" (Natureza Verbal) O verbo expressa ESTADO ou AÇÃO/PROCESSO?
➔ VERBO DE ESTADO VERBO DE AÇÃO
- Tem Predicativo do Sujeito? Inspecionar termos pós-verbais ➔ ("Mantra do Contexto"): - Sem objeto (só adjunto adv.) ➔ VI [ SIM ] [ NÃO ] - Objeto sem preposição ➔ VTD
- Objeto com preposição ➔ VTI - Ambos os objetos ➔ VTDI VERBO DE VERBO DE
LIGAÇÃO AÇÃO (VL) (VI) Há termo adjetivo predicativo?
- ➔ PREDICADO PREDICADO NOMINAL VERBAL [ NÃO ] [ SIM ] (PN) (PV)
PREDICADO PREDICADO VERBAL VERBO-NOMINAL (PV) (PVN)
...
1. Etapa 2 — Delimitação do Predicado:
...
1. Etapa 3 — O Mantra da Sintaxe Contextual e a Natureza do Verbo:

- Aplique o teste: o verbo indica estado ou ação?

1. Etapa 4 — Classificação da Predicação e do Predicado:
...
1. Verifique se o termo seguinte é um adjetivo que qualifica o sujeito (preocupado qualifica Ele; doente qualifica Ela).
2. Conclusão: Mantido o sentido de estado e a presença do adjetivo, o verbo é Verbo de Ligação (VL) e o predicado é Nominal (PN).
...
| Critério Diagnóstico | Adjunto Adverbial | Objeto Indireto (OI) |
| --- | --- | --- |
| Natureza Semântica | Circunstância pura (onde, quando, como, por que). | Alvo/Paciente preposicionado sem valor de lugar/tempo. |
| Obrigatoriedade Sintática | Termo acessóriodispensável (pode ser suprimido). | Termo integranteobrigatório exigido pela regência. |
| Efeito na Predicação | O verbo permaneceIntransitivo (VI). | O verbo classifica-se comoTransitivo Indireto (VTI). |
| Exemplo-Chave | "Chegamos à porta da cantina" (Lugar $\rightarrow$ VI). | "Visamos a um cargo elevado" (Alvo $\rightarrow$ VTI). |

| Critério Diagnóstico | Predicativo do Objeto | Adjunto Adnominal |
| --- | --- | --- |
| Relação com o Substantivo | Atributo, julgamento ou estado atribuído via predicado. | Característica inerente, permanente ou interna ao sintagma. |
| Posição Estrutural | Termo autônomo no predicado que qualifica o objeto. | Termo acessório embutido dentro da estrutura do objeto. |
| Independência na Oração | Não se desloca em bloco rígido com o substantivo. | Desloca-se junto com o núcleo nominal em qualquer inversão. |
| Exemplo-Chave | "Consideraram absurda a decisão" (absurda = Pred. Objeto). | "Visamos a um cargo elevado" (elevado = Adj. Adnominal). |

|:-------------------------------------- |:------------------------------------------------------------- |:--------------------------------------- |:-----------------------: |:-------------------------------- |

| Predicado Nominal (PN) | $\text{VL} + \text{Predicativo do Sujeito}$ | 1 Núcleo:O Nome (Predicativo) | Obrigatória | Verbo de Ligação (Estado) |

| Predicado Verbal (PV) | $\text{Verbo de Ação} \pm \text{Complementos/Adjuntos}$ | 1 Núcleo:O Verbo (Nocional) | Incompatível | Verbo Nocional (Ação/Movimento) |

| Predicado Verbo-Nominal (PVN) | $\text{Verbo de Ação} + \text{Predicativo (Suj. ou Obj.)}$ | 2 Núcleos:Verbo + Nome | Obrigatória | Verbo Nocional (Ação/Movimento) |
...
1. Verbo: chegou.
2. Pergunta pelo sujeito: "Quem é que chegou ontem a São Paulo?" $\rightarrow$ "Uma comitiva de empresários" (Sujeito Simples).
3. Núcleo do Sujeito: "comitiva" (substantivo principal não preposicionado).
4. Termos periféricos do sujeito: "Uma" (adjunto adnominal) e "de empresários" (adjunto adnominal preposicionado).
5. Predicado: "chegou ontem a São Paulo" ($\text{Frase} - \text{Sujeito}$).
6. Classificação do Predicado: chegou (ação $\rightarrow$ VI) + ontem (adj. adv. tempo) + a São Paulo (adj. adv. lugar) $\rightarrow$ Predicado Verbal (PV).
...
2. "Ofereceram o cargo ao deputado."

- Análise: Verbos conjugados na 3ª pessoa do plural sem sujeito expresso e sem referência anafórica no texto $\rightarrow$ Sujeito Indeterminado. Na oração 2: o cargo = OD; ao deputado = OI $\rightarrow$ Verbo VTDI $\rightarrow$ Predicado Verbal (PV).

- Oração: "O menino foi ao clube."
- Análise: O menino = Sujeito; foi = VI (verbo de movimento); ao clube = Adjunto Adverbial de Lugar.
- Justificativa: "Ao clube" responde a onde? (circunstância). Sendo acessório, pode ser suprimido sem destruir a integridade sintática básica do verbo, mantendo a intransitividade verbal.

- Orações:

1. "De repente, você surgiu na minha frente."
2. "As crianças corriam pelo gramado."

- Análise na Frase 1: você = Sujeito; De repente = Adjunto Adverbial de Modo; na minha frente = Adjunto Adverbial de Lugar; surgiu = Verbo Intransitivo (VI) $\rightarrow$ Predicado Verbal (PV).

- Orações:

1. "Comprei jornais variados." $\rightarrow$ comprei = VTD; jornais variados = OD.
2. "Estes documentos pertencem ao cliente." $\rightarrow$ pertencem = VTI; ao cliente = OI (preposição a obrigatória).
3. "Visamos a um cargo elevado." $\rightarrow$ Visamos = VTI; a um cargo elevado = OI; elevado = Adjunto Adnominal.
...
2. "As mochilas são mais caras que os livros." $\rightarrow$ são = VL (estado permanente) + mais caras = Predicativo do Sujeito $\rightarrow$ Predicado Nominal (PN).
3. "Permaneciam abertas as listas de adesão." $\rightarrow$ Ordem direta: "As listas de adesão permaneciam abertas" $\rightarrow$ permaneciam = VL (continuidade de estado) + abertas = Predicativo do Sujeito $\rightarrow$ Predicado Nominal (PN).
4. "Ele andava preocupado." $\rightarrow$ andava = equivale a estava (estado transitório / VL) + preocupado = Predicativo do Sujeito $\rightarrow$ Predicado Nominal (PN).
5. "Ela caiu doente." $\rightarrow$ caiu = equivale a ficou (mudança de estado / VL) + doente = Predicativo do Sujeito $\rightarrow$ Predicado Nominal (PN).

| Nº | Oração Analisada | Análise do Verbo | Termos Integrantes / Acessórios | Análise do Predicativo | Tipo de Predicado |

|:-: |:---------------------------------------------- |:-------------------------------------------- |:---------------------------------------- |:--------------------------------- |:---------------: |

| 1 | "Ela chegou desesperada." | chegou (Ação $\rightarrow$ VI) | — | desesperada (Pred. Sujeito) | PVN |

| 2 | "Ela ligou o ferro silenciosa." | ligou (Ação $\rightarrow$ VTD) | o ferro (Objeto Direto) | silenciosa (Pred. Sujeito) | PVN |

| 3 | "Chegamos ofegantes à porta da cantina." | Chegamos (Ação $\rightarrow$ VI) | à porta da cantina (Adj. Adv. Lugar) | ofegantes (Pred. Sujeito) | PVN |

| 4 | "Tu pisavas nos astros distraída." | pisavas (Ação $\rightarrow$ VI) | nos astros (Adj. Adv. Lugar) | distraída (Pred. Sujeito) | PVN |

| 5 | "O jogador correu para a bola afoito." | correu (Ação $\rightarrow$ VI) | para a bola (Adj. Adv. Lugar) | afoito (Pred. Sujeito) | PVN |

| 6 | "Consideraram absurda a decisão do chefe." | Consideraram (Ação $\rightarrow$ VTD) | a decisão do chefe (Objeto Direto) | absurda (Pred. do Objeto) | PVN |
...
-  — Predicação Verbal: Relação sintático-semântica que o verbo estabelece com o sujeito e com os termos que integram ou determinam seu significado na oração.
-  — Verbo Nocional (Pleno / Significativo): Verbo dotado de conteúdo semântico pleno que indica ação, processo, movimento ou fenômeno natural (VI, VTD, VTI, VTDI).
-  — Verbo Relacional (de Ligação / Cópula): Verbo desprovido de valor nocional de ação, cuja função é servir de elo sintático entre o sujeito e seu predicativo, veiculando noções de estado.
-  — Predicativo do Sujeito: Termo do predicado com função atributiva que qualifica, caracteriza ou classifica o sujeito por meio de concordância morfossintática.
-  — Predicativo do Objeto: Termo atributivo do predicado que expressa uma qualidade, estado ou juízo atribuído ao núcleo do objeto direto ou indireto.
-  — Adjunto Adverbial: Termo acessório da oração que expressa circunstância modificadora do verbo, adjetivo ou advérbio, definido pelo princípio da dispensabilidade sintática.
-  — Objeto Direto (OD): Complemento verbal não preposicionado obrigatoriamente que integra o sentido de um Verbo Transitivo Direto.
-  — Objeto Indireto (OI): Complemento verbal introduzido por preposição gramatical obrigatória exigida pela regência de um Verbo Transitivo Indireto.
-  — Predicado Nominal: Predicado estruturado por Verbo de Ligação + Predicativo do Sujeito, cujo núcleo semântico é o nome atributivo.
-  — Predicado Verbal: Predicado estruturado por verbo nocional de ação desprovido de predicativos, cujo núcleo semântico é a própria forma verbal.
-  — Predicado Verbo-Nominal: Predicado estruturado por verbo de ação + predicativo (do sujeito ou do objeto), contendo dois núcleos significativos concomitantes.
-  — Sujeito: Termo oracional que expressa o tópico sobre o qual recai a declaração do predicado, localizado pela fórmula Quem/O que é que + VERBO?.
...
Ao concluir este grupo temático, o estudante domina a competência central da sintaxe da oração: analisar a estrutura oracional a partir do verbo, e não da decoreba linear.
...
1. Listas mnemônicas de verbos de ligação são contextuais: cair doente é verbo de ligação (mudança de estado com predicativo), enquanto cair na rua é verbo intransitivo de ação (ação física com adjunto adverbial).
2. O predicativo é universal e pode acoplar-se a verbos de ação. Assim, os Tipos de Predicado definem-se com precisão algorítmica:
...
A metodologia desenvolvida pela Profª. Adriana Figueiredo supera a memorização estática tradicional através de quatro princípios fundamentais:
