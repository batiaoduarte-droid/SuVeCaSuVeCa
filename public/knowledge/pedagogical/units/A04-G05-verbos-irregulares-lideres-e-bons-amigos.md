# Verbos Irregulares - Líderes e Bons Amigos
...
- Distinção básica entre os Modos Verbais (Indicativo: certeza; Subjuntivo: hipótese/dúvida; Formas Nominais: infinitivo, gerúndio, particípio).
...
1. Grupo 1 — Verbos Líderes e Bons Amigos (Derivados): Composto por 4 verbos matrizes primitivos fundamentais (PÔR, TER, VER, VIR) e todas as suas respectivas famílias de verbos derivados cognatos (propor, deter, rever, intervir, etc.). A regra mestra deste grupo é a fidelidade absoluta: o derivado segue 100% da flexão do líder primitivo.
2. Grupo 2 — Verbos Falsos Amigos e Verbos de Difícil Conjugação ("Aloprados"): Composto por verbos que aparentam pertencer à família dos líderes mas possuem flexões divergentes (ex.: o verbo prover, que não segue ver, flexionando-se no pretérito como proveu/bebeu), além de verbos com alternâncias radicais foneticamente complexas (como aferir, acudir, polir).
3. Grupo 3 — Verbos Defectivos: Verbos que possuem lacunas ou imperfeições no paradigma conjugacional, deixando de existir em certas pessoas ou tempos por motivos de eufonia ou uso (com a atualização jurisprudencial/normativa sobre a aceitação da conjugação completa de adequar-se nas bancas modernas).
...
A fórmula morfológica invariável da derivação é:

$$
\text{Forma Conjugada do Derivado} = \text{Prefixo do Cognato} + \text{Forma Conjugada do Verbo Líder}
$$
...
3. Conjugue o líder para a pessoa e tempo requeridos.
4. Junte o prefixo à forma flexionada.
...
- Pretérito Imperfeito (gatilho "antigamente"): punha, punhas, punha, púnhamos, púnheis, punham
- Pretérito Mais-que-perfeito (desinência "-ra" / "outrora"): pusera, puseras, pusera, puséramos, puséreis, puseram
...
- Presente do Subjuntivo: que eu tenha, tu tenhas, ele tenha, nós tenhamos, vós tenhais, eles tenham
- Pretérito Imperfeito do Subjuntivo: se eu tivesse, tu tivesses, ele tivesse, nós tivéssemos, vós tivésseis, eles tivessem
...
1. Nos Verbos Derivados de TER (oxítonos terminados em -em):
...
- Presente do Subjuntivo: que eu veja, tu vejas, ele veja, nós vejamos, vós vejais, eles vejam
- Pretérito Imperfeito do Subjuntivo: se eu visse, tu visses, ele visse, nós víssemos, vós vísseis, eles vissem
...
1. Vício de Linguagem Recorrente: Substituir erradamente o presente "Hoje nós vimos" por "Hoje nós viemos", induzido pelo estranhamento fônico com o verbo ver.
...
| --- | --- | --- |
| Futuro do Subjuntivo | Raizvir-: quando eu vir, tu vires, ele vir, nós virmos, vós virdes, eles virem | Raizvier-: quando eu vier, tu vieres, ele vier, nós viermos, vós vierdes, eles vierem |
| Pret. Imperfeito Subj. | Raizvis-: se eu visse, tu visses, ele visse, nós víssemos, vós vísseis, eles vissem | Raizvies-: se eu viesse, tu viesses, ele viesse, nós viéssemos, vós viésseis, eles viessem |

- "Quando eu ver A abordagem didática..." $\rightarrow$ ERRADO (Norma exige: Quando eu vir).
- "Se os viajantes anteviessem o perigo..." $\rightarrow$ ERRADO (Como deriva de VER, o correto é antevissem).
- "Se as autoridades intervissem no caso..." $\rightarrow$ ERRADO (Como deriva de VIR, o correto é interviessem).
...
- "Viu a mulher vindo em sua direção."

$\rightarrow$ Teste: "Viu a mulher chegando em sua direção..." $\rightarrow$ Classificação: Gerúndio.
...
- Presente do Indicativo: vós amais
- Pretérito Imperfeito do Indicativo: vós amáveis
- Pretérito Mais-que-perfeito do Indicativo: vós amáreis
- Futuro do Presente do Indicativo: vós amareis
- Futuro do Pretérito do Indicativo: vós amaríeis
- Presente do Subjuntivo: que vós ameis
- Pretérito Imperfeito do Subjuntivo: se vós amásseis

1. Desinência -stes (Exclusiva do Pretérito Perfeito do Indicativo):

- Pretérito Perfeito: vós amastes (eu amei, tu amaste, ele amou, nós amamos, vós amastes, eles amaram)

1. Desinência -des (Futuro do Subjuntivo e Infinitivo Pessoal):

- Futuro do Subjuntivo: quando vós amardes
- Infinitivo Pessoal: (para) vós amardes

Quando um verbo foge a esse esquema, manifesta-se sua irregularidade. Por exemplo, o verbo PÔR no Presente do Indicativo faz vós pondes (adotando -des em lugar do padrão -is).
...
1. Sintaxe do Verbo CONVIR com Pronome "Te":
...
| Verbo Líder | Derivados Cognatos Típicos | Pretérito Perfeito (3ª pl.) | Futuro Subjuntivo (1ª sing.) | Particípio | Ponto Crítico de Atenção |
| --- | --- | --- | --- | --- | --- |
| PÔR | propor, dispor, compor, contrapor, depor, supor, repor | puseram (propuseram) | puser (depuser) | POSTO (irregular) | Infinitivo Pessoal (para porem) vs. Futuro Subjuntivo (quando puserem). |
| TER | deter, obter, manter, conter, abster-se, reter | tiveram (detiveram) | tiver (mantiver) | tido (regular) | Acento diferencial:ele tem / eles têm; ele mantém / eles mantêm. |
| VER | antever, prever, rever, entrever | viram (anteviram) | vir (previr) | VISTO (irregular) | Raiz do subjuntivo:vir (futuro) e visse (imperfeito). |
| VIR | advir, intervir, convir, provir, sobrevir | vieram (provieram) | vier (intervier) | VINDO (irregular homógrafo) | Parvimos (pres.) vs viemos (pass.); teste CHEGAR para a forma vindo. |
...
1. Validação: "Eles tinham [vindo / intervindo]" $\rightarrow$ "Eles tinham chegado" $\rightarrow$ Particípio.
...
| Forma Verbal | Verbo Primitivo | Tempo / Modo | Gatilho / Sentido | Exemplo Correto |
| --- | --- | --- | --- | --- |
| Vimos | VIR | Presente do Indicativo (1ª pl.) | HOJE (deslocamento presente) | "Hoje nós vimos apresentar a proposta." |
...
| --- | --- | --- | --- | --- |
| VER | vir- (vir, vires, vir, virmos, virdes, virem) | Quando ele previr | vis- (visse, visses, visse, víssemos...) | Se eles antevissem |
| VIR | vier- (vier, vieres, vier, viermos, vierdes, vierem) | Quando ele intervier | vies- (viesse, viesses, viesse, viéssemos...) | Se eles interviessem |

| Verbo Líder | Infinitivo Impessoal | Infinitivo Pessoal (3ª pl. - "PARA") | Particípio (Classificação) | Gerúndio ("-ndo") |
| --- | --- | --- | --- | --- |
| PÔR | pôr | (para) eles porem | posto (Irregular em -to) | pondo |
| TER | ter | (para) eles terem | tido (Regular em -do) | tendo |
| VER | ver | (para) eles verem | visto (Irregular em -to) | vendo |
| VIR | vir | (para) eles virem | vindo (Irregular Homógrafo) | vindo |

---

## Exemplos comentados

- Enunciado: "1. Os pais não se  a ficar com as crianças. (DISPOR – pretérito imperfeito do indicativo)"
...
- Enunciado: "2. Os economistas já  ao Governo os mais diversos planos de ação. (PROPOR – pretérito perfeito do indicativo)"
...
- Enunciado: "3. O artista  duas músicas por dia. (COMPOR - presente do indicativo)"
...
- Enunciado: "4. Na próxima audiência nós  a versão da vítima. (CONTRAPOR - futuro do presente do indicativo)"
...
- Enunciado: "5. Se eu  contra o prefeito, não sei o que ele faria. (DEPOR - futuro do subjuntivo)"
...
- Enunciado: "6. Os pais só  as crianças quando se dispõem a brincar com elas. (ENTRETER – presente do indicativo)"
...
- Enunciado: "7. Os alunos da minha escola jamais  incentivo para redigir textos em crônicas. (OBTER – pretérito perfeito do indicativo)"
...
- Enunciado: "8. Infelizmente não  os meios de comunicação. (DETER – presente do indicativo)"
...
- Enunciado: "9. A diretora pediu que nós  o contato com os alunos formados. (MANTER - presente do subjuntivo)"
...
- Enunciado: "10. Os alunos disseram que  dessa discussão. (ABSTER-SE - futuro do pretérito do indicativo)"
...
- Enunciado: "11. Os estudiosos  um papel relevante para Falcón. (ANTEVER - pretérito perfeito do indicativo)"
...
- Enunciado: "12. Chamou um engenheiro para que  as necessidades das plantas e do setor. (PREVER - presente do subjuntivo)"
...
- Enunciado: "13. Há anos que eu não  esse filme. (REVER - pretérito imperfeito do indicativo)"
...
- Enunciado: "14. O motor do elevador  de São Paulo. (PROVIR – pretérito perfeito do indicativo)"
...
- Enunciado: "15. Essa necessidade  da atual carência de recursos nessa área. (ADVIR – presente do indicativo)"
...
- Enunciado: "16. As autoridades  na situação antes que o pior acontecesse. (INTERVIR – pretérito mais-que-perfeito)"
...
- Enunciado: "17. Aceite esse convite se te . (CONVIR - futuro do subjuntivo)"
...
- Enunciado: "18. Eu teria  mais vezes se você tivesse convidado (VIR - particípio)"
- Resolução: Particípio irregular de vir é vindo (validado por chegado).
- Resposta: vindo | Fonte: 016

- Enunciado: "19. Viu a mulher  em sua direção. (VIR - gerúndio)"
- Resolução: Gerúndio de vir é vindo (validado por chegando).
- Resposta: vindo | Fonte: 016

- Enunciado: "20. Os fiscais  as empresas coletoras de entulho irregulares. (DETER - pretérito perfeito do indicativo)"
...
- Enunciado: "21. Os funcionários  os produtos se houvesse estoque. (REPOR - futuro do pretérito do indicativo)"
...
- Enunciado: "22. Os autores  a liberdade como base de tudo. (SUPOR - presente do indicativo)"
- Resolução: Infinitivo SUPOR $\rightarrow$ Líder PÔR $\rightarrow$ "Hoje eles põem" $\rightarrow$ supõem.
- Resposta: supõem | Fonte: 017

- Enunciado: "23. Precisa de um produto que  glúten. (CONTER - presente do subjuntivo)"
...
- Enunciado: "24. Os engenheiros  os trabalhadores de informações sobre os entulhos. (PROVIR - pretérito perfeito do indicativo)"
...
- Enunciado: "25. A prefeitura  no destino dos entulhos da construção. (INTERVIR - futuro do presente do indicativo)"
...
- Enunciado: "26. Se os viajantes  as dificuldades da viagem, muitos deles desistiriam da aventura. (ANTEVER - pretérito imperfeito do subjuntivo)"
- Resolução: Infinitivo ANTEVER $\rightarrow$ Líder VER (visão) $\rightarrow$ "Se os viajantes vissem" (raiz vis-) $\rightarrow$ antevissem.
- Resposta: antevissem | Fonte: 017
...
| --- | --- | --- | --- |
| Indicativo | Presente | "Hoje..." | Hoje eutenho / ponho / vejo / venho |
| Indicativo | Pretérito Perfeito | "Ontem..." | Ontem eutive / pus / vi / vim |
| Indicativo | Pretérito Imperfeito | "Antigamente..." | Antigamente eutinha / punha / via / vinha |
| Indicativo | Pretérito Mais-que-perfeito | Desinência"-ra" / "Outrora" | Outrora eutivera / pusera / vira / viera |
| Indicativo | Futuro do Presente | "Amanhã..." | Amanhã euterei / porei / verei / virei |
| Indicativo | Futuro do Pretérito | Desinência"-ria" | Euteria / poria / veria / viria |
| Subjuntivo | Presente | Conector"QUE..." | Que eutenha / ponha / veja / venha |
| Subjuntivo | Pretérito Imperfeito | Conector"SE..." | Se eutivesse / pusesse / visse / viesse |
| Subjuntivo | Futuro | Conector"QUANDO..." | Quando eutiver / puser / vir / vier |
| Forma Nominal | Infinitivo Pessoal | Preposição"PARA..." | Para euter / pôr / ver / vir |
...
- A memória motora e ortográfica sedimentada por esse treino elimina o estresse na hora da prova ("paz de espírito").
...
- Exceção do Futuro do Subjuntivo / Infinitivo Pessoal: Termina em -DES (amardes).
...
- Regra: Antever deriva de VER (raiz vis- $\rightarrow$ antevissem). Derivados de VIR utilizam a raiz vies- (interviessem).
...
Ao concluir este grupo temático, o estudante deve ter internalizado:
...
1. A Eliminação Definitiva de Vícios e Pegadinhas:
...
1. O Diagnóstico Preciso das Formas Nominais:
...
1. O Domínio Morfossintático Conectado:
...
**Apoio indireto:** Os paradigmas de verbos irregulares exigem aprendizagem morfológica própria; a SuVeCA apenas mostra em que oração, pessoa e relação a forma conjugada está sendo usada.
