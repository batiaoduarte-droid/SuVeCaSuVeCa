...
**Método central:** Nos verbos pronominais, determine se o pronome integra o verbo, realiza complemento, marca voz ou produz outro efeito a partir da valência e do mapa contextual.
...
│
└── 3. VALOR ESTILÍSTICO
 └── 3.1 Partícula Expletiva / de Realce ──► Ênfase expressiva ──► [Pode ser SUPRIMIDA sem prejuízo]
```
...
- *"A menina concentrava-se para realizar a prova."* (`041` — ) $\rightarrow$ *se* = PIV (processo mental/foco).
...
- *"Não se exigiu do cronista a perfeição."* (`041` — ) $\rightarrow$ *A perfeição não foi exigida do cronista.* (VTDI + PA; *a perfeição* = sujeito paciente).
- *"Compra-se ouro..."* (`042` — ) $\rightarrow$ *Ouro é comprado.* (PA).
- *"Encontrou-se um caminho..."* (`042` — ) $\rightarrow$ *Um caminho foi encontrado.* (PA).
- *"Constata-se que é uma discussão..."* (`042` — ) $\rightarrow$ *É constatado que é uma discussão...* (PA com oração subordinada substantiva subjetiva).

- **Contrasta diretamente com:**  (PIS/IIS).
...
- *"Não se trata de combater a tecnologia."* (`042` — ) $\rightarrow$ *trata* = VTI; *se* = PIS/IIS.
...
- *Recíproco:* *"Os amigos se abraçaram na despedida."* (`040` — ) $\rightarrow$ Abraçaram um ao outro.
- *Recíproco:* *"Os alunos se olharam surpresos..."* (`041` — ) $\rightarrow$ Olharam um ao outro.
- *Recíproco:* *"As pessoas se repelem e se atraem..."* (`042` — ) $\rightarrow$ Repelem umas às outras.
- *Recíproco:* *"Ao dividirem o palco, trataram-se com muita indiferença."* (`042` — ) $\rightarrow$ Trataram um ao outro.
...
Esta seção fornece uma síntese de consulta rápida com os critérios decisórios para cada uma das funções consolidadas:

| Função / Valor do SE | Natureza Gramatical | Critério Decisório de Reconhecimento | Comportamento do Verbo | Teste Mnemônico |
| :--------------------------------------------- | :------------------------------------------ | :----------------------------------------------------- | :------------------------------------------- | :------------------------------------------------------- |
| **Parte Integrante do Verbo (PIV)** | Morfema verbal (sem função sintática) | Integra verbos pronominais essenciais ou acidentais | Flexiona com o sujeito (*me, te, se, nos*) | Teste da conjugação dinâmica |
| **Pronome Apassivador (PA)** | Pronome morfossintático | Liga-se a VTD/VTDI; sujeito paciente sem preposição | Concorda com o sujeito paciente | Conversão em Passiva Analítica (*ser + particípio*) |
| **Partícula Indeterminadora (PIS/IIS)** | Índice morfossintático | Liga-se a VTI/VI/VL com termo preposicionado/advérbio | Fixo na 3ª pessoa do singular | Sujeito genérico (*"alguém"*) |
| **Pronome Reflexivo** | Pronome oblíquo (Objeto Direto / Indireto) | O sujeito pratica e recebe a ação sobre si mesmo | Verbo transitivo pleno | Macete do*"Menino"* / *"a si mesmo"* |
| **Pronome Recíproco** | Pronome oblíquo (Objeto Direto / Indireto) | Ação mútua entre dois ou mais sujeitos | Verbo obrigatoriamente no plural | Troca por*"um ao outro"* |
| **Conjunção Integrante** | Conjunção subordinativa | Introduz oração subordinada substantiva | Rege oração completiva/subjetiva | Macete do*"ISSO"* (*"DISSO"*, *"NISSO"*) |
| **Conjunção Condicional** | Conjunção subordinativa | Introduz oração adverbial de hipótese | Modo subjuntivo | Troca por*"CASO"* |
| **Conjunção Causal** | Conjunção subordinativa | Introduz a causa de fato consumado | Relação de causa e efeito | Troca por*"JÁ QUE"* (*Se... então*) |
| **Conjunção Concessiva** | Conjunção subordinativa | Introduz ressalva / oposição que não impede o fato | Sentido de contraste | Troca por*"EMBORA"* / *"AINDA QUE"* |
| **Partícula de Realce / Expletiva** | Vocábulo de realce | Elemento acessório de ênfase expressiva | Verbos intransitivos/movimento | Teste da supressão sem prejuízo |
...
`text
 ...
 ┌────────────────────────────────┴────────────────────────────────┐
 ▼ ▼
[ETAPA 1: TESTE DE CONJUNÇÃO] [ETAPA 2: TESTE DE REALCE]
 A palavra liga duas orações? Pode retirar o "se" sem qualquer alteração
 ├─ Troca a oração por "ISSO"? ──► CONJUNÇÃO INTEGRANTE estrutural ou semântica? (ex.: foram-se)
 ├─ Troca por "CASO"? ───────────► CONJUNÇÃO CONDICIONAL └─ Sim ──► PARTÍCULA DE REALCE / EXPLETIVA
 ├─ Troca por "JÁ QUE"? ─────────► CONJUNÇÃO CAUSAL
 └─ Troca por "EMBORA"? ─────────► CONJUNÇÃO CONCESSIVA
 │ (Se não for conjunção nem realce)
 ▼
 [ETAPA 3: TESTE PRONOMINAL / SINTÁTICO]
 │
 ┌───────────────────────────────────────┬────────────────────────┴──────────────┬────────────────────────────────────────┐
 ▼ ▼ ▼ ▼
[TESTE DA PASSIVA (PA)] [TESTE DO SUJEITO (PIS)] [TESTE DO MENINO (REFLEX)] [TESTE DA CONJUGAÇÃO (PIV)]
 Verbo VTD/VTDI + termo sem Verbo VTI/VI/VL + termo com Ação sobre o próprio corpo; Verbo só existe com pronome ou
 preposição: converte em passiva preposição: verbo fixo no permite transferir a terceiro muda regência; conjuga em
 analítica (ser + particípio). singular ("alguém..."). ("olhou o menino"). todas as pessoas (me/te/se...).
 └─► PRONOME APASSIVADOR └─► ÍNDICE INDETERMINADOR └─► PRONOME REFLEXIVO └─► PARTE INTEGRANTE (PIV)
 (Se plural mútuo ─► RECÍPROCO)
```text

---

## Método de Distinção Conclusiva entre PA e PIS/IIS

### Sequência passo a passo

1. **Passo 1 — Predicação do verbo:**
 - É Transitivo Direto (VTD) ou Transitivo Direto e Indireto (VTDI)? $\rightarrow$ **Candidato a PA**.
 - É Transitivo Indireto (VTI), Intransitivo (VI) ou de Ligação (VL)? $\rightarrow$ **Candidato a PIS**.
2. **Passo 2 — Análise da preposição no termo subsequente:**
 - O termo posposto **não tem preposição**? $\rightarrow$ Trata-se do Sujeito Paciente. O verbo deve concordar em número (*"Vendem-se casas"* $\rightarrow$ *Casas são vendidas*). Confirma-se **PA**.
 - O termo posposto **vem regido por preposição** obrigatória (*de, em, a*)? $\rightarrow$ Trata-se de Objeto Indireto ou Adjunto. O verbo fica travado no singular (*"Precisa-se de empregados"* $\rightarrow$ *não existe "empregados são precisados"*). Confirma-se **PIS/IIS**.
3. **Passo 3 — Teste de Transposição Analítica:**
 - Se couber a conversão *"Sujeito + Ser + Particípio"*, é rigorosamente **PA**.

---

## Teste de Reconhecimento de PIV por Conjugação Dinâmica

### Sequência passo a passo

1. Isole a forma verbal acompanhada de pronome (*ex.: concentrava-se, arrependeu-se, rendeu-se*).
2. Verifique se o sujeito é determinado (*A menina, Ele, A população*).
3. Execute mentalmente a flexão nas três primeiras pessoas do singular e do plural:
 - *Eu **me** [arrependo / concentro / rendo / transformo]*
 - *Tu **te** [arrependes / concentras / rendes / transformas]*
 - *Ele **se** [arrepende / concentra / rende / transforma]*
 - *Nós **nos** [arrependemos / concentramos / rendemos / transformamos]*
4. Verifique se o pronome é intrínseco à conjugação e desprovido de função de complemento externo.
5. **Resultado:** Classifica-se como **Parte Integrante do Verbo (PIV)**.
...
### Matriz de Contrastes Estruturais

| Par Comparativo | Critério Decisivo de Diferenciação | Exemplo Típico A | Exemplo Típico B |
|:-------------------------------------- |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |:-------------------------------------------------------------------------------------- |:------------------------------------------------------------------------------------------------------ |
| **PA vs. PIS** | **Transitividade e Preposição:** PA exige VTD/VTDI sem preposição no sujeito paciente (verbo flexiona); PIS ocorre com VTI/VI/VL com preposição/advérbio (verbo fixo no singular). | *"Destruíram-se as provas."* (PA — VTD — *as provas* = sujeito paciente plural). | *"Precisa-se de voluntários."* (PIS — VTI — *de voluntários* = objeto indireto). |
| **PIV vs. Reflexivo** | **Transferência a Terceiro (Macete do Menino):** No reflexivo, a ação recai sobre si mesmo e pode ser aplicada a um terceiro; na PIV, o verbo expressa processo interno, mental ou estado, não admitindo troca por terceiro. | *"Ele se queixou de dor."* (PIV — não existe *"queixar o menino"*). | *"Ele se feriu com a faca."* (Reflexivo — equivale a *"feriu a si mesmo"* / *"feriu o menino"*). |
| **Reflexivo vs. Recíproco** | **Número Verbal e Mutualidade:** O reflexivo pode ocorrer no singular ou plural (ação individual sobre si); o recíproco exige plural obrigatório e expressa troca bilateral (*"um ao outro"*). | *"Ela se olhou no espelho."* (Reflexivo — singular — olhou a si mesma). | *"Eles se olharam surpresos."* (Recíproco — plural — olharam um ao outro). |
| **PIV vs. Realce** | **Dependência Estrutural:** O pronome de realce pode ser eliminado sem afetar o sentido ou a regência; a PIV é estruturalmente obrigatória na forma pronominal culta. | *"A mulher se arrependeu."* (PIV — incorreto dizer *"a mulher arrependeu"*). | *"Eles se foram embora."* (Realce — perfeitamente válido dizer *"Eles foram embora"*). |
| **Conjunção Integrante vs. PA** | **Hifenização e Natureza da Oração:** A conjunção integrante introduz uma oração inteira (trocável por *ISSO*); o PA vem hifenizado ou ligado a verbo que passiva um substantivo. | *"Não sei se ele virá."* (Conjunção Integrante — *Não sei [isso]*). | *"Percebe-se o erro."* (PA — *O erro é percebido*). |
...
- **Concessiva:** Troque por *"EMBORA"* / *"AINDA QUE"* (fórmula de oposição) (`041` — ).
...
Ao concluir o estudo do Grupo `esta unidade`, o estudante deve dominar os seguintes conhecimentos e habilidades operacionais:

1. **Domínio dos Verbos Pronominais:** Saber que a Parte Integrante do Verbo (PIV) não possui função sintática isolada, varia de acordo com a pessoa gramatical (*me, te, se, nos, vos, se*) e não pode ser suprimida na norma culta padrão.
