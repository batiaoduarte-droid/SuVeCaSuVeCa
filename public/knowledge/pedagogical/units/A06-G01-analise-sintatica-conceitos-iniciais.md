...
```text
 [ Artigo / Adjunto Adnominal: "A" ] ──┐
 ▼
 [ SUBSTANTIVO NÚCLEO: "expressão" ]
 ▲
...
|:----------------------------------- |:--------------------- |:------------------------------ |:---------------------------------------------- |
| **A** | Artigo definido | Adjunto Adnominal | Determina o núcleo*expressão* |
...
Oração 1: [Os meninos] (Sujeito Sintático Explícito) jogam futebol.
 ▲
 │ (Seta Semântica / Referência Coesiva)
...
[ PREDICADO COMPLETO (Toda a Oração) ]
```
...
```text
Análise Sintática vs. Semântica:
Oração 1: [Os meninos] (Sujeito Sintático Explícito) jogam futebol.
Oração 2: [Ø] (Sujeito Sintático Oculto) Jogam futebol todos os dias.
 │
...
```text
Estrutura Sintática Interna do Sujeito:
[ Artigo: "A" (Adjunto Adnominal) ] ───┐
 ├──> [ "expressão" (NÚCLEO DO SUJEITO / Substantivo) ]
[ Aposto: "'inteligência artificial'" ] ─┘
```
...
* *"A"* (artigo) aponta para *"expressão"*;
* *"'inteligência artificial'"* (aposto especificativo) aponta para *"expressão"*;
* *"expressão"* é a palavra mais especificada (o núcleo).
...
### Tabela-Resumo de Formulações Canônicas
...
3. **Reescrever na Ordem Direta Canônica:** Reestruture mentalmente ou no rascunho:
 ...
 $$
4. **Verificar a Regência da Concordância:** Comprove que o substantivo núcleo do sujeito posposto é quem dita a flexão plural/singular do verbo e do adjetivo predicativo.
5. **Julgar a Assertiva:** Se a banca afirmar que o adjetivo inicial é sujeito ou que o substantivo concorda com o adjetivo, marque o item como **ERRADO**.
...
### Tabela 1: Frase vs Oração vs Período
...
| **Tratamento em Concurso** | Utilizada pelas bancas como**pegadinha / armadilha** | Fundamento obrigatório para julgar itens certos/errados |
...
Ao concluir o estudo do Grupo Temático `esta unidade`, o estudante deve ser capaz de:
