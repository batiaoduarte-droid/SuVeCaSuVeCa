...
>
> Compreender e definir os princípios normativos e conceituais de Desinências Verbais. Aplicar regras canônicas e procedimentos decisórios de Desinências Verbais na resolução de questões. Analisar o papel de Desinências Verbais no eixo Apoio estrutural e reconhecer armadilhas e variações de bancas.
...
**Apoio estrutural:** Desinências verbais são analisadas morfologicamente. A SuVeCA fornece o contexto de concordância e permite relacionar marcas de pessoa, número, tempo e modo ao sujeito e à predicação.
...
➔ ➔ RADICAL VOGAL TEMÁTICA (VT) DMT DNP (Significado (Classifica a conjugação: (Modo e Tempo: (Número e Pessoa: Léxico) 1ª: -a-, 2ª: -e-, 3ª: -i-) marca comum a marca particular
- todas as pessoas) que varia p/ pessoa)
➔ Pret. Imp. Ind (1ª): -va- 1ª Sing: -o / -i / Ø
- TEMA VERBAL
Pret. Imp. Ind (2ª/3ª): -ia- 2ª Sing: -s
- (Radical + VT)
Pret. Imp. Subj: -sse- 3ª Sing: Ø ➔ Pres. Subj (1ª): -e- (VT Ø) 1ª Plural: -mos Pres. Subj (2ª/3ª): -a- (VT Ø) 2ª Plural: -is / -des Pres. Ind: Ø 3ª Plural: -m / -ão
...
3. Compreender a diferença funcional entre DMT (marca comum/tempo) e DNP (marca particular/pessoa).
4. Praticar o Método dos 3 Passos identificando formas com morfemas nulos ($\emptyset$) e alomorfes.
5. Reconhecer as divergências doutrinárias (Bechara) e as armadilhas de bancas examinadoras.
...
- Radical: Elemento irredutível que comporta a carga semântica lexical básica.
- Vogal Temática (VT): Morfema que se acopla ao radical para preparar a base verbal e indicar a conjugação.
- Tema Verbal: Estrutura formada pela união do Radical com a Vogal Temática:
...
- A desinência de infinitivo -r é retirada; a vogal remanescente na extremidade é a Vogal Temática (a, e ou i); a porção anterior é o Radical.
- Em verbos regulares: falar $\rightarrow$ Radical fal-, VT a, Tema fala-.
- Em verbos irregulares no tema do perfeito: em pusera, o radical de perfeito é pus-, a VT da 2ª conjugação é e, compondo o tema puse-.
...
- Exemplo: Em falávamos, falavas, falavam, o segmento -va- é a marca recorrente do Pretérito Imperfeito do Indicativo.
...
- 1ª Pessoa Singular (Eu): -o (no Presente do Indicativo: fal-o), -i (no Futuro do Presente: falare-i) ou Ø (morfema zero nos Pretéritos e Subjuntivo: falava-Ø, fale-Ø).
- 2ª Pessoa Singular (Tu): -s (fala-s, falava-s, fale-s).
- 3ª Pessoa Singular (Ele/Ela): Ø (morfema zero em praticamente todos os tempos: fala-Ø, falava-Ø, fale-Ø).
- 1ª Pessoa Plural (Nós): -mos (fala-mos, faláva-mos, fale-mos).
- 2ª Pessoa Plural (Vós): -is ou -des (fala-is, faláve-is, fale-is, insistir-des).
- 3ª Pessoa Plural (Eles/Elas): -m (fala-m, falava-m, fale-m) ou -ão (falar-ão).

- Dica associada:  (O -is como âncora do vós)
...
1. Alomorfia de Vogal Temática: No verbo partir (3ª conjugação, VT padrão i), as formas do Presente do Indicativo partes, parte e partem exibem a vogal e. O elemento e é classificado como alomorfe da vogal temática i.
2. Alomorfia de Desinência Modo-Temporal: No Pretérito Imperfeito do Indicativo de 1ª conjugação (falar), a DMT padrão é -va-. Na 2ª pessoa do plural (faláveis), a DMT assume a forma -ve-. O segmento -ve- é um alomorfe da DMT -va-.
...
- 1º PASSO: ACHAR A VOGAL TEMÁTICA • "Jogar" o verbo para o Infinitivo Impessoal. • Identificar a vogal antes do "-r" (A = 1ª, E = 2ª, I = 3ª). • Isolar o Radical e obter a base do Tema (Radical + VT).
2º PASSO: ACHAR A DESINÊNCIA MODO-TEMPORAL (DMT) • Conjugar mentalmente o tempo verbal com o apoio de marcadores. • Isolar a desinência COMUM que se repete em todas as pessoas.
- 3º PASSO: ACHAR A DESINÊNCIA NÚMERO-PESSOAL (DNP) • Observar a terminação específica da pessoa solicitada. • Isolar a desinência PARTICULAR que varia de pessoa para pessoa.
...
- Nas demais pessoas (contamos = CONT + A + $\emptyset$ + MOS), há Radical, VT e DNP, mas a DMT permanece zero ($\emptyset$).
...
- Armadilha: A vogal a em possam ou a vogal e em amem não são vogais temáticas, mas sim DMTs do Presente do Subjuntivo.
...
1. Futuro do Presente do Indicativo: DMT -re- / -ra- (ou -rá-).
...
1. Pretérito Perfeito do Indicativo: Fato pontual consumado no passado ("Ontem eles puxaram").
2. Pretérito Mais-Que-Perfeito do Indicativo: Fato passado anterior a outro passado ("Outrora eles puxaram" = haviam puxado). Paradigma: puxara, puxaras, puxara, puxáramos, puxáreis, puxaram.

- Ambas as formas possuem pronúncia e grafia idênticas. Sem contexto textual que imponha a correlação verbal, a forma isolada pode pertencer legitimamente a qualquer um dos dois tempos.
...
- Conjugações Verbais: 1ª Conjugação (VT = A), 2ª Conjugação (VT = E, inclui pôr < poer), 3ª Conjugação (VT = I). Inexistência de 4ª conjugação .
- Tema Verbal: Fórmula canônica $\text{Tema} = \text{Radical} + \text{Vogal Temática}$ .
- DMT (Desinência Modo-Temporal): Morfema fixo e comum que identifica modo e tempo ao longo das pessoas gramaticais .
- DNP (Desinência Número-Pessoal): Morfema variável e particular que individualiza o número e a pessoa gramatical .
- Alomorfe: Realização variante de um morfema em contexto específico (part-e-s, fal-á-ve-is) .
- Morfema Zero ($\emptyset$): Ausência significativa de afixo em posições paradigmáticas (ex.: DMT no Presente do Indicativo; DNP na 3ª pess. sing.) .
- DMT no Subjuntivo: Substituição da VT pela DMT (-e- para 1ª conj.; -a- para 2ª e 3ª conj.) .
- DMT do Imperfeito (Padrão Bechara): -va-/-ve- (1ª conj.) e -ia-/-ie- (2ª e 3ª conj.) .
- Infinitivo Pessoal: Radical + VT + DMT -r- + DNPs pessoais .
- Homonímia em -aram: Coincidência morfológica entre Pretérito Perfeito e Pretérito Mais-Que-Perfeito na 3ª pessoa do plural .
...
1. Isole a forma (ex.: possam, fale, amem).
2. Enuncie o infinitivo não flexionado (poder, falar, amar).
...
| Elemento / Fenômeno | Conceito A | Conceito B | Critério Decisivo de Diferenciação |
| --- | --- | --- | --- |
| DMT vs. DNP | DMT: Marca o Modo e o Tempo. | DNP: Marca o Número e a Pessoa. | A DMT é a desinênciacomum fixa no tempo verbal; a DNP é a desinência particular que varia a cada pessoa. |
| Vogal Temática vs. DMT no Subjuntivo | VT: Identifica a conjugação primitiva no infinitivo (amar $\rightarrow$ a). | DMT do Subjuntivo: Vogal trocada que marca o modo (amem $\rightarrow$ e). | No Presente do Subjuntivo a VT primitiva desaparece ($\emptyset$); a vogal visível no verbo é a DMT. |
| DMT no Pret. Imperfeito (2ª/3ª conj.) | Padrão Bechara: O bloco -ia-/-ie- é DMT integral; VT é $\emptyset$. | Visão Tradicional Escolar: O i é VT e apenas o -a- é DMT. | Bancas de alto nível (FGV, Cebraspe, FCC, FUNRIO) adotam o padrão Bechara (DMT = -ia-). |
| Terminação -aram Descontextualizada | Pretérito Perfeito: Ação pontual concluída no passado (ontem puxaram). | Pretérito Mais-Que-Perfeito: Ação passada anterior a outro passado (outrora puxaram). | Grafia e pronúncia idênticas na 3ª pess. plural da 1ª conjugação; distinção só é possível com contexto textual. |
| Infinitivo Pessoal vs. Futuro do Subjuntivo | Infinitivo Pessoal: Rege-se por preposição (para nós dedicarmos). | Futuro do Subjuntivo: Rege-se por conjunção temporal/condicional (se/quando nós dedicarmos). | Em verbos regulares as formas coincidem; o conector sintático define a classificação. |
| Perfil FUNDATEC vs. CESPE/FGV | FUNDATEC: Aceita imprecisões escolares (ex.: bloco ar como desinência de infinitivo). | CESPE / FGV: Exige decomposição científica estrita (separa radical, VT, DMT e DNP sem fusões). | Candidato deve adequar o rigor de análise ao perfil histórico da banca examinadora. |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| a | amem | amar | Presente do Subjuntivo | AM | $\emptyset$ | E | m |
| b | dormíeis | dormir | Pretérito Imperfeito do Indicativo (Bechara) | DORM | $\emptyset$ | ÍE | IS |
| c | correrás | correr | Futuro do Presente do Indicativo | CORR | E | RA | S |
| d | entrego | entregar | Presente do Indicativo | ENTREG | $\emptyset$ | $\emptyset$ | O |
...
Ao concluir o estudo desta unidade (Desinências Verbais), o estudante consolida as seguintes competências operacionais:
...
1. Mapeamento de Nulidades e Trocas Vocálicas:
...
1. Alinhamento com Doutrinas de Prova:
