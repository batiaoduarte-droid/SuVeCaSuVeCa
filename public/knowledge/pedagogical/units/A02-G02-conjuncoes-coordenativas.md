...
**Conexão forte:** Monte o mapa interno das orações coordenadas e, em seguida, classifique a relação aditiva, adversativa, alternativa, conclusiva ou explicativa criada entre elas.
...
- Noções Básicas de Sintaxe da Oração: Identificação de sujeito, verbo, predicado e limites oracionais.
...
- ➔ 1. ADITIVAS (Ideia de Soma / Adição / Acréscimo)
➔ Lista Canônica: e, nem, não só... mas também, não apenas... como também
- ➔ Correlativas Aditivas: "Não só/apenas A, mas também B" = Soma de termos/causas complementares (= E)
➔ Conectivo "NEM":
- ➔ Com negação antecedente: Conjunção Coordenativa Aditiva (= E NÃO) -> SEM vírgula e SEM "e"
➔ Isolado no início: Advérbio de Negação (= NÃO / SEQUER)
- ➔ Locução "TANTO... QUANTO":
➔ Soma de sujeitos/elementos: Valor Aditivo (= E) -> Ex.: "Tanto João quanto José vieram"
- ➔ Igualdade de intensidade/grau: Valor Comparativo -> Ex.: "João estuda tanto quanto José"
➔ 2. ADVERSATIVAS (Ideia de Oposição / Contraste / Restrição / Ressalva)
- ➔ Sinônimos Semânticos Canônicos: Oposição = Contraste = Contraposição
➔ Lista Canônica: mas, porém, todavia, contudo, entretanto, no entanto, não obstante
- ➔ Dupla Função Discursiva em Prova:
➔ Oposição / Contraste Estrito: Polaridade antagônica direta (Fato Positivo [+] vs. Fato Negativo [-])
- ➔ Restrição / Ressalva / Compensação: Limitação contextual sem contradição simétrica/antônima
➔ 3. ALTERNATIVAS (Ideia de Alternância no Tempo vs. Escolha/Exclusão Mútua)
- ➔ Distinção Crítica:
➔ Alternância: Ações sucessivas que se alternam no tempo ("ora estuda, ora trabalha")
- ➔ Escolha / Exclusão: Opções que se anulam mutuamente ("ou saio eu, ou sai ele")
➔ Lista Canônica: ou, ou... ou, ora... ora, já... já, quer... quer
- ➔ 4. CONCLUSIVAS (Ideia de Conclusão / Dedução / Consequência Lógica)
➔ Paráfrase Semântica Canônica: Conclusão = Consequência (Efeito derivado de uma causa/premissa)
- ➔ Lista Canônica: logo, portanto, por conseguinte, por isso, dessa forma, assim, pois (deslocado)
➔ Regra do "POIS" Deslocado: Posicionado APÓS o verbo da oração = Conclusivo (= portanto)
- ➔ Conectivo "ENTÃO":
➔ Valores possíveis: Temporal (tempo) ou Conclusivo (= portanto)
- ➔ A "Vacina do CEBRASPE": O conectivo "ENTÃO" NUNCA possui valor explicativo!
➔ 5. EXPLICATIVAS (Ideia de Explicação / Justificativa / Motivação) ➔ Sinônimos Semânticos Canônicos: Explicação = Justificativa ➔ Associação Sintática Típica: Orações com verbo no MODO IMPERATIVO (Ordem/Pedido + Justificativa) ➔ Lista Canônica: que, porque, porquanto, pois (no início da oração / antes do verbo) ➔ Regra do "POIS" Explicativo: Posicionado no INÍCIO da oração (pré-verbal) = Explicativo (= porque) ➔ Diferenciação Crítica: PORQUANTO (= porque / explicativa) vs. PORTANTO (= logo / conclusiva)
...
- A Dupla Estratégia Pedagógica ("Entender + Decorar"): Para obter 100% de precisão em concursos públicos, o estudante não pode se apoiar apenas na intuição nem exclusivamente na memorização cega. Exige-se:

1. Entender (Valor Semântico): Analisar a relação de sentido concreta que o conector estabelece no contexto textual específico.
2. Decorar (Listas Canônicas): Ter memorizado o repertório de conectivos característicos de cada família para identificar anomalias, arcaísmos e falsos equivalentes propostos pelas bancas.
...
1. NEM como Advérbio de Negação (= não / = sequer):
...
1. Regras Obrigatórias de Pontuação e Sintaxe para o "NEM" Aditivo:
...
1. Restrição / Ressalva / Compensação: Ocorre quando a segunda oração não nega diretamente a primeira nem expressa uma oposição simétrica, mas introduz um limite, uma ressalva ou uma compensação ao escopo da declaração anterior.
...
1. Alternância: As ações não se anulam; elas ocorrem de maneira intercalada ou sucessiva no tempo.
...
| Categoria / Conector | Classificação Canônica | Sentido Principal / Sinônimos de Prova | Lista de Conectivos Típicos | ID Detalhado |
| --- | --- | --- | --- | --- |
| Aditivas | Coord. Aditiva | Adição, Soma, Acréscimo, Complementar | e, nem, não só... mas também, não apenas... como também |  |
| NEM (com negação) | Coord. Aditiva | Soma de fatos negativos (= e não) | ...não [verbo] nem [verbo] (sem vírgula e sem "e") |  |
| NEM (início de frase) | Advérbio de Negação | Negação estrita (= não / = sequer) | Nem [verbo]... (sem negação prévia) |  |
| Adversativas | Coord. Adversativa | Oposição, Contraste, Contraposição, Restrição, Ressalva | mas, porém, todavia, contudo, entretanto, no entanto |  |
| Alternativas | Coord. Alternativa | Alternância temporal vs. Escolha / Exclusão | ou, ou... ou, ora... ora, já... já, quer... quer |  |
| Conclusivas | Coord. Conclusiva | Conclusão, Consequência, Efeito Lógico | logo, portanto, por conseguinte, por isso, dessa forma |  |
| Pois (Pós-verbal) | Coord. Conclusiva | Conclusão (= portanto) | [verbo], pois,... (deslocado após o verbo) |  |
| Explicativas | Coord. Explicativa | Explicação, Justificativa, Motivação | que, porque, porquanto, pois (pré-verbal) |  |
| Pois (Pré-verbal) | Coord. Explicativa | Explicação / Justificativa (= porque) | ..., pois [verbo]... (início da oração) |  |
| Porquanto | Coord. Explicativa / Causal | Explicação / Causa (= porque) | porquanto (inconfundível com portanto) |  |
...
➔ 2. Verificar a posição do "POIS" em relação a esse verbo:
- ➔ O "POIS" está DEPOIS do verbo? (Posição Pós-verbal / Deslocado)
➔ Teste: Substituir mentalmente por PORTANTO.
- ➔ Classificação: CONJUNÇÃO CONCLUSIVA (Valor: Conclusão / Consequência).
➔ O "POIS" está ANTES do verbo? (Posição Pré-verbal / Início da oração)
- ➔ Teste: Substituir mentalmente por PORQUE.
➔ Classificação: CONJUNÇÃO EXPLICATIVA (Valor: Explicação / Justificativa).
- [Fim]
```
...
1. Se HOUVER negação antecedente (ex.: "Ele não estuda nem trabalha"):
...
1. Se NÃO HOUVER negação antecedente e o "NEM" estiver isolado no início (ex.: "Nem estuda"):
...
1. Analisar o conectivo original "A" no contexto do texto. Determinar seu sentido real (ex.: Conclusivo, Adversativo, Aditivo).
2. Analisar o conectivo substituto "B" proposto pela banca. Verificar sua família semântica e requisitos sintáticos. Teste de Equivalência: Pertencem à mesma família semântica e mantêm a sintaxe? SIM ➔ Item CERTO (mantém sentido e correção). NÃO ➔ Item ERRADO (altera sentido ou fere a gramática). [Fim]
...
| Par de Conceitos / Conectivos | Critério Diferenciador Decisivo | Comportamento no Contexto A | Comportamento no Contexto B | Exemplo Contrastivo |
| --- | --- | --- | --- | --- |
| Porquanto vs. Portanto | Família Semântica e Função Lógica | Porquanto = Explicativa / Causal ($=\text{porque}$) | Portanto = Conclusiva / Consequência ($=\text{logo}$) | "Estude, porquanto a prova se aproxima" vs. "Estudou muito; passou, portanto." |
| Pois Deslocado vs. Pois em Início | Posição sintática em relação ao verbo da oração | Pós-verbal = Conclusivo ($=\text{portanto}$) | Pré-verbal = Explicativo ($=\text{porque}$) | "Não reclame, pois, do teste" vs. "Venha já, pois vai chover." |
| Oposição vs. Restrição / Ressalva | Existência de polaridade antagônica estrita | Oposição: Antagonismo simétrico direto[+] vs [-] | Restrição: Limitação/ressalva sem contradição simétrica | "A violência caiu, porém há preocupações" vs. "É bom aluno, mas não gosta de ler." |
| Alternância vs. Exclusão | Coexistência dos fatos no tempo | Alternância: Fatos sucessivos que não se anulam | Exclusão: Fatos mutuamente excludentes | "Ora corre, ora descansa" vs. "Ou entra você, ou entro eu." |
| Tanto... quanto (Adição vs. Comparação) | Soma de agentes vs. Medição de intensidade verbal | Adição: Soma dois sujeitos na ação ($=\text{e}$) | Comparação: Mede a intensidade de uma ação comum | "Tanto Pedro quanto Ana vieram" vs. "Pedro estuda tanto quanto Ana." |
| Nem (Conjunção vs. Advérbio) | Presença de negação prévia no enunciado | Conjunção Aditiva: Antecedido por negação ($=\text{e não}$) | Advérbio: Isolado no início de frase ($=\text{não/sequer}$) | "Não trabalha nem estuda" vs. "Nem trabalha, quanto mais estuda." |
| Então (Conclusivo vs. Explicação) | Compatibilidade semântica na norma culta | Conclusivo / Temporal: Legítimo ($=\text{portanto}$) | Explicativo:Inexistente / Proibido | "Penso, então existo" (Conclusão legítima; NUNCA explicação). |
...
- Classificação: Conjunção Coordenativa Aditiva (Valor: Adição / Soma).
...
- Classificação: Conjunção Coordenativa Adversativa (Valor: Oposição / Contraste).
...
- Classificação: Estrutura Correlativa Aditiva (Valor: Adição / Soma).
...
- Classificação: Conjunção Coordenativa Explicativa (Valor: Explicação / Justificativa).
...
2. ( b ) "Todos prometeram ajudar; muitos, porém, não cumpriram a promessa." (Adversidade / Quebra de expectativa).
3. ( a ) "Ela não foi só recebê-lo no aeroporto mas também se prontificou a mostrar-lhe a cidade." (Correlativa Aditiva).
4. ( e ) "Vamos embora, pois o filme está muito chato." (Justificativa de ordem / Imperativo).
5. ( d ) "Você leu as cláusulas do contrato; não reclame, pois, das dificuldades que surgirem." (Pois pós-verbal deslocado $= \text{portanto}$).
6. ( c ) "As crianças, entusiasmadas, ora corriam pelo quintal, ora entravam pelos corredores." (Alternância no tempo).
...
- Análise e Resolução: Aplicação do método de polaridade: a primeira oração destaca a queda da violência letal (fato positivo [+]); a segunda, introduzida por Porém, aponta movimentos preocupantes e tendências negativas (fato desfavorável [-]). Há oposição e contraste estrito.
- Gabarito: CERTO
...
- Análise e Resolução: Aplicação imediata da "vacina do CEBRASPE": o conector então só pode expressar tempo ou conclusão ($=\text{portanto}$), nunca explicação. No texto, estabelece a conclusão dedutiva de que, se a história é moldada hoje, a arquitetura é o resultado coletivo.
- Gabarito: ERRADO
...
- Análise e Resolução: Aplicação do método em 2 passos: (1) O conector mas é coordenativo adversativo com valor de oposição no texto; (2) O conector substituto porém pertence à mesma família e possui equivalência sintático-semântica perfeita.
- Gabarito: CERTO
...
Ao concluir o estudo deste grupo temático, o estudante deve ter desenvolvido competência para:
...
1. Operar a Leitura Semântico-Discursiva em Questões Avançadas (CEBRASPE):
...
1. Executar o Procedimento de Reescritura em 2 Passos: Julgar itens de substituição textual avaliando a compatibilidade semântica da conjunção original com a conjunção proposta e verificando a integridade sintática e pontuação do período.
