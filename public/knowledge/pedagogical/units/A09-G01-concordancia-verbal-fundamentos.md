...
1. Instrumento preposicionado (no relógio, nos sinos) ou omitido: A preposição (em + o = no) rebaixa o instrumento a adjunto adverbial de lugar. Como o núcleo do sujeito não pode ser preposicionado, o sujeito passa a ser o numeral de horas:
...
1. Verbo Anteposto ao Sujeito Composto (Verbo + Sujeito Composto): Admite dupla possibilidade de concordância:
...
1. Hierarquia de Pessoas Gramaticais (Pronomes Pessoais Retos):
...
A tabela abaixo consolida as regras fundamentais desta unidade para consulta rápida:
...
| Sujeito Composto Posposto | Sujeito Composto + Verbo | Flexão obrigatória noplural (Concordância Total/Lógica). |
...
1. Isolar o sintagma nominal que responde integralmente à pergunta.
2. Descarte sistemático de termos preposicionados: Risque ou elimine mentalmente todos os sintagmas introduzidos por preposição (de, em, a, com, por, para, crase às), pois termo preposicionado nunca é sujeito.
3. Isolar o núcleo substantivo: Identifique a palavra-base sem preposição e circule-a.
4. Verificar a flexão:
...
| --- | --- | --- |
| Existência Semântica | O agenteexiste na realidade (alguém, todo mundo). | O agentenão existe no plano real nem sintático. |
| Tipologia Verbal | 3ª pessoa plural OU VI/VTI/VL + SE (PIS). | Verbos impessoais (haver = existir; fenômenos meteorológicos). |
| Comportamento Verbal | Fixo na 3ª do plural ou 3ª do singular comSE. | Fixo na3ª pessoa do singular (Havia problemas). |
| Base Teórica |  | ,  |
...
Ao concluir esta unidade, o estudante deve dominar os seguintes pilares da concordância verbal:
