...
├── 1. Seleção de Pronomes Pessoais Oblíquos
...
│
└── 6. Regência com Pronomes Relativos
 ├── Equivalências ────────► em que = no qual | de que = do qual
 └── Restrições ───────────► "Aonde" exige verbo de movimento + prep. "a" (incompatível com "investir")
```
...
- *Obedeci ao menino prontamente* $\rightarrow$ *Obedeci-**lhe** prontamente* (Correto — *obedecer* é VTI).
...
- Se o pronome expressar **posse** sobre um substantivo $\rightarrow$ `lhe` é **Adjunto Adnominal**.
...
|:-------------------- |:------------------- |:---------------------------------------- |:------------------------------ |:------------------------------------------------------ |
| **Acarretar** | VTDI | Rege O.D. de coisa + O.I. de pessoa | O.D. =`o/a` \| O.I. = `lhe` | *A falta acarretou-**lhe** penalidades.* |
| **Desobedecer** | VTI | Rege preposição*a* | Exige`lhe / lhes` | *Não **lhe** desobedecerei jamais.* |
| **Ajudar** | VTD | Sem preposição (norma tradicional) | Exige`o / a / os / as` | *Eu **o** ajudei na tarefa.* |
| **Incomodar** | VTD | Sem preposição | Exige`o / a / os / as` | *O barulho incomodou-**os**.* |
| **Satisfazer** | VTD | Sem preposição (com pessoa) | Exige`o / a / os / as` | *A resposta não **o** satisfez.* |
...
2. **Construção B (Coisa como O.D. + Pessoa como O.I.):**
 $$
...
- O verbo *obedecer* é VTI (exige preposição *a* $\rightarrow$ *obedecer às ordens*).
...
### Tabela canônica de consulta rápida
...
```text
 ...
 ▼ ▼
 ┌──────────────────────┐ ┌──────────────────────┐
 │ O pronome inserido │ │ O pronome inserido │
 │ DEVE SER INDIRETO │ │ DEVE SER DIRETO │
 │ (lhe / lhes / a ele) │ │ (o / a / os / as) │
 └──────────────────────┘ └──────────────────────┘
 │ │
 ▼ ▼
 ┌──────────────────────┐ ┌──────────────────────┐
 │ Proibido inserir: │ │ Proibido inserir: │
 │ o / a / os / as │ │ lhe / lhes │
 └──────────────────────┘ └──────────────────────┘
```
...
|:------------------------------------- |:------------------------------ |:------------------------------------------------ |:-------------------------------- |:--------------------------- |
| **Objeto Indireto (O.I.)** | Verbo (VTI ou VTDI) | Completa a regência verbal com preposição*a* | *Obedeci ao menino* | *Obedeci-lhe prontamente.* |
...
Ao concluir o estudo do Grupo `esta unidade`, o estudante deve dominar as seguintes competências práticas e teóricas:
