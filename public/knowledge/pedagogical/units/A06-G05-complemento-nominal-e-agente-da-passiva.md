...
│
└── 3. AGENTE DA PASSIVA (NÃO manda seta para ninguém: termo autônomo na passiva)
 ├── Ambiente Sintático: Voz Passiva Analítica ("SER + PARTICÍPIO")
 ├── Preposições Introdutórias:
 │ ├── Padrão / Mais Frequente: "Por" (e contrações: pelo, pela, pelos, pelas)
 │ └── Secundária / Menos Frequente: "De" (ex.: "cercado de inimigos")
 └── Validação Inequívoca (Teste da Voz Ativa):
 ├── Vira Sujeito Agente na Ativa ──> AGENTE DA PASSIVA ("filmado pela TV" -> "A TV filmou")
 └── NÃO vira Sujeito Agente na Ativa:
 ├── Indica Causa/Motivo ─────> ADJUNTO ADVERBIAL DE CAUSA ("elogiado pela inteligência")
 └── Particípio Adjetivado ────> COMPLEMENTO NOMINAL ("recebida dos pais")
```
...
- *Ele necessita* $\rightarrow$ flexão verbal $\rightarrow$ termo regido é **Objeto Indireto**.
...
### Tabela de Contrastes Críticos

| Critério de Confronto | Termo Sintático A | Termo Sintático B | Fator Decisivo de Diferenciação |
|:---------------------------------------------------------------------- |:----------------------------------------------------------------- |:-------------------------------------------------------------------------------- |:-------------------------------------------------------------------------------------------------------------------------------------- |
| **Regente Verbal vs. Regente Nominal** | **Objeto Indireto (OI)***(ex.: necessita de ajuda)* | **Complemento Nominal (CN)***(ex.: necessidade de ajuda)* | A classe do regente: OI completa**verbo**; CN completa **nome** (subst., adj., adv.). |
...
| **Comportamento Vetorial** | **OD, OI e CN** | **Agente da Passiva** | OD, OI e CN**mandam seta** de subordinação; o Agente da Passiva **não manda seta** (`—`). |
