...
**Método central:** Complemento nominal e agente da passiva ampliam o mapa para relações ligadas a nomes e à voz passiva, evitando classificações baseadas apenas na preposição.
...
- Classes Gramaticais (Morfologia): Distinção clara entre substantivo, adjetivo, advérbio e verbo; identificação de preposições puras e contraídas (a, de, em, por, à, ao, do, no, pelo).
- Transitividade Verbal: Compreensão de verbos transitivos diretos (VTD), transitivos indiretos (VTI) e transitivos diretos e indiretos (VTDI).
...
1. Complementos Verbais: Objeto Direto (OD) e Objeto Indireto (OI), que completam o sentido de verbos transitivos.
2. Complemento Nominal (CN): Termo preposicionado que completa o sentido de nomes (substantivos, adjetivos e advérbios).
3. Agente da Passiva (AP): Termo preposicionado que expressa o ser executor da ação na voz passiva analítica.

A função nuclear dos termos integrantes é satisfazer exigências sintático-semânticas estruturais: verbos e nomes que demandam complemento tornam-se agramaticais ou semanticamente truncados sem a presença de seus respectivos termos integrantes.
...
1. Preposição "por" e variantes contratas (padrão majoritário): pelo, pela, pelos, pelas.
2. Preposição "de" (variante clássica e menos frequente): admitida gramaticalmente, como em O castelo foi cercado de inimigos.
...
3. Aplicar o Teste de Transposição Ativa : o termo preposicionado deve se transformar perfeitamente no sujeito agente da oração correspondente na voz ativa.

- Expande para:  (AP com particípio reduzido).
- Exemplificado em: , .
...
| Termo Sintático | Papel Sintático | Referente (Seta para) | Exigência Preposicional | Morfologia do Núcleo | Exemplo Canônico Consolidado |
| --- | --- | --- | --- | --- | --- |
| Objeto Direto (OD) | Completa o verbo | Verbo | Não obrigatória (admite OD preposicionado) | Substantivo (ou pronome) | João leu o livro. |
| Objeto Indireto (OI) | Completa o verbo | Verbo | Obrigatória | Substantivo (ou pronome) | João gosta de suco. |
...
- A necessidade $\rightarrow$ aceita artigo definidor $\rightarrow$ é substantivo $\rightarrow$ termo regido é Complemento Nominal.
...
1. Caso de Falso Agente da Passiva (Adjunto Adverbial de Causa):
...
- Complemento Nominal (Regra Canônica): Termo integrante preposicionado obrigatório que completa o sentido de substantivo abstrato (com sentido passivo), adjetivo ou advérbio .
- Agente da Passiva (Regra Canônica): Termo integrante preposicionado (por ou de) que indica o agente executor da ação em orações na voz passiva analítica (ser + particípio), convertendo-se em sujeito na voz ativa .
- Objeto Direto vs. Objeto Indireto: Ambos completam verbo; o OD possui preposição facultativa/não obrigatória, enquanto o OI possui preposição estritamente obrigatória .
- Conceito Operacional de "Nome": No âmbito da sintaxe oracional, compreende estritamente a tríade morfossintática: substantivo, adjetivo e advérbio .
- Regra da Autonomia Vetorial do Agente da Passiva: O Agente da Passiva não estabelece subordinação de complementação sobre outro termo (não manda seta); atua diretamente como praticante da ação verbal passiva .
...
1. Passo 2 — Classificar Morfologicamente o Termo Regente (Destino da Seta):
...
1. Passo 3 — Enquadrar na Matriz Sintática:
...
1. Avalie o resultado semântico:
...
| Critério de Confronto | Termo Sintático A | Termo Sintático B | Fator Decisivo de Diferenciação |
| --- | --- | --- | --- |
| Regente Verbal vs. Regente Nominal | Objeto Indireto (OI)(ex.: necessita de ajuda) | Complemento Nominal (CN)(ex.: necessidade de ajuda) | A classe do regente: OI completaverbo; CN completa nome (subst., adj., adv.). |
| Executor Ativo vs. Motivo Causal | Agente da Passiva (AP)(ex.: filmado pela TV) | Adjunto Adverbial de Causa(ex.: elogiado pela inteligência) | Teste da ativa: AP vira sujeito agente (A TV filmou); o adjunto de causa não pode virar sujeito (A inteligência não elogia). |
| Agente em Particípio Reduzido vs. Referência de Particípio | Agente da Passiva com "de"(ex.: cercado de curiosos) | Complemento Nominal de Particípio(ex.: herança recebida dos pais) | Sentido do agente:Curiosos cercaram o menino (AP); Os pais não receberam a herança, eles a deixaram (CN de recebida). |
| Comportamento Vetorial | OD, OI e CN | Agente da Passiva | OD, OI e CNmandam seta de subordinação; o Agente da Passiva não manda seta (—). |
...
1. Forma Variante (Preposição de):
...
1. Estava realmente agradecido a eles.
...
1. Comer demais é prejudicial à saúde.
...
1. Não duvides das verdades divinas.
...
1. A crença em dias melhores animava-os.
...
1. Passou aos filhos a herança recebida dos pais.
...
1. O coração não resistiu à prova.
...
- Como Evitar: Aplique rigorosamente a transposição para a voz ativa. Se o termo preposicionado não puder ser o sujeito da ativa, trata-se de Adjunto Adverbial de Causa.
...
Ao concluir este grupo temático, o estudante deve ter internalizado e ser capaz de aplicar as seguintes competências operacionais:

1. Dominar o Algoritmo dos Três Passos: Nunca tentar classificar um termo por intuição ou decoreba; localizar o referente lançando a seta, classificar a morfologia do referente e cruzar com a tabela sintática.
2. Distinguir Inequivocamente Complemento Nominal de Objeto Indireto: Reconhecer que termos com preposições e morfologias idênticas (de ajuda, aos companheiros, a eles) têm sua função ditada pelo referente: verbo $\rightarrow$ Objeto Indireto; nome (substantivo, adjetivo, advérbio) $\rightarrow$ Complemento Nominal.
3. Validar o Agente da Passiva pelo Teste de Transposição: Comprovar a presença da voz passiva analítica (ser + particípio) e verificar se o termo introduzido por por ou de converte-se com perfeição em sujeito agente na voz ativa, blindando-se contra a pegadinha do Adjunto Adverbial de Causa.
4. Reconhecer Agente da Passiva com Preposição "De" em Particípios Reduzidos: Identificar particípios com verbos auxiliares elípticos (típicos de bancas como FGV) e contrastá-los com particípios puramente adjetivados cujo termo preposicionado atua como Complemento Nominal.
