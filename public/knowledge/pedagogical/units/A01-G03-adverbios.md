...
>
> Compreender e definir os princípios normativos e conceituais de Advérbios. Aplicar regras canônicas e procedimentos decisórios de Advérbios na resolução de questões. Analisar o papel de Advérbios no eixo Conexão forte e reconhecer armadilhas e variações de bancas.
...
**Conexão forte:** A SuVeCA localiza o advérbio ou a locução como modificador do verbo, do adjetivo, de outro advérbio ou da oração e ajuda a separar valor adverbial de emprego adjetivo.
...
- Invariabilidade Adverbial: Propriedade formal que impede o advérbio de sofrer flexão de gênero ou número.
...
1. Lugar: Responde a Onde? (ex.: "Chorei no cinema").
2. Tempo: Responde a Quando? ou indica frequência (ex.: "Saí à noite").
3. Modo: Responde a Como? ou traduz o Jeito de realização do fato verbal (ex.: "Saiu apressadamente"). A equivalência didática é: $\text{Modo} = \text{Jeito}$.
4. Intensidade: Expressa gradação de força, quantidade ou intensidade (ex.: "Estudamos muito").
5. Afirmação: Confirma e reforça a predicação (ex.: "Certamente serei aprovado").
6. Negação: Invalida ou nega a predicação (ex.: "Eu nunca quis uma festa").
...
- "É bem provável." $\rightarrow$ bem modifica o adjetivo provável $\implies$ Advérbio de Intensidade (intensificador).
- "Recursos bem diferentes." $\rightarrow$ bem modifica o adjetivo diferentes $\implies$ Advérbio de Intensidade (= muito diferentes).
...
- Sentido de Negação: Invalida o fato verbal (equivale a "não quis").
- Sentido de Tempo: Circunscreve a negação a um intervalo temporal absoluto (equivale a "em tempo algum").

Ambas as classificações são reconhecidas pelas bancas examinadoras conforme o foco exigido no comando da questão.
...
| --- | --- | --- |
| Teste do Plural | "Elas estãobem." (Termo invariável) | "Elas estãofelizes." (Termo flexiona em número) |
| Classe Morfológica | Advérbio de Modo | Adjetivo |
...
- Classificação: O vocábulo clara atua contextualmente como advérbio de modo modificador do verbo explica-se, e não como adjetivo qualificador do substantivo questão.
- Mantra Didático: "O que vem depois, salva!" — Ao analisar termo aparentemente adjetivo coordenado a advérbio em -mente, examine o termo subsequente para reconhecer a elipse do sufixo.
...
- O vocábulo Hoje surge na cabeça do parágrafo, isolado por vírgulas e distante fisicamente do verbo abrange.
- O teste do referente comprova a ligação: abrange quando? $\rightarrow$ Hoje.
- Conclusão: Trata-se de advérbio de tempo modificador de verbo distante.
...
1. Confirmar se o termo modificado $Y$ é um adjetivo ou advérbio.
2. Realizar o teste de substituição de $X$ pelo advérbio muito.
...
Esta tabela sintetiza as formulações canônicas desenvolvidas no grupo, apontando para as unidades temáticas detalhadas da Seção 5:

| Conceito / Regra | Formulação Canônica | ID Detalhado |
| --- | --- | --- |
| Semântica do Advérbio | Sentido e valor circunstancial projetados sobre verbo, adjetivo ou advérbio. |  |
| Regra do Intensificador | Advérbio ligado a adjetivo ou advérbio expressa obrigatoriamente intensidade. |  |
| Dupla Face de 'Nunca' | O vocábulonunca expressa simultaneamente valor de negação e de tempo. |  |
| Sufixo '-mente' Temporal | Terminações em-mente podem indicar tempo/frequência (raramente) ou afirmação (certamente). |  |
| Invariabilidade em 'Estar Bem' | Bem invariável = advérbio (adjunto adverbial); verbo estar = intransitivo (V.I.). |  |
| Coordenação em '-mente' | Em advérbios coordenados, o sufixo-mente figura no último e fica elíptico nos anteriores. |  |
| Mobilidade do Advérbio | O adjunto adverbial pode estar deslocado e distante sem perder a ligação ao verbo. |  |
| Adjetivo vs Advérbio | Modificador de substantivo é adjetivo; modificador de verbo/adj/adv é advérbio. |  |
| Comando 'Intensifica' | Na linguagem Cebraspe, "intensifica o sentido" equivale a "advérbio de intensidade". |  |
...
1. Se o advérbio apontar para adjetivo/advérbio, classifique-o imediatamente como Intensidade.
...
1. Julgue o Bloco 1 isoladamente no texto de apoio.
2. Se o Bloco 1 contiver erro morfológico (ex.: chamar adjetivo de advérbio), invalide o item imediatamente (marque ERRADO), sem se deixar influenciar pela beleza ou veracidade do Bloco 3.
3. O item só será CERTO se todos os blocos fracionados forem rigorosamente verdadeiros.
...
1. Se o teste validar o papel modificador de adjetivo/advérbio, marque CERTO.
...
| Critério de Comparação | Conceito A | Conceito B | Critério Decisivo de Distinção |
| --- | --- | --- | --- |
| Referente Sintático | Adjetivo (liga-se a Substantivo) | Advérbio (liga-se a Verbo, Adjetivo ou Advérbio) | Desenhar a seta sintática . Modificador de substantivo jamais é advérbio. |
| Semântica do Vocábulo 'Bem' | Modo (quando ligado a Verbo: "dorme bem") | Intensidade (quando ligado a Adjetivo/Advérbio: "bem alto", "bem cedo") | Identificar a classe gramatical do termo imediatamente modificado . |
| Sufixo '-mente' | Modo (rapidamente = jeito rápido) | Tempo / Frequência (raramente = poucas vezes no tempo) | Perguntar: Indica ojeito de fazer ou quando/com que frequência ocorre? |
| Predicação Verbal | Estar + Adjetivo ("Ela está feliz" $\rightarrow$ VL + Predicativo) | Estar + Advérbio ("Ela está bem" $\rightarrow$ VI + Adjunto Adverbial) | Teste do plural : adjetivo flexiona (felizes); advérbio não flexiona (bem). |
| Coordenação de Sufixo '-mente' | Primeiro Termo (clara em "clara e singelamente") | Segundo Termo (singelamente) | Ambos são advérbios de modo; o sufixo-mente fica implícito no primeiro termo . |
...
- Classificação: Advérbio de Tempo (Frequência).

- Confiança: alta
- Texto: "Hoje, em boa parte das sociedades modernas, o conceito de povo abrange todos os adultos integrados na sociedade..."
- Item: A palavra “Hoje” (primeiro período do último parágrafo) classifica-se como advérbio de tempo.
- Gabarito: CERTO
...
- Gabarito: CERTO
- Justificativa Pedagógica: "Diferentes" é adjetivo relativo ao substantivo "recursos". O vocábulo "bem" modifica esse adjetivo, funcionando como advérbio de intensidade (equivalente a "muito diferentes"). A assertiva utiliza corretamente o termo técnico "intensifica".
...
Classe gramatical de palavra invariável que se relaciona com um verbo, um adjetivo ou outro advérbio, projetando sobre ele uma circunstância (tempo, modo, lugar, afirmação, negação) ou intensidade. Unidades relacionadas: , .

Denominação técnica utilizada pelas bancas de concurso (notadamente o Cebraspe) para o advérbio de intensidade quando este atua modificando a gradação semântica de um adjetivo ou de outro advérbio. Unidades relacionadas: , .

Propriedade morfológica intrínseca do advérbio, caracterizada pela ausência de flexão de gênero (masculino/feminino) e de número (singular/plural), diferentemente de adjetivos, substantivos e pronomes. Unidades relacionadas: , .

Função sintática desempenhada pelo advérbio ou pela locução adverbial no interior da oração, qualificando o verbo, adjetivo ou advérbio. Unidades relacionadas: , .

Técnica operacional de resolução de itens de Certo/Errado que divide uma proposição complexa em subafirmações morfológicas, sintáticas e semânticas independentes. Unidades relacionadas: , .

Estratégia redacional das bancas examinadoras consistente em formular uma conclusão textual correta e envolvente no desfecho de um item para mascarar uma incorreção técnica de morfossintaxe apresentada no início. Unidades relacionadas: , .

---

## Síntese para recuperação ativa

Ao concluir o estudo consolidado desta unidade , o estudante domina com segurança:

1. A Dimensão Semântica do Advérbio: Sabe identificar com precisão se um advérbio ou locução expressa tempo, lugar, modo, intensidade, negação ou afirmação por meio das perguntas-chave (onde?, quando?, como/jeito?).
2. A Regra de Ouro da Modificação: Reconhece instantaneamente que um advérbio ligado a adjetivo ou a outro advérbio atua como intensificador (intensidade), abandonando a falsa premissa de que a palavra bem expressa sempre modo.
3. A Desmistificação do Sufixo '-mente': Compreende que palavras em -mente podem indicar tempo/frequência (raramente) ou afirmação (certamente), e sabe resolver coordenações estilísticas (clara e singelamente) aplicando o mantra "o que vem depois, salva".
4. A Morfossintaxe e Invariabilidade Adverbial: Aplica o teste do plural para comprovar a invariabilidade do advérbio e compreende por que, na oração "Ela está bem", a palavra bem é adjunto adverbial de modo e o verbo estar é intransitivo (V.I.).
5. A Mobilidade Sintática: Rastreia adjuntos adverbiais deslocados ao longo do período ("Hoje"... "abrange"), identificando seu verbo de referência independentemente da distância física.
6. A Blindagem contra Armadilhas do Cebraspe: Domina o método do fatiamento de assertivas e neutraliza a estratégia de "sedução semântica" da banca examinadora.
